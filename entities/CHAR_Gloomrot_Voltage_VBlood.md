---
title: CHAR_Gloomrot_Voltage_VBlood
guid: -1101874342
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Gloomrot_Voltage_VBlood_Downed PrefabGuid(1682893847)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(198641253)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Gloomrot_Voltage_VBlood PrefabGuid(-1101874342)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Gloomrot_Voltage PrefabGuid(816206535)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_KickCombo_AbilityGroup PrefabGuid(1878838878)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_LeapAttack_Hard_AbilityGroup PrefabGuid(-1853889696)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_Whip_AbilityGroup PrefabGuid(1191517048)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_ElectricSprint_AbilityGroup PrefabGuid(-177268000)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_LeapAttack_AbilityGroup PrefabGuid(2016544872)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_SprintKick_AbilityGroup PrefabGuid(788963695)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_Whirlwind_AbilityGroup PrefabGuid(-1243386667)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_ElectricRod_AbilityGroup PrefabGuid(-1548349308)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_KickCombo_Final_AbilityGroup PrefabGuid(1851411882)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_SprintKick_Antip_AbilityGroup PrefabGuid(-1143650386)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Voltage_Swap_AbilityGroup PrefabGuid(-1372140488)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_Gloomrot_Voltage_HideWhip PrefabGuid(-1716622857)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Voltage_Stage2_Transition1 PrefabGuid(-10363246)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Voltage PrefabGuid(228678537)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T06_Whip PrefabGuid(142799020)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Voltage PrefabGuid(-525986975)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: Buff_Gloomrot_Voltage_Return PrefabGuid(-1773136595)`
  - `State: ProjectM.GenericEnemyState Return`

- **[2]**
  - `BuffGuid: Buff_Gloomrot_Voltage_HideWhip PrefabGuid(-1716622857)`
