---
title: Recipe_Ingredient_SculpturedWood
guid: 222408145
...
# Recipe_Ingredient_SculpturedWood
...
- [RecipeData](/components/RecipeData){:target="_blank"}
  - `Entity: Prefab Recipe_Ingredient_SculpturedWood PrefabGuid(222408145) - Entity(19449:1)`
  - `Guid: Recipe_Ingredient_SculpturedWood PrefabGuid(222408145)`
  - `CraftDuration: 30`
  - `HudSortingOrder: 0`
  - `AlwaysUnlocked: True`
  - `HideInStation: False`
...
- **[0]**
  - `Guid: Item_Ingredient_SculpturedWood PrefabGuid(-793913499)`
  - `Amount: 1`
