---
title: CHAR_Farmlands_HostileVillager_Male_Torch
guid: -81727312
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1204578387)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_HostileVillager_Thrower PrefabGuid(359947687)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_HostileVillager_TorchAttack_AbilityGroup PrefabGuid(2136688539)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_HostileVillager_TorchThrow_AbilityGroup PrefabGuid(1850527627)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
