---
title: AB_Vampire_CrimsonIronMaiden_Expunge_Cast
guid: 1261360934
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_CrimsonIronMaiden_Expunge_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Vampire_CrimsonIronMaiden_Expunge_Cast PrefabGuid(1261360934)`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffOnAllWithBuff_Cast_DataServer](/components/Script_ApplyBuffOnAllWithBuff_Cast_DataServer){:target="_blank"}
  ...
  - `BuffRequired: AB_Vampire_CrimsonIronMaiden_Entomb_TargetEntombedBuff PrefabGuid(-1906344151)`
  - `BuffToApply: AB_Vampire_CrimsonIronMaiden_Expunge_LaunchBuff PrefabGuid(-382462124)`
