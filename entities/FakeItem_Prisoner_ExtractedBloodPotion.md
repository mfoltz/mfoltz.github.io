---
title: FakeItem_Prisoner_ExtractedBloodPotion
guid: -1871776321
categories: ['All', 'Fake']
nav_exclude: true
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: FakeItem_Prisoner_ExtractedBloodPotion PrefabGuid(-1871776321)`
  - `DropItemPrefab: Resource_Drop_General PrefabGuid(-1221682951)`
  - `DropItemArc: GUID Not Found`
  - `MaxAmount: 1`
  - `ItemType: ProjectM.ItemType Consumable`
  - `ItemCategory: ProjectM.ItemCategory Blood, BloodPotion`
  - `RemoveOnConsume: True`
  - `SortOrder: 0`

- [CastAbilityOnConsume](/components/CastAbilityOnConsume){:target="_blank"}
  - `AbilityGuid: AB_Consumable_PrisonBloodPotion_AbilityGroup PrefabGuid(974235336)`

- [DealDamageToPrisoner](/components/DealDamageToPrisoner){:target="_blank"}
  - `DealPercentualDamage_Min: 0.3`
  - `DealPercentualDamage_Max: 0.6`
  - `DealPercentualTorture_Min: 0.1`
  - `DealPercentualTorture_Max: 0.2`

- [StoredBlood](/components/StoredBlood){:target="_blank"}
  - `BloodQuality: 0`
