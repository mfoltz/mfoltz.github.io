---
title: CHAR_Undead_SkeletonGolem
guid: -1380216646
categories: ['All', 'CHAR']
nav_exclude: true
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Undead_SkeletonGolem_MinionSpawner PrefabGuid(-931287980)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -128742993`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1430087990`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_SkeletonGolem PrefabGuid(-644899121)`
