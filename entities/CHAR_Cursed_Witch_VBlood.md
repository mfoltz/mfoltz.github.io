---
title: CHAR_Cursed_Witch_VBlood
guid: -910296704
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `CircleChangeDirectionFrequencyMax: 4.5`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Cursed_Witch_VBlood_Downed PrefabGuid(1739795357)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(838363153)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Cursed_Witch_VBlood PrefabGuid(-910296704)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_Witch_VBlood PrefabGuid(987360205)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_WitchBolt_AbilityGroup PrefabGuid(1511001063)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_WickedWhisps_AbilityGroup PrefabGuid(1294766036)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_Hex_VBlood_AbilityGroup PrefabGuid(1860769470)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_ExplodingMushrooms_AbilityGroup PrefabGuid(1603735911)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_CorruptedGhouls_AbilityGroup PrefabGuid(1898980277)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_ExplodeMosquito_AbilityGroup PrefabGuid(-1729075022)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_DeathSquad_AbilityGroup PrefabGuid(1628136011)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Witch PrefabGuid(739063686)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Witch PrefabGuid(-1219399206)`
