---
title: AB_Interact_UseCastleHeart
guid: -600929294
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.UI.GoToHUDMenu](/components/GoToHUDMenu){:target="_blank"}
  - `Delay: 0`
  - `IsHandled: False`
  - `MenuType: ProjectM.UI.HUDMenuType CastleHeartMenu`
...
- **[0]**
  - `Trophy: ProjectM.Trophy LordOfTheLand`
...
- [ProjectM.UseCastleHeart](/components/UseCastleHeart){:target="_blank"}
  - *(No fields)*
