...
- [AchievementData](/components/AchievementData){:target="_blank"}
  - `Level: 30`
  - `Reward: Journal_Reward_Tech_ServantCoffin PrefabGuid(-217048074)`
...
- **[0]**
  - `PrefabGuid: Journal_SubTask_Interact_StoneCoffin PrefabGuid(-2058636945)`
