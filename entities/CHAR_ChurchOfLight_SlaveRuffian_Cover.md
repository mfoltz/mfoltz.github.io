---
title: CHAR_ChurchOfLight_SlaveRuffian_Cover
guid: -1387838833
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_ChurchOfLight_SlaveRuffian_Servant PrefabGuid(-1416355128)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(671871002)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 43.881657`
  - `SpellPower: 43.881657`
  - `ResourcePower: 27.789999`
  - `SiegePower: 16.6`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_SlaveRuffian PrefabGuid(71256154)`
...
- **[1]**
  - `BaseAbilityGroupOnSlot: AB_SlaveRuffian_Mine_AbilityGroup PrefabGuid(2122592609)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_SlaveRuffian_Shout_AbilityGroup PrefabGuid(506072916)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff2: Buff_General_SilverSlaveCover PrefabGuid(-1274403808)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_CoverSlave PrefabGuid(-223678683)`
