---
title: AB_Purifier_ChaosVolley_Channel
guid: 1984434974
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Purifier_ChaosVolley_Channel
...
- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: AB_Purifier_ChaosVolley_PostCast PrefabGuid(-1907523949)`
...
- [ProjectM.Gameplay.Scripting.AbilityThrowMultipleWithSpreadOnTick_DataServer](/components/AbilityThrowMultipleWithSpreadOnTick_DataServer){:target="_blank"}
  - `RandomHitRadius: 1`
  - `NewThrowEntity: AB_Purifier_ChaosVolley_Throw PrefabGuid(1613206303)`
  - `Count: 1`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1089221531`
