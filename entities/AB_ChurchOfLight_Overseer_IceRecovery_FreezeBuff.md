...
- [AbsorbCapStackModifier](/components/AbsorbCapStackModifier){:target="_blank"}
  - `BaseValue: 0`
  - `Modifier: 0.2`
...
- [DestroyBuffOnDamageTaken](/components/DestroyBuffOnDamageTaken){:target="_blank"}
  - `IncludeDoTs: False`

- [SetDynamicCollisionHardnessBuff](/components/SetDynamicCollisionHardnessBuff){:target="_blank"}
  - `Hardness: 1`
