---
title: AB_Sommelier_HorizontalBarrel_Hard_SpawnerTripple
guid: 216868165
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Sommelier_HorizontalBarrel_Hard_SpawnerTripple
...
- [ProjectM.Gameplay.Scripting.Script_SommelierHorizontalBarrels_DataServer](/components/Script_SommelierHorizontalBarrels_DataServer){:target="_blank"}
  - `SpawnEntity: AB_Sommelier_HorizontalBarrel_Hard_Projectile PrefabGuid(673647636)`
  - `Amount: 11`
  - `Waves: 5`
  - `Spacing: 2.5`
  - `DelayBetweenWaves: 1.5`
  - `DelayBetween_Min: 0`
  - `DelayBetween_Max: 0.2`
  - `RoomSizeOffset: 15.5`
  - `Timer: 0`
  - `WaveTimer: 0`
  - `CenterPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `Direction: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
...
- [ProjectM.Gameplay.Scripting.BarrelIds](/components/BarrelIds){:target="_blank"}
  - *(No fields)*
