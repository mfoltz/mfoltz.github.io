...
- [Script_SommelierHorizontalBarrels_DataServer](/components/Script_SommelierHorizontalBarrels_DataServer){:target="_blank"}
...
- [BarrelIds](/components/BarrelIds){:target="_blank"}
  - *(No fields)*
