---
title: AB_Interact_ServantCoffinSpawn_Travel
guid: 509296401
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_ServantCoffinSpawn_Travel
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_afdgigchdc`
...
- [ProjectM.Gameplay.Scripting.UpdateBuffTargetSpawnPosition_DataServer](/components/UpdateBuffTargetSpawnPosition_DataServer){:target="_blank"}
  - `When: ProjectM.Gameplay.Scripting.UpdateBuffTargetSpawnPositionWhen Destroy`
