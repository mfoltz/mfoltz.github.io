---
title: AB_IceRanger_LurkerSpikes_Split_Cast
guid: 1868900578
categories: ['AB', 'All']
nav_exclude: true
...
# AB_IceRanger_LurkerSpikes_Split_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_IceRanger_LurkerSpikes_Split_Cast PrefabGuid(1868900578)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 1.0471976`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_IceRanger_LurkerSpikes_Split_Projectile PrefabGuid(801218059)`
  - `Count: 3`
  - `Condition: None`
