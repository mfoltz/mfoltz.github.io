---
title: AB_Subdue_RecallTarget_Cast
guid: 1983062393
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityTarget](/components/AbilityTarget){:target="_blank"}
  ...
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(685381065)`
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Subdue_RecallTarget_Cast PrefabGuid(1983062393)`
...
- [ProjectM.AbilityInterruptData](/components/AbilityInterruptData){:target="_blank"}
  ...
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, OnDamageTaken, GameplayAbilities, Obstructed`
...
- **[0]**
  - `SpawnPrefab: AB_Subdue_RecallTarget_Trigger PrefabGuid(-1608732309)`
