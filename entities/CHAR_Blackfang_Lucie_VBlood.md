---
title: CHAR_Blackfang_Lucie_VBlood
guid: 1295855316
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Downed_Lucie_VBlood PrefabGuid(-1117809650)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(90523416)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Blackfang_Lucie_VBlood PrefabGuid(1295855316)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Lucie_VBlood PrefabGuid(-1198955038)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_ToxinBolt_AbilityGroup PrefabGuid(2053056011)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_DeadlyInjection_AbilityGroup PrefabGuid(973975627)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_ClarityPotion_AbilityGroup PrefabGuid(1310557060)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_CripplingGoo_AbilityGroup PrefabGuid(1501543883)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_Barrier_AbilityGroup PrefabGuid(1628835400)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_LiquidFire_AbilityGroup PrefabGuid(846507754)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_PanicShot_AbilityGroup PrefabGuid(2041625587)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_PickUpPotion_WalkToPotion_AbilityGroup PrefabGuid(385165207)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_PickUpPotion_Pickup_AbilityGroup PrefabGuid(505640659)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_Roll_AbilityGroup PrefabGuid(-1358113706)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_AlchemicMadness_WalkToPos_AbilityGroup PrefabGuid(550876706)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_AlchemicMadness_Channel_AbilityGroup PrefabGuid(-1617880256)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Lucie_WakeGolemPotion_AbilityGroup PrefabGuid(-2029137394)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Lucie PrefabGuid(-1642797098)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Lucie_VBlood PrefabGuid(604033279)`
