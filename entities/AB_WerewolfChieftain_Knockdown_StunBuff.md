...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_WerewolfChieftain_Knockdown_AttackBuff PrefabGuid(-317372843)`
...
- **[0]**
  - `PrimarySequenceGuid: SequenceGUID -259365030`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-317372843)`
