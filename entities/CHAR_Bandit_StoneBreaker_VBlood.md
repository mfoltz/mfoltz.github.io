---
title: CHAR_Bandit_StoneBreaker_VBlood
guid: -2025101517
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-520625151)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_StoneBreaker_VBlood PrefabGuid(-2025101517)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_StoneBreaker_VBlood PrefabGuid(-956340614)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_VBlood_SwingAttack_AbilityGroup PrefabGuid(-331113507)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_SwingAttack_Hard_AbilityGroup PrefabGuid(1684865572)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_VBlood_RockSmash_AbilityGroup PrefabGuid(-96620724)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_RockSmash_Hard_AbilityGroup PrefabGuid(2078583785)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_VBlood_SpinAttack_Group PrefabGuid(-47403235)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_VBlood_Reinforcement_Group PrefabGuid(1267543813)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_VBlood_MountainRumbler_AbilityGroup PrefabGuid(593979922)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StoneBreaker_MountainRumbler_Hard_AbilityGroup PrefabGuid(1688748795)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T02_StoneBreaker PrefabGuid(-1230635663)`

- **[1]**
  - `Guid: Tech_Storage_Pack_T01_A PrefabGuid(134968992)`

- **[2]**
  - `Guid: Tech_Collection_Brazier_01 PrefabGuid(1789166952)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_StoneBreaker PrefabGuid(-955739317)`
