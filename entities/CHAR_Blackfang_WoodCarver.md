---
title: CHAR_Blackfang_WoodCarver
guid: -1508046438
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_WoodCarver_Servant PrefabGuid(-2089362645)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_WoodCarver PrefabGuid(-1729879936)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_StrongBlade_Workers_T01 PrefabGuid(1017396238)`
