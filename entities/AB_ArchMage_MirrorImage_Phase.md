---
title: AB_ArchMage_MirrorImage_Phase
guid: 30325069
categories: ['AB', 'All']
nav_exclude: true
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_ArchMage_MirrorImage_EndPhase PrefabGuid(262354515)`
...
- **[0]**
  - `SpawnPrefab: AB_ArchMage_MirrorImage_Trigger PrefabGuid(292114817)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
