---
title: AB_Dracula_Final_TravelToCenter_Hard_LandPhase
guid: -1722767889
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Dracula_Final_TravelToCenter_Hard_LandPhase
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 0f, 0.2f)`
...
- [ProjectM.TravelBuff](/components/TravelBuff){:target="_blank"}
  ...
  - `RotationMode: ProjectM.MovementCurveRotationMode None`
  - `CurveId: 0`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Dracula_Final_Channel_02_SummonBloodSouls PrefabGuid(344852790)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1932157180`
