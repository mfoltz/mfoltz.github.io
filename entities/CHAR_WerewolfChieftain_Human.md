---
title: CHAR_WerewolfChieftain_Human
guid: -1505705712
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 32`
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 8`
  - `CircleChangeDirectionFrequencyMax: 9`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_WerewolfChieftain_VBlood_Downed PrefabGuid(928010188)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1788823022)`
...
- [ProjectM.CastHistoryData](/components/CastHistoryData){:target="_blank"}
  - `StorageTimeSeconds: 60`

- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(62959306)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_WerewolfChieftain_Human PrefabGuid(-1505705712)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_WerewolfChieftain_VBlood PrefabGuid(-2131084443)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_Human_MeleeAttack_Group PrefabGuid(1916767891)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_MeleeAttack_AbilityGroup PrefabGuid(-988264305)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_ShadowDash_AbilityGroup PrefabGuid(-566065717)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_Knockdown_AbilityGroup PrefabGuid(1445822330)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_Stealth_AbilityGroup PrefabGuid(-192549213)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_MultiBite_AbilityGroup PrefabGuid(-174926399)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_MultiBiteBuff_AbilityGroup PrefabGuid(-67893977)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_OpenTheCages_AbilityGroup PrefabGuid(2030404176)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_FeedBuff_AbilityGroup PrefabGuid(1001804923)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_Feed_AbilityGroup PrefabGuid(1113171592)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_WerewolfChieftain_MultiBiteBuff_Hard_AbilityGroup PrefabGuid(149010586)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_General_Shapeshift_Werewolf_VBlood PrefabGuid(-622259665)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Werewolf PrefabGuid(-330347291)`

- **[1]**
  - `Guid: Tech_Collection_Clocks PrefabGuid(-1847627135)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_WerewolfChieftain_Werewolf PrefabGuid(1287682259)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: Buff_WerewolfChieftain_Return PrefabGuid(-1511222240)`
  - `State: ProjectM.GenericEnemyState Return`

- **[2]**
  - `BuffGuid: Buff_WerewolfChieftain_Idle PrefabGuid(-43198776)`
  - `State: ProjectM.GenericEnemyState Idle`

- [ProjectM.Shared.DropTableBuffer](/components/DropTableBuffer){:target="_blank"}

- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_Villagers PrefabGuid(997800352)`
