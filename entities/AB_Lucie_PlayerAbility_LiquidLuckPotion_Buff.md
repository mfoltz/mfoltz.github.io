...
# AB_Lucie_PlayerAbility_LiquidLuckPotion_Buff
...
- [ProjectM.Gameplay.Scripting.Script_ModifySpellAbilityCooldownOnGameplayEvent_DataServer](/components/Script_ModifySpellAbilityCooldownOnGameplayEvent_DataServer){:target="_blank"}
  - `ModifyCooldown: 0`
