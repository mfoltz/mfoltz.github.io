---
title: TM_CarriageContainer_BanditCopper
guid: 785770588
categories: ['All', 'TM']
nav_exclude: true
...
# TM_CarriageContainer_BanditCopper
...
- **[0]**
  - `DropTableGuid: DT_Shared_Treasure_Carriage_T01_Bandit PrefabGuid(881815799)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnSpawnDropInInventory`
  - `RelicType: ProjectM.Shared.RelicType None`

- **[1]**
  - `DropTableGuid: DT_Carriage_T01_Copper PrefabGuid(-1677509406)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnSpawnDropInInventory`
  - `RelicType: ProjectM.Shared.RelicType None`
