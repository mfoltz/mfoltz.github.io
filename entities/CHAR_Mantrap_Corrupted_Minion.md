---
title: CHAR_Mantrap_Corrupted_Minion
guid: 1906792990
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1368394802)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_MantrapSapling_Corrupted_Projectile_AbilityGroup PrefabGuid(-581209791)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_MantrapSapling_Corrupted_MeleeAttack_AbilityGroup PrefabGuid(-267258900)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
