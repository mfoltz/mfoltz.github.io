---
title: AB_Blackfang_Morgana_SpectralSwarm_DummyBuff
guid: 2017731479
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Blackfang_Morgana_SpectralSwarm_DummyBuff
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-2122362769)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralSwarm_Projectile02 PrefabGuid(1268090318)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget BuffTarget`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
