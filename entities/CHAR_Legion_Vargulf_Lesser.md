---
title: CHAR_Legion_Vargulf_Lesser
guid: 2049379982
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-515279445)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 52.045605`
  - `SpellPower: 52.045605`
  - `ResourcePower: 32.8`
  - `SiegePower: 15.4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Vargulf PrefabGuid(987389967)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_SlicingArm_AbilityGroup PrefabGuid(523087989)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulKnockdown_AbilityGroup_Lesser PrefabGuid(1131137826)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulSetup_TravelRight_AbilityGroup PrefabGuid(1166812757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulSetup_TravelLeft_AbilityGroup PrefabGuid(-1229087512)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulSetup_Init_AbilityGroup PrefabGuid(86533405)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_Approach_AbilityGroup PrefabGuid(-968445725)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulSetup_Init_AbilityGroup_Followup PrefabGuid(-1915922151)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_Legion_Normal_T01 PrefabGuid(-2122742635)`
