...
- [ProjectM.Terrain.WorldZoneId](/components/WorldZoneId){:target="_blank"}
  - `MapType: ProjectM.Terrain.MapType None`
  - `ZoneStartChunk: ProjectM.Terrain.TerrainChunk 0,0`
  - `ZoneChunkSize: Unity.Mathematics.int2 int2(0, 0)`
  - `IsChunkInstance: False`

- [Stunlock.Core.PrefabGUID](/components/PrefabGUID){:target="_blank"}
  - `_Value: 1781887812`

- [ProjectM.UserMapZonePackedRevealElement](/components/UserMapZonePackedRevealElement){:target="_blank"}
  - *(No fields)*
