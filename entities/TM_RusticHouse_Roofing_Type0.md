---
title: TM_RusticHouse_Roofing_Type0
guid: 1479642074
categories: ['All', 'TM']
nav_exclude: true
...
- [ProjectM.CastleBuilding.CastleRoofOrnaments](/components/CastleRoofOrnaments){:target="_blank"}
...
- [ProjectM.Roofs.RoofTileData](/components/RoofTileData){:target="_blank"}
  - `RoofCategory: ProjectM.Roofs.RoofCategoryType RusticHouse`
  - `TileBlobType: ProjectM.Roofs.TileBlobRootType Type0_Empty`
  - `RotationOffset: ProjectM.Terrain.OrthogonalRotation Rotate_180`
...
- [ProjectM.Roofs.RoofInstanceTypeId](/components/RoofInstanceTypeId){:target="_blank"}
