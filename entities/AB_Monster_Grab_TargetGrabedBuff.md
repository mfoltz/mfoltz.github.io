---
title: AB_Monster_Grab_TargetGrabedBuff
guid: -759087433
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Monster_Grab_TargetGrabedBuff
...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  - `ClientPositionOffset: Unity.Mathematics.float3 float3(-0.5f, -0.3f, -0.2f)`
  - `ClientRotationOffset: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `ServerPositionOffset: Unity.Mathematics.float3 float3(0f, 3f, -0.5f)`
  - `HybridBone: 2`
  - `CopyPosition: True`
  - `CopyRotation: True`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Monster_Grab_HasGrabedBuff PrefabGuid(1120701436)`
