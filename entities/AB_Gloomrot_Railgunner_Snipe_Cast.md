---
title: AB_Gloomrot_Railgunner_Snipe_Cast
guid: 1948219540
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Gloomrot_Railgunner_Snipe_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Gloomrot_Railgunner_Snipe_Cast PrefabGuid(1948219540)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_Railgunner_Snipe_Projectile PrefabGuid(459499791)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_Railgunner_Snipe_SelfKnockback PrefabGuid(-1598227601)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
