---
title: AB_Vampire_BloodKnight_SkeweringLeap_Disengage_Phase
guid: -230111348
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_BloodKnight_SkeweringLeap_Disengage_Phase
...
- **[0]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 0.4`
  - `Stacks: 1`
  - `Buff0: AB_Vampire_BloodKnight_SkeweringLeap_PostTravelBuff PrefabGuid(635641795)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1765120998`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_SkeweringLeap_AreaImpact PrefabGuid(633578107)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
