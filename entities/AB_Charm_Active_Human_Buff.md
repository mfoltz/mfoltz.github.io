...
- [ProjectM.BlockHealBuff](/components/BlockHealBuff){:target="_blank"}
  - `PercentageBlocked: 1`

- [ProjectM.ModifyTeamBuff](/components/ModifyTeamBuff){:target="_blank"}
  - `Source: ProjectM.ModifyTeamBuffAuthoring+ModifyTeamSource OwnerTeam`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Charm_Owner_HasCharmedTarget_Buff PrefabGuid(-2147040513)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1427964088`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1967893740`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  ...
  - `Slot: 5`
  - `ReplaceGroupId: AB_Charm_AbilityGroup PrefabGuid(-107743040)`
  - `NewGroupId: AB_Charm_ReleaseTarget_Human_AbilityGroup PrefabGuid(826190081)`
  - `Priority: 5`
  - `Condition: None`
...
- [ProjectM.FollowBuffOwner](/components/FollowBuffOwner){:target="_blank"}
  - *(No fields)*

- [ProjectM.PreventDisableBuff](/components/PreventDisableBuff){:target="_blank"}
  - *(No fields)*
