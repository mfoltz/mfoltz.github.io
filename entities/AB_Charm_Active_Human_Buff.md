...
- [BlockHealBuff](/components/BlockHealBuff){:target="_blank"}
  - `PercentageBlocked: 1`
...
- [FollowBuffOwner](/components/FollowBuffOwner){:target="_blank"}
  - *(No fields)*

- [PreventDisableBuff](/components/PreventDisableBuff){:target="_blank"}
  - *(No fields)*
