---
title: CHAR_Undead_BishopOfDeath_VBlood
guid: 577478542
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_BishopOfDeath_VBlood_Downed PrefabGuid(-1333192053)`
  - `TriggerSequence: SequenceGUID 429419297`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(662505323)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_BishopOfDeath_VBlood PrefabGuid(577478542)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_BishopOfDeath_VBlood PrefabGuid(-789777617)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_Projectile_Group PrefabGuid(780432315)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_ChainBolt_Hard_AbilityGroup PrefabGuid(-323939446)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_CorpseExplosion_AbilityGroup PrefabGuid(-1272200774)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_CorpseExplosion_Hard_AbilityGroup PrefabGuid(1971375367)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_FleshWarp_Travel_AbilityGroup PrefabGuid(2145809434)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_CorpseParty_AbilityGroup PrefabGuid(622287046)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_CorpseParty_Hard_AbilityGroup PrefabGuid(-184530068)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfDeath_SmallExplosion_AbilityGroup PrefabGuid(852659329)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T03_Goreswine_MagicSource PrefabGuid(-934771037)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T03_Goreswine PrefabGuid(503108272)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_T03_Goreswine_Units PrefabGuid(1226331752)`

- **[3]**
  - `Guid: Tech_Collection_VBlood_T03_GoreswineFence PrefabGuid(-1852229711)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_BishopOfDeath PrefabGuid(-1410079457)`
