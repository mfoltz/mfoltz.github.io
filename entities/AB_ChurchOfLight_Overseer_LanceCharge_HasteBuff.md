---
title: AB_ChurchOfLight_Overseer_LanceCharge_HasteBuff
guid: -1916256107
categories: ['AB', 'All']
nav_exclude: true
...
# AB_ChurchOfLight_Overseer_LanceCharge_HasteBuff
...
- [ProjectM.Gameplay.Scripting.Script_IceMovementBuff_DataServer](/components/Script_IceMovementBuff_DataServer){:target="_blank"}
  - `Acceleration: 0.5`
  - `Friction: 2`
  - `AccerationModId: Unset`
  - `FrictionModId: Unset`
