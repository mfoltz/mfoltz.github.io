---
title: CHAR_Legion_Guardian_DraculaMinion_Lesser
guid: 1144208724
categories: ['All', 'CHAR']
nav_exclude: true
...
# CHAR_Legion_Guardian_DraculaMinion_Lesser
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1542934598)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Guardian_MinionAttackChain_AbilityGroup_01 PrefabGuid(-2042076580)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Guardian_NecroWarp_AbilityGroup PrefabGuid(-639471262)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Guardian_MinionAttackChain_AbilityGroup_02 PrefabGuid(-809908964)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
