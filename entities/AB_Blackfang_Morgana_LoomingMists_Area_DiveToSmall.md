---
title: AB_Blackfang_Morgana_LoomingMists_Area_DiveToSmall
guid: -563834486
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Blackfang_Morgana_LoomingMists_Area_DiveToSmall
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acikhjeehkg`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Morgana_LoomingMists_Area_Default PrefabGuid(-75547790)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Morgana_LoomingMists_Area_CenterPool PrefabGuid(-1739908100)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  ...
  - `CurveMin: 10`
  - `CurveMax: 70`
  - `CombatTagEvent: External - -734495057`
  - `StaticDistance: 0`
...
- [ProjectM.DestroyOnOwnerDeath](/components/DestroyOnOwnerDeath){:target="_blank"}
  - *(No fields)*
