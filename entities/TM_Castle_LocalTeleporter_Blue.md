---
title: TM_Castle_LocalTeleporter_Blue
guid: 760696617
categories: ['All', 'TM']
nav_exclude: true
...
# TM_Castle_LocalTeleporter_Blue
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_LocalTeleporter_Blue PrefabGuid(760696617) - Entity(41282:2)`
  - `Guid: TM_Castle_LocalTeleporter_Blue PrefabGuid(760696617)`
...
��  �.��   ��V�<`
  - `Component  ��������        ���h`
  - `ConditionalElements`
  - `Ability: AB_Interact_LocalCastleTeleport_Blue_AbilityGroup PrefabGuid(1550864188)`
  - `Importance: 1`
