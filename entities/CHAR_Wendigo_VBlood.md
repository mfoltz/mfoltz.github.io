...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Wendigo_VBlood_Downed PrefabGuid(-1720429443)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1557464335)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(-535162217)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Wendigo_VBlood PrefabGuid(24378719)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Wendigo_VBlood PrefabGuid(-646154887)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_MeleeAttack_AbilityGroup PrefabGuid(1568904735)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IcicleThrow_AbilityGroup PrefabGuid(-1683730497)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_FrostNova_AbilityGroup PrefabGuid(1238313774)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceDash_Travel_AbilityGroup PrefabGuid(-496233120)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceDash_Strike_AbilityGroup PrefabGuid(203761859)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceBeam_First_AbilityGroup PrefabGuid(495259674)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_SnowStorm_AbilityGroup PrefabGuid(-2090815764)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceDash_Init_AbilityGroup PrefabGuid(54541608)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceBeam_Second_AbilityGroup PrefabGuid(1390611238)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceDash_Travel_Hard_AbilityGroup PrefabGuid(-2029387940)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_IceDash_Strike_Hard_AbilityGroup PrefabGuid(929369353)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Wendigo_LeapAttack_AbilityGroup PrefabGuid(-1986179833)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T04_Wendigo PrefabGuid(43505638)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T04_Wendigo_Claws PrefabGuid(803940486)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Wendigo PrefabGuid(989251425)`
