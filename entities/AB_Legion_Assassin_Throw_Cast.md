---
title: AB_Legion_Assassin_Throw_Cast
guid: 663997624
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Legion_Assassin_Throw_Cast PrefabGuid(663997624)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_Assassin_Throw_Projectile PrefabGuid(1235292090)`
