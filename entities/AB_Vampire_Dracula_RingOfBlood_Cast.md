---
title: AB_Vampire_Dracula_RingOfBlood_Cast
guid: -404686552
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_Dracula_RingOfBlood_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Vampire_Dracula_RingOfBlood_Cast PrefabGuid(-404686552)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_RingOfBlood_RingArea PrefabGuid(417050911)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_RingOfBlood_ChannelBuff PrefabGuid(-339999587)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Vampire_Dracula_RingOfBlood_Spinner PrefabGuid(-513506791)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
