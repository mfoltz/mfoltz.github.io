---
title: CHAR_Forest_Bear_Dire_Vblood
guid: -1391546313
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Forest_Bear_Dire_VBlood_Downed PrefabGuid(1795477728)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1437704949)`

- [ProjectM.AimRotationParameters](/components/AimRotationParameters){:target="_blank"}
  - `Constant: 1.9`
  - `CoreModifier: 0.95`
...
- [ProjectM.LegDirection_Shared](/components/LegDirection_Shared){:target="_blank"}
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Forest_Bear_Dire_Vblood PrefabGuid(-1391546313)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Forest_Bear_Dire_Vblood PrefabGuid(1159402146)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_MeleeAttack_AbilityGroup PrefabGuid(1814567660)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_AreaAttack_AbilityGroup PrefabGuid(-1972594588)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_Dash_AbilityGroup PrefabGuid(-1709055711)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_Roar_AbilityGroup PrefabGuid(-1559349374)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bear_FallAsleep_Group PrefabGuid(-193432841)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bear_WakeUp_Group PrefabGuid(-388636006)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_MeleeAttack_AbilityGroup_Hasted PrefabGuid(-217583794)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_TargetSwitch_AbilityGroup PrefabGuid(-1748125028)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Dire_OnAggro_Emote_AbilityGroup PrefabGuid(-1155840114)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_FerociousBear PrefabGuid(1481816999)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T05_FerociousBear_Rugs PrefabGuid(-979296135)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Bear_Dire PrefabGuid(1960737087)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_VBlood_DireBear_T01 PrefabGuid(1386511898)`
