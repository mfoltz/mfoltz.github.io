---
title: AB_Bandit_Deadeye_RangedAttack_Cast
guid: 1015300268
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Bandit_Deadeye_RangedAttack_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Bandit_Deadeye_RangedAttack_Cast PrefabGuid(1015300268)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Deadeye_RangedAttack_Projectile PrefabGuid(1262043059)`
