---
title: AB_Consumable_GarlicResistancePotion_T02_Buff
guid: -1796828440
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Consumable_GarlicResistancePotion_T02_Buff
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag GarlicResistance`
  - `KeepOldest: False`
...
- **[0]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1731982445)`
...
- **[1]**
  ...
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag GarlicResistance`
  - `IncludeSelf: False`
...
- [ProjectM.UserRemovableBuff](/components/UserRemovableBuff){:target="_blank"}
  - *(No fields)*
