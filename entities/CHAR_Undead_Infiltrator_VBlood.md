---
title: CHAR_Undead_Infiltrator_VBlood
guid: 613251918
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_Infiltrator_VBlood_Downed PrefabGuid(2075976215)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-311060437)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_Infiltrator_VBlood PrefabGuid(613251918)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_Infiltrator_VBlood PrefabGuid(96615775)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_DoubleStrike_AbilityGroup PrefabGuid(1456136938)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_HeavyAttack_AbilityGroup PrefabGuid(-1422240708)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_ShadowStep_AbilityGroup PrefabGuid(-664569083)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_AfterImage_AbilityGroup PrefabGuid(-1532726733)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_KnifeThrow_AbilityGroup PrefabGuid(1621601748)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_ShadowFlurry_AbilityGroup PrefabGuid(94933870)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_ArmyOfShadows_AbilityGroup PrefabGuid(1986068244)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Infiltrator_KnifeThrow_Hard_AbilityGroup PrefabGuid(-39228843)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  - `Guid: Tech_Collection_VBlood_T05_Infiltrator_Daggers PrefabGuid(1521034384)`
...
- **[0]**
  - `BuffGuid: Buff_Undead_Infiltrator_VBlood_InCombat PrefabGuid(-1173838598)`
...
- **[2]**
  - `BuffGuid: Buff_Undead_Infiltrator_OutOfCombat PrefabGuid(-27509782)`
  - `State: ProjectM.GenericEnemyState Idle, Follow`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Infiltrator_Armor PrefabGuid(1639850227)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
