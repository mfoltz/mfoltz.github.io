---
title: AB_Vampire_Dracula_QuickTeleport_Phase
guid: -863790332
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_Dracula_QuickTeleport_Phase
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 0f, 0.1f)`

- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: AB_Vampire_Dracula_QuickTeleport_End PrefabGuid(2034239168)`
...
- [ProjectM.ModifyStunCloth_Data](/components/ModifyStunCloth_Data){:target="_blank"}
  - `ModType: 0`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Dracula_QuickTeleport_End PrefabGuid(2034239168)`
