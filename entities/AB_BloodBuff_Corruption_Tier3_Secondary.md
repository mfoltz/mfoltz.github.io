---
title: AB_BloodBuff_Corruption_Tier3_Secondary
guid: -779149453
categories: ['AB', 'All']
nav_exclude: true
...
- **ProjectM.Gameplay.Scripting.BloodBuff_Corruption_SnareOnHit_DataShared**
  ...
  - `RequiredBloodPercentage: 60`
  - `IsSecondaryBlood: True`
  - `BuffType: Buff_BloodBuff_Corruption_Tier3_TriggerEffect PrefabGuid(1805583648)`
  - `SpellType: Spell_Corruption_Tier3_Snare_Throw PrefabGuid(123399875)`
...
- **[0]**
  ...
  - `SoftCapValueMinMax: ProjectM.FloatRange { Min: 2, Max: 3 }`
  - `BaseQuality: 60`
...
- **[1]**
  - `StaticValueMinMax: ProjectM.FloatRange { Min: 0, Max: 0 }`
  - `SoftCapValueMinMax: ProjectM.FloatRange { Min: 2.5, Max: 2.5 }`
  - `BaseQuality: 60`
  - `BloodEfficiencyModificationId: Unset`
  - `BloodEfficiencyExcluded: False`
