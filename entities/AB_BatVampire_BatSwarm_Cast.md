---
title: AB_BatVampire_BatSwarm_Cast
guid: -97131038
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_BatVampire_BatSwarm_Cast PrefabGuid(-97131038)`
...
- **[0]**
  - `SpawnPrefab: AB_BatVampire_BatSwarm_Trigger PrefabGuid(410670682)`
...
- **[1]**
  - `SpawnPrefab: AB_BatVampire_BatSwarm_Projectile_Straight PrefabGuid(-1553976958)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
