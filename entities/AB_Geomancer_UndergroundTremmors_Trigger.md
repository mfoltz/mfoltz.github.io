---
title: AB_Geomancer_UndergroundTremmors_Trigger
guid: -1158810522
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Geomancer_UndergroundTremmors_Trigger
...
- [ProjectM.Gameplay.Scripting.Script_SpawnThrowTowardsNearbyVampires_DataServer](/components/Script_SpawnThrowTowardsNearbyVampires_DataServer){:target="_blank"}
  - `ThrowType: AB_Geomancer_UndergroundTremmors_Throw PrefabGuid(18696225)`
  - `MaximumCount: 0`
  - `CountPerTarget: 5`
  - `Radius: 20`
  - `OffsetMin: 0.5`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -2047593101`
