---
title: TM_GloomRot_LightningRod_Refinement_01
guid: -1932531289
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_GloomRot_LightningRod_Refinement_01
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_GloomRot_LightningRod_Refinement_01 PrefabGuid(-1932531289) - Entity(32614:2)`
  - `Guid: TM_GloomRot_LightningRod_Refinement_01 PrefabGuid(-1932531289)`
...
- [LightningRodStation](/components/LightningRodStation){:target="_blank"}
  - `State: ProjectM.LightningRodStationState Ready`
  - `ProcessingRecipe: GUID Not Found`
  - `Progress: 0`
  - `ResetTime: 300`
  - `TimeToReset: 0`
  - `TimeProgressPerStrike: 1`
  - `ConsumerRadius: 0`
  - `ReadySequenceGuid: SequenceGUID 1225254638`
  - `ReadySequenceState: SequenceState`
  - `Id: Entity(0:0)`
  - `WorkingSequenceGuid: SequenceGUID 1790657879`
  - `WorkingSequenceState: SequenceState`
  - `Id: Entity(0:0)`
  - `CompleteSequenceGuid: SequenceGUID -1660087235`
  - `CompleteSequenceState: SequenceState`
  - `Id: Entity(0:0)`
  - `OverloadedSequenceGuid: SequenceGUID 816637522`
  - `OverloadedSequenceState: SequenceState`
  - `Id: Entity(0:0)`
...
- [LightningConsumer](/components/LightningConsumer){:target="_blank"}
  - `ReplacePrefab: True`
  - `Prefab: AB_LightningStorm_Throw_RodConsume PrefabGuid(-856735567)`
  - `Radius: 15`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cihfbcidj`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseLightningRodStation_AbilityGroup PrefabGuid(-1339620791)`
  - `Importance: 1`
...
- **[1]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseLightningRodStation_Overloaded_AbilityGroup PrefabGuid(-80003337)`
  - `Importance: 1`
  - `HideInteractHUDWhileCasting: False`
...
- **[0]**
  - `RecipeGuid: Recipe_Ingredient_BatteryCharged_10x PrefabGuid(1499185347)`
