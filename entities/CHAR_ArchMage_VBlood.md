...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_ArchMage_VBlood_Downed PrefabGuid(-726799934)`
  - `TriggerSequence: SequenceGUID 424470019`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-726763920)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_ArchMage_VBlood PrefabGuid(-2013903325)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ArchMage PrefabGuid(1218517046)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_CrystalLance_AbilityGroup PrefabGuid(1520734123)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_CrystalLance_Charged_AbilityGroup PrefabGuid(1187623532)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_ArcaneImprisonment_AbilityGroup PrefabGuid(91941562)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_MirrorImage_AbilityGroup PrefabGuid(-1897317770)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_FireSpinner_AbilityGroup PrefabGuid(1217615468)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_FlamingIce_AbilityGroup PrefabGuid(-2025881745)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_Teleport_AbilityGroup PrefabGuid(886063983)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_LightningCurse_AbilityGroup PrefabGuid(1365358996)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_LightningArc_AbilityGroup PrefabGuid(-1232816408)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_Emote_Aggro_AbilityGroup PrefabGuid(-139137314)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Archmage PrefabGuid(26064539)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T07_Archmage_JewelsT03 PrefabGuid(-942401074)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_CrystalLamp PrefabGuid(1120119195)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Archmage PrefabGuid(1486750501)`
