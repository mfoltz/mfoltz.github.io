...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Trees_Birch02_Small_Dynamics PrefabGuid(1243946873)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 982085171`
...
- **[0]**
  - `DropTableGuid: DT_Resource_Tree_Sapling_Birch PrefabGuid(-334626750)`
