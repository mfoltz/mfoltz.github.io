---
title: AB_Unholy_Soulburn_SpellBlock_Buff
guid: 1552904661
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Unholy_Soulburn_SpellBlock_Buff
...
- [ProjectM.Gameplay.Scripting.Script_Buff_Spellblock_DataServer](/components/Script_Buff_Spellblock_DataServer){:target="_blank"}
  - `SpellblockBuffType: AB_Unholy_Soulburn_Silence_Buff PrefabGuid(1387118598)`
  - `TriggerBuffDuration: 1.5`
  - `IgnoreSpellBlockFlags: ProjectM.AbilityTypeFlag IgnoreSpellBlock`
  - `TriggerSequence: SequenceGUID 757146082`
