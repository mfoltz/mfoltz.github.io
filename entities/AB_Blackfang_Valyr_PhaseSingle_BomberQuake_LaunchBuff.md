---
title: AB_Blackfang_Valyr_PhaseSingle_BomberQuake_LaunchBuff
guid: -1091954393
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Blackfang_Valyr_PhaseSingle_BomberQuake_LaunchBuff
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseSingle_BomberQuake_SpawnProjectile1 PrefabGuid(-1786507260)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseSingle_BomberQuake_SpawnProjectile3 PrefabGuid(382833138)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseSingle_BomberQuake_SpawnProjectile2 PrefabGuid(-1252965849)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[3]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseSingle_BomberQuake_SpawnProjectile4 PrefabGuid(-1866432316)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
