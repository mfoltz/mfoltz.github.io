---
title: Buff_General_IgniteLesser
guid: -756302728
categories: ['All', 'Buff']
nav_exclude: true
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag Ignite`
  - `KeepOldest: False`
...
- [ProjectM.Gameplay.Scripting.Script_IgniteDebuff_DataServer](/components/Script_IgniteDebuff_DataServer){:target="_blank"}
  - `TotalTicks: 3`
  - `Damage_TotalProcentualHealth_Vampire: 0.03`
  - `Damage_TotalProcentualHealth_Pve: 0.015`
  - `TicksCounter: 0`
  - `StaticPveBonusDamage: 4`
...
- [ProjectM.YieldResourceDisable](/components/YieldResourceDisable){:target="_blank"}
  - *(No fields)*
