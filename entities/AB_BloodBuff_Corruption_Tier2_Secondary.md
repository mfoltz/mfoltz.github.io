---
title: AB_BloodBuff_Corruption_Tier2_Secondary
guid: 1971282100
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_BloodBuff_Corruption_Tier2_Secondary
...
- **ProjectM.Gameplay.Scripting.BloodBuff_Corruption_ReduceMaxStack_DataShared**
  - `MinStack: 4`
  - `MaxStack: 8`
  - `RequiredBloodPercentage: 30`
  - `MaximumStackReductionFromBlood: 9`
...
- **[0]**
  - `StaticValueMinMax: ProjectM.FloatRange { Min: 0.5, Max: 1 }`
...
- **[0]**
  ...
  - `StatType: ProjectM.UnitStatType BloodDrainMultiplier`
