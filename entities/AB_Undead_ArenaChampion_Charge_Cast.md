---
title: AB_Undead_ArenaChampion_Charge_Cast
guid: 163324070
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Undead_ArenaChampion_Charge_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Undead_ArenaChampion_Charge_Cast PrefabGuid(163324070)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_ArenaChampion_Charge_Dash PrefabGuid(-1846280592)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_ArenaChampion_Charge_BlockChargeBuff PrefabGuid(837397627)`
