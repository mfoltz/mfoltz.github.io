...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-233366319)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID -1260462112`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_FlyingSkull PrefabGuid(-910885763)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_FlyingSkull_Approach_AbilityGroup PrefabGuid(381103028)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_FlyingSkull_SelfDestruct_AbilityGroup PrefabGuid(304835919)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_Undead_FlyingSkull_LivingMaterial PrefabGuid(-1559874083)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1559874083)`
