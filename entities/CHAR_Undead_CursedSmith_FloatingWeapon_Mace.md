---
title: CHAR_Undead_CursedSmith_FloatingWeapon_Mace
guid: -55245645
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2041350912)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingMace_MeleeAttack_AbilityGroup PrefabGuid(558343424)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingMace_HammerSlam_AbilityGroup PrefabGuid(-1713640367)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
