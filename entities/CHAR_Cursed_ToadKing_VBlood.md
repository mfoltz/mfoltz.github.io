---
title: CHAR_Cursed_ToadKing_VBlood
guid: -203043163
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Cursed_MonsterToad_VBlood_Downed PrefabGuid(-415035829)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1569981848)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Cursed_ToadKing_VBlood PrefabGuid(-203043163)`
  - `JournalCategory: ProjectM.JournalCategoryType CursedForest`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  ...
  - `KnockbackRange: 0.5`
  - `WoundedKnockbackResistanceIndex: 9`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_ToadKing_VBlood PrefabGuid(-1593130676)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_DoubleTongueSlap_AbilityGroup PrefabGuid(1718898538)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_TongueGrab_AbilityGroup PrefabGuid(-514415940)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_PoisonLeap_Travel_AbilityGroup PrefabGuid(1790744720)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_FrogSplit_Travel_AbilityGroup PrefabGuid(1808492070)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_PoisonRain_AbilityGroup PrefabGuid(-1864096491)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_Swallow_AbilityGroup PrefabGuid(1292896032)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_Spit_AbilityGroup PrefabGuid(-1238687119)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadKing_FrogVomit_Group PrefabGuid(1421967280)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_ToadKing PrefabGuid(1846992402)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T06_ToadKing_Coins PrefabGuid(-837551957)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_ToadKing PrefabGuid(52223855)`
