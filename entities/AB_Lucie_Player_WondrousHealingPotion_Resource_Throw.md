---
title: AB_Lucie_Player_WondrousHealingPotion_Resource_Throw
guid: -1960893454
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Lucie_Player_WondrousHealingPotion_Resource_Throw
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 1.5f, 1.5f)`
...
- [ProjectM.TargetAoE](/components/TargetAoE){:target="_blank"}
  - `TargetPositionType: ProjectM.TargetAoE+TargetPositionTypeEnum SelfDirection`
...
- **[0]**
  - `Sequence: SequenceGUID -1418222434`
  - `ImpactSequence: SequenceGUID -789591251`
...
- **[0]**
  - `SpawnPrefab: AB_Lucie_Player_WondrousHealingPotion_Resource_Drop PrefabGuid(-1423960159)`
