---
title: TM_Castle_Wall_Tier02_Stone_Entrance
guid: 728150320
categories: ['All', 'TM']
nav_exclude: true
...
# TM_Castle_Wall_Tier02_Stone_Entrance
...
- [ProjectM.CastleBuilding.CastleRoomWall](/components/CastleRoomWall){:target="_blank"}
  - `FloorNorth: Entity(0:0)`
  - `FloorEast: Entity(0:0)`
  - `FloorSouth: Entity(0:0)`
  - `FloorWest: Entity(0:0)`

- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Wall_Tier02_Stone_Entrance PrefabGuid(728150320) - Entity(41160:2)`
  - `Guid: TM_Castle_Wall_Tier02_Stone_Entrance PrefabGuid(728150320)`
  ...
  - `BuildingSequence: SequenceGUID 809462849`
...
- [ProjectM.Wallpaper_Synced_0](/components/Wallpaper_Synced_0){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [ProjectM.Wallpaper_Synced_180](/components/Wallpaper_Synced_180){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [ProjectM.WallpaperStyles](/components/WallpaperStyles){:target="_blank"}
  - `SplitsPerStyle: ProjectM.ObjectSplits TwoParts`
  - `Blob: WallpaperStyleBlob`
  - `Styles: [`
  - `48 entries`
  - `]`
  - `MeshVariationsByIndex: [`
  - `22 entries`
  - `]`
...
- [ProjectM.CastleBuilding.WallRoofOrnament](/components/WallRoofOrnament){:target="_blank"}
  - `OrnamentPrefab: TM_Castle_Wall_Tier02_Stone_EntranceCrown PrefabGuid(-251630856)`
  - `CountWallAsRoofOpening: True`

- [ProjectM.CastleBuilding.AssetSwapping.AssetSwapState](/components/AssetSwapState){:target="_blank"}
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_akjfkcijhh`
...
- [ProjectM.CastleBuilding.ImmaterialWhileRaided](/components/ImmaterialWhileRaided){:target="_blank"}
  - `BuffStateId: Unset`
  - `TileModelId: Unset`
...
- **[0]**
  - `Entity: Entity(11997:3)`
  - `BlobIndex: 9`

- **[1]**
  - `Entity: Entity(11998:3)`
  - `BlobIndex: 17`
...
- [ProjectM.CastleBuilding.AssetSwapping.AssetSwapColliderBuffer](/components/AssetSwapColliderBuffer){:target="_blank"}

- **[0]**
  - `AssetSwapConfig: Unity.Entities.BlobAssetReference`1[ProjectM.CastleBuilding.AssetSwapping.AssetSwapConfig] Unity.Entities.BlobAssetReference`1[ProjectM.CastleBuilding.AssetSwapping.AssetSwapConfig]`
  - `ColliderEntity: Entity(11998:3)`
...
- **[0]**
  - `Value: Prefab TM_Castle_Wall_Tier02_Stone_Entrance PrefabGuid(728150320) - Entity(41160:2)`

- **[1]**
  - `Value: Entity(11997:3)`

- **[2]**
  - `Value: Entity(11998:3)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Build_Spawn_Buff_WeakStructure_Wall PrefabGuid(740689171)`
...
- **38 total elements but only showing the first 36**
  - *(No fields)*

- [ProjectM.CastleBuilding.CastleWall](/components/CastleWall){:target="_blank"}
  - *(No fields)*

- **ProjectM.CastleBuilding.CastleEntrance**
  - *(No fields)*
...
- [ProjectM.AnnounceCastleBreached](/components/AnnounceCastleBreached){:target="_blank"}
  - *(No fields)*
