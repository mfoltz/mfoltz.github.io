---
title: AB_Cursed_ToadKing_PoisonRain_Cast
guid: 917745068
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Cursed_ToadKing_PoisonRain_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_ToadKing_PoisonRain_Cast PrefabGuid(917745068)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_ToadKing_PoisonRain_Trigger PrefabGuid(-933062954)`
...
- **[1]**
  - `SpawnPrefab: AB_Cursed_ToadKing_PoisonRain_InitialThrow PrefabGuid(-1854898448)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
