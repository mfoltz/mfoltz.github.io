---
title: CHAR_Dracula_BloodSoul_Heart
guid: 55100532
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-276242059)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(2010023718)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Dracula_BloodSoul PrefabGuid(1414670325)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dracula_BloodSoul_ChannelHeal_AbilityGroup PrefabGuid(1767074088)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_FeedDraculaBloodSoul_01_Initiate_AbilityGroup PrefabGuid(1491658671)`
  - `Importance: 3`
...
- **[0]**
  ...
  - `Buff1: Buff_Dracula_BloodSoul_Heart_Effect PrefabGuid(251142117)`
