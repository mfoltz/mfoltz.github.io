---
title: AB_Militia_FabiansSteed_RunClose_Buff
guid: -38800429
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Militia_FabiansSteed_RunClose_Buff
...
- **[0]**
  ...
  - `Target: ProjectM.GameplayEventTarget UnitMounter`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_Militia_FabiansSteed_CastImpair PrefabGuid(-1205493484)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 1`
  - `Stacks: 1`
  - `Buff0: Buff_Militia_Fabian_CastImpair PrefabGuid(1671499645)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `ForceCastAbility: AB_Militia_FabiansSteed_LeapMovement_AbilityGroup PrefabGuid(975866147)`
