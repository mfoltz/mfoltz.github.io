---
title: CHAR_Cursed_MountainBeast_VBlood
guid: -1936575244
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 55`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Cursed_MountainBeast_VBlood_Downed PrefabGuid(1853113733)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1851596382)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Cursed_MountainBeast_VBlood PrefabGuid(-1936575244)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_MountainBeast_VBlood PrefabGuid(444838754)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Mountainbeast_TrippleAttack_AbilityGroup PrefabGuid(-1771783202)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_WhackAVampBuff_AbilityGroup PrefabGuid(756139644)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_KongPound_AbilityGroup PrefabGuid(2067796423)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_LeapAttack_Travel_AbilityGroup PrefabGuid(-130931989)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_DashAttack_AbilityGroup PrefabGuid(556335075)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_WhackAVamp_AbilityGroup PrefabGuid(1221980502)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Mountainbeast_HornFlick_AbilityGroup PrefabGuid(-749389155)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_SpiritDouble_AbilityGroup PrefabGuid(-430375110)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_Enrage_Travel_AbilityGroup PrefabGuid(1439273397)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Mountainbeast_MeleeStraight_AbilityGroup PrefabGuid(-453331838)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_GhostCall_AbilityGroup PrefabGuid(-1574537639)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T08_Behemoth PrefabGuid(-2059047777)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_MountainBeast PrefabGuid(1683300592)`
