...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2014972241)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 62.140007`
  - `SpellPower: 62.140007`
  - `ResourcePower: 36.4`
  - `SiegePower: 17.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Harpy_Scratcher PrefabGuid(526073827)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Scratcher_Launcher_AbilityGroup PrefabGuid(1245308829)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Scratcher_Melee_AbilityGroup PrefabGuid(769558056)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Scratcher_Dash_AbilityGroup PrefabGuid(-265839081)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Scratcher_SpinAttack_AbilityGroup PrefabGuid(-738502538)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Silver_Harpy_Rank02 PrefabGuid(-1647082571)`
