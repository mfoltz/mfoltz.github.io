---
title: CHAR_Militia_Guard_Summon
guid: 1050151632
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Guard PrefabGuid(-1787316651)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_MeleeAttack_Group PrefabGuid(931534835)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_ShieldAttack_Group PrefabGuid(-668603830)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
