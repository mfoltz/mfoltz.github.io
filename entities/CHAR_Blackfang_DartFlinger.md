---
title: CHAR_Blackfang_DartFlinger
guid: 1209580976
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_DartFlinger_Servant PrefabGuid(-253226787)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_DartFlinger PrefabGuid(1972196370)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_StrongBlade_Rank01 PrefabGuid(-438086091)`
