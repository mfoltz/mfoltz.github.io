---
title: CHAR_Blackfang_Venomblade
guid: 1864177126
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_Venomblade_Servant PrefabGuid(1906807803)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Venomblade PrefabGuid(1363315280)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_Blackfang PrefabGuid(1787445817)`
