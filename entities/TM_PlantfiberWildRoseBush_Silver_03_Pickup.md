---
title: TM_PlantfiberWildRoseBush_Silver_03_Pickup
guid: -974149708
categories: ['All', 'TM']
nav_exclude: true
...
# TM_PlantfiberWildRoseBush_Silver_03_Pickup
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(0.99f, 0f, 0f, 0f,  0f, 1.075255f, 0f, 0f,  0f, 0f, 0.99f, 0f,  0f, 0f, 0f, 1f)`
