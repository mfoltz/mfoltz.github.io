...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(949923642)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(10678632)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 17.371368`
  - `SpellPower: 17.371368`
  - `ResourcePower: 16.4`
  - `SiegePower: 7.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Moose_Standard PrefabGuid(405737090)`
...
- [Unity.Transforms.LocalTransform](/components/LocalTransform){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(-3122.246f, 4.881746f, -3113.358f)`
  - `Scale: 1`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Moose_Charge_AbilityGroup PrefabGuid(1883230955)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Creature_Moose PrefabGuid(949107101)`
