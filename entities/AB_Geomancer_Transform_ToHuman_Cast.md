---
title: AB_Geomancer_Transform_ToHuman_Cast
guid: 1484136519
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Geomancer_Transform_ToHuman_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Geomancer_Transform_ToHuman_Cast PrefabGuid(1484136519)`
...
- **[0]**
  - `SpawnPrefab: AB_Geomancer_BreakForm_Travel PrefabGuid(33805998)`
