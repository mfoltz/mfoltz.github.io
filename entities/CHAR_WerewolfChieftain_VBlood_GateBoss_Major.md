---
title: CHAR_WerewolfChieftain_VBlood_GateBoss_Major
guid: 2079933370
categories: ['All', 'CHAR']
nav_exclude: true
...
# CHAR_WerewolfChieftain_VBlood_GateBoss_Major
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_General_VBlood_Downed PrefabGuid(-806335869)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-843166688)`
