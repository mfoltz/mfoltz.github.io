...
- [ProjectM.Gameplay.Scripting.BloodBuff_VBlood_0_DataShared](/components/BloodBuff_VBlood_0_DataShared){:target="_blank"}
  - `DrainIncreaseFactor: 3`
