---
title: TM_Castle_LocalTeleporter_Yellow
guid: 1579702125
categories: ['All', 'TM']
nav_exclude: true
...
# TM_Castle_LocalTeleporter_Yellow
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_LocalTeleporter_Yellow PrefabGuid(1579702125) - Entity(41281:2)`
  - `Guid: TM_Castle_LocalTeleporter_Yellow PrefabGuid(1579702125)`
...
��  �.��   ��V�<  `
  - `Component �������        ���h=`
  - `ConditionalElements`
  - `Ability: AB_Interact_LocalCastleTeleport_Yellow_AbilityGroup PrefabGuid(1088859718)`
  - `Importance: 1`
