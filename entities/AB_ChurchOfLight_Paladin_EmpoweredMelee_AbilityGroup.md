...
- [ProjectM.Shared.IgnoreHitsPerTarget](/components/IgnoreHitsPerTarget){:target="_blank"}
  - `HitResetTimer: 0.2`
  - `ReductionModifier: 0`
...
- [ProjectM.Shared.IgnoreHitsPerTargetElement](/components/IgnoreHitsPerTargetElement){:target="_blank"}
  - *(No fields)*
