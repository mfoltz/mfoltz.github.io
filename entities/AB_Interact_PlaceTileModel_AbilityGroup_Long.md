---
title: AB_Interact_PlaceTileModel_AbilityGroup_Long
guid: 1399369255
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_PlaceTileModel_AbilityGroup_Long
...
- [ProjectM.PlaceTilemodelAbility](/components/PlaceTilemodelAbility){:target="_blank"}
  - `SpawnTranslation: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `PrefabGuid: GUID Not Found`
  - `SpawnTileRotation: ProjectM.Tiles.TileRotation None`
  - `ConsumeType: ProjectM.BuildResourceConsumeType LocalInventory`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_agjkgikkig`
...
- **[0]**
  - `PrefabGUID: AB_Interact_PlaceTileModel_Cast_Long PrefabGuid(-1587789246)`
