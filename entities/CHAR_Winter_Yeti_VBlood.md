...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Winter_Yeti_VBlood_Downed PrefabGuid(309433400)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1666305403)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Winter_Yeti_VBlood PrefabGuid(-1347412392)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Winter_Yeti_VBlood PrefabGuid(-210551232)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_TrippleAttack_AbilityGroup PrefabGuid(-905574209)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_AntarcticLeap_Hard_AbilityGroup PrefabGuid(-1568811754)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_Avalanche_Hard_AbilityGroup_01 PrefabGuid(1387986806)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_Avalanche_Hard_AbilityGroup_02 PrefabGuid(-1839296163)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_Avalanche_AbilityGroup PrefabGuid(151283351)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_CaveRumble_AbilityGroup PrefabGuid(-544868559)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_IceCrack_AbilityGroup PrefabGuid(1910986910)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_AntarcticLeap_AbilityGroup PrefabGuid(1205896854)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_GrabIcicle_AbilityGroup PrefabGuid(1253708985)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_FrostBite_AbilityGroup PrefabGuid(-1321161639)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_GrabIcicle_Aggro_AbilityGroup PrefabGuid(430166804)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_ThrowIcicle_AbilityGroup PrefabGuid(-1571128781)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_Enrage_Travel_AbilityGroup PrefabGuid(-252663641)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_GrabIcicle_Roar_AbilityGroup PrefabGuid(320434570)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_Enrage_DirectBuff_AbilityGroup PrefabGuid(691162066)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[15]**
  - `BaseAbilityGroupOnSlot: AB_Winter_Yeti_GrabIcicle_Hard_AbilityGroup PrefabGuid(-1126887871)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Yeti PrefabGuid(-1435750586)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Yeti PrefabGuid(-1814423891)`
