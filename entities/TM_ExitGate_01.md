...
- [ProjectM.ChunkPortal](/components/ChunkPortal){:target="_blank"}
  ...
  - `InPositionOffset: Unity.Mathematics.float3 float3(0f, 0f, 5f)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acdkhbejfkd`
...
- [Unity.Transforms.LocalTransform](/components/LocalTransform){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(58.99f, 10f, 64.93f)`
  - `Scale: 1`
  - `Rotation: Unity.Mathematics.quaternion quaternion(0f, -2.071261E-06f, 0f, 1f)`
...
- **[0]**
  - `Condition: None`
  - `Ability: AB_Interact_UseEntryway_Exit_AbilityGroup PrefabGuid(592600719)`
  - `Importance: 1`
