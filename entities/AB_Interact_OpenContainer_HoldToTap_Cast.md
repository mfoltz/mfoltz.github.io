---
title: AB_Interact_OpenContainer_HoldToTap_Cast
guid: 420840336
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_OpenContainer_HoldToTap_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_OpenContainer_HoldToTap_Cast PrefabGuid(420840336)`
...
- **[0]**
  - `SpawnPrefab: AB_Interact_OpenContainer_HoldToTap PrefabGuid(1771112861)`
