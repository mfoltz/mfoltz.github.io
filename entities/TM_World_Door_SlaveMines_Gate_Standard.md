...
- [Door](/components/Door){:target="_blank"}
  - `AgeSinceOpened: 0`
  - `AutoCloseTime: 60`
  - `OpenEntityLeft: Prefab GUID Not Found - Entity(17976:3)`
  - `OpenEntityRight: Prefab GUID Not Found - Entity(17975:3)`
  - `ClosedEntity: Prefab GUID Not Found - Entity(41505:2)`
  - `LastSequenceEntity: Entity(0:0)`
  - `OpenLeftDoorSequence: SequenceGUID 1202451887`
  - `CloseLeftDoorSequence: SequenceGUID 1848655294`
  - `OpenRightDoorSequence: SequenceGUID 1202451887`
  - `CloseRightDoorSequence: SequenceGUID 1848655294`
  - `OpenState: False`
  - `OpenLeftDoor: False`
  - `LastOpenState: Il2CppSystem.Nullable_Unboxed`1[Boolean]`
  - `SkipNextSequence: True`
  - `DenyManualCloseDoor: True`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_gjjigekfd`
...
- **[0]**
  - `Entity: Prefab GUID Not Found - Entity(41505:2)`
  - `BlobIndex: 6`

- **[1]**
  - `Entity: Prefab GUID Not Found - Entity(17976:3)`
  - `BlobIndex: 8`

- **[2]**
  - `Entity: Prefab GUID Not Found - Entity(17975:3)`
  - `BlobIndex: 9`
...
- **[0]**
  - `Value: Prefab TM_World_Door_SlaveMines_Gate_Standard PrefabGuid(-601116315) - Entity(41439:3)`

- **[1]**
  - `Value: Prefab GUID Not Found - Entity(41505:2)`

- **[2]**
  - `Value: Prefab GUID Not Found - Entity(17976:3)`

- **[3]**
  - `Value: Prefab GUID Not Found - Entity(17975:3)`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_OpenGate_AbilityGroup PrefabGuid(-2057340406)`
  - `Importance: 2`
