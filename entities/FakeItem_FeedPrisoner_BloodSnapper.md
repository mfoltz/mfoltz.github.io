---
title: FakeItem_FeedPrisoner_BloodSnapper
guid: 526090146
categories: ['All', 'Fake']
nav_exclude: true
...
# FakeItem_FeedPrisoner_BloodSnapper
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: FakeItem_FeedPrisoner_BloodSnapper PrefabGuid(526090146)`
...
- [FeedPrisoner](/components/FeedPrisoner){:target="_blank"}
  - `RecoverHealth_Min: 0.5`
  - `RecoverHealth_Max: 0.75`
  - `RecoverMisery_Min: 0.05`
  - `RecoverMisery_Max: 0.1`
