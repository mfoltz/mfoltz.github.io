...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_Noctem_CrateLarge01 PrefabGuid(2026862319)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `DropTableGuid: DT_Breakables_T02_General_Noctem PrefabGuid(2076943224)`
