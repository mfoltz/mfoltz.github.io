...
- [ProjectM.ModifyEntityCategoryBuff](/components/ModifyEntityCategoryBuff){:target="_blank"}
  ...
  - `UnitCategory: ProjectM.UnitCategory Demon`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyCastOptions_DataServer](/components/Script_Buff_ModifyCastOptions_DataServer){:target="_blank"}
  - `CastOptionsPrefab: CO_Legion_Gargoyle_TailorVariant PrefabGuid(-1831546379)`
  - `ModId: Unset`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyFaction_DataServer](/components/Script_Buff_ModifyFaction_DataServer){:target="_blank"}
  - `Faction: Faction_Legion PrefabGuid(-772044125)`
  - `ModId: Unset`

- [ProjectM.Behaviours.ModifyBehaviourBuff](/components/ModifyBehaviourBuff){:target="_blank"}
  - `Behaviour: BEH_Bandit_Mugger PrefabGuid(-1665557261)`
  - `ModId: Unset`
...
- **[0]**
  - `EventId: Local - 790174577`
  - `Condition: None`
  - `Source: ProjectM.GameplayEventTarget Owner`
  - `Target: ProjectM.GameplayEventTarget Owner`
  - `EnteredState: ProjectM.GenericEnemyState Idle`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 790174577`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1199178267`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -1170681482`
