---
title: TM_Emery_02_Stage0_Resource
guid: 1686044871
categories: ['All', 'TM']
nav_exclude: true
...
- **ProjectM.Gameplay.Scripting.Script_EmeryVeinBuildupData**
  ...
  - `Id: Entity(0:0)`
  - `DestroySequence: SequenceGUID -1559585392`
  - `TargetFactor: 0`
  - `CurrentFactor: 0`
...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: EmeryNode02_Broken_Small PrefabGuid(2045195584)`
  - `AlwaysSpawn: False`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_achbdicfjce`
