...
- **ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshhold_MonsterVBlood_DataServer**
  ...
  - `ThresholdMetFrame: Il2CppSystem.Nullable_Unboxed`1[Int32]`
  - `DontTriggerOnDots: False`
  - `DontTriggerInFlight: False`

- [Script_ApplyBuffUnderThreeHealthThreshholds_DataServer](/components/Script_ApplyBuffUnderThreeHealthThreshholds_DataServer){:target="_blank"}
  - `HealthFactor1: 0.75`
  - `HealthFactor2: 0.5`
  - `HealthFactor3: 0.25`
