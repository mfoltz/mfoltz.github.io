---
title: AB_ChurchOfLight_Overseer_SpinAttack_Channel
guid: -1743979096
categories: ['AB', 'All']
nav_exclude: true
...
# AB_ChurchOfLight_Overseer_SpinAttack_Channel
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_ChurchOfLight_Overseer_SpinAttack_PostCast PrefabGuid(511192765)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[Single]`
  - `Stacks: 1`
  - `Buff0: AB_ChurchOfLight_Overseer_SpinAttack_Hard_SpinnerBuff PrefabGuid(-1987830486)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_SpinAttack_Hit PrefabGuid(-1015785362)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
