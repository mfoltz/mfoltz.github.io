...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_Strongblade_Barrel01 PrefabGuid(-2122608214)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1106898456`
