---
title: AB_Vampire_VeilOfIllusion_TriggerBonusEffects
guid: -733228440
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_VeilOfIllusion_TriggerBonusEffects
...
- [ProjectM.CopySpellModSetFromAbilitySlot](/components/CopySpellModSetFromAbilitySlot){:target="_blank"}
  - `AbilitySlot: 2`
...
- **[2]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Illusion_Vampire_SpellMod_Shield_Buff PrefabGuid(1093914645)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_VeilOfIllusion_PhantasmOnHit PrefabGuid(1016557168)`
...
- **[2]**
  - `Condition: None`
  - `SpellMod: SpellMod_VeilOfIllusion_AttackInflictFadingSnare PrefabGuid(2138408718)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 0`
