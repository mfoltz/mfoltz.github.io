---
title: AB_Undead_SkeletonGolem_Swallow_TargetSwallowedBuff
guid: -743287512
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_SkeletonGolem_Swallow_TargetSwallowedBuff
...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  - `ClientPositionOffset: Unity.Mathematics.float3 float3(0f, 1f, -0.5f)`
  - `ClientRotationOffset: Unity.Mathematics.float3 float3(0f, 1f, -0.5f)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Undead_SkeletonGolem_Swallow_HasSwallowedBuff PrefabGuid(1303687336)`
