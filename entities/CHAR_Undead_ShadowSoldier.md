---
title: CHAR_Undead_ShadowSoldier
guid: 678628353
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1930656222)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_ShadowSoldier PrefabGuid(1394122777)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ShadowSoldier_ShadowStrike_Dash_AbilityGroup PrefabGuid(1478784055)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ShadowSoldier_ShadowStrike_Strike_AbilityGroup PrefabGuid(1435233272)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
