---
title: Recipe_Headgear_NecromancerHat_T01_Trader
guid: 737997561
...
# Recipe_Headgear_NecromancerHat_T01_Trader
...
- [RecipeData](/components/RecipeData){:target="_blank"}
  - `Entity: Prefab Recipe_Headgear_NecromancerHat_T01_Trader PrefabGuid(737997561) - Entity(19224:1)`
  - `Guid: Recipe_Headgear_NecromancerHat_T01_Trader PrefabGuid(737997561)`
  - `CraftDuration: 0`
  - `HudSortingOrder: 0`
  - `AlwaysUnlocked: True`
  - `HideInStation: False`
...
- **[0]**
  - `Guid: Item_Headgear_NecromancerMitre PrefabGuid(607559019)`
  - `Amount: 1`
