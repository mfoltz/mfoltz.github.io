...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 100`
...
- [ProjectM.BuffResistances](/components/BuffResistances){:target="_blank"}
  ...
  - `InitialSettingGuid: BuffResistance_UberMob_IgniteResistant PrefabGuid(960451195)`
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 20`
  - `CircleChangeDirectionFrequencyMax: 30`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Castleman_VBlood_Downed PrefabGuid(-1662822036)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(616943015)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(2120169232)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_VHunter_CastleMan PrefabGuid(336560131)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_VHunter_CastleMan PrefabGuid(-1056865179)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_Whip_AbilityGroup PrefabGuid(-499397494)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_Whip_Hard_AbilityGroup PrefabGuid(626219559)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_FlameWhip_Hard_AbilityGroup PrefabGuid(-1272535312)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_Grab_AbilityGroup PrefabGuid(-460221305)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_LastingHolyWater_AbilityGroup PrefabGuid(-650079140)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_SpinShield_AbilityGroup PrefabGuid(112329675)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_KnockbackWhip_Fire_AbilityGroup PrefabGuid(504586218)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_FlameWhip_AbilityGroup PrefabGuid(-1736553762)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_SpinningCross_AbilityGroup PrefabGuid(761680482)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_AxeThrow_AbilityGroup PrefabGuid(1022054621)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_JumpRight_AbilityGroup PrefabGuid(1122774146)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_Tackle_AbilityGroup PrefabGuid(-296227812)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_TrippleSpinningCross_AbilityGroup PrefabGuid(874909393)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_Throw_AbilityGroup PrefabGuid(1797118698)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_DaggerProjectile_AbilityGroup PrefabGuid(1302295192)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[15]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_BackStep_DaggerThrow_AbilityGroup PrefabGuid(1945392759)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[16]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_ChaseTargetBuff_AbilityGroup PrefabGuid(-1068854418)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[17]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_DaggerThrow_AbilityGroup PrefabGuid(1771330790)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[18]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_KnockbackWhip_AbilityGroup PrefabGuid(-64218175)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[19]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_JumpInit_AbilityGroup PrefabGuid(207057426)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[20]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_WhipAoEChangePhase_AbilityGroup PrefabGuid(109607953)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[21]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_FlameWhip_SingleAttack_AbilityGroup PrefabGuid(-653938456)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[22]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_HolyBeam_AbilityGroup PrefabGuid(906463896)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[23]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_CastleMan_BackStep_Dodge_AbilityGroup PrefabGuid(8807466)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[24]**
  - `BaseAbilityGroupOnSlot: AB_CastleMan_HolyBeam_Hard_AbilityGroup PrefabGuid(583436571)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_VHunter_CastleMan_HideWhip_Buff PrefabGuid(-202999668)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Castleman_SanguineWhip PrefabGuid(499979034)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_EndGame PrefabGuid(-2071666138)`
...
- **360 total elements but only showing the first 36**
  - *(No fields)*
...
- **99 total elements but only showing the first 36**
  - *(No fields)*

- [ProjectM.Behaviours.BehaviourTreeStateBuffsBuffer](/components/BehaviourTreeStateBuffsBuffer){:target="_blank"}

- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_CastleMan PrefabGuid(731266864)`
...
- **[2]**
  - `BuffGuid: Buff_VHunter_CastleMan_HideWhip_Buff PrefabGuid(-202999668)`
  - `State: ProjectM.GenericEnemyState Idle, Alert, Combat, Return, Relocate_Unstuck`

- [ProjectM.Shared.DropTableBuffer](/components/DropTableBuffer){:target="_blank"}

- **[0]**
  - `DropTableGuid: DT_Shared_Unit_VBlood_T05_EndGame PrefabGuid(1830862057)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`

- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_VampireHunter_Headgear PrefabGuid(843971231)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
