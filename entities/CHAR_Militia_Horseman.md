...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(783818504)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(-1620185637)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 27.920887`
  - `SpellPower: 27.920887`
  - `ResourcePower: 20.859999`
  - `SiegePower: 12.4`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cbcjbibcbf`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Horseman PrefabGuid(-2022421342)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_AbilityGroup PrefabGuid(-1077139800)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_UnlockRotation_AbilityGroup PrefabGuid(-1162366175)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_AttackChain_AbilityGroup PrefabGuid(-1843850355)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_StepAttack_AbilityGroup PrefabGuid(-342380924)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_AttackChain_Right_AbilityGroup PrefabGuid(262116525)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_AttackChain_Left_AbilityGroup PrefabGuid(1660777757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **384 total elements but only showing the first 36**
  - *(No fields)*
...
- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_Militia_Rank01 PrefabGuid(-810965603)`
