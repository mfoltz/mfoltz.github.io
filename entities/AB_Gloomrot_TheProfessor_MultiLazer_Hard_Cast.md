---
title: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Cast
guid: -633627968
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_TheProfessor_MultiLazer_Hard_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Cast PrefabGuid(-633627968)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Projectile_01 PrefabGuid(713915490)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Projectile_02 PrefabGuid(-393998335)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Projectile_03 PrefabGuid(437291488)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Hard_Projectile_04 PrefabGuid(-1039861337)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
