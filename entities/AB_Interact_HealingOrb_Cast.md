---
title: AB_Interact_HealingOrb_Cast
guid: 1025740289
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_HealingOrb_Cast PrefabGuid(1025740289)`
...
- **[0]**
  - `SpawnPrefab: AB_Interact_HealingOrb_Buff PrefabGuid(1294634937)`
