...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(398043275)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 61.352093`
  - `SpellPower: 61.352093`
  - `ResourcePower: 34.39`
  - `SiegePower: 20.6`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Nightmare PrefabGuid(64373002)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Nightmare_AbilityGroup PrefabGuid(-1526010521)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Nightmare_Taunt_AbilityGroup PrefabGuid(-740078985)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff: Buff_General_Spawn_Unit_Fast_WarEvent_Trash PrefabGuid(2090187901)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_Legion_Trash_T02 PrefabGuid(307475012)`
