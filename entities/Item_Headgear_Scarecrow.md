...
- [ProjectM.ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Prefab Item_Headgear_Scarecrow PrefabGuid(403967307) - Entity(2964:1)`
  - `ItemTypeGUID: Item_Headgear_Scarecrow PrefabGuid(403967307)`
