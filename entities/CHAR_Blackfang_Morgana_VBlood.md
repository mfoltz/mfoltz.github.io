---
title: CHAR_Blackfang_Morgana_VBlood
guid: 591725925
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 38`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Blackfang_Morgana_Downed PrefabGuid(194798727)`
...
- [ProjectM.CombatMusicSource_Server](/components/CombatMusicSource_Server){:target="_blank"}
  - `Active: True`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-471905299)`
...
- [ProjectM.TravelToTargetRadius](/components/TravelToTargetRadius){:target="_blank"}
  - `Radius: 3.5`
...
- **ProjectM.ModifiablePhysicsShape**
  - `PhysicsShapeSource: ModifiablePrefabGUID PrefabGuid(0)`
  - `ActivePhysicsShapeSource: GUID Not Found`

- [ProjectM.Torture](/components/Torture){:target="_blank"}
  - `TortureModifier: 1`
  - `TorturePerDamage: 0.5`

- **ProjectM.MorganaWorshipperHandler**
  - `InitialTriggered: False`
  - `DurationForReset: 120`
  - `NextTriggerTime: 0`
  - `WorshipperBuff: Buff_General_Spawn_VBlood_WorshippersOfMorgana PrefabGuid(746755827)`
...
- [ProjectM.MinionMaster](/components/MinionMaster){:target="_blank"}
  - `TotalMaxMinions: 10`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Blackfang_Morgana_VBlood PrefabGuid(591725925)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0`
  ...
  - `KnockbackRange: 0.5`
  - `WoundedKnockbackResistanceIndex: 5`
...
- **ProjectM.SyncAimData**
  - `AimPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `LerpedAimPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `LerpDuration: 0.2`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 106.908745`
  - `SpellPower: 106.908745`
  - `ResourcePower: 54.239998`
  - `SiegePower: 21.6`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 0`
  - `GoalDistanceInner: 12`
  - `GoalDistanceOuter: 12`
  - `MaxDistance: 16`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_adbefebjjb`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Morgana PrefabGuid(1593278515)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_MeleeAttack_AbilityGroup PrefabGuid(2134120100)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralBlast_AbilityGroup PrefabGuid(1173842428)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelToPosition_AbilityGroup PrefabGuid(-918633640)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralSwarm_AbilityGroup PrefabGuid(1485893437)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_LoomingMists_CombatTag_AbilityGroup PrefabGuid(1684080967)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SummonTail_AbilityGroup PrefabGuid(-195933675)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_DownHorizontalSlash_Right_AbilityGroup PrefabGuid(-1736482208)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_DownHorizontalSlash_Left_AbilityGroup PrefabGuid(-63677606)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralHell_AbilityGroup PrefabGuid(1185642044)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_GroundPiercer_AbilityGroup PrefabGuid(-668068170)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralBeam_AbilityGroup PrefabGuid(2099754785)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelToPosition_Emerge_AbilityGroup PrefabGuid(1673956324)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralOrbBarrage_AbilityGroup PrefabGuid(1990869093)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_CrossWindSlash_AbilityGroup PrefabGuid(846291757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralBeamEmerge_AbilityGroup PrefabGuid(-1241930020)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[15]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelToPosition_Swarm_AbilityGroup PrefabGuid(-1980019894)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[16]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralHell_Far_AbilityGroup PrefabGuid(-135866689)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[17]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_RingsOfTerror_AbilityGroup PrefabGuid(-616120746)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[18]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_Transformation_AbilityGroup PrefabGuid(-690426342)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[19]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_CorruptionFountain_AbilityGroup PrefabGuid(1298623256)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[20]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralSwarm_Humanoid_AbilityGroup PrefabGuid(1326530647)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[21]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralBeamSlow_AbilityGroup PrefabGuid(898624706)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[22]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralSnake_AbilityGroup PrefabGuid(1946293901)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[23]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelingOrbBarrage_AbilityGroup PrefabGuid(1242557903)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[24]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralSnake_Far_AbilityGroup PrefabGuid(-95450612)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[25]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_CorruptionFountain_Far_AbilityGroup PrefabGuid(325438116)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[26]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_SpectralBlast_Humanoid_AbilityGroup PrefabGuid(-1681336728)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[27]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_EyeOfTheCorruption_Setup_AbilityGroup PrefabGuid(734658196)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[28]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_RingsOfTerror_Humanoid_AbilityGroup PrefabGuid(345561766)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[29]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_MistSpinners_AbilityGroup PrefabGuid(1278045964)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- [ProjectM.MaxMinionsPerPlayerElement](/components/MaxMinionsPerPlayerElement){:target="_blank"}
...
- [ProjectM.VBloodUnlockTechBuffer](/components/VBloodUnlockTechBuffer){:target="_blank"}

- **[0]**
  - `Guid: Tech_Collection_VBlood_T08_Morgana PrefabGuid(-1902462638)`

- **[1]**
  - `Guid: Tech_Collection_Dracula_Armor_Legs PrefabGuid(-997181076)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_Morgana PrefabGuid(303061990)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[1]**
  - `Kind: ProjectM.SpawnBuffKind Praying`
  - `Buff: Buff_General_Spawn_VBlood_Morgana PrefabGuid(303061990)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[2]**
  - `Kind: ProjectM.SpawnBuffKind Sleep`
  - `Buff: AB_Blackfang_Morgana_TriggerSecondPhase_DEBUG PrefabGuid(809604772)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **103 total elements but only showing the first 36**
  - *(No fields)*

- [ProjectM.Behaviours.BehaviourTreeStateBuffsBuffer](/components/BehaviourTreeStateBuffsBuffer){:target="_blank"}

- **[0]**
  - `BuffGuid: Buff_Blackfang_Morgana_InCombat PrefabGuid(-776252955)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: Buff_Blackfang_Morgana_Return PrefabGuid(1902427906)`
  - `State: ProjectM.GenericEnemyState Return`

- **[2]**
  - `BuffGuid: AB_Blackfang_Morgana_IdleBuff PrefabGuid(515276391)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_Relic_Morgana_Unique PrefabGuid(1273222726)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType Morgana`
...
- **ProjectM.TravelToTargetIgnoreCollision**
  - *(No fields)*
