...
- [ProjectM.Gameplay.Scripting.Script_SommelierBarrelFountain_DataServer](/components/Script_SommelierBarrelFountain_DataServer){:target="_blank"}
  - `SpawnEntity: AB_Sommelier_HorizontalBarrel_Projectile PrefabGuid(332296669)`
  - `DelayBetween_Min: 0.3`
  - `DelayBetween_Max: 0.4`
  - `OffsetDistance: 6`
  - `Timer: 0`
