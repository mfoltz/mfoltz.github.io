---
title: AB_Charm_SendToPrison_Cast
guid: -1987926603
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityTarget](/components/AbilityTarget){:target="_blank"}
  ...
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1303169868)`
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Charm_SendToPrison_Cast PrefabGuid(-1987926603)`
...
- [ProjectM.AbilityInterruptData](/components/AbilityInterruptData){:target="_blank"}
  ...
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, OnMove, OnDamageTaken, GameplayAbilities, Obstructed`
...
- **[0]**
  - `SpawnPrefab: AB_Charm_SendToPrison_Trigger PrefabGuid(1789285456)`
