...
- [Script_Buff_ModifyDynamicCollision_DataServer](/components/Script_Buff_ModifyDynamicCollision_DataServer){:target="_blank"}
...
- [InCombatBuff](/components/InCombatBuff){:target="_blank"}
  - *(No fields)*

- [UseCombatAnimationState](/components/UseCombatAnimationState){:target="_blank"}
  - *(No fields)*
