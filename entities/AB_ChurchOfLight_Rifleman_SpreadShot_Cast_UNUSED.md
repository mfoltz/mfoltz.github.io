---
title: AB_ChurchOfLight_Rifleman_SpreadShot_Cast_UNUSED
guid: -2110353406
categories: ['AB', 'All']
nav_exclude: true
...
# AB_ChurchOfLight_Rifleman_SpreadShot_Cast_UNUSED
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_ChurchOfLight_Rifleman_SpreadShot_Cast_UNUSED PrefabGuid(-2110353406)`
...
- [ProjectM.AbilityDirectionInaccuracy](/components/AbilityDirectionInaccuracy){:target="_blank"}
  - `MaxDegrees: 15`
  - `CurrentDegrees: 0`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 0.7853982`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_ChurchOfLight_Rifleman_SpreadShot_UNUSED PrefabGuid(-1431227036)`
  - `Count: 5`
  - `Condition: None`
