...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1303404732)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Rider PrefabGuid(1605659023)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Rider_Crossbow_Group PrefabGuid(-1418783710)`
  - `ShowOnBar: True`
