---
title: CHAR_VHunter_Jade_VBlood
guid: -1968372384
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `CircleChangeDirectionFrequencyMax: 1.5`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_VHunter_Jade_VBlood_Downed PrefabGuid(-237898435)`
  - `TriggerSequence: SequenceGUID 429670956`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1267744240)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_VHunter_Jade_VBlood PrefabGuid(-1968372384)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_VHunter_Jade_VBlood PrefabGuid(-534404918)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Revolvers4_Group PrefabGuid(688350142)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Revolvers_Group PrefabGuid(-1783782358)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Snipe_Group PrefabGuid(-1884688827)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Caltrops_Hard_Group PrefabGuid(1372353064)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Caltrops_Group PrefabGuid(-1294182358)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Snipe_Hard_Group PrefabGuid(-1030552412)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_DisablingShot_Group PrefabGuid(-526118698)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_BlastVault_Group PrefabGuid(76767983)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Stealth_Group PrefabGuid(501615608)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_ExplosiveShells_Group PrefabGuid(-453760177)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Revolvers2_Group PrefabGuid(-2013216961)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Jade_Revolvers3_Group PrefabGuid(1196517991)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Jade PrefabGuid(-1809787416)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T06_Jade_Pistols PrefabGuid(-1329550886)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VHunter_Jade PrefabGuid(170721886)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Jade_Weapon PrefabGuid(-847478692)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
