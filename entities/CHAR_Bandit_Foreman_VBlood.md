---
title: CHAR_Bandit_Foreman_VBlood
guid: 2122229952
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 35`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Bandit_Foreman_VBlood_Downed PrefabGuid(-1996490428)`
  - `TriggerSequence: SequenceGUID 424805563`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(812159192)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Foreman_VBlood PrefabGuid(2122229952)`
  ...
  - `SpellSchool: BloodSpellSchoolAsset PrefabGuid(969332277)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Foreman_VBlood PrefabGuid(957382832)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Crossbow_Group PrefabGuid(-2010697707)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_ThrowNet_Group PrefabGuid(2130985273)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Roll_Group PrefabGuid(-1773431654)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Reinforcement_Group PrefabGuid(1914101495)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_BloodRage_AbilityGroup PrefabGuid(-892431821)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Crossbow_BloodRage_Group PrefabGuid(-1100933071)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_RapidShot_AbilityGroup PrefabGuid(-1326540020)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_BoltStorm_Group PrefabGuid(1187864883)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_RapidShot_Init_AbilityGroup PrefabGuid(-871701576)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_RapidShot_Hard_AbilityGroup PrefabGuid(-1696612225)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_RapidShot_Init_Hard_AbilityGroup PrefabGuid(-1568783706)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Crossbow_Hard_AbilityGroup PrefabGuid(46962343)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Foreman_Crossbow_Hard_BloodRage_AbilityGroup PrefabGuid(-1432555386)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T02_RufusForeman PrefabGuid(-1375294270)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T02_RufusForeman_Crossbow PrefabGuid(1080245850)`

- **[2]**
  - `Guid: Tech_Collection_Furniture_Simple_T01 PrefabGuid(1549360318)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_FirstBandits PrefabGuid(148706785)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Foreman PrefabGuid(-1200676651)`
