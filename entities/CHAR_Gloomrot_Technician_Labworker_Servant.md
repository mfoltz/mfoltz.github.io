...
- [ProjectM.CanPreventDisableWhenNoPlayersInRange](/components/CanPreventDisableWhenNoPlayersInRange){:target="_blank"}
  - `CanDisable: True`
...
- [ProjectM.CharmSource](/components/CharmSource){:target="_blank"}
  - *(No fields)*
