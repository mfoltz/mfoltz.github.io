---
title: TM_Dracula_WarpRift_GoToDemise
guid: -140123614
categories: ['All', 'TM']
nav_exclude: true
...
# TM_Dracula_WarpRift_GoToDemise
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_agigicbibf`
...
- **[0]**
  - `Condition: None`
  - `Ability: AB_Interact_WarpRift_EndGame_Exit_AbilityGroup PrefabGuid(-646168524)`
  - `Importance: 1`
...
- [ProjectM.Gameplay.Scripting.Script_Dracula_EndGamePortal_Tag](/components/Script_Dracula_EndGamePortal_Tag){:target="_blank"}
  - *(No fields)*
