---
title: AB_Dracula_SpellStone_OrbitingBlood_Cast
guid: -1098931978
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Dracula_SpellStone_OrbitingBlood_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Dracula_SpellStone_OrbitingBlood_Cast PrefabGuid(-1098931978)`
...
- [ProjectM.HideWeaponDuringCast](/components/HideWeaponDuringCast){:target="_blank"}
  - `CastStartTime: 0`
  - `Duration: 0.7`
  - `CastStartCounter: 0`
...
- **[0]**
  - `SpawnPrefab: AB_Dracula_SpellStone_OrbitingBlood_Buff01 PrefabGuid(-1686378107)`
...
- **[1]**
  - `SpawnPrefab: AB_Dracula_SpellStone_OrbitingBlood_Buff02 PrefabGuid(-1306359474)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Dracula_SpellStone_OrbitingBlood_Buff03 PrefabGuid(-603907675)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Dracula_SpellStone_OrbitingBlood_Buff04 PrefabGuid(2143179196)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[4]**
  - `SpawnPrefab: AB_Dracula_SpellStone_OrbitingBlood_Buff05 PrefabGuid(-1775216837)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
