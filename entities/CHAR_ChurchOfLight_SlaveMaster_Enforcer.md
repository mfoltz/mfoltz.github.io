---
title: CHAR_ChurchOfLight_SlaveMaster_Enforcer
guid: 891705701
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_ChurchOfLight_SlaveMaster_Enforcer_Servant PrefabGuid(-2114140065)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_SlaveMaster_Enforcer PrefabGuid(1529648266)`
...
- **[3]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_SlaveMaster_VisualSlaveWhip_AbilityGroup PrefabGuid(-1276648449)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Silver_Town_Rank01 PrefabGuid(-1943982529)`
