...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1157952193)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Nightlurker PrefabGuid(-1457158903)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Nightlurker_MeleeAttack01_AbilityGroup PrefabGuid(-195118922)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Nightlurker_Rush_AbilityGroup PrefabGuid(-413591328)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Nightlurker_HeavyAttack_AbilityGroup PrefabGuid(-14207169)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Nightlurker_MeleeAttack02_AbilityGroup PrefabGuid(1708209167)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[2]**
  - `BuffGuid: Buff_General_SemiTransparent PrefabGuid(1511101848)`
  - `State: ProjectM.GenericEnemyState 774`

- [ProjectM.Shared.DropTableBuffer](/components/DropTableBuffer){:target="_blank"}

- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Nightlurker PrefabGuid(-1849214024)`
