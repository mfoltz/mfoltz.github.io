---
title: JumpFromCliffs_Travel_Upwards
guid: -915122939
...
- [ProjectM.JumpFromCliffsTravelBuff](/components/JumpFromCliffsTravelBuff){:target="_blank"}
  ...
  - `StartPositionClient: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `EndPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`

- [ProjectM.JumpFromCliffsTravelBuffConstants](/components/JumpFromCliffsTravelBuffConstants){:target="_blank"}
  - `Height: 5`
  - `MaxSearchAngle: 90`
  - `LengthPerHeightCurve: Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData] Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData]`
  - `LengthPerSpeedCurve: Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData] Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData]`
  - `TimePerHeightCurve: Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData] Unity.Entities.BlobAssetReference`1[ProjectM.CurveBlobData]`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acegbdcgkdf`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: JumpFromCliffs_Landing PrefabGuid(940232581)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: JumpFromCliffs_AvoidDoubleJump PrefabGuid(-2140163907)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
