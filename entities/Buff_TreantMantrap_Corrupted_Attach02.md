---
title: Buff_TreantMantrap_Corrupted_Attach02
guid: -1416960739
categories: ['All', 'Buff']
nav_exclude: true
...
# Buff_TreantMantrap_Corrupted_Attach02
...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  - `ClientPositionOffset: Unity.Mathematics.float3 float3(0.3f, 0f, 0.15f)`
  - `ClientRotationOffset: Unity.Mathematics.float3 float3(0f, -120f, -90f)`
  - `ServerPositionOffset: Unity.Mathematics.float3 float3(1f, 1f, 0f)`
  - `HybridBone: 12`
  - `CopyPosition: True`
  - `CopyRotation: True`
