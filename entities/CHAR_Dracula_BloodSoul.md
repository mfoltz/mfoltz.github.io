...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(665364376)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID 2092753505`
  - `WoundedSequenceGuid: SequenceGUID 395723216`
  - `TriggerKnockbackOnWounded: True`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dracula_BloodSoul_Absorb_AbilityGroup PrefabGuid(-1768784526)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Buff1: Buff_Dracula_BloodSoul_Effect PrefabGuid(1814805925)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_NoneCombatState PrefabGuid(597754491)`
