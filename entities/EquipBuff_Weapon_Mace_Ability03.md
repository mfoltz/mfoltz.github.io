---
title: EquipBuff_Weapon_Mace_Ability03
guid: 250456816
...
# EquipBuff_Weapon_Mace_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Mace_Primary_MeleeAttack_AbilityGroup PrefabGuid(722599012)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Mace_CrushingBlow_Slam_AbilityGroup PrefabGuid(1262003451)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Mace_Smack_AbilityGroup PrefabGuid(1121958763)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
