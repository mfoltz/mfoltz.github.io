...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(217223051)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Mutant_Rat PrefabGuid(-749320115)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Rat_Scratch_Group PrefabGuid(-650383304)`
  - `ShowOnBar: True`
...
- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Rat_Taunt_Group PrefabGuid(306615743)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: Mutant_RatHorror_Spawn_PoolJump PrefabGuid(-79158284)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Mutant_Rat PrefabGuid(-712272657)`
