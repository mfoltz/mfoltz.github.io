---
title: CHAR_Undead_Leader_Vblood
guid: -1365931036
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_Leader_VBlood_Downed PrefabGuid(-2002379408)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-873917285)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_Leader_Vblood PrefabGuid(-1365931036)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_Leader PrefabGuid(350688287)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Leader_MeleeStandard_Group PrefabGuid(346834991)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Leader_ChainHookProjectile_Group PrefabGuid(234226418)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Leader_SpinningDash_Group PrefabGuid(948587795)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Leader_AreaAttack_Group PrefabGuid(211628325)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Leader_WardOfTheDamned_AbilityGroup PrefabGuid(-1504629350)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_UndeadLeader_Reaper PrefabGuid(-1631949089)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T05_UndeadLeader PrefabGuid(684401761)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_T05_UndeadLeader_Bells PrefabGuid(-1062774694)`
...
- **[0]**
  - `BuffGuid: Buff_Undead_Leader_VBlood_InCombat PrefabGuid(-2079744569)`
