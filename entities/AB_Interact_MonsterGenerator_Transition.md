...
- [ProjectM.Gameplay.Scripting.Script_TransitionInteractedOnSpawn_DataServer](/components/Script_TransitionInteractedOnSpawn_DataServer){:target="_blank"}
  - `TransitionId: Unity.Collections.FixedString32Bytes OnInteracted`
