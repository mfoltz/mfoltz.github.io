...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_Bandit_Chair01 PrefabGuid(1926372834)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1961336875`
