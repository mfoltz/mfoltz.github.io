---
title: CHAR_Geomancer_Human_VBlood
guid: -1065970933
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 28`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Bandit_Deadeye_VBlood_Downed PrefabGuid(1871586579)`
...
- **ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderThreeHealthThreshholdsDataCarrier_DataServer**
  - `OnDamageTakenListener: ProjectM.Scripting.ListenerId ProjectM.Scripting.ListenerId`
  - `ThresholdMet1: False`
  - `ThresholdMet2: False`
  - `ThresholdMet3: False`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1977720510)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Geomancer_Human_VBlood PrefabGuid(-1065970933)`
  ...
  - `TooltipGUID: JournalAsset_VBlood_Shapeshift PrefabGuid(1097416038)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 57.896446`
  - `SpellPower: 57.896446`
  - `ResourcePower: 37.44`
  - `SiegePower: 14.599999`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Geomancer_Human_VBlood PrefabGuid(-1484629956)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Human_Projectile_Group PrefabGuid(-1635892700)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Transform_ToGolem_AbilityGroup PrefabGuid(1925592126)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_MeleeAttack_Group PrefabGuid(1500843923)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_RockSlam_AbilityGroup PrefabGuid(-221719333)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_GroundSlam_Group PrefabGuid(2106422510)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_UndergroundTremmors_AbilityGroup PrefabGuid(-1148606177)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_EnragedSmash_AbilityGroup PrefabGuid(1079488801)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Enrage_AbilityGroup PrefabGuid(-1204505053)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Awake_AbilityGroup PrefabGuid(-394948183)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Transform_ToHuman_AbilityGroup PrefabGuid(-716557249)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Golem_RaiseGuardians_AbilityGroup PrefabGuid(-598112885)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Geomancer_Transform_ToGolem_SecondTime_AbilityGroup PrefabGuid(-2084016434)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Geomancer_BreakForm_Travel PrefabGuid(33805998)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_Golem PrefabGuid(292267578)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T05_GolemGems PrefabGuid(-1074691879)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_T05_GolemObsidian PrefabGuid(-318857592)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Geomancer_Human PrefabGuid(-1352713778)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Geomancer_MagicSource PrefabGuid(-2136955642)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
