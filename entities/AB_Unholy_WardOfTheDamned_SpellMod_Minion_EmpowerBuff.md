---
title: AB_Unholy_WardOfTheDamned_SpellMod_Minion_EmpowerBuff
guid: 345491926
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Unholy_WardOfTheDamned_SpellMod_Minion_EmpowerBuff
...
- [ProjectM.EmpowerBuff](/components/EmpowerBuff){:target="_blank"}
  - `EmpowerModifier: 0`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_WardOfTheDamned_EmpowerSkeletonsOnRecast PrefabGuid(761541981)`
...
- **[1]**
  ...
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget EmpowerBuff_Empower`
  - `TargetIndex: -1`
