---
title: CHAR_ChurchOfLight_Overseer_VBlood
guid: -26105228
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_ChurchOfLight_Overseer_VBlood_Downed PrefabGuid(1136634549)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2059198289)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_ChurchOfLight_Overseer_VBlood PrefabGuid(-26105228)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_Overseer PrefabGuid(612310328)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_SwingAttack_AbilityGroup PrefabGuid(613355091)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_SpinAttack_AbilityGroup PrefabGuid(-985136954)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_IceRecovery_AbilityGroup PrefabGuid(1792964134)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_PiercingCharge_AbilityGroup PrefabGuid(-1973550282)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_PiercingCharge_Throw_AbilityGroup PrefabGuid(493409764)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_Reinforcement_AbilityGroup PrefabGuid(1823825002)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_IcicleField_AbilityGroup PrefabGuid(1964067196)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Overseer_Hard_SnowLob_AbilityGroup PrefabGuid(1541929232)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Overseer PrefabGuid(-1652178969)`

- **[1]**
  - `Guid: Tech_Storage_Pack_T02 PrefabGuid(-612322185)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Overseer PrefabGuid(1860175001)`
