...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_CrateLarge_Destory01 PrefabGuid(-1509057274)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 563431669`
...
- **[0]**
  - `DropTableGuid: DT_Breakables_T02_General_MilitiaCrate PrefabGuid(2054529563)`
