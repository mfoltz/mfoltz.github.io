---
title: AB_FeedBoss_FeedOnDracula_03_Complete_Trigger
guid: 1229263634
categories: ['AB', 'All']
nav_exclude: true
...
# AB_FeedBoss_FeedOnDracula_03_Complete_Trigger
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_BloodBuff_Creature_Tier4_Empower PrefabGuid(-604757170)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-670750933)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(51055185)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
...
- **[0]**
  - `SpawnPrefab: AB_FeedBoss_FeedOnDracula_03_Complete_AreaDamage PrefabGuid(1340086775)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- **[1]**
  - `Trophy: ProjectM.Trophy AFirstTaste`
