...
- [ProjectM.SetOwnerRotateTowardsMouse](/components/SetOwnerRotateTowardsMouse){:target="_blank"}
  - `Importance: 0`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_OutOfCombat PrefabGuid(897325455)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -900115846`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 573658277`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(897325455)`
