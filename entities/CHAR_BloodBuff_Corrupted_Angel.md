---
title: CHAR_BloodBuff_Corrupted_Angel
guid: -932793458
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_BloodBuff_Corrupted_Angel
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1933154276)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(-1702123687)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_BloodBuff_Corrupted_Angel PrefabGuid(1739767381)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_BloodBuff_Corrupted_Angel_Dash_AbilityGroup PrefabGuid(-1869894099)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Buff1: Buff_Corruption_HarpyEffect PrefabGuid(-2084519380)`
