...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Consumable_SunResistancePotion_T01 PrefabGuid(-38051433)`
...
- [CastAbilityOnConsume](/components/CastAbilityOnConsume){:target="_blank"}
  - `AbilityGuid: AB_Consumable_SunResistancePotion_T01_AbilityGroup PrefabGuid(-603849198)`
