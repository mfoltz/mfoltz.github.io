---
title: AB_VHunter_Jade_Caltrops_Hard_Cast
guid: -781534465
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_VHunter_Jade_Caltrops_Hard_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_VHunter_Jade_Caltrops_Hard_Cast PrefabGuid(-781534465)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiThrow_Cast_DataServer](/components/Script_MultiThrow_Cast_DataServer){:target="_blank"}
  - `MinRange: 0.5`
  - `MaxRange: 10`
  - `OffsetAngle: 0`
  - `RandomAngle: 6.2831855`
  - `NewThrowEntity: AB_VHunter_Jade_Caltrops_Hard_Throw PrefabGuid(-878288024)`
  - `Count: 12`
