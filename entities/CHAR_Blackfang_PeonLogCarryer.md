---
title: CHAR_Blackfang_PeonLogCarryer
guid: 1451256919
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1059023076)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_PeonLogCarryer PrefabGuid(-1672148294)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_PeonLogCarryer_Melee_AbilityGroup PrefabGuid(936609695)`
  - `ShowOnBar: True`
