...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Lucie_PanicShot_Cast PrefabGuid(-1416803366)`
...
- **[0]**
  - `SpawnPrefab: AB_Lucie_PanicShot_Projectile PrefabGuid(1052579549)`
