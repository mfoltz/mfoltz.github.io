---
title: CHAR_Vampire_Cultist_PrayingArmsOut_Female
guid: -1074322242
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Vampire_Cultist_PrayingArmsOut_Female
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 18`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(184969275)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Vampire_Cultist_Female_Servant PrefabGuid(1703325932)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vampire_Cultist PrefabGuid(580259360)`
...
- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_StopChannel_AbilityGroup PrefabGuid(1210884829)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_Channel_AbilityGroup PrefabGuid(1983112426)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_Praying_01_AbilityGroup PrefabGuid(-2059612596)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_Praying_02_AbilityGroup PrefabGuid(657450547)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_Whittling_AbilityGroup PrefabGuid(1814959003)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Cultist_BloodCrystal_AbilityGroup PrefabGuid(-501371757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[2]**
  - `BuffGuid: Buff_Vampire_Cultist_CombatBuff PrefabGuid(1120328360)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`
