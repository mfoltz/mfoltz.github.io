---
title: AB_Monster_FinalProjectile_Cast
guid: 374856501
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Monster_FinalProjectile_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Monster_FinalProjectile_Cast PrefabGuid(374856501)`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_FinalProjectile_Projectile01 PrefabGuid(171128206)`
...
- **[1]**
  - `SpawnPrefab: AB_Monster_FinalProjectile_Projectile02 PrefabGuid(288386871)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
