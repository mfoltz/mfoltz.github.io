---
title: TM_PlantfiberBushPlainAutumn_01_Pickup
guid: -478682617
categories: ['All', 'TM']
nav_exclude: true
...
# TM_PlantfiberBushPlainAutumn_01_Pickup
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0f,  0f, 0.7135f, 0f, 0f,  0f, 0f, 1f, 0f,  0f, 0f, 0f, 1f)`
