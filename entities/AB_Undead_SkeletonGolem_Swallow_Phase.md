---
title: AB_Undead_SkeletonGolem_Swallow_Phase
guid: -1865259954
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Undead_SkeletonGolem_Swallow_Phase
...
- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: AB_Undead_SkeletonGolem_Swallow_Hit PrefabGuid(-886600453)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Undead_SkeletonGolem_Swallow_End PrefabGuid(-1794709849)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1401882476`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(580160506)`
