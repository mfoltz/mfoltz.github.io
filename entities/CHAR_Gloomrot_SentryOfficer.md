---
title: CHAR_Gloomrot_SentryOfficer
guid: 1401026468
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Gloomrot_SentryOfficer_Servant PrefabGuid(-1213645419)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Gloomrot_SentryOfficer PrefabGuid(-398535308)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Rank02 PrefabGuid(-1174421397)`
