---
title: AB_IceRanger_JumpDown_Travel
guid: 1937056675
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: AB_IceRanger_JumpDown_Travel_Land PrefabGuid(-21518537)`
...
- [ProjectM.TravelBuffSpawn](/components/TravelBuffSpawn){:target="_blank"}
  ...
  - `MinDuration: 1`
  - `MaxDuration: 1`
  - `TravelTargetMode: ProjectM.TravelTargetMode InputDirection`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-2036645637)`
