---
title: AB_Vampire_Dracula_FeedAttack_TargetGrabedBuff
guid: 123709251
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_Dracula_FeedAttack_TargetGrabedBuff
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 0f, 2.5f)`
...
- [ProjectM.TravelBuffSpawn](/components/TravelBuffSpawn){:target="_blank"}
  - `TargetRangeOffset: 0`
  - `MinRange: 0`
  - `MaxRange: 3`
  ...
  - `MinDuration: 1`
  - `MaxDuration: 5`
  - `TravelTargetMode: ProjectM.TravelTargetMode ToSpellPosition`
  - `GetStartPositionFromBuffTarget: True`
  - `ScaleDuration: False`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acdfgkjgicc`
...
- **[1]**
  - `EventId: Local - -523413670`
  - `Target: ProjectM.GameplayEventTarget BuffTarget`
  - `SpecificDestroyReason: True`
  - `DestroyReason: ProjectM.DestroyReason ManualInterrupt`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Dracula_FeedAttack_InterruptedBuff PrefabGuid(-1842497689)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Dracula_FeedAttack_LaunchBuff PrefabGuid(1548355736)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[2]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Dracula_FeedAttack_HasGrabedBuff PrefabGuid(295991134)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- [ProjectM.ChangeBloodOnGameplayEvent](/components/ChangeBloodOnGameplayEvent){:target="_blank"}

- **[0]**
  - `BloodValue: -25`
  - `BloodQuality: 0`
  - `BloodType: GUID Not Found`
  - `GainBloodType: ProjectM.GainBloodType BloodMend`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -523413670`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1750992520`
