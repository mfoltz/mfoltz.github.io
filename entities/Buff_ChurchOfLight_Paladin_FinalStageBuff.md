---
title: Buff_ChurchOfLight_Paladin_FinalStageBuff
guid: 2144624015
categories: ['All', 'Buff']
nav_exclude: true
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_ChurchOfLight_Paladin_HolyBubble_InvulnerableBuff PrefabGuid(358972271)`
...
- **[0]**
  ...
  - `AbilityGroupId: AB_ChurchOfLight_Paladin_EmpoweredMelee_AbilityGroup PrefabGuid(-947518364)`
  - `SlotIndex: 0`

- **[1]**
  - `Target: ProjectM.ChangeAbilityTarget Target`
  - `AbilityGroupId: AB_ChurchOfLight_Paladin_Melee_AbilityGroup PrefabGuid(1673497547)`
  - `SlotIndex: 0`
