...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cfkigbekgk`

- [ProjectM.Shared.WarEvents.WarEvent_NetworkedData](/components/WarEvent_NetworkedData){:target="_blank"}
  - `NextEventTimeTicks: 0`
  - `LastEventTimeTicks: 0`
  - `ActiveEventStartTimeTicks: 0`
  - `ActiveEventEndTimeTicks: 0`
  - `ActiveEventDecayTicks: 0`
  - `IsActive: False`
  - `ActiveType: ProjectM.Shared.WarEvents.WarEventType Major`
...
- [ProjectM.Shared.WarEvents.WarEvent_NetworkedEntity](/components/WarEvent_NetworkedEntity){:target="_blank"}
  - *(No fields)*
