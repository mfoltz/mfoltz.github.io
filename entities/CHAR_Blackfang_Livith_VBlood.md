---
title: CHAR_Blackfang_Livith_VBlood
guid: -1383529374
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 4`
  - `CircleChangeDirectionFrequencyMax: 6`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Downed_Livith_VBlood PrefabGuid(1072109427)`
  - `TriggerSequence: SequenceGUID 423127841`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-8518182)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(-1460095921)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Blackfang_Livith_VBlood PrefabGuid(-1383529374)`
  ...
  - `SpellSchool: IllusionSpellSchoolAsset PrefabGuid(-526263322)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Livith_VBlood PrefabGuid(-1473448723)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_MeleeAttack_AbilityGroup PrefabGuid(139802405)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_SlicingDash_AbilityGroup PrefabGuid(-407341422)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_Stealth_AbilityGroup PrefabGuid(1920281924)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_StealthAttack_AbilityGroup PrefabGuid(-1372642162)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_RoundKick_AbilityGroup PrefabGuid(-385314771)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_CloneNinjutsu_AbilityGroup PrefabGuid(-1337706250)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_CuttingWind_AbilityGroup PrefabGuid(-315621824)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_Dash_AbilityGroup PrefabGuid(1318543111)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_SpiritOrbs_AbilityGroup PrefabGuid(1584749067)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_CirclingStance_AbilityGroup PrefabGuid(987540308)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_SlicingDash_Single_AbilityGroup PrefabGuid(1261373899)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_SpiritOrbs_ClearCheck_AbilityGroup PrefabGuid(-1518495336)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_PermanentStealth_AbilityGroup PrefabGuid(-140727030)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_AggroPlayers_AbilityGroup PrefabGuid(-941466362)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Livith_ShadowDance_AbilityGroup PrefabGuid(168833229)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Livith PrefabGuid(1851932061)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T07_Livith_Slashers PrefabGuid(1262310143)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_Livith PrefabGuid(2111855750)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Livith_VBlood PrefabGuid(1161649372)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_VBlood_T04_Normal PrefabGuid(2125107631)`
