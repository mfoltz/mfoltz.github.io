---
title: AB_Storm_EyeOfTheStorm_Cast
guid: 1368053381
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Storm_EyeOfTheStorm_Cast PrefabGuid(1368053381)`
...
- **[0]**
  - `SpawnPrefab: AB_Storm_EyeOfTheStorm_Buff PrefabGuid(1538254242)`
