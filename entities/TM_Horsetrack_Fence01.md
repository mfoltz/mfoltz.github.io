...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_Horsetrack_Fence01 PrefabGuid(918048395)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1184145071`
