---
title: CHAR_Gloomrot_TheProfessor_VBlood
guid: 814083983
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 14`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Gloomrot_Professor_VBlood_Downed PrefabGuid(-1736795990)`
  - `TriggerSequence: SequenceGUID 431935880`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1022070092)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Gloomrot_TheProfessor_VBlood PrefabGuid(814083983)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0`
  - `WoundedTriggerSequenceGuid: SequenceGUID 584042160`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Gloomrot_TheProfessor_VBlood PrefabGuid(-938648791)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_ImplodingOrb_Group PrefabGuid(-506564570)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_MultiLazer_Hard_AbilityGroup PrefabGuid(922412053)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_ElectricPush_Group PrefabGuid(1142491430)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_Discharge_AbilityGroup PrefabGuid(98352404)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_TeleportMid_AbilityGroup PrefabGuid(-559662270)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_FewBeams_Group PrefabGuid(1957366402)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_PermaBeams_Group PrefabGuid(-727882902)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_OverloadOrb_AbilityGroup PrefabGuid(-1904011556)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_ManyBeams_Group PrefabGuid(-841469184)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_ManyBeams_Hard_Group PrefabGuid(1379672205)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_TheProfessor_MultiLazer_AbilityGroup PrefabGuid(-2097618568)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Professor PrefabGuid(-1199699442)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_TheProfessor PrefabGuid(-1781177443)`
