---
title: AB_Consumable_Eat_TrippyShroom_Cast
guid: 476025843
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Consumable_Eat_TrippyShroom_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Consumable_Eat_TrippyShroom_Cast PrefabGuid(476025843)`
...
- **[0]**
  - `SpawnPrefab: AB_Consumable_Eat_TrippyShroom_Activate PrefabGuid(1495017287)`
