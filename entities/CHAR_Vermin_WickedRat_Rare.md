---
title: CHAR_Vermin_WickedRat_Rare
guid: -19165577
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-874783405)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vermin_GiantRat PrefabGuid(-1921095795)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_Rat_MeleeAttack_AbilityGroup PrefabGuid(-1007898441)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Rare_WickedRat PrefabGuid(-1772066863)`
