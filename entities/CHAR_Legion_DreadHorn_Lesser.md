---
title: CHAR_Legion_DreadHorn_Lesser
guid: -1140588645
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-813769179)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Dreadhorn PrefabGuid(-1065784703)`
...
- [ProjectM.Shared.DropTableOnDeath](/components/DropTableOnDeath){:target="_blank"}
  - `Dropped: False`
  - `CustomDropArc: DropItemSphere PrefabGuid(-2054980473)`
  - `MinRange: 3`
  - `MaxRange: 6`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_MeleeAttack_AbilityGroup PrefabGuid(-1362226779)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_AreaAttack_AbilityGroup PrefabGuid(-1924032736)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_Trample_Init_AbilityGroup PrefabGuid(-1670440585)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_Trample_AbilityGroup PrefabGuid(-2081714952)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_TargetSwitch_AbilityGroup PrefabGuid(-1450279612)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Dreadhorn_Trample_Second_Init_AbilityGroup PrefabGuid(1236214928)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
