---
title: Buff_General_Shield_DarkEnchantment
guid: -684755394
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_SCTOnEvent_DataServer](/components/Script_SCTOnEvent_DataServer){:target="_blank"}
  - `Text: Stunlock.Core.AssetGuid bf52fe439ad44d3d95ca82a1373d323a`
  - `SCTType: SCT_Type_Generic PrefabGuid(-1687715009)`
  - `Value: 1`
  - `Location: ProjectM.Gameplay.Scripting.SCTTargetLocation EventTarget`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1286812958`
