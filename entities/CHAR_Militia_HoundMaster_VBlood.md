---
title: CHAR_Militia_HoundMaster_VBlood
guid: -784265984
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(825142113)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_HoundMaster_VBlood PrefabGuid(2128632339)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_QuickShot_AbilityGroup PrefabGuid(1219885177)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_Shove_AbilityGroup PrefabGuid(-367310449)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_Tackel_AbilityGroup PrefabGuid(1648996357)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_Roll_AbilityGroup PrefabGuid(-1416105872)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_SpreadShot_AbilityGroup PrefabGuid(479773974)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_Command_AbilityGroup PrefabGuid(-91811178)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Militia_HoundMaster_Heal_AbilityGroup PrefabGuid(-1449494345)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_HoundMaster_DeathTrackingBuff PrefabGuid(2062815630)`
