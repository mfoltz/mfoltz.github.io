---
title: CHAR_Undead_CursedSmith_FloatingWeapon_Spear
guid: 233127264
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2063777079)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingSpear_MeleeAttack_AbilityGroup PrefabGuid(793860757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingSpear_SpearThrust_AbilityGroup PrefabGuid(1166337981)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
