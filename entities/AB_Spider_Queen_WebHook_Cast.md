---
title: AB_Spider_Queen_WebHook_Cast
guid: 1099578860
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Spider_Queen_WebHook_Cast PrefabGuid(1099578860)`
...
- **[0]**
  - `SpawnPrefab: AB_Spider_Queen_WebHook PrefabGuid(1678598978)`
