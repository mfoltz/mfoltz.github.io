...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  ...
  - `ServerPositionOffset: Unity.Mathematics.float3 float3(0f, 2.7f, 0f)`
  - `HybridBone: 0`
  - `CopyPosition: True`
  - `CopyRotation: False`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_IgnoresPathfindingLineOfSight_DataServer](/components/Script_Buff_IgnoresPathfindingLineOfSight_DataServer){:target="_blank"}
  - `ModId: Unset`
...
- **[0]**
  ...
  - `DestroyReason: ProjectM.DestroyReason ParentDestruction`
