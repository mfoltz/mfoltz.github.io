---
title: TM_CarriageChest_ChurchMutant
guid: -1497964417
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acjcjdccfe`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Spawn_Unit PrefabGuid(396339796)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Treasure_Regular_T02_GloomrotSouth PrefabGuid(-87450162)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnSpawnDropInInventory`
  - `RelicType: ProjectM.Shared.RelicType None`

- **[1]**
  - `DropTableGuid: DT_Carriage_T03_Mutant PrefabGuid(-1297823967)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnSpawnDropInInventory`
  - `RelicType: ProjectM.Shared.RelicType None`
...
- [ProjectM.OffsetLastTranslationOnSpawn](/components/OffsetLastTranslationOnSpawn){:target="_blank"}
  - *(No fields)*
