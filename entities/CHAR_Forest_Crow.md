...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2096743453)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_GiantCrow_Peck_AbilityGroup PrefabGuid(898033701)`
  - `ShowOnBar: True`
...
- **[1]**
  ...
  - `Buff: AB_GiantCrow_Spawn_FlyDownSmoothly PrefabGuid(1793230259)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Creature_ForestCrow PrefabGuid(1758005653)`
