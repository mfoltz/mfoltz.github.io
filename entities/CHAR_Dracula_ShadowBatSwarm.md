---
title: CHAR_Dracula_ShadowBatSwarm
guid: -2092104425
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1216038746)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ahjeijhdfc`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Dracula_ShadowBatSwarm PrefabGuid(258244584)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dracula_ShadowBatSwarm_Dash_AbilityGroup PrefabGuid(-1099406988)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Buff1: Buff_Dracula_ShadowBatSwarm_Effect PrefabGuid(-855125670)`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1982127024`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SpawnPrefab: AB_General_BloodOrb_Dracula_Object_AutoPickup PrefabGuid(-273077376)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
