---
title: AB_Vampire_Sword_Shockwave_Recast_TravelToTargetFirstStrike
guid: -438334309
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Vampire_Sword_Shockwave_Recast_TravelToTargetFirstStrike
...
- [ProjectM.GetOwnerRotation](/components/GetOwnerRotation){:target="_blank"}
  ...
  - `Type: ProjectM.GetRotationType TowardsSpellTarget`
...
- [ProjectM.Gameplay.Scripting.Script_Sword_Shockwave_ReturnToTargetPosition_Data](/components/Script_Sword_Shockwave_ReturnToTargetPosition_Data){:target="_blank"}
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Sword_Shockwave_Recast_TravelToTargetSecondStrike PrefabGuid(1473518847)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1696208877`
...
- [ProjectM.UpdateAgeWhenDisabled](/components/UpdateAgeWhenDisabled){:target="_blank"}
  - *(No fields)*

- [ProjectM.UpdateLifeTimeWhenDisabled](/components/UpdateLifeTimeWhenDisabled){:target="_blank"}
  - *(No fields)*
