---
title: AB_Wendigo_FrostNova_RingArea
guid: -1227952025
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.RingAoE_DataShared](/components/RingAoE_DataShared){:target="_blank"}
  - `StartRadius: 1`
  - `EndRadius: 12`
  - `Duration: 1`
  - `RingThickness: 1`
  - `TimeBetweenHits: 1`
  - `Height: 3`
  - `RingSequence: SequenceGUID -40367522`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acggfcbekbj`
...
- [ProjectM.Gameplay.Scripting.HitList](/components/HitList){:target="_blank"}
  - *(No fields)*
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Wendigo_FrostNova_MoveBehaviourBuff PrefabGuid(325147096)`
...
- **[2]**
  ...
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `EntityOwner: ProjectM.SetEntityOwner Default`
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 6`
  - `Stacks: 1`
  - `Buff0: Buff_General_Chill PrefabGuid(-1974768686)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `PrimarySequenceGuid: SequenceGUID 1237580971`
