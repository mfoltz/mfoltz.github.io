---
title: AB_Undead_SkeletonGolem_Swallow_OnHitTravel
guid: -1014729642
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Undead_SkeletonGolem_Swallow_OnHitTravel
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 3f, -0.5f)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Undead_SkeletonGolem_Swallow_TargetSwallowedBuff PrefabGuid(-743287512)`
