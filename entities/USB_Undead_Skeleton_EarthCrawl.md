---
title: USB_Undead_Skeleton_EarthCrawl
guid: -1500949089
...
# USB_Undead_Skeleton_EarthCrawl
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_iicekghif`
...
- [ProjectM.Gameplay.Scripting.Script_UnitSpawn_DataServer](/components/Script_UnitSpawn_DataServer){:target="_blank"}
  - `UnitToSpawn: CHAR_Undead_SkeletonSoldier_Withered PrefabGuid(-1584807109)`
  - `UnitSpawnBuff: Buff_SpawnBuff_Skeleton_EarthCrawl PrefabGuid(1820474368)`
  - `ProximityActivationRadius: 3`
  - `ProximityActivationTime: 0.4`
  - `LifetimeBuff: Buff_USB_Lifetime PrefabGuid(71525166)`
  - `AllyAllertRadius: 8`
  - `AllyActivationExtraDelayTime: 0.2`
  - `Activated: False`
