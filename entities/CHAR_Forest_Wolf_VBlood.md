...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Forest_Wolf_VBlood_Downed PrefabGuid(-1288467635)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-672126651)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Forest_Wolf_VBlood PrefabGuid(-1905691330)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Wolf_vblood PrefabGuid(44468604)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_Bite_Group PrefabGuid(-1654954396)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_Bite_Enraged_Group PrefabGuid(1558429115)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_DashAttack_Single_AbilityGroup PrefabGuid(920051497)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_DashAttack_Double_AbilityGroup PrefabGuid(280173050)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_DashAttack_Tripple_AbilityGroup PrefabGuid(-1161539168)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_Maul_Hard_AbilityGroup PrefabGuid(2145136774)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_Pounce_AbilityGroup PrefabGuid(-821573025)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_StepBack_AbilityGroup PrefabGuid(1456629565)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_Howl_AbilityGroup PrefabGuid(247740796)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Boss_SpeedBuff_AbilityGroup PrefabGuid(544754926)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T02_AlphaWolf PrefabGuid(-1031733757)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_AlphaWolf PrefabGuid(600470494)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Forest_Wolf PrefabGuid(195947260)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_VBlood_DireWolf_T01 PrefabGuid(-952119416)`
