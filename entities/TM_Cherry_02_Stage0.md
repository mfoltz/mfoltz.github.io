...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Trees_Cherry02_Small_Dynamics PrefabGuid(1092953816)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `DropTableGuid: DT_Resource_Tree_Sapling_CherryBlossom PrefabGuid(1315524229)`
