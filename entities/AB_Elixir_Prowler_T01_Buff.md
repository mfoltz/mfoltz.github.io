---
title: AB_Elixir_Prowler_T01_Buff
guid: 1578287607
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag ElixirConsumable`
  - `KeepOldest: False`
...
- **[0]**
  ...
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag ElixirConsumable`
  - `IncludeSelf: False`
...
- **[1]**
  - `AttributeCapType: ProjectM.AttributeCapType SoftCapped`
  - `StatType: ProjectM.UnitStatType TravelCooldownRecoveryRate`
  - `ModificationType: ProjectM.ModificationType Add`
  - `Value: 0`
  - `SoftCapValue: 1`
  - `Modifier: 1`
