...
- [ProjectM.Mountable](/components/Mountable){:target="_blank"}
  - `MaxSpeed: 0`
  - `Acceleration: 0`
  - `RotationSpeed: 0`
  - `Mounter: Entity(0:0)`
  - `MountBuff: AB_Interact_Mount_Owner_Buff_Horse PrefabGuid(854656674)`
...
- [ProjectM.FeedableInventory](/components/FeedableInventory){:target="_blank"}
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Mount_Horse_Downed PrefabGuid(-266455478)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_gehcicceh`
...
- **[1]**
  ...
  - `Component               �TҰ<`
  - `ConditionalElements`
  - `Ability: AB_FeedRevive_01_Initiate_AbilityGroup PrefabGuid(1754040702)`
  - `Importance: 1`
  - `HideInteractHUDWhileCasting: False`
...
- **448 total elements but only showing the first 36**
  - *(No fields)*
...
- **107 total elements but only showing the first 36**
  - *(No fields)*
