---
title: TM_DraculasCastle_Throne_Clean01
guid: -151766050
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_DraculasCastle_Throne_Clean01
...
- [ProjectM.Gameplay.Scripting.Script_Dracula_SpawnerData](/components/Script_Dracula_SpawnerData){:target="_blank"}
  - `State: ProjectM.Gameplay.Scripting.Script_Dracula_SpawnerData+DraculaState Reset`
  - `DraculaInstance: Entity(0:0)`
  - `DraculaPrefabGuid: CHAR_Vampire_Dracula_VBlood PrefabGuid(-327335305)`
  - `SeatedPrefabGuid: Buff_Vampire_Dracula_Seated PrefabGuid(1264659054)`
  - `StandUpPrefabGuid: Buff_Vampire_Dracula_StandUp PrefabGuid(-2081244038)`
  - `VictoryTeleportBuff: Buff_General_DraculaTeleport_Out PrefabGuid(-246759104)`
  - `VictoryChunk: ProjectM.Terrain.TerrainChunk 24,1`
  - `SpawnOffset: Unity.Mathematics.float3 float3(0f, 0f, 9f)`
  - `DraculaFeed: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-670750933)`
  - `DraculaDowned: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-187191126)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cechggbfcg`
...
- [Unity.Transforms.LocalTransform](/components/LocalTransform){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(-2.477239E-06f, 0f, 1.106177f)`
  - `Scale: 1`
