...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(471295142)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID -1523613209`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_Mosquito PrefabGuid(-889406876)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Mosquito_MeleeAttack_AbilityGroup PrefabGuid(1451199905)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Mosquito_DashAttack_AbilityGroup PrefabGuid(-1979483677)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Mosquito PrefabGuid(-993326673)`
