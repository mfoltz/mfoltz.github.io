---
title: TM_GemRegular_01_Stage0_Resource
guid: -1486510754
categories: ['All', 'TM']
nav_exclude: true
...
# TM_GemRegular_01_Stage0_Resource
...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: GoldNode01_Broken PrefabGuid(-1915684879)`
  - `AlwaysSpawn: False`
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0f,  0f, 1f, 0f, 0f,  0f, 0f, 1.0035f, 0f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `DropTableGuid: DT_Resource_Vein_Gem_Destroy_T02 PrefabGuid(-10059465)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`

- **[1]**
  - `DropTableGuid: DT_Resource_Vein_Rock_General PrefabGuid(2009635259)`
