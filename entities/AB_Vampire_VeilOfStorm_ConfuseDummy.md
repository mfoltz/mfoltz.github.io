---
title: AB_Vampire_VeilOfStorm_ConfuseDummy
guid: 1782955054
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_VeilOfStorm_ConfuseDummy
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_VeilOfStorm_SpellMod_SparklingIllusion PrefabGuid(529399706)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1005267832`
...
- [ProjectM.GetOwnerFactionOnSpawn](/components/GetOwnerFactionOnSpawn){:target="_blank"}
  - *(No fields)*
