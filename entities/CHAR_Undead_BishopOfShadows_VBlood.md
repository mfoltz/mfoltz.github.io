---
title: CHAR_Undead_BishopOfShadows_VBlood
guid: 939467639
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_BishopOfShadows_VBlood_Downed PrefabGuid(-721205311)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-377981910)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_BishopOfShadows_VBlood PrefabGuid(939467639)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_BishopOfShadows_VBlood PrefabGuid(1521680311)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_Projectile_AbilityGroup PrefabGuid(787702249)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_Projectile_Hard_AbilityGroup PrefabGuid(651637774)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_TrippleBolt_AbilityGroup PrefabGuid(-1795148379)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_ShadowStep_AbilityGroup PrefabGuid(1325722355)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_ShadowSoldier_AbilityGroup PrefabGuid(461701172)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_BishopOfShadows_EternalDarkness_AbilityGroup PrefabGuid(1583944483)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_BishopOfShadow PrefabGuid(1795449585)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_BishopOfShadows PrefabGuid(-219121351)`
...
- **[2]**
  - `BuffGuid: AB_Undead_BishopOfShadows_Idle_Buff PrefabGuid(-1782768874)`
