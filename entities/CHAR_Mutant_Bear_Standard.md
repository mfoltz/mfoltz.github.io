---
title: CHAR_Mutant_Bear_Standard
guid: 1938756250
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1997519238)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(1344481611)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Mutant_Bear_Standard PrefabGuid(-1372447475)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Mutant_MeleeAttack_Group PrefabGuid(-77977745)`
  - `ShowOnBar: True`
...
- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Mutant_AreaAttack_Group PrefabGuid(-44955695)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Mutant_AreaAttack_Fast_Group PrefabGuid(616732424)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Mutant_Bear PrefabGuid(78942656)`
