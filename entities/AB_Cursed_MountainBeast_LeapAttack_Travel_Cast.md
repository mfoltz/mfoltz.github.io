---
title: AB_Cursed_MountainBeast_LeapAttack_Travel_Cast
guid: -1461990482
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Cursed_MountainBeast_LeapAttack_Travel_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_MountainBeast_LeapAttack_Travel_Cast PrefabGuid(-1461990482)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_LeapAttack_Travel_Phase PrefabGuid(881475206)`
...
- **[1]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_LeapAttack_AggroBuff PrefabGuid(1826885843)`
