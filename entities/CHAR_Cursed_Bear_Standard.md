---
title: CHAR_Cursed_Bear_Standard
guid: -559819989
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_Bear_Standard PrefabGuid(-1554281311)`
...
- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bear_Cursed_Dash_Group PrefabGuid(-730437928)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Bear PrefabGuid(-1703387309)`
