---
title: AB_Mantrap_Corrupted_SpawnSaplings_Cast
guid: 1994684330
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Mantrap_Corrupted_SpawnSaplings_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Mantrap_Corrupted_SpawnSaplings_Cast PrefabGuid(1994684330)`
...
- **[0]**
  - `SpawnPrefab: AB_Mantrap_Corrupted_SpawnSaplings_Summon01 PrefabGuid(1490149155)`
...
- **[1]**
  - `SpawnPrefab: AB_Mantrap_Corrupted_SpawnSaplings_Summon02 PrefabGuid(910313018)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
