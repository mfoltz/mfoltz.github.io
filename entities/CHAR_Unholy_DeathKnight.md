...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(144216116)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cceebhhddk`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Unholy_DeathKnight PrefabGuid(2080585865)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Unholy_DeathKnightStrike_AbilityGroup PrefabGuid(483769006)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Unholy_DeathKnight_MeleeCombo_Group PrefabGuid(684476797)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1027626630`
...
- **[0]**
  - `SpawnPrefab: AB_Unholy_Shared_SkeletonSpawner_Mage_DeathKnightJewel PrefabGuid(1654690407)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_Militia_Rank02 PrefabGuid(-729874259)`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_DeathKnight_IncreaseLifetime PrefabGuid(771873857)`
