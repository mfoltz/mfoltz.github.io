---
title: CHAR_Undead_ArenaChampion_VBlood
guid: -753453016
categories: ['All', 'CHAR']
nav_exclude: true
...
# CHAR_Undead_ArenaChampion_VBlood
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_ArenaChampion_VBlood_Downed PrefabGuid(83174109)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1118808720)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_ArenaChampion_VBlood PrefabGuid(-753453016)`
  ...
  - `SpellSchool: UnholySpellSchoolAsset PrefabGuid(232985690)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_ArenaChampion_VBlood PrefabGuid(-639872266)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_SweepAttacks_AbilityGroup PrefabGuid(-1781725233)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_Fadestrike_AbilityGroup PrefabGuid(-547251580)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_SideStep_Left_AbilityGroup PrefabGuid(-1253650402)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_SideStep_Right_AbilityGroup PrefabGuid(-887581044)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_Windslash_AbilityGroup PrefabGuid(-2023636973)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_Disengage_AbilityGroup PrefabGuid(-1175912131)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_LeapStrike_AbilityGroup PrefabGuid(2136656017)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_Charge_AbilityGroup PrefabGuid(-1810214745)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_Kick_AbilityGroup PrefabGuid(-1756717462)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_AddToDuel_AbilityGroup PrefabGuid(341647784)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Undead_AreanaChampion_CorpseBuff_AbilityGroup PrefabGuid(-89125940)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_StabLaunch_AbilityGroup PrefabGuid(821808685)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_TwinbladeThrow_AbilityGroup PrefabGuid(1322698651)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_CounterStrike_AbilityGroup PrefabGuid(-1357375516)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_ChainsOfDeath_AbilityGroup PrefabGuid(-782050236)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[15]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ArenaChampion_KillDisconnected_AbilityGroup PrefabGuid(-725828654)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Undead_ArenaChampion_AntennaBuff_Rear PrefabGuid(-529019452)`
  - `Buff1: Undead_ArenaChampion_AntennaBuff_Far_Rear PrefabGuid(-1133885917)`
  - `Buff2: Undead_ArenaChampion_AntennaBuff_Right PrefabGuid(837772421)`
  - `Buff3: Undead_ArenaChampion_AntennaBuff_Left PrefabGuid(-1116643482)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_ArenaChampion PrefabGuid(-2144827499)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T05_ArenaChampion_TwinBlades PrefabGuid(1469248266)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_ArenaDecorations PrefabGuid(959981888)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_Spawn_VBlood_ArenaChampion PrefabGuid(339702988)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_VBlood_T02_Normal PrefabGuid(-435504482)`
