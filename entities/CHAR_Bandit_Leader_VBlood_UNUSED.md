---
title: CHAR_Bandit_Leader_VBlood_UNUSED
guid: -175381832
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1412702580)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Leader_VBlood_UNUSED PrefabGuid(-175381832)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Leader_VBlood PrefabGuid(281269854)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_Crossbow_Group PrefabGuid(-589722860)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_Roll_AbilityGroup PrefabGuid(138056981)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_CallWolf_AbilityGroup PrefabGuid(-1854347593)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_ThrowNet_Group PrefabGuid(1550497814)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_OnAggro_AbilityGroup PrefabGuid(1567999366)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_Strafe_Group PrefabGuid(920868547)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Leader_QuickDraw_AbilityGroup PrefabGuid(-67405040)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_BanditLeader PrefabGuid(-282443267)`
