---
title: AB_Cardinal_LightSwitch_Cast
guid: 1123510843
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cardinal_LightSwitch_Cast PrefabGuid(1123510843)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 6.2831855`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Cardinal_Projectile PrefabGuid(-2138362741)`
  - `Count: 8`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Cardinal_LightSwitch_Phase PrefabGuid(-377571930)`
...
- **[1]**
  - `SpawnPrefab: AB_Cardinal_LightSwitch_Phase_Ally PrefabGuid(-950278780)`
  - `Target: ProjectM.AbilitySpawnTarget AllyHoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
  - `Condition: None`
