---
title: Buff_General_Corruption_Area_Debuff_T01_Healing
guid: 1124447451
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
# Buff_General_Corruption_Area_Debuff_T01_Healing
...
- [ProjectM.CreateEventOnHealthChangeAmount](/components/CreateEventOnHealthChangeAmount){:target="_blank"}
  - `TriggerEventId: Local - 1897596518`
  - `TriggerEventThreshold: 1`
...
- [ProjectM.LifeTime](/components/LifeTime){:target="_blank"}
  - `Duration: 3`
  - `EndAction: ProjectM.LifeTimeEndAction RemoveBuffStack`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1897596518`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SpawnPrefab: Chaos_Vampire_Ignite_AreaImpact PrefabGuid(1687723202)`
