---
title: CHAR_Villager_CursedWanderer_VBlood
guid: 109969450
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Villager_CursedWanderer_VBlood_Downed PrefabGuid(1950981925)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(21417799)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Villager_CursedWanderer_VBlood PrefabGuid(109969450)`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 99`
  - `GoalDistanceInner: 100`
  - `GoalDistanceOuter: 100`
  - `MaxDistance: 101`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_CursedWanderer_VBlood PrefabGuid(1644201647)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_CursedWanderer_MeleeAttack_Group PrefabGuid(-127603789)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_CursedWanderer_FakeMeleeAttack_Group PrefabGuid(-1512616160)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_CursedWanderer_Gossip_Group PrefabGuid(-1137336047)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 461846903`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_CursedWanderer PrefabGuid(-608704270)`
...
- **[0]**
  - `BuffGuid: Buff_CursedWanderer_VBlood_Flee PrefabGuid(573463911)`
