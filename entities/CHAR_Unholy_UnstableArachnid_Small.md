---
title: CHAR_Unholy_UnstableArachnid_Small
guid: -1106602776
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1636008213)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_adfebbicie`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Unholy_UnstableArachnid_Small PrefabGuid(1161313498)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Unholy_UnstableArarchnid_Explode_Small_AbilityGroup PrefabGuid(-1031367685)`
  - `ShowOnBar: True`
