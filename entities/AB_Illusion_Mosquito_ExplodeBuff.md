---
title: AB_Illusion_Mosquito_ExplodeBuff
guid: -1120131759
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Illusion_Mosquito_ExplodeBuff
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer){:target="_blank"}
  ...
  - `OffsetAngle: 0`
  - `RandomOffset: 0`
  - `IndividualRandom: 0.17453292`
  - `NewProjectileEntity: Illusion_Vampire_Wisp_Projectile_Mosquito PrefabGuid(-1325101036)`
...
- **[0]**
  - `SpawnPrefab: AB_Illusion_Mosquito_Area_Explosion PrefabGuid(2123590060)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
