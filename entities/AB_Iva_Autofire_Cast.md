...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Iva_Autofire_Cast PrefabGuid(1954950048)`
...
- **[0]**
  - `SpawnPrefab: AB_Iva_Autofire_Channel PrefabGuid(-1483089104)`
...
- **[1]**
  - `SpawnPrefab: AB_Iva_Autofire_AggroBuff PrefabGuid(1713781158)`
