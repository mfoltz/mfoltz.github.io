---
title: CHAR_Spider_Baneling_Summon
guid: -1004061470
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 2.5`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1989202755)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Spider_Baneling PrefabGuid(388805852)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Baneling_Explode_Poison_Group PrefabGuid(-891106318)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Baneling_ChangeState_Group PrefabGuid(1790377808)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
