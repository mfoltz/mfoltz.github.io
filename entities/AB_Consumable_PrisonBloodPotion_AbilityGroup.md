...
- [ProjectM.AbilityGroupConsumeItemOnCast](/components/AbilityGroupConsumeItemOnCast){:target="_blank"}
...
- [ProjectM.StoredBloodAbility](/components/StoredBloodAbility){:target="_blank"}
  - `BloodQuality: 0`
