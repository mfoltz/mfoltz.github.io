...
- [Buff_ApplyBuffOnDamageTypeDealt_DataShared](/components/Buff_ApplyBuffOnDamageTypeDealt_DataShared){:target="_blank"}
  - `ProcChance: 1`
...
- [CreateGameplayEventOnBuffReapply](/components/CreateGameplayEventOnBuffReapply){:target="_blank"}
