---
title: AB_Chaos_PowerSurge_Buff_MagicSource
guid: 763939566
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Buff_ApplyBuffOnDamageTypeDealt_DataShared](/components/Buff_ApplyBuffOnDamageTypeDealt_DataShared){:target="_blank"}
  - `ProcChance: 1`
  - `ProcBuff: Chaos_Vampire_Buff_Ignite PrefabGuid(348724578)`
  ...
  - `ImpactSequence: SequenceGUID 208463295`
...
- [ProjectM.CreateGameplayEventOnBuffReapply](/components/CreateGameplayEventOnBuffReapply){:target="_blank"}

- **[0]**
  - `EventId: Local - 212448904`
  - `Target: ProjectM.GameplayEventTarget BuffTarget`

- **[1]**
  - `EventId: Local - -400307400`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1260583600`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 212448904`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1364321206`
