...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1115204634)`
...
- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Vargulf_MaulKnockdown_AbilityGroup PrefabGuid(-634705694)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
