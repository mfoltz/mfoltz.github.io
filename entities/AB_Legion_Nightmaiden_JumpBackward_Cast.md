---
title: AB_Legion_Nightmaiden_JumpBackward_Cast
guid: 1339302981
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Legion_Nightmaiden_JumpBackward_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Legion_Nightmaiden_JumpBackward_Cast PrefabGuid(1339302981)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_Nightmaiden_JumpBackWard_Dash PrefabGuid(1420846288)`
