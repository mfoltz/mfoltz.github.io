---
title: CHAR_Undead_ShadowSoldier_GateBoss
guid: -361904832
categories: ['All', 'CHAR']
nav_exclude: true
...
# CHAR_Undead_ShadowSoldier_GateBoss
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1160695966)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_akbdhddhci`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ShadowSoldier_GateBoss_ShadowStrike_Dash_AbilityGroup PrefabGuid(-200440242)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ShadowSoldier_GateBoss_ShadowStrike_Strike_AbilityGroup PrefabGuid(-660542965)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ShadowSoldier_GateBoss_ShadowStep_AbilityGroup PrefabGuid(-22490832)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
