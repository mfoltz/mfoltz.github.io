---
title: AB_Vampire_Dracula_Feed_Cast
guid: 996991048
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Vampire_Dracula_Feed_Cast PrefabGuid(996991048)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_Feed_HiddenBuff PrefabGuid(-1285880026)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_Feed_Trigger PrefabGuid(-1476040775)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Vampire_Dracula_Feed_PrimaryTargetBuff PrefabGuid(-334553503)`
