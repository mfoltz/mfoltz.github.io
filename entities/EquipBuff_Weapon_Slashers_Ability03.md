---
title: EquipBuff_Weapon_Slashers_Ability03
guid: 2036742434
...
# EquipBuff_Weapon_Slashers_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Slashers_Primary_MeleeAttack_AbilityGroup PrefabGuid(1470213751)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Slashers_ElusiveStrike_Dash_AbilityGroup PrefabGuid(-1545438316)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Slashers_Camouflage_Main_AbilityGroup PrefabGuid(1438305657)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
