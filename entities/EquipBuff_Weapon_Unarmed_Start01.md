...
- **[0]**
  - `AbilitySlotIndex: 0`
  - `NewGroupId: AB_Vampire_Unarmed_Primary_Mounted_AbilityGroup PrefabGuid(-57462538)`
  - `Priority: 0`
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Unarmed_Primary_MeleeAttack_AbilityGroup PrefabGuid(-1772111618)`
  - `Priority: 0`
  - `Condition: None`
