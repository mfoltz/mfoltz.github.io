...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 24.005882`
  - `SpellPower: 24.005882`
  - `ResourcePower: 18.880001`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_BellRinger PrefabGuid(283809536)`
...
- **[0]**
  - `BuffGuid: Buff_ChurchOfLight_Flee_Bellringer PrefabGuid(-1202486333)`
