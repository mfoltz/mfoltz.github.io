---
title: TM_PlantfiberWildRoseBush_Silver_01_Pickup
guid: -903154463
categories: ['All', 'TM']
nav_exclude: true
...
# TM_PlantfiberWildRoseBush_Silver_01_Pickup
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(0.9753039f, 0f, 0f, 0f,  0f, 0.8841467f, 0f, 0f,  0f, 0f, 0.9753039f, 0f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `DropTableGuid: DT_Pickup_T01_PlantFiber PrefabGuid(921599876)`
