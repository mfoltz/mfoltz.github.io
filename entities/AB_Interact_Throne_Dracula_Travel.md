---
title: AB_Interact_Throne_Dracula_Travel
guid: 559608494
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_Throne_Dracula_Travel
...
- [ProjectM.TravelToTarget](/components/TravelToTarget){:target="_blank"}
  ...
  - `Offset: Unity.Mathematics.float3 float3(0f, 2f, 3f)`
...
- [ProjectM.BuffModificationFlagData](/components/BuffModificationFlagData){:target="_blank"}
  - `ModificationTypes: 30792816261304`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Seat_Busy PrefabGuid(1845376969)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Interact_Throne_Dracula_Buff_Sit PrefabGuid(-13752172)`
  - `Buff1: AB_Interact_UseRelic_Behemoth_Buff PrefabGuid(-1703886455)`
  - `Buff2: AB_Interact_UseRelic_Paladin_Buff PrefabGuid(-1161197991)`
  - `Buff3: AB_Interact_UseRelic_Manticore_Buff PrefabGuid(-238197495)`
  - `EventOnConsume: Local - 0`
  - `ConsumeIfAlreadyExists: False`
  - `ConsumeConditional: None`
  - `CustomAbilitySpellModsSource: GUID Not Found`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -81001943`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -591853511`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -1780773164`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
