---
title: AB_Winter_Yeti_AntarcticLeap_Hard_Phase
guid: 1497209227
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Winter_Yeti_AntarcticLeap_Hard_Phase
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Winter_Yeti_AntarcticLeap_PostTravelBuff PrefabGuid(1574481581)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -824854473`
...
- **[0]**
  - `SpawnPrefab: AB_Winter_Yeti_AntarcticLeap_End_1 PrefabGuid(177328272)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
