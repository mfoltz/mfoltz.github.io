---
title: AB_HighLord_GroundSword_ConnectBuff_Sword
guid: 667903561
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_HighLord_GroundSword_ConnectBuff_Sword
...
- [ProjectM.Gameplay.Scripting.Script_ModifyAbilityCooldownOnGameplayEvent_DataServer](/components/Script_ModifyAbilityCooldownOnGameplayEvent_DataServer){:target="_blank"}
  - `AbilityGroupType: AB_HighLord_LeapStrike_AbilityGroup PrefabGuid(938684260)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1313986901`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
