---
title: CHAR_Legion_Shadowkin_Lesser
guid: -1200074387
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1163937295)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Shadowkin PrefabGuid(-806745151)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Shadowkin_MeleeAttack_AbilityGroup PrefabGuid(1617928948)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Shadowkin_ChaosBoltSingleCast_AbilityGroup PrefabGuid(530484088)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
