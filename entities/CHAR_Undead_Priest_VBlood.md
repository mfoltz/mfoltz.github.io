---
title: CHAR_Undead_Priest_VBlood
guid: 153390636
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_Priest_VBlood_Downed PrefabGuid(-1455144915)`
  - `TriggerSequence: SequenceGUID 426147740`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(579544718)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_Priest_VBlood PrefabGuid(153390636)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 37.483562`
  - `SpellPower: 37.483562`
  - `ResourcePower: 28.8`
  - `SiegePower: 11`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_Priest_VBlood PrefabGuid(-242661990)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_Projectile_Group PrefabGuid(14728131)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_Teleport_Travel_AbilityGroup PrefabGuid(-1125894381)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_ProjectileNova_AbilityGroup PrefabGuid(1988754598)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_RaiseDead_AbilityGroup PrefabGuid(-2034290170)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_RaiseHorde_AbilityGroup PrefabGuid(1414167161)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_Emote_Aggro_AbilityGroup PrefabGuid(-1153380978)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_Idle_AbilityGroup PrefabGuid(1338374909)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_ProjectileNova_Hard_AbilityGroup PrefabGuid(1619461812)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Elite_Projectile_Hard_Group PrefabGuid(1837385563)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T04_NicholausTheFallen PrefabGuid(656825307)`

- **[1]**
  - `Guid: Tech_Collection_CandleStands_T01 PrefabGuid(-1032220214)`

- **[2]**
  - `Guid: Tech_Collection_FrayedDecor PrefabGuid(524373519)`

- **[3]**
  - `Guid: Tech_Floor_Treasury PrefabGuid(833988507)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Undead_Priest PrefabGuid(747679525)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Priest_MagicSource PrefabGuid(-293956848)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
