...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1288765948)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 46.392693`
  - `SpellPower: 46.392693`
  - `ResourcePower: 28.78`
  - `SiegePower: 17.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Harpy_Dasher PrefabGuid(700854431)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dasher_Launcher_AbilityGroup PrefabGuid(191219781)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Dasher_Melee_AbilityGroup PrefabGuid(1524767753)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Dasher_Dash_AbilityGroup PrefabGuid(437523703)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Dasher_Dive_AbilityGroup PrefabGuid(705089395)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Silver_Harpy_Rank01 PrefabGuid(226592651)`
