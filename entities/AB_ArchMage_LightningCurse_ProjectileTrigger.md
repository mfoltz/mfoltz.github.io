---
title: AB_ArchMage_LightningCurse_ProjectileTrigger
guid: 390853496
categories: ['AB', 'All']
nav_exclude: true
...
# AB_ArchMage_LightningCurse_ProjectileTrigger
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 1f, -7.5f)`
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer){:target="_blank"}
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_ArchMage_LightningCurse_Projectile PrefabGuid(-1317668918)`
