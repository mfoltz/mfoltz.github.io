---
title: CHAR_Vampire_IceRanger_VBlood
guid: 795262842
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(262864067)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Vampire_IceRanger_VBlood PrefabGuid(795262842)`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 3`
  - `GoalDistanceInner: 8.5`
  - `GoalDistanceOuter: 8.5`
  - `MaxDistance: 9`
  - `MovePattern: 1`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vampire_IceRanger_VBlood PrefabGuid(-894265904)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_VBlood_IceRanger_Primary_AbilityGroup PrefabGuid(-1770479364)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Crossbow_IceShard_Group PrefabGuid(765386506)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_IceRanger_VeilOfFrost_Group PrefabGuid(-354379679)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Crossbow_IceRanger_IceShard_ChannelBarrage_Group PrefabGuid(-1454951943)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_ColdSnap_AbilityGroup PrefabGuid(-926355648)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_IceNova_AbilityGroup PrefabGuid(953519927)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_TowerOfFrost_AbilityGroup PrefabGuid(1431473799)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_LurkerSpikes_AbilityGroup PrefabGuid(1766924388)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_TowerOfFrost_LowHealth_AbilityGroup PrefabGuid(2057952818)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_IceNova_Large_AbilityGroup PrefabGuid(1691254929)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_LurkerSpikes_Split_AbilityGroup PrefabGuid(-808864212)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_BloodMend_AbilityGroup PrefabGuid(-1710744334)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_IceRanger_JumpDown_AbilityGroup PrefabGuid(1064969109)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_VBlood_IceRanger_Primary_Followup_AbilityGroup PrefabGuid(-336633586)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_IceRanger PrefabGuid(-1286478056)`

- **[1]**
  - `Guid: Tech_Collection_Carpet_Stately PrefabGuid(-1363487077)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_IceRanger PrefabGuid(-107868613)`
