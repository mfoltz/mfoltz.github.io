---
title: AB_Interact_WaypointSpawn_Travel
guid: -66432447
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_WaypointSpawn_Travel
...
- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: Buff_Waypoint_TravelEnd PrefabGuid(-1361133205)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1071113521`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 2043265493`
...
- [ProjectM.ModifyObstacleFadeoutBuff](/components/ModifyObstacleFadeoutBuff){:target="_blank"}
  - *(No fields)*
