---
title: CHAR_Bandit_Stalker_VBlood
guid: 1106149033
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 17`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Bandit_Stalker_VBlood_Downed PrefabGuid(734435586)`
  - `TriggerSequence: SequenceGUID 427322145`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1499696370)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Stalker_VBlood PrefabGuid(1106149033)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 29.991623`
  - `SpellPower: 29.991623`
  - `ResourcePower: 24.960001`
  - `SiegePower: 9.400001`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Stalker_VBlood PrefabGuid(1746008604)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_MeleeAttack_Group PrefabGuid(-66951019)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_ChargeAttack_Group PrefabGuid(65616384)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_Projectile_Group PrefabGuid(226929260)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_SpinAttack_Group PrefabGuid(-2121210997)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_Reinforcement_Group PrefabGuid(-1749428209)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_SpikeTrap_Group PrefabGuid(19031114)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_Emote_Aggro_AbilityGroup PrefabGuid(-146108512)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_SpinAttack_Hard_Group PrefabGuid(-609538743)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Stalker_VBlood_Projectile_Hard_Group PrefabGuid(-1865487078)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T03_Grayson PrefabGuid(-819263071)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T03_Grayson_Floors PrefabGuid(613260763)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Armorer PrefabGuid(1958910703)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_VBlood_T01_Normal PrefabGuid(830431682)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`

- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Stalker_Armor PrefabGuid(1084892181)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
