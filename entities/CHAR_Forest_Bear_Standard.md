---
title: CHAR_Forest_Bear_Standard
guid: 1043643344
categories: ['All', 'CHAR']
nav_exclude: true
...
- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bear_AreaAttack_Group PrefabGuid(160063059)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Creature_Bear PrefabGuid(113668998)`
