---
title: CHAR_Undead_ZealousCultist_VBlood
guid: -1208888966
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_ZealousCultist_VBlood_Downed PrefabGuid(1044823130)`
  - `TriggerSequence: SequenceGUID 431264791`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2039844809)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_ZealousCultist_VBlood PrefabGuid(-1208888966)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_ZealousCultist_VBlood PrefabGuid(-1236860084)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_Slice_AbilityGroup_01 PrefabGuid(-116587794)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_Slice_AbilityGroup_02 PrefabGuid(-280574043)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_SummonGhosts_AbilityGroup PrefabGuid(-1784566500)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_GhastlyMockery_AbilityGroup PrefabGuid(-281508142)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_ShadowMeld_AbilityGroup PrefabGuid(-1441325084)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_ShadowMeld_Melee_AbilityGroup PrefabGuid(-597391921)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_ZealousCultist PrefabGuid(-242619336)`
...
- **[0]**
  - `BuffGuid: Buff_Undead_ZealousCultist_InCombat PrefabGuid(-652831057)`
