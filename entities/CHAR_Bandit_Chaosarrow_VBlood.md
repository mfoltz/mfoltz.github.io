---
title: CHAR_Bandit_Chaosarrow_VBlood
guid: 763273073
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-120985325)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Chaosarrow_VBlood PrefabGuid(763273073)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Deadeye_Chaosarrow_VBlood PrefabGuid(1068852483)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Chaosstorm_Group PrefabGuid(-1230681995)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Camouflage_AbilityGroup PrefabGuid(403340165)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Roll_AbilityGroup PrefabGuid(-912372242)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Chaosbarrage_Group PrefabGuid(1996370390)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Chaosstorm_Hard_Group PrefabGuid(-836774616)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_Chaosbarrage_Hard_Group PrefabGuid(642767950)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_ChaosNuke_Hard_Group PrefabGuid(-1181691042)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T02_LidiaChaosArrow PrefabGuid(873587326)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T02_LidiaChaosArrow_Longbow PrefabGuid(-272307342)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Chaosarrow PrefabGuid(-2137397598)`
