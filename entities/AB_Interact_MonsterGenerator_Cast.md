---
title: AB_Interact_MonsterGenerator_Cast
guid: 1723562682
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_MonsterGenerator_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_MonsterGenerator_Cast PrefabGuid(1723562682)`
...
- **[0]**
  - `SpawnPrefab: AB_Interact_MonsterGenerator_Transition PrefabGuid(1318259684)`
