...
- [ProjectM.ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Prefab Item_Headgear_RazerHood PrefabGuid(-1797796642) - Entity(2983:1)`
  - `ItemTypeGUID: Item_Headgear_RazerHood PrefabGuid(-1797796642)`
  - `DropItemPrefab: Resource_Drop_Headgear PrefabGuid(362690558)`
  - `DropItemArc: GUID Not Found`
  - `MaxAmount: 1`
  - `ItemType: ProjectM.ItemType Equippable`
  - `ItemCategory: ProjectM.ItemCategory Armor`
...
- [ProjectM.EquipmentToggleData](/components/EquipmentToggleData){:target="_blank"}
  ...
  - `HideCharacterFacialFeaturesOnEquip: True`
  - `HideCharacterHeadOnEquip: True`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ackebkbdbjj`
