...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1966644449)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_Witch PrefabGuid(-542349260)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_Projectile_AbilityGroup PrefabGuid(1915605718)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_MeleeAttack_AbilityGroup PrefabGuid(2025233638)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_Hex_AbilityGroup PrefabGuid(429807295)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_Witch_AoeChannel_AbilityGroup PrefabGuid(2107853915)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Witch PrefabGuid(297346186)`
