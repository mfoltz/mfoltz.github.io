---
title: TM_FarmRuin_SilverHills_Wall04
guid: 944871581
categories: ['All', 'TM']
nav_exclude: true
...
# TM_FarmRuin_SilverHills_Wall04
...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_FarmRuin_SilverHills_Wall01 PrefabGuid(531052136)`
  - `AlwaysSpawn: False`
...
- [ProjectM.Sequencer.ImpactMaterial](/components/ImpactMaterial){:target="_blank"}
  - `IntType: 2`
  - `Offset: Unity.Mathematics.float3 float3(0f, 0.5f, 0f)`
  - `PlayOnSelf: False`
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0f,  0f, 1f, 0f, 0f,  0f, 0f, 1.2025f, 0f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `DropTableGuid: DT_Resource_FarmRuins_Rock_General PrefabGuid(1633277778)`
...
- [ProjectM.MegaStaticCompatibleTag](/components/MegaStaticCompatibleTag){:target="_blank"}
  - *(No fields)*
