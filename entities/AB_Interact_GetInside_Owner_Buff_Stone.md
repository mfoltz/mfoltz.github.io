---
title: AB_Interact_GetInside_Owner_Buff_Stone
guid: 569692162
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Interact_GetInside_Owner_Buff_Stone
...
- [ProjectM.InsideBuff](/components/InsideBuff){:target="_blank"}
  - `ExitBuff: AB_ExitCoffin_Travel_Phase_Stone PrefabGuid(-162820429)`
...
- [ProjectM.BuffModificationFlagData](/components/BuffModificationFlagData){:target="_blank"}
  - `ModificationTypes: 2206715562160`
  - `ModificationId: Unset`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_djigibich`
