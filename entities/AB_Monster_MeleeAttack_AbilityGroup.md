...
- [DamageReductionPerTarget](/components/DamageReductionPerTarget){:target="_blank"}
  - `HitResetTimer: 0.3`
...
- [DamageReductionPerTargetElement](/components/DamageReductionPerTargetElement){:target="_blank"}
  - *(No fields)*
