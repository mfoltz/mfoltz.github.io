...
- [ProjectM.Shared.DamageReductionPerTarget](/components/DamageReductionPerTarget){:target="_blank"}
  - `HitResetTimer: 0.3`
...
- [ProjectM.Shared.DamageReductionPerTargetElement](/components/DamageReductionPerTargetElement){:target="_blank"}
  - *(No fields)*
