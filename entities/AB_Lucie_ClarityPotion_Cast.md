---
title: AB_Lucie_ClarityPotion_Cast
guid: 1930880741
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Lucie_ClarityPotion_Cast PrefabGuid(1930880741)`
...
- **[0]**
  - `SpawnPrefab: AB_Lucie_ClarityPotion_Throw PrefabGuid(2084005838)`
