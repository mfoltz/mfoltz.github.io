...
- [ProjectM.Gameplay.Scripting.Script_SetTransformBasedOnNearbyEntity_DataServer](/components/Script_SetTransformBasedOnNearbyEntity_DataServer){:target="_blank"}
  - `NearbyEntity: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-948443398)`
  - `Radius: 20`
