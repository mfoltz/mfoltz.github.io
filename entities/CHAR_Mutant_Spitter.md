...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-533665239)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Mutant_Spitter PrefabGuid(-2121728120)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Spitter_Bash_AbilityGroup PrefabGuid(1771061239)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Spitter_Taunt_AbilityGroup PrefabGuid(-1038102898)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Spitter_Projectile_AbilityGroup PrefabGuid(1271143604)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_Spitter_PoisonRain_AbilityGroup PrefabGuid(1388701732)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: Mutant_Spitter_Spawn_PoolJump PrefabGuid(-1529092559)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Mutant_Spitter PrefabGuid(-1121990122)`
