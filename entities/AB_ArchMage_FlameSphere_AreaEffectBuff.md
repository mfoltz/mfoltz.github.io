...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_ArchMage_FlameSphere_AreaDamageBuff PrefabGuid(-1640482518)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1640482518)`
...
- **[0]**
  - `SpawnPrefab: AB_ArchMage_FlameSphere_Projectile PrefabGuid(269193311)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
