...
- [ProjectM.Gameplay.Scripting.RadialZone_Environment_Data](/components/RadialZone_Environment_Data){:target="_blank"}
  - `Debuff: Buff_General_CurseOfTheForest_Area PrefabGuid(821183186)`
...
- [ProjectM.Gameplay.Scripting.CurseArea](/components/CurseArea){:target="_blank"}
  - *(No fields)*
