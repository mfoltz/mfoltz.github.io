---
title: EquipBuff_Weapon_DualHammers_Ability03
guid: 1644894901
...
# EquipBuff_Weapon_DualHammers_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_DualHammers_Primary_MeleeAttack_AbilityGroup PrefabGuid(367876187)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_DualHammers_StormMace_AbilityGroup PrefabGuid(-1612983976)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_DualHammers_Thunderclap_AbilityGroup PrefabGuid(1600917906)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
