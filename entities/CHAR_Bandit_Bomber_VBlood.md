---
title: CHAR_Bandit_Bomber_VBlood
guid: 1896428751
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 6`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Bandit_Bomber_VBlood_Downed PrefabGuid(761242835)`
  - `TriggerSequence: SequenceGUID 429922614`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1927829198)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Bomber_VBlood PrefabGuid(1896428751)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Bomber_VBlood PrefabGuid(-2059538752)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_ClusterBombThrow_AbilityGroup PrefabGuid(-444905742)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Bomber_Elite_Roll_Group PrefabGuid(192866635)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_StickyBomb_AbilityGroup PrefabGuid(1479036818)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T04_CliveTheFirestarter PrefabGuid(1165734787)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Bandit_Bomber PrefabGuid(1514481038)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_Bomber_Weapon PrefabGuid(152807706)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
