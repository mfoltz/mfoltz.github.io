---
title: AB_Cursed_Witch_Projectile_Cast
guid: 98245092
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Cursed_Witch_Projectile_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_Witch_Projectile_Cast PrefabGuid(98245092)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_Witch_Projectile PrefabGuid(627053549)`
