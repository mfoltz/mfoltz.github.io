---
title: CHAR_Bandit_Frostarrow_VBlood
guid: 1124739990
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1875845509)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Frostarrow_VBlood PrefabGuid(1124739990)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Deadeye_VBlood PrefabGuid(-61349024)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_FrosttArrow_MultiShot_Group PrefabGuid(2134585360)`
  - `ShowOnBar: True`
...
- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_FrostArrow_RainOfArrows_AbilityGroup PrefabGuid(766284586)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_FrosttArrow_MultiShot_Hard_Group PrefabGuid(-1871956083)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_FrostArrow_RainOfArrows_Hard_AbilityGroup PrefabGuid(-328617085)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_FrostArrow_Camouflage_HARD_AbilityGroup PrefabGuid(1015070299)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T02_KeelyFrostArrow PrefabGuid(792292662)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Frostarrow PrefabGuid(-2060227403)`
