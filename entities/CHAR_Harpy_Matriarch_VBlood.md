---
title: CHAR_Harpy_Matriarch_VBlood
guid: 685266977
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Harpya_Matriarch_VBlood_Downed PrefabGuid(265849192)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1464479007)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(1731533561)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Harpy_Matriarch_VBlood PrefabGuid(685266977)`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 0`
  - `GoalDistanceInner: 1.25`
  - `GoalDistanceOuter: 1.25`
  - `MaxDistance: 8`
  - `MovePattern: 1`
  - `ForceLookAtTarget: 2`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Harpy_Matriarch_VBlood PrefabGuid(1778109938)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Launcher_AbilityGroup PrefabGuid(341041700)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Melee_AbilityGroup PrefabGuid(-1389186216)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Dash_AbilityGroup PrefabGuid(-12917778)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_SpinAttack_AbilityGroup PrefabGuid(494176178)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Projectile_AbilityGroup PrefabGuid(-514516956)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_AoE_AbilityGroup PrefabGuid(-424388071)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Soar_Travel_AbilityGroup PrefabGuid(1212947823)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Matriarch_Dash_HARD_AbilityGroup PrefabGuid(1088363798)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Harpy PrefabGuid(56158045)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T07_HarpyGems PrefabGuid(-477566763)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Harpy_Matriarch PrefabGuid(78907725)`
...
- **[2]**
  - `BuffGuid: Harpy_Matriarch_Idle_Buff PrefabGuid(-479553028)`
