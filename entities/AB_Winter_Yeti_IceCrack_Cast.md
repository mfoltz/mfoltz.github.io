---
title: AB_Winter_Yeti_IceCrack_Cast
guid: -404128651
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Winter_Yeti_IceCrack_Cast PrefabGuid(-404128651)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 0.7853982`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Winter_Yeti_IceCrack_Projectile PrefabGuid(989269783)`
  - `Count: 3`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Winter_Yeti_IceCrack_MeleeHit PrefabGuid(-286177331)`
