---
title: CHAR_ChurchOfLight_Cardinal_VBlood
guid: 114912615
categories: ['All', 'CHAR']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_ChurchOfLight_Cardinal_VBlood_Downed PrefabGuid(334972667)`
  - `TriggerSequence: SequenceGUID 431348677`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1463951847)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_ChurchOfLight_Cardinal_VBlood PrefabGuid(114912615)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_Cardinal_VBlood PrefabGuid(-238211903)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_LightWave_AbilityGroup PrefabGuid(194868388)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_Channel_AbilityGroup PrefabGuid(-1015165123)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_LightSwitch_AbilityGroup PrefabGuid(-1301873763)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_Zap_AbilityGroup PrefabGuid(1172834223)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_LightNova_AbilityGroup PrefabGuid(114484622)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_SummonOrb_AbilityGroup PrefabGuid(-16930230)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Cardinal_SummonAide_AbilityGroup PrefabGuid(-1381729810)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_CardinalPriest PrefabGuid(1270259509)`

- **[1]**
  - `Guid: Tech_Collection_Carpet_Ostenstatious PrefabGuid(377882346)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_ChurchOfLight_Cardinal PrefabGuid(22992735)`
