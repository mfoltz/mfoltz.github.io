---
title: AB_Shapeshift_Bat_TakeFlight_Buff
guid: 1205505492
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Shapeshift_Bat_TakeFlight_Buff
...
- [ProjectM.AbilityOwner](/components/AbilityOwner){:target="_blank"}
...
- [ProjectM.Gameplay.Scripting.Script_Buff_Shapeshift_DataShared](/components/Script_Buff_Shapeshift_DataShared){:target="_blank"}
...
- [ProjectM.ShapeshiftImpairBuff](/components/ShapeshiftImpairBuff){:target="_blank"}
  - `FailKey: 4ba680df-720e-492d-ac9f-12ed0267f83a - Cannot transform while flying`
  - `Condition: None`
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag BatForm`
  - `KeepOldest: False`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cgbeibighh`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_AggroRangeFactor_DataShared](/components/Script_Buff_AggroRangeFactor_DataShared){:target="_blank"}
  - `AggroRangeFactor: 0.5`
  - `AggroRangeFactorModificationId: Unset`

- [ProjectM.Gameplay.Scripting.Script_SetFlyingHeightVision_Buff_DataShared](/components/Script_SetFlyingHeightVision_Buff_DataShared){:target="_blank"}
...
- **[1]**
  - `Trophy: ProjectM.Trophy ToTheSkies`
...
- **[2]**
  ...
  - `Slot: 2`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Shapeshift_Bat_Land_AbilityGroup PrefabGuid(1558475957)`
  - `Priority: 99`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- [ProjectM.RunScriptOnPreCastEnded](/components/RunScriptOnPreCastEnded){:target="_blank"}
  - *(No fields)*
