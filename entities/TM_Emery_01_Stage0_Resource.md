---
title: TM_Emery_01_Stage0_Resource
guid: -78152017
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- **ProjectM.Gameplay.Scripting.Script_EmeryVeinBuildupData**
  ...
  - `Id: Entity(0:0)`
  - `DestroySequence: SequenceGUID -1568860731`
  - `TargetFactor: 0`
  - `CurrentFactor: 0`
...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: EmeryNode01_Broken_Small PrefabGuid(-80715900)`
  - `AlwaysSpawn: False`
