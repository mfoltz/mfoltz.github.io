---
title: AB_Gloomrot_RailgunSergeant_WarpInit_Cast
guid: -1500917125
categories: ['AB', 'All']
nav_exclude: true
...
# AB_Gloomrot_RailgunSergeant_WarpInit_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Gloomrot_RailgunSergeant_WarpInit_Cast PrefabGuid(-1500917125)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 1.7453293`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Gloomrot_RailgunSergeant_WarpInit_FakeProjectile PrefabGuid(1080842952)`
  - `Count: 2`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_WarpInit_FakeProjectileShort PrefabGuid(2052570628)`
