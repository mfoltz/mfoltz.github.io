---
title: AB_Subdue_RecallTarget_Travel
guid: -1697229695
categories: ['AB', 'All']
nav_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_TeleportNearSpellTarget_DataServer](/components/Script_TeleportNearSpellTarget_DataServer){:target="_blank"}
  - `Range: 2`
  - `NearAngles: 180`
  - `NearSteps: 10`

- [ProjectM.Gameplay.Scripting.Script_SetBehaviourTreeStateOnGameplayEvent_DataServer](/components/Script_SetBehaviourTreeStateOnGameplayEvent_DataServer){:target="_blank"}
  - `State: ProjectM.GenericEnemyState Idle_Horse`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 2088170976`
...
- **[1]**
  - `SequenceGuid: SequenceGUID 628892143`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID 941514066`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
