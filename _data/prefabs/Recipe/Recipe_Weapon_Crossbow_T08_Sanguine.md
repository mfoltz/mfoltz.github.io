---
title: Recipe_Weapon_Crossbow_T08_Sanguine
nav_order: 1
...
**Prefab GUID:** `-1064000514`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Crossbow_T08_Sanguine PrefabGuid(-1064000514) - Entity(56282:2)`
  - `Guid: Recipe_Weapon_Crossbow_T08_Sanguine PrefabGuid(-1064000514)`
  - `CraftDuration: 10`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Crossbow_T07_DarkSilver PrefabGuid(-814739263)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Crossbow_T08_Sanguine PrefabGuid(1389040540)`
  - `Amount: 1`
