---
title: Recipe_Weapon_Slashers_T08_Sanguine
nav_order: 1
...
**Prefab GUID:** `373339628`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Slashers_T08_Sanguine PrefabGuid(373339628) - Entity(56062:2)`
  - `Guid: Recipe_Weapon_Slashers_T08_Sanguine PrefabGuid(373339628)`
  - `CraftDuration: 10`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Slashers_T07_DarkSilver PrefabGuid(633666898)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Slashers_T08_Sanguine PrefabGuid(1322545846)`
  - `Amount: 1`
