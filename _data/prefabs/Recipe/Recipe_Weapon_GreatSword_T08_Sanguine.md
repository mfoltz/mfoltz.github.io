---
title: Recipe_Weapon_GreatSword_T08_Sanguine
nav_order: 1
...
**Prefab GUID:** `1944286219`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_GreatSword_T08_Sanguine PrefabGuid(1944286219) - Entity(56174:2)`
  - `Guid: Recipe_Weapon_GreatSword_T08_Sanguine PrefabGuid(1944286219)`
  - `CraftDuration: 10`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_GreatSword_T07_DarkSilver PrefabGuid(674704033)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_GreatSword_T08_Sanguine PrefabGuid(147836723)`
  - `Amount: 1`
