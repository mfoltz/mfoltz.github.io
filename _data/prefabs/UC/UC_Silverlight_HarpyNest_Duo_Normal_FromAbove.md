---
title: UC_Silverlight_HarpyNest_Duo_Normal_FromAbove
nav_order: 1
parent: UC Prefabs
---

# UC_Silverlight_HarpyNest_Duo_Normal_FromAbove

**Prefab GUID:** `2023603466`
...
- **[1]**
  - `Unit: CHAR_Harpy_Dasher PrefabGuid(-1846851895)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[2]**
  - `Unit: CHAR_Harpy_Sorceress PrefabGuid(1224283123)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
