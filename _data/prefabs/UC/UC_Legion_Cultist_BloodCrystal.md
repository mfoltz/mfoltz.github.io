---
title: UC_Legion_Cultist_BloodCrystal
nav_order: 1
parent: UC Prefabs
---

# UC_Legion_Cultist_BloodCrystal

**Prefab GUID:** `-886526987`
...
- **[0]**
  - `Unit: CHAR_Vampire_Cultist_BloodCrystal PrefabGuid(-1671572471)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Vampire_Cultist_BloodCrystal_Female PrefabGuid(-1208066429)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
