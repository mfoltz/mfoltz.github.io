---
title: UC_Farbane_RuneStones
nav_order: 1
parent: UC Prefabs
---

# UC_Farbane_RuneStones

**Prefab GUID:** `-1402392049`
...
- **[0]**
  - `Unit: CHAR_Undead_SkeletonSoldier_Withered PrefabGuid(-1584807109)`
  - `IsVBloodUnit: False`
...
- **[6]**
  - `Unit: CHAR_Undead_Assassin PrefabGuid(-1365627158)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
