---
title: UC_Silverlight_GlobalPatrol_Guards_Trio_BrightHaven
nav_order: 1
parent: UC Prefabs
---

# UC_Silverlight_GlobalPatrol_Guards_Trio_BrightHaven

**Prefab GUID:** `-649984199`
...
- **[6]**
  - `Unit: CHAR_ChurchOfLight_Priest PrefabGuid(1406393857)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
...
- **[10]**
  - `Unit: CHAR_ChurchOfLight_Rifleman PrefabGuid(1148936156)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`
