---
title: UC_Cursed_Swamp_Patrol_Solo
nav_order: 1
parent: UC Prefabs
---

# UC_Cursed_Swamp_Patrol_Solo

**Prefab GUID:** `953344614`
...
- **[0]**
  - `Unit: CHAR_Cursed_MonsterToad PrefabGuid(575918722)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Cursed_Mosquito PrefabGuid(-744966291)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
