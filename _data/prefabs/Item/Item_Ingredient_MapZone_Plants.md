---
title: Item_Ingredient_MapZone_Plants
nav_order: 1
parent: Item Prefabs
---

# Item_Ingredient_MapZone_Plants

**Prefab GUID:** `968796494`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_MapZone_Plants PrefabGuid(968796494)`
