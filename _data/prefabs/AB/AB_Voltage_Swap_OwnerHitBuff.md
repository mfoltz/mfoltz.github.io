---
title: AB_Voltage_Swap_OwnerHitBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Voltage_Swap_OwnerHitBuff

**Prefab GUID:** `-178329434`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Voltage_Swap_Travel PrefabGuid(1107291914)`
...
- **[0]**
  - `SpawnPrefab: AB_Voltage_Swap_AoE PrefabGuid(-1378206778)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
