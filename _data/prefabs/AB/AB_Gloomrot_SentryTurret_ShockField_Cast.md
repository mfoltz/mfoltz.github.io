---
title: AB_Gloomrot_SentryTurret_ShockField_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_SentryTurret_ShockField_Cast

**Prefab GUID:** `-1575106294`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_SentryTurret_ShockField_Cast PrefabGuid(-1575106294)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SentryTurret_ShockField_Area PrefabGuid(-1848156807)`
