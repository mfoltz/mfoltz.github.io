---
title: AB_VHunter_CastleMan_JumpInit_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_VHunter_CastleMan_JumpInit_Cast

**Prefab GUID:** `390014348`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_VHunter_CastleMan_JumpInit_Cast PrefabGuid(390014348)`
...
- **[0]**
  - `SpawnPrefab: AB_VHunter_CastleMan_JumpInit_FakeProjectileRight PrefabGuid(-1855836071)`
...
- **[1]**
  - `SpawnPrefab: AB_VHunter_CastleMan_JumpInit_FakeProjectileLeft PrefabGuid(1950248830)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
