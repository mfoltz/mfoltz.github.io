---
title: AB_Bandit_Deadeye_Chaosstorm_Hard_Channel_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Bandit_Deadeye_Chaosstorm_Hard_Channel_Buff

**Prefab GUID:** `-381215490`
...
- **ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer**
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Bandit_Deadeye_Chaosstorm_Hard_Projectile PrefabGuid(338969973)`
