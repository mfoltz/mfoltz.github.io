---
title: AB_Illusion_MistTrance_SpellMod_DamageOnAttackBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Illusion_MistTrance_SpellMod_DamageOnAttackBuff

**Prefab GUID:** `-1633277893`
...
- **[0]**
  - `PrimarySequenceGuid: SequenceGUID -1199695021`
  - `ImpactMappingGuid: Magic_ImpactMapping PrefabGuid(-1184337946)`
  - `SkipMaterialSequence: False`
  - `RotationOffsetEulerMin: Unity.Mathematics.float3 float3(0f, -90f, 0f)`
  - `RotationOffsetEulerMax: Unity.Mathematics.float3 float3(0f, -90f, 0f)`
  - `Scale: 1`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_MIstTrance_DamageOnAttack PrefabGuid(-845453001)`
