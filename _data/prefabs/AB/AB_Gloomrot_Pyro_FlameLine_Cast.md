---
title: AB_Gloomrot_Pyro_FlameLine_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_Pyro_FlameLine_Cast

**Prefab GUID:** `2009840201`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_Pyro_FlameLine_Cast PrefabGuid(2009840201)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_Pyro_FlameLine_Channel PrefabGuid(2062177006)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_Pyro_FlameLine_Projectile PrefabGuid(1092340098)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
