---
title: AB_Bandit_StickyBomb_ExplosiveBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Bandit_StickyBomb_ExplosiveBuff

**Prefab GUID:** `-695537141`
...
- **ProjectM.Network.NetworkSnapshot**
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cfdieegibk`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Bandit_StickyBomb_HitBuff PrefabGuid(1118893557)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_StickyBomb_ExplosiveImpact PrefabGuid(-896351921)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
