---
title: AB_Gloomrot_TheProfessor_ManyBeams_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_TheProfessor_ManyBeams_Cast

**Prefab GUID:** `-1250418460`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_TheProfessor_ManyBeams_Cast PrefabGuid(-1250418460)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_ManyBeams_Trigger PrefabGuid(1849768379)`
