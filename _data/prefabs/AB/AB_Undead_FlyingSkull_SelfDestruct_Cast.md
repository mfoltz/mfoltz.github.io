---
title: AB_Undead_FlyingSkull_SelfDestruct_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_FlyingSkull_SelfDestruct_Cast

**Prefab GUID:** `1371509529`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Undead_FlyingSkull_SelfDestruct_Cast PrefabGuid(1371509529)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_FlyingSkull_SelfDestruct_Fuse PrefabGuid(-514685097)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_FlyingSkull_SelfDestruct_AggroBuff PrefabGuid(2057963226)`
