---
title: AB_Legion_NightMaiden_Seduce_Lesser_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Legion_NightMaiden_Seduce_Lesser_Cast

**Prefab GUID:** `-1228698821`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Legion_NightMaiden_Seduce_Lesser_Cast PrefabGuid(-1228698821)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_NightMaiden_Seduce_Lesser_Projectile PrefabGuid(-822734490)`
...
- **[1]**
  - `SpawnPrefab: AB_Legion_NightMaiden_Seduce_RecastPrevention_Buff PrefabGuid(1190823686)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
