---
title: AB_Vampire_Dracula_RingOfBlood_ChannelBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Dracula_RingOfBlood_ChannelBuff

**Prefab GUID:** `-339999587`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Dracula_RingOfBlood_PostChannelBuff PrefabGuid(791291028)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_RingOfBlood_EndGroundImpact PrefabGuid(1035629642)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
