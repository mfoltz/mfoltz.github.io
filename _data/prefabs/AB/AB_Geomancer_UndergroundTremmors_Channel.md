---
title: AB_Geomancer_UndergroundTremmors_Channel
nav_order: 1
parent: AB Prefabs
---

# AB_Geomancer_UndergroundTremmors_Channel

**Prefab GUID:** `-969545560`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Geomancer_AwakeBuff PrefabGuid(1144293329)`
...
- **[0]**
  - `SpawnPrefab: AB_Geomancer_UndergroundTremmors_Trigger PrefabGuid(-1158810522)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
