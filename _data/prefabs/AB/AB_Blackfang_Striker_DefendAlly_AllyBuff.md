---
title: AB_Blackfang_Striker_DefendAlly_AllyBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_Striker_DefendAlly_AllyBuff

**Prefab GUID:** `1398380888`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Striker_DefendAlly_SelfBuff PrefabGuid(2040321461)`
...
- **[1]**
  ...
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `EntityOwner: ProjectM.SetEntityOwner Default`
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 12`
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Striker_FistBlock_Buff PrefabGuid(659713715)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -309618801`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(2040321461)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(659713715)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
