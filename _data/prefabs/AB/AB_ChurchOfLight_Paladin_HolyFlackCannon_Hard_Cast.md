---
title: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_Cast

**Prefab GUID:** `-1298826028`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_Cast PrefabGuid(-1298826028)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_Spinner01 PrefabGuid(485865847)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_Spinner02 PrefabGuid(-1847076350)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_ChannelBuff PrefabGuid(-1471487774)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
