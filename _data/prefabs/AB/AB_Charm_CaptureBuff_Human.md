---
title: AB_Charm_CaptureBuff_Human
nav_order: 1
parent: AB Prefabs
---

# AB_Charm_CaptureBuff_Human

**Prefab GUID:** `-1683471273`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Charm_Active_Human_Buff PrefabGuid(1303169868)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Charm_Owner_Channeling_PostCast PrefabGuid(-1348576822)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  ...
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag Stun`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1002852223)`
