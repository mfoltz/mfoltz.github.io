---
title: AB_Undead_CursedSmith_FloatingAxes_XStrikeXStrike_Toss_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_CursedSmith_FloatingAxes_XStrikeXStrike_Toss_Cast

**Prefab GUID:** `566534594`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Undead_CursedSmith_FloatingAxes_XStrikeXStrike_Toss_Cast PrefabGuid(566534594)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_FloatingAxes_XStrikeXStrike_Toss_Projectile01 PrefabGuid(190656604)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_CursedSmith_FloatingAxes_XStrikeXStrike_Toss_Projectile02 PrefabGuid(-429163663)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
