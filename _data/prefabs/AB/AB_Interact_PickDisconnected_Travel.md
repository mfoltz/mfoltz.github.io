---
title: AB_Interact_PickDisconnected_Travel
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_PickDisconnected_Travel

**Prefab GUID:** `-1976208593`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Interact_PickDisconnected_Target_Buff PrefabGuid(-1839902827)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Interact_PickDisconnected_Owner_Init_Buff PrefabGuid(-1204937944)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
