---
title: AB_ChurchOfLight_Paladin_SummonDivineAngel_DeathBuff
nav_order: 1
parent: AB Prefabs
---

# AB_ChurchOfLight_Paladin_SummonDivineAngel_DeathBuff

**Prefab GUID:** `-1934189109`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1704366925`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -1182146370`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
...
- **[0]**
  ...
  - `MasterDeathAction: ProjectM.MinionMasterDeathAction ApplyBuffOnMinion`
  - `MasterDeathBuffPrefabGuid: Buff_RemoveAfterDuration_FadeOut PrefabGuid(-101157490)`
