---
title: AB_Iva_BomberJetpack_ChaseTarget_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Iva_BomberJetpack_ChaseTarget_Cast

**Prefab GUID:** `1411838706`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Iva_BomberJetpack_ChaseTarget_Cast PrefabGuid(1411838706)`
...
- **[0]**
  - `SpawnPrefab: AB_Iva_BomberJetpack_ChaseTarget_AggroBuff PrefabGuid(591917862)`
...
- **[1]**
  - `SpawnPrefab: AB_Iva_BomberJetpack_ChaseTarget_TargetedBuff PrefabGuid(1887608621)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Iva_BomberJetpack_ChaseTarget_HasteBuff PrefabGuid(-992946595)`
