---
title: AB_Interact_GetInside_Travel_Stone
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_GetInside_Travel_Stone

**Prefab GUID:** `-342726392`
...
- **ProjectM.TravelToTarget**
  ...
  - `OffsetType: ProjectM.TravelToTargetOffsetType TargetDirectionTransition`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Interact_GetInside_Owner_Init_Buff_Stone PrefabGuid(1956875482)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Interact_GetInside_Target_Buff_Stone PrefabGuid(-2072683514)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -671867949`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
