---
title: AB_Interact_Construct_Long_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_Construct_Long_Cast

**Prefab GUID:** `895690552`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Interact_Construct_Long_Cast PrefabGuid(895690552)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag AbilityKit_IgnoreInCombat, IgnoreSpellBlock, Demount`
...
- **ProjectM.AbilityInterruptData**
  - `CooldownOnInterrupt: 0.05`
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, OnDamageTaken`
