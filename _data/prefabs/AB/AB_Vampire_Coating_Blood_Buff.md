---
title: AB_Vampire_Coating_Blood_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Coating_Blood_Buff

**Prefab GUID:** `632067678`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Blood_Vampire_Buff_Leech PrefabGuid(-1246704569)`
  - `Buff1: AB_Blood_VampiricCurse_Buff_Lesser PrefabGuid(178387762)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -802536078`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -1314334047`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID -2076975393`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
