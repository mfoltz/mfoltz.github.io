---
title: AB_Vampire_Dracula_BloodStones_Setup_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Dracula_BloodStones_Setup_Cast

**Prefab GUID:** `1992185760`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Vampire_Dracula_BloodStones_Setup_Cast PrefabGuid(1992185760)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_BloodStones_CenterSpinner01 PrefabGuid(-1269656471)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_BloodStones_CenterSpinner02 PrefabGuid(-1295590777)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
