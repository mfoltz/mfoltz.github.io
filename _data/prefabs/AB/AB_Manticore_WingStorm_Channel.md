---
title: AB_Manticore_WingStorm_Channel
nav_order: 1
parent: AB Prefabs
---

# AB_Manticore_WingStorm_Channel

**Prefab GUID:** `-1855133289`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -536909030`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SpawnPrefab: AB_Manticore_WingStorm_TriggerRight PrefabGuid(1782002185)`
...
- **[1]**
  - `SpawnPrefab: AB_Manticore_WingStorm_Hit PrefabGuid(-1069525126)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_Manticore_WingStorm_TriggerLeft PrefabGuid(-27093903)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
