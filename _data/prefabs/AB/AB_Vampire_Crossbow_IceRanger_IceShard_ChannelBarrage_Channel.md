---
title: AB_Vampire_Crossbow_IceRanger_IceShard_ChannelBarrage_Channel
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Crossbow_IceRanger_IceShard_ChannelBarrage_Channel

**Prefab GUID:** `-2125640842`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Crossbow_IceRanger_IceShard_ChannelBarrage_ForEachEnemy_Trigger PrefabGuid(-1841404307)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Crossbow_IceShard_Throw_Center PrefabGuid(1016234872)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
