---
title: AB_Undead_BishopOfShadows_TrippleBolt_Trigger
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_BishopOfShadows_TrippleBolt_Trigger

**Prefab GUID:** `-1057483318`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_TrippleBolt_Left PrefabGuid(159545095)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_TrippleBolt_Centre PrefabGuid(1132277864)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_TrippleBolt_Right PrefabGuid(743487414)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
