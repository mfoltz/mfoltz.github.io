...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gallop_Cast PrefabGuid(1362070909)`
...
- **[0]**
  - `SpawnPrefab: AB_Gallop_Buff PrefabGuid(1156367321)`
...
- **[1]**
  - `SpawnPrefab: AllowJumpFromCliffsBuff PrefabGuid(-701914966)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
