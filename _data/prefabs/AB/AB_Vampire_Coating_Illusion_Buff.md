---
title: AB_Vampire_Coating_Illusion_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Coating_Illusion_Buff

**Prefab GUID:** `-2040918753`
...
- **ProjectM.Gameplay.Scripting.Script_CreateGameplayEventOnDamageDealtToEntityCategory_DataServer**
  ...
  - `FilterByEntityCategory: True`
  - `FilterByDamageType: False`
  - `OnlyTriggerOnPrimaryAttack: True`
...
- **ProjectM.CreateGameplayEventsOnOwnerSpellHitConsumed**
  - *(No fields)*

- **[0]**
  - `EventId: Local - 222406837`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 222406837`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1077172713`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -704087057`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Coating_Illusion_Area PrefabGuid(-1373223213)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget EventTarget`
