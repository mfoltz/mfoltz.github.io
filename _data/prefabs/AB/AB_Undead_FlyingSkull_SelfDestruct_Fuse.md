---
title: AB_Undead_FlyingSkull_SelfDestruct_Fuse
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_FlyingSkull_SelfDestruct_Fuse

**Prefab GUID:** `-514685097`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1277984216)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_FlyingSkull_SelfDestruct_Area PrefabGuid(1812451074)`
