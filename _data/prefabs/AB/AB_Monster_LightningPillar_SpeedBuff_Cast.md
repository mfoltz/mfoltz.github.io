---
title: AB_Monster_LightningPillar_SpeedBuff_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Monster_LightningPillar_SpeedBuff_Cast

**Prefab GUID:** `-2078217582`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Monster_LightningPillar_SpeedBuff_Cast PrefabGuid(-2078217582)`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_LightningPillar_SpeedBuff_Buff PrefabGuid(-1108748292)`
