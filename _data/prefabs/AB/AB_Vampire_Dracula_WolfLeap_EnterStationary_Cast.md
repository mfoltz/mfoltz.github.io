---
title: AB_Vampire_Dracula_WolfLeap_EnterStationary_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Dracula_WolfLeap_EnterStationary_Cast

**Prefab GUID:** `907728329`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Vampire_Dracula_WolfLeap_EnterStationary_Cast PrefabGuid(907728329)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfLeap_EnterStationary_PostBuff PrefabGuid(-665366708)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfLeap_ShapeshiftBuff PrefabGuid(-29962731)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfLeap_EnterTravel_AggroBuff PrefabGuid(1833168673)`
...
- **[3]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfLeap_SummonWolfTrigger01 PrefabGuid(979371542)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[4]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfLeap_SummonWolfTrigger02 PrefabGuid(-2061647637)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
