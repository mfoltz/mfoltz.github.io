---
title: AB_Bandit_Foreman_BoltStorm_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Bandit_Foreman_BoltStorm_Cast

**Prefab GUID:** `-102278544`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Bandit_Foreman_BoltStorm_Cast PrefabGuid(-102278544)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Foreman_BoltStorm_Trigger PrefabGuid(-978448375)`
...
- **[1]**
  - `SpawnPrefab: AB_Bandit_Foreman_BoltStorm_Throw_Center PrefabGuid(1034684941)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
