...
- **ProjectM.BlueprintData**
  - `Entity: Prefab TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732) - Entity(8726:2)`
...
- **[0]**
  - `Entity: Entity(8466:2)`
  - `BlobIndex: 13`

- **[1]**
  - `Entity: Entity(8465:2)`
  - `BlobIndex: 14`
...
- **[0]**
  - `RendererEntity: Entity(8466:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(8465:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732) - Entity(8726:2)`
