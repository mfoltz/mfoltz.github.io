---
title: CHAR_ChurchOfLight_Sommelier_BarrelMinion
nav_order: 1
parent: CHAR Prefabs
---
...
- **ProjectM.CastOptionsUser**
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1597406610)`
...
- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Barrel_DestoryOak01 PrefabGuid(-1635659418)`
  - `AlwaysSpawn: False`
...
- **ProjectM.Network.NetworkSnapshot**
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ikggbjbc`

- **ProjectM.Behaviours.BehaviourTreeBinding**
  - `PrefabGUID: BEH_Sommelier_BarrelMinion_Standard PrefabGuid(1595167720)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_BarrelMinion_BarrelRoll_AbilityGroup PrefabGuid(-1252510507)`
  - `ShowOnBar: True`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -269804732`
