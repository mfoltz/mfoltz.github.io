---
title: CHAR_Undead_GhostAssassin
nav_order: 1
parent: CHAR Prefabs
---
...
- **ProjectM.CastOptionsUser**
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1332868659)`
...
- **ProjectM.Behaviours.BehaviourTreeBinding**
  - `PrefabGUID: BEH_Undead_GhostAssassin PrefabGuid(162797016)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_DoubleStrike_AbilityGroup PrefabGuid(575048784)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_DoubleStrikeFollowUp_AbilityGroup PrefabGuid(57588514)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_Rush_AbilityGroup PrefabGuid(1365714615)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_HeavyAttack_AbilityGroup PrefabGuid(1791635791)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_JumpForward_AbilityGroup PrefabGuid(-923762386)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostAssassin_JumpBackward_AbilityGroup PrefabGuid(236831977)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
