---
title: AB_Illusion_Curse_Debuff
guid: 569697629
categories: ['AB', 'All']
nav_exclude: true
...
- **ProjectM.Gameplay.Scripting.Script_DealDamageBasedOnDamageTaken_Entry**
  - `DamageFactor: 0.4`
  - `RestrictToDamageType: ProjectM.MainDamageType Physical`
  - `LimitToType: False`
  - `DamageListenerId: ProjectM.Scripting.ListenerId ProjectM.Scripting.ListenerId`
  - `TotalDamage: 0`
  - `DamageDealtType: ProjectM.MainDamageType Spell`
  - `MaximumDamage: 5`
  - `Condition: None`
...
- **ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer**
  ...
  - `OffsetAngle: 0`
  - `RandomOffset: 0`
  - `IndividualRandom: 6.2831855`
  - `NewProjectileEntity: Illusion_Vampire_Wisp_Projectile_Curse PrefabGuid(1553637877)`
  - `NewProjectileEntityAlternate: GUID Not Found`
  - `Count: 1`
  - `TickCount: 0`
  - `UseOwnerAimDirection: False`
  - `SetSpellTargetToSelf: False`
  - `SetSpellTargetToSelfSpellTarget: True`
...
- **[0]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 5`
  - `Stacks: 1`
  - `Buff0: Illusion_Vampire_Buff_Weaken PrefabGuid(1723455773)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1742000564`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[3]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -972970713`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1685628625`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Curse_IncreaseDuration PrefabGuid(-1926752281)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_Curse_DamageFactor PrefabGuid(240097113)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Add`
  - `ValueIndex: 0`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget DealDamageBasedOnDamageTaken_DamageFactor`
  - `TargetIndex: -1`
...
- **[3]**
  - `Condition: None`
  - `SpellMod: SpellMod_Mosquito_WispsOnDestroy PrefabGuid(-1087850059)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget AbilityProjectileFanOnGameplayEvent_Count`
  - `TargetIndex: -1`
