...
export type TextVariableSourceKind = "localized-resource" | "bloodcraft-resource" | "extractor-event-buffer";
...
const textVariableSourceKinds = new Set<string>(["localized-resource", "bloodcraft-resource", "extractor-event-buffer"]);
