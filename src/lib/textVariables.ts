...
export type TextVariableSourceKind = "localized-resource" | "bloodcraft-resource" | "extractor-event-buffer" | "server-damage-evidence";
...
const textVariableSourceKinds = new Set<string>(["localized-resource", "bloodcraft-resource", "extractor-event-buffer", "server-damage-evidence"]);
