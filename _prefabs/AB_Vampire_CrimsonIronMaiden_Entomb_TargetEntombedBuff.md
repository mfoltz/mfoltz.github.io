---
title: AB_Vampire_CrimsonIronMaiden_Entomb_TargetEntombedBuff
guid: -1906344151
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_CrimsonIronMaiden_Entomb_TargetEntombedBuff
...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  ...
  - `ServerPositionOffset: Unity.Mathematics.float3 float3(0f, 0.5f, 0f)`
  - `HybridBone: 0`
  - `CopyPosition: True`
  - `CopyRotation: True`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_CrimsonIronMaiden_Entomb_HasEntombedBuff PrefabGuid(-1083189016)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Vampire_CrimsonIronMaiden_Expunge_LaunchBuff PrefabGuid(-382462124)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[9]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -957569642`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 907434320`
...
- **[1]**
  - `SequenceGuid: SequenceGUID 1061350769`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID -1579074245`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1083189016)`
