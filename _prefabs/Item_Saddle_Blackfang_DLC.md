---
title: Item_Saddle_Blackfang_DLC
guid: -1793846754
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Saddle_Blackfang_DLC PrefabGuid(-1793846754)`
...
- [ProjectM.SaddleData](/components/SaddleData){:target="_blank"}
  - `MountBuff: AB_Interact_Mount_Owner_Buff_Horse_Vampire_Blackfang PrefabGuid(-2000859158)`
  - `MaxSpeed: 1`
  - `RotationSpeed: 0`
  - `Acceleration: 1`
