---
title: TM_Stash_Chest_Rebuilding
guid: -220201461
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Stash_Chest_Rebuilding PrefabGuid(-220201461) - Entity(41411:2)`
  - `Guid: TM_Stash_Chest_Rebuilding PrefabGuid(-220201461)`
...
- [ProjectM.GiveAchievementOnSpawn](/components/GiveAchievementOnSpawn){:target="_blank"}
  - `Achievement: TM_Stash_Chest_Wood_General PrefabGuid(-251472465)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_chbjhkechi`
...
- [ProjectM.DestroyWhenInventoryIsEmpty](/components/DestroyWhenInventoryIsEmpty){:target="_blank"}
  - *(No fields)*

- [ProjectM.ShrinkInventoryWhenWithdrawn](/components/ShrinkInventoryWhenWithdrawn){:target="_blank"}
  - *(No fields)*
...
- [ProjectM.CastleBuilding.CastleRebuildTransferContainer](/components/CastleRebuildTransferContainer){:target="_blank"}
  - *(No fields)*
