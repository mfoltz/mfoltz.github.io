---
title: TM_Castle_Chain_Plant_Grapes_Object
guid: 1992848416
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_Castle_Chain_Plant_Grapes_Object
...
- [ProjectM.NetworkedSpawnChainChild](/components/NetworkedSpawnChainChild){:target="_blank"}
  - `SpawnChain: NetworkedEntity(0:0)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acjgddgjiif`
...
- [Unity.Transforms.LocalTransform](/components/LocalTransform){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(0f, -0.0001263618f, -0.001627982f)`
  - `Scale: 1`
  - `Rotation: Unity.Mathematics.quaternion quaternion(0.0009765269f, 0f, 0f, 0.9999995f)`
...
- [ProjectM.YieldResourcesOnDamageTaken](/components/YieldResourcesOnDamageTaken){:target="_blank"}
  - *(No fields)*
...
- **[0]**
  - `DropTableGuid: DT_Pickup_Flower_Castle_T01_Grapes PrefabGuid(1864634743)`
