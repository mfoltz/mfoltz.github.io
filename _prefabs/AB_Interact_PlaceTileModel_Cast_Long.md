---
title: AB_Interact_PlaceTileModel_Cast_Long
guid: -1587789246
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Interact_PlaceTileModel_Cast_Long
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_PlaceTileModel_Cast_Long PrefabGuid(-1587789246)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag Dismantle, IgnoreSpellBlock`
