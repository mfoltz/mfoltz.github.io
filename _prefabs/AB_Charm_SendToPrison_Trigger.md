---
title: AB_Charm_SendToPrison_Trigger
guid: 1789285456
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_RemoteImprison_DataServer](/components/Script_RemoteImprison_DataServer){:target="_blank"}
  - `ImprisonEvent: AB_PrisonInteract_Hit PrefabGuid(1435009879)`
  - `ConsumeItemType: Item_Consumable_DuskCaller PrefabGuid(1128262258)`
  - `RemoveCharmBuffType: AB_Shapeshift_DominatingPresence_PsychicForm_Buff PrefabGuid(-1447419822)`
  - `NoEmptyPrisonInBase_LKey: Stunlock.Core.AssetGuid 52475dfe36ac4f76b79bf208e56e0f14`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Charm_SendToPrison_Invulnerability PrefabGuid(-1988445418)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -629840546`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -332032270`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
