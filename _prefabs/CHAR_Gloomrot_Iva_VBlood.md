---
title: CHAR_Gloomrot_Iva_VBlood
guid: 172235178
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 10`
  - `CircleChangeDirectionFrequencyMax: 15`
  ...
  - `OnlyChangeCircleDirectionOnCast: False`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Gloomrot_Iva_VBlood_Downed PrefabGuid(-764330540)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(793352943)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Gloomrot_Iva_VBlood PrefabGuid(172235178)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 66.920845`
  - `SpellPower: 66.920845`
  - `ResourcePower: 40.800003`
  - `SiegePower: 16`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 1`
  - `GoalDistanceInner: 3.5`
  - `GoalDistanceOuter: 3.5`
  - `MaxDistance: 4`
  - `MovePattern: 1`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Gloomrot_Iva PrefabGuid(-1988492521)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Iva_ShotgunBlast_AbilityGroup PrefabGuid(1450987113)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Iva_Autofire_AbilityGroup PrefabGuid(-580940152)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Iva_Burn_AbilityGroup PrefabGuid(-247423777)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BurningRingOfFire_AbilityGroup PrefabGuid(1517447626)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BFG_Orb_AbilityGroup PrefabGuid(-786900742)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BFGLightningFire_AbilityGroup PrefabGuid(1524772628)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BallLightning_AbilityGroup PrefabGuid(870237772)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Iva_Tazer_AbilityGroup PrefabGuid(891644945)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Iva_JetDash_AbilityGroup PrefabGuid(-639593760)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponEquip_Flamer_AbilityGroup PrefabGuid(-2020699185)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponEquip_Shotgun_AbilityGroup PrefabGuid(-420570478)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponEquip_Tazer_AbilityGroup PrefabGuid(-1409019914)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponEquip_BFG_AbilityGroup PrefabGuid(948730951)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponMalfunction_Flamer_AbilityGroup PrefabGuid(49364370)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[14]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponMalfunction_Shotgun_AbilityGroup PrefabGuid(-680856467)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[15]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponMalfunction_BFG_AbilityGroup PrefabGuid(2013545793)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[16]**
  - `BaseAbilityGroupOnSlot: AB_Iva_WeaponMalfunction_Tazer_AbilityGroup PrefabGuid(1149489416)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[17]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BomberJetpack_ChaseTarget_AbilityGroup PrefabGuid(-1715136284)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[18]**
  - `BaseAbilityGroupOnSlot: AB_Iva_JetEscape_AbilityGroup PrefabGuid(-309871879)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[19]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BomberJetpack_TakeOff_AbilityGroup PrefabGuid(-1770586075)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[20]**
  - `BaseAbilityGroupOnSlot: AB_Iva_BomberJetpack_Land_AbilityGroup PrefabGuid(-577179884)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_Iva_WeaponEquip_HideAll PrefabGuid(-1584074836)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_Iva PrefabGuid(-1168862239)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Iva PrefabGuid(-1784269994)`
