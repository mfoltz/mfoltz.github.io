---
title: CHAR_Vermin_DireRat_VBlood
guid: -2039908510
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BuffResistances](/components/BuffResistances){:target="_blank"}
  ...
  - `InitialSettingGuid: BuffResistance_EliteMob PrefabGuid(1973136122)`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Vermin_DireRat_VBlood_Downed PrefabGuid(-190654335)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-212591729)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Vermin_DireRat_VBlood PrefabGuid(-2039908510)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  ...
  - `WoundedSequenceGuid: SequenceGUID -1790785992`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vermin_DireRat_VBlood PrefabGuid(752897267)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_DireRat_Gnaw_AbilityGroup PrefabGuid(-1199198217)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_DireRat_MultiGnawBuff_AbilityGroup PrefabGuid(1450204157)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_DireRat_MultiGnaw_AbilityGroup PrefabGuid(-70575944)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_DireRat_PoisonBurst_AbilityGroup PrefabGuid(-1024883556)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Vermin_DireRat_RatVanguard_AbilityGroup PrefabGuid(830495620)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_General_TimeOut_Despawn PrefabGuid(-1953483362)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T03_PutridRat PrefabGuid(-482440851)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_DireRat PrefabGuid(-258353694)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_VBlood_DireRat_T01 PrefabGuid(-348808090)`
