...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Illusion_Curse_Cast PrefabGuid(609428826)`
...
- **[0]**
  - `SpawnPrefab: AB_Illusion_Curse_Arc PrefabGuid(218990010)`
