...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 18.500057`
  - `SpellPower: 18.500057`
  - `ResourcePower: 17.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Thief PrefabGuid(1829522622)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Bandit_Normal_Rank01 PrefabGuid(2057203303)`
