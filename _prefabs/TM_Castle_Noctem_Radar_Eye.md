---
title: TM_Castle_Noctem_Radar_Eye
guid: 1383395802
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Noctem_Radar_Eye PrefabGuid(1383395802) - Entity(41288:2)`
  - `Guid: TM_Castle_Noctem_Radar_Eye PrefabGuid(1383395802)`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseNoctemRadar_AbilityGroup PrefabGuid(-857675545)`
  - `Importance: 0`
...
- [ProjectM.NoctemRadar](/components/NoctemRadar){:target="_blank"}
  - *(No fields)*
