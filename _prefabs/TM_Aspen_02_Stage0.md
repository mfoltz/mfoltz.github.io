...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Trees_Aspen02_Dynamics_Small PrefabGuid(1818087098)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `DropTableGuid: DT_Resource_Tree_Sapling_Aspen PrefabGuid(1312571976)`
