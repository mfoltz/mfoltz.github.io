---
title: TM_Castle_WallDecor_Gothic_Window_Skyblue02
guid: -2028788906
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_Castle_WallDecor_Gothic_Window_Skyblue02
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_WallDecor_Gothic_Window_Skyblue02 PrefabGuid(-2028788906) - Entity(12012:3)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cgfcfckbdc`
...
- [ProjectM.CastleBuilding.SwapArtWhileRaidedRoot](/components/SwapArtWhileRaidedRoot){:target="_blank"}
  - `IsRaided: False`
...
- [ProjectM.CastleBuilding.CastleBuildingAttachmentActiveBuffsBuffer](/components/CastleBuildingAttachmentActiveBuffsBuffer){:target="_blank"}
  - *(No fields)*

- [ProjectM.BuffBuffer](/components/BuffBuffer){:target="_blank"}
  - *(No fields)*

- [ProjectM.CastleBuilding.CastleBuildingAttachmentApplyBuff](/components/CastleBuildingAttachmentApplyBuff){:target="_blank"}
