---
title: AB_Interact_Servant_Buff
guid: -127008514
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AdditionalInteractBuff](/components/AdditionalInteractBuff){:target="_blank"}
  - `Buff: AB_Interact_Servant_TargetBuff PrefabGuid(-435793813)`
...
- [ProjectM.UI.GoToHUDMenu](/components/GoToHUDMenu){:target="_blank"}
  - `Delay: 0`
  - `IsHandled: False`
  - `MenuType: ProjectM.UI.HUDMenuType ServantMenu`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ehkcekjii`
