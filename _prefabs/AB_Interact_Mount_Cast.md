...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_Mount_Cast PrefabGuid(-372722894)`
...
- **[0]**
  - `SpawnPrefab: AB_Interact_Mount_Travel PrefabGuid(1848617499)`
...
- **[1]**
  - `SpawnPrefab: AB_Interact_Mount_BlockInteract_Buff PrefabGuid(-202566556)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
