---
title: AB_Undead_Infiltrator_AfterImage_Cast
guid: -286856064
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_Infiltrator_AfterImage_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Undead_Infiltrator_AfterImage_Cast PrefabGuid(-286856064)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Infiltrator_AfterImage_Dash PrefabGuid(1412957994)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_Infiltrator_AfterImage_AggroOwnerBuff PrefabGuid(-229821029)`
