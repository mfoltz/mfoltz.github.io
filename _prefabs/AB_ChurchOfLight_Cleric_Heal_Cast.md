---
title: AB_ChurchOfLight_Cleric_Heal_Cast
guid: -2036444563
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ChurchOfLight_Cleric_Heal_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_ChurchOfLight_Cleric_Heal_Cast PrefabGuid(-2036444563)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Cleric_Heal_ChannelBuff PrefabGuid(-844701160)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Cleric_Heal_HealingOverTime_Buff PrefabGuid(-1639791914)`
