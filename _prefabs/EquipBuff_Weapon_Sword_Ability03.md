---
title: EquipBuff_Weapon_Sword_Ability03
guid: 1232942168
...
# EquipBuff_Weapon_Sword_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Sword_Primary_MeleeAttack_AbilityGroup PrefabGuid(-2097352908)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Sword_Whirlwind_Spin_AbilityGroup PrefabGuid(-2029046970)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Sword_Shockwave_Main_AbilityGroup PrefabGuid(1335008684)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
