...
- [DestroyGroup](/systems/server/DestroyGroup)
...
- [DestroySpawnChainChildrenOnDestroySystem](/systems/server/DestroySpawnChainChildrenOnDestroySystem)
...
- [Destroy_SetOwnerRotateTowardsMouseSystem](/systems/server/Destroy_SetOwnerRotateTowardsMouseSystem)
- [Destroy_SetOwnerRotateTowardsMovementSystem](/systems/server/Destroy_SetOwnerRotateTowardsMovementSystem)
...
- [UnitMountDestroySystem](/systems/server/UnitMountDestroySystem)
- [UnitMounterDestroySystem](/systems/server/UnitMounterDestroySystem)
...
- [DestroyGroup](/systems/client/DestroyGroup)
