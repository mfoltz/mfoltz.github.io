---
title: CHAR_Gloomrot_SentryOfficer_Servant
guid: -1213645419
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1603956935)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Gloomrot_SentryOfficer_Servant PrefabGuid(629455802)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryOfficer_MeleeAttack_AbilityGroup PrefabGuid(1971068020)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryOfficer_PlaceTurret_AbilityGroup PrefabGuid(2052063970)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryOfficer_ShockGrenade_AbilityGroup PrefabGuid(-466422619)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_Gloomrot_SentryOfficer_HasTurret PrefabGuid(185404345)`
