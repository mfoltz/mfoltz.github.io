...
- [ProjectM.Gameplay.Scripting.Script_Buff_ApplyNewBuffOnOwnerDeath_DataServer](/components/Script_Buff_ApplyNewBuffOnOwnerDeath_DataServer){:target="_blank"}
  - `Buff: Buff_General_SilverSlaveReleased PrefabGuid(1229176670)`
