---
title: TM_Castle_FloorDecor_Carpet02_Cross-Section_Dyable
guid: -922187970
categories:
- All
- TM
...
# TM_Castle_FloorDecor_Carpet02_Cross-Section_Dyable
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_FloorDecor_Carpet02_Cross-Section_Dyable PrefabGuid(-922187970) - Entity(41261:2)`
...
- [PavementBonusSource](/components/PavementBonusSource){:target="_blank"}
  - `MovementSpeed: 0.15`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ckjehbkged`
...
- **[0]**
  - `PrefabGUID: Item_Ingredient_CarpetRoll PrefabGuid(1046366876)`
  - `Amount: 1`
