---
title: AB_Vampire_Daggers_CallDaggers_Cast
guid: 1394178657
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Daggers_CallDaggers_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Daggers_CallDaggers_Cast PrefabGuid(1394178657)`
...
- [ProjectM.AbilityInterruptData](/components/AbilityInterruptData)
  ...
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, Obstructed`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Daggers_CallDaggers_Trigger_SlowEnemy PrefabGuid(1791596661)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Daggers_CallDaggers_Trigger_NoSlow PrefabGuid(1029797703)`
  - `BuffDuration: 0`
  - `Condition: None`
