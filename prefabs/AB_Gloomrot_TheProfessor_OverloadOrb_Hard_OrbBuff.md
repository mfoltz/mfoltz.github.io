...
- [ProjectM.Gameplay.Scripting.Script_ProfessorProjectileOnGameplayEvent_DataServer](/components/Script_ProfessorProjectileOnGameplayEvent_DataServer){:target="_blank"}
  - `Angle: 3.4906585`
