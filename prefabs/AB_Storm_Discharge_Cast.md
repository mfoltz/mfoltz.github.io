...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Storm_Discharge_Cast PrefabGuid(922224629)`
...
- **[0]**
  - `SpawnPrefab: AB_Storm_Discharge_Counter_Buff PrefabGuid(-755938348)`
