---
title: AB_CastleMan_Grab_OnHitTravel
guid: 810941144
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 1f, 1.7f)`
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 1`
  - `Groups: ProjectM.BuffCategoryFlag Stun, Travel`
  - `KeepOldest: False`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_CastleMan_Throw_LaunchBuff PrefabGuid(1269998543)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_CastleMan_Grab_HasGrabedBuff PrefabGuid(-1881495377)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -561796950`
