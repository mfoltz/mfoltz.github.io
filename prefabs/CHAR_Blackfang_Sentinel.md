...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_Sentinel_Servant PrefabGuid(-1287013240)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(-516976528)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Sentinel PrefabGuid(565364519)`
...
- **[0]**
  ...
  - `Buff1: Shared_Affix_LevelAura_Self PrefabGuid(-2104035188)`
  - `Buff2: Buff_General_ChanceToCorruptBlood PrefabGuid(1524978405)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_StrongBlade_Rank03 PrefabGuid(-1593943953)`
