---
title: AB_Blackfang_Livith_ShadowDance_Buff
guid: 2104665805
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Blackfang_Livith_ShadowDance_Buff
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Livith_ShadowDance_Phase PrefabGuid(1860384370)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Livith_ShadowDance_AggroBuff PrefabGuid(-629777717)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -938148097`
...
- **[0]**
  ...
  - `Rotation: ProjectM.SpawnMinionOnGameplayEventRotation TowardTarget`
