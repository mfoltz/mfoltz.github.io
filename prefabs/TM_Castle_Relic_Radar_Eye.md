---
title: TM_Castle_Relic_Radar_Eye
guid: -622002417
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData](/components/BlueprintData)
  - `Entity: Prefab TM_Castle_Relic_Radar_Eye PrefabGuid(-622002417) - Entity(14283:3)`
  - `Guid: TM_Castle_Relic_Radar_Eye PrefabGuid(-622002417)`
...
- [ProjectM.CastleLimited](/components/CastleLimited)
  - `Type: ProjectM.CastleLimitedType EyeStructures`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot)
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_aggefhhff`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseRelicRadar_AbilityGroup PrefabGuid(-1337273957)`
  - `Importance: 0`
...
- **[0]**
  - `PrefabGUID: Item_Ingredient_Mineral_GoldBar PrefabGuid(-1027710236)`
  - `Amount: 4`

- **[1]**
  - `PrefabGUID: Item_Ingredient_PowerCore PrefabGuid(-1190647720)`
  - `Amount: 4`
...
- [ProjectM.RelicRadar](/components/RelicRadar)
