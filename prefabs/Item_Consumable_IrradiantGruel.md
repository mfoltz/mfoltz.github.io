---
title: Item_Consumable_IrradiantGruel
guid: 1851490036
categories:
- All
- Item
...
# Item_Consumable_IrradiantGruel
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Consumable_IrradiantGruel PrefabGuid(1851490036)`
...
- [CastAbilityOnConsume](/components/CastAbilityOnConsume){:target="_blank"}
  - `AbilityGuid: AB_Consumable_IrradiantGruel_AbilityGroup PrefabGuid(-1156226621)`
