---
title: Recipe_Weapon_Whip_T06_Iron_Reinforced
nav_order: 1
...
**Prefab GUID:** `465080212`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Whip_T06_Iron_Reinforced PrefabGuid(465080212) - Entity(56065:2)`
  - `Guid: Recipe_Weapon_Whip_T06_Iron_Reinforced PrefabGuid(465080212)`
  - `CraftDuration: 4`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Whip_T05_Iron PrefabGuid(-847062445)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Whip_T06_Iron_Reinforced PrefabGuid(1393113320)`
  - `Amount: 1`
