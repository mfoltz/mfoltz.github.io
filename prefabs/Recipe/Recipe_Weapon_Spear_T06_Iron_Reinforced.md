---
title: Recipe_Weapon_Spear_T06_Iron_Reinforced
nav_order: 1
...
**Prefab GUID:** `-499925914`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Spear_T06_Iron_Reinforced PrefabGuid(-499925914) - Entity(56169:2)`
  - `Guid: Recipe_Weapon_Spear_T06_Iron_Reinforced PrefabGuid(-499925914)`
  - `CraftDuration: 4`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Spear_T05_Iron PrefabGuid(1853029976)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Spear_T06_Iron_Reinforced PrefabGuid(1065194820)`
  - `Amount: 1`
