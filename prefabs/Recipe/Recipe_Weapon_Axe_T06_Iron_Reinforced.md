---
title: Recipe_Weapon_Axe_T06_Iron_Reinforced
nav_order: 1
...
**Prefab GUID:** `690858507`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Axe_T06_Iron_Reinforced PrefabGuid(690858507) - Entity(56154:2)`
  - `Guid: Recipe_Weapon_Axe_T06_Iron_Reinforced PrefabGuid(690858507)`
  - `CraftDuration: 4`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Axe_T05_Iron PrefabGuid(-1579575933)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Axe_T06_Iron_Reinforced PrefabGuid(198951695)`
  - `Amount: 1`
