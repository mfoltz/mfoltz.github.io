---
title: Recipe_Weapon_TwinBlades_T08_Sanguine
nav_order: 1
...
**Prefab GUID:** `1259720344`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_TwinBlades_T08_Sanguine PrefabGuid(1259720344) - Entity(56183:2)`
  - `Guid: Recipe_Weapon_TwinBlades_T08_Sanguine PrefabGuid(1259720344)`
  - `CraftDuration: 10`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_TwinBlades_T07_DarkSilver PrefabGuid(-1595292245)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_TwinBlades_T08_Sanguine PrefabGuid(-297349982)`
  - `Amount: 1`
