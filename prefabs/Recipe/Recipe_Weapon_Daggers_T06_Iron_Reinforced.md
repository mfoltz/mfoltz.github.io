---
title: Recipe_Weapon_Daggers_T06_Iron_Reinforced
nav_order: 1
...
**Prefab GUID:** `-328931595`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Daggers_T06_Iron_Reinforced PrefabGuid(-328931595) - Entity(56153:2)`
  - `Guid: Recipe_Weapon_Daggers_T06_Iron_Reinforced PrefabGuid(-328931595)`
  - `CraftDuration: 4`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Daggers_T05_Iron PrefabGuid(1296724931)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Daggers_T06_Iron_Reinforced PrefabGuid(703783407)`
  - `Amount: 1`
