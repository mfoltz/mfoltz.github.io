---
title: Recipe_Ingredient_CastleKey_T03
nav_order: 1
parent: Recipe Prefabs
---

# Recipe_Ingredient_CastleKey_T03

**Prefab GUID:** `690675608`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Ingredient_CastleKey_T03 PrefabGuid(690675608) - Entity(20385:5)`
  - `Guid: Recipe_Ingredient_CastleKey_T03 PrefabGuid(690675608)`
  - `CraftDuration: 300`
  - `HudSortingOrder: 0`
  - `AlwaysUnlocked: True`
  - `HideInStation: False`
...
- **[0]**
  - `Guid: Item_Ingredient_CastleKey_T03 PrefabGuid(-950839771)`
  - `Amount: 1`
