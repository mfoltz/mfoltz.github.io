---
title: Recipe_Weapon_Sword_T08_Sanguine
nav_order: 1
...
**Prefab GUID:** `895742048`

## Components

- **ProjectM.RecipeData**
  - `Entity: Prefab Recipe_Weapon_Sword_T08_Sanguine PrefabGuid(895742048) - Entity(56430:2)`
  - `Guid: Recipe_Weapon_Sword_T08_Sanguine PrefabGuid(895742048)`
  - `CraftDuration: 10`
  - `HudSortingOrder: 0`
...
- **[0]**
  - `Guid: Item_Weapon_Sword_T07_DarkSilver PrefabGuid(-1455388114)`
  - `Amount: 1`
...
- **[0]**
  - `Guid: Item_Weapon_Sword_T08_Sanguine PrefabGuid(-774462329)`
  - `Amount: 1`
