---
title: AB_Poloma_Hard_Projectile_Cast
guid: -1214248619
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Poloma_Hard_Projectile_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Poloma_Hard_Projectile_Cast PrefabGuid(-1214248619)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 5.8293996`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Poloma_Hard_Projectile PrefabGuid(-397818132)`
  - `Count: 10`
  - `Condition: None`
