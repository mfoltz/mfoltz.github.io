---
title: AB_Interact_Siege_Structure_T02_Activate
guid: 440049814
categories:
- AB
- All
...
# AB_Interact_Siege_Structure_T02_Activate
...
- [Script_ApplyExclusiveSiegeBuff_DataServer](/components/Script_ApplyExclusiveSiegeBuff_DataServer){:target="_blank"}
  - `NewBuffEntity: AB_Shapeshift_Golem_T02_Buff PrefabGuid(914043867)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 986721799`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -255270221`
