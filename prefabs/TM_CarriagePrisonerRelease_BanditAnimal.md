---
title: TM_CarriagePrisonerRelease_BanditAnimal
guid: 264976858
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_CarriagePrisonerRelease_BanditAnimal
...
- [ProjectM.Sequencer.SpawnSequenceForEntity](/components/SpawnSequenceForEntity){:target="_blank"}
...
- [ProjectM.DestroyAfterDuration](/components/DestroyAfterDuration){:target="_blank"}
  - `Duration: 1200`
  - `EndTime: 0`
  - `Condition: None`

- [ProjectM.DestroyAfterDuration_ActiveUserCheck](/components/DestroyAfterDuration_ActiveUserCheck){:target="_blank"}
  - `Range: 20`
...
- [ProjectM.Gameplay.Scripting.Script_CarriageCollidersData](/components/Script_CarriageCollidersData){:target="_blank"}
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1417085393`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1024819149`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[4]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1558186917`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[5]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1552645517`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[6]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -897753165`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[7]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -905405136`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[8]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1735955625`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SpawnPrefab: TM_CarriageChest_BanditAnimal PrefabGuid(-1819342331)`
...
- [ProjectM.Shared.BranchThroughGameplayEvent](/components/BranchThroughGameplayEvent){:target="_blank"}

- **[0]**
  - `OnTrue: Local - 1024819149`
  - `OnFalse: Local - -1558186917`
...
- **[1]**
  - `OnTrue: Local - -897753165`
  - `OnFalse: Local - 1552645517`
  - `Condition: ConditionBlob`
  - `ConditionInfo`
  - `Prefab                                        `
  - `Component                                    `
...
- **[2]**
  - `OnTrue: Local - -905405136`
  - `OnFalse: Local - 1735955625`
  - `Condition: ConditionBlob`
  - `ConditionInfo`
  - `Prefab                                        `
  - `Component                                    `
