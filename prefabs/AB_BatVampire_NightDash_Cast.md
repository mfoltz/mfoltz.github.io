---
title: AB_BatVampire_NightDash_Cast
guid: 793689690
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_BatVampire_NightDash_Cast PrefabGuid(793689690)`
...
- **[0]**
  - `SpawnPrefab: AB_BatVampire_NightDash_Travel PrefabGuid(-873017477)`
...
- **[1]**
  - `SpawnPrefab: AB_BatVampire_NightDash_TargetedBuff PrefabGuid(-1202372086)`
...
- **[2]**
  - `SpawnPrefab: AB_BatVampire_NightDash_AggroBuff PrefabGuid(1751996731)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
