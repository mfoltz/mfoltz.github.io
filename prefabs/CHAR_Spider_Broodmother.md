...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-522528604)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Spider_Broodmother PrefabGuid(1282440184)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Broodmother_SpawnAdds_AbilityGroup PrefabGuid(983916408)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Creature_Spider_Rank02 PrefabGuid(498560037)`
