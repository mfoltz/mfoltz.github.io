---
title: AB_Undead_ArenaChampion_AwakeSequence_Cast
guid: -947257653
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_ArenaChampion_AwakeSequence_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Undead_ArenaChampion_AwakeSequence_Cast PrefabGuid(-947257653)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag AbilityKit, Interact`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_ArenaChampion_AwakeSequence_Trigger PrefabGuid(-909853022)`
...
- **[1]**
  - `SpawnPrefab: AB_Interact_DuelFlag_Buff PrefabGuid(-1801874471)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
