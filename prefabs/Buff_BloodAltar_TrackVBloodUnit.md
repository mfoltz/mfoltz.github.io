---
title: Buff_BloodAltar_TrackVBloodUnit
guid: -1458480041
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
# Buff_BloodAltar_TrackVBloodUnit
...
- [ProjectM.Gameplay.Scripting.Script_BloodAltar_TrackVBloodUnit_Server](/components/Script_BloodAltar_TrackVBloodUnit_Server){:target="_blank"}
  - `NextUnitCheckTime: 0`
  - `TrackingUnit: Entity(0:0)`

- [ProjectM.Script_BloodAltar_TrackVBloodUnit_Shared](/components/Script_BloodAltar_TrackVBloodUnit_Shared){:target="_blank"}
  - `TrackPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `TrackedUnit: GUID Not Found`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_adbgiccjej`
...
- **[0]**
  - `SpawnPrefab: AB_BloodAltar_TrackVbloodUnit_Trigger PrefabGuid(-1024503212)`
