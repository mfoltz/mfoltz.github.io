---
title: CHAR_Militia_Torchbearer_Servant
guid: 986768339
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1971404132)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Militia_Torchbearer_Servant PrefabGuid(986768339)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Torchbearer_MeleeAttack_Group PrefabGuid(471046053)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_TorchThrow_AbilityGroup PrefabGuid(-116877786)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
