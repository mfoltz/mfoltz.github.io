---
title: TM_Castle_Container_Specialized_Soulshards_Manticore
guid: 653759442
categories:
- All
- TM
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Container_Specialized_Soulshards_Manticore PrefabGuid(653759442) - Entity(41467:2)`
  - `Guid: TM_Castle_Container_Specialized_Soulshards_Manticore PrefabGuid(653759442)`
...
- **[0]**
  - `Entity: Prefab GUID Not Found - Entity(11950:3)`
  - `BlobIndex: 1`

- **[1]**
  - `Entity: Prefab GUID Not Found - Entity(11949:3)`
  - `BlobIndex: 4`
...
- **[0]**
  ...
  - `RestrictedType: Item_MagicSource_SoulShard_Manticore PrefabGuid(-1260254082)`
...
- **[0]**
  - `Value: Prefab TM_Castle_Container_Specialized_Soulshards_Manticore PrefabGuid(653759442) - Entity(41467:2)`

- **[1]**
  - `Value: Prefab GUID Not Found - Entity(11950:3)`

- **[2]**
  - `Value: Prefab GUID Not Found - Entity(11949:3)`
...
- **[1]**
  - `PrefabGUID: Item_Ingredient_OnyxTear PrefabGuid(-651878258)`
  - `Amount: 1`
