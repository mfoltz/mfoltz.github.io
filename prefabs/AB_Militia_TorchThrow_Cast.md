---
title: AB_Militia_TorchThrow_Cast
guid: 441300272
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Militia_TorchThrow_Cast PrefabGuid(441300272)`
...
- [ProjectM.HideWeaponDuringCast](/components/HideWeaponDuringCast){:target="_blank"}
  ...
  - `Duration: 1`
  - `CastStartCounter: 0`
  - `Type: ProjectM.HideWeaponDuringCastType PostCast`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_TorchThrow_Throw PrefabGuid(-1324026835)`
