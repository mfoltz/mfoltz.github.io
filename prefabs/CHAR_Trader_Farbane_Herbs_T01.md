---
title: CHAR_Trader_Farbane_Herbs_T01
guid: -375258845
categories:
- All
- CHAR
...
- [CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1202124672)`
...
- [BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Trader_Farbane_Stalker_T01 PrefabGuid(538182877)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Trader_Farbane_Stalker_MeleeAttack_Group PrefabGuid(1110054537)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Trader_Farbane_Stalker_ChargeAttack_Group PrefabGuid(1487412876)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- [TraderCollectionGenerator](/components/TraderCollectionGenerator){:target="_blank"}

- **[0]**
  - `GeneratorBlob: Unity.Entities.BlobAssetReference`1[TraderCollectionGeneratorBlob] Unity.Entities.BlobAssetReference`1[TraderCollectionGeneratorBlob]`
...
- [TraderEntry](/components/TraderEntry){:target="_blank"}
  - *(No fields)*

- [TradeCost](/components/TradeCost){:target="_blank"}
  - *(No fields)*

- [TradeOutput](/components/TradeOutput){:target="_blank"}
  - *(No fields)*
...
- [Snapshot_TradeCost](/components/Snapshot_TradeCost){:target="_blank"}
  - *(No fields)*

- [Snapshot_TradeOutput](/components/Snapshot_TradeOutput){:target="_blank"}
  - *(No fields)*

- [Snapshot_TraderEntry](/components/Snapshot_TraderEntry){:target="_blank"}
  - *(No fields)*
...
- **[1]**
  - `RecipeGuid: Recipe_Headgear_NecromancerHat_T01_Trader PrefabGuid(737997561)`

- **[2]**
  - `RecipeGuid: Recipe_Consumable_HealingPotion_T01_Trader PrefabGuid(1446468348)`

- **[3]**
  - `RecipeGuid: Recipe_Consumable_PhysicalPowerPotion_T01_Trader PrefabGuid(-1373956725)`

- **[4]**
  - `RecipeGuid: Recipe_Consumable_GarlicResistancePotion_T01_Trader PrefabGuid(-767965323)`

- **[5]**
  - `RecipeGuid: Recipe_Consumable_Explosives_Minor_T01_Trader PrefabGuid(-149394540)`

- **[6]**
  - `RecipeGuid: Recipe_Weapon_MinersMace_T01_Trader PrefabGuid(-1476908192)`

- **[7]**
  - `RecipeGuid: Recipe_Weapon_LumberjackAxe_T01_Trader PrefabGuid(2136704250)`

- **[8]**
  - `RecipeGuid: Recipe_Seed_BloodRose_T01_Trader PrefabGuid(1930056104)`

- **[9]**
  - `RecipeGuid: Recipe_Seed_FireBlossom_T01_Trader PrefabGuid(-693582888)`

- **[10]**
  - `RecipeGuid: Recipe_Seed_SnowFlower_T01_Trader PrefabGuid(640919389)`

- **[11]**
  - `RecipeGuid: Recipe_Seed_MourningLily_T01_Trader PrefabGuid(-1271741418)`

- **[12]**
  - `RecipeGuid: Recipe_Seed_HellsClarion_T01_Trader PrefabGuid(-1079722820)`

- **[13]**
  - `RecipeGuid: Recipe_Gem_Amethyst_T01_Trader PrefabGuid(-1101407057)`

- **[14]**
  - `RecipeGuid: Recipe_Gem_Emerald_T01_Trader PrefabGuid(777459323)`

- **[15]**
  - `RecipeGuid: Recipe_Gem_MistStone_T01_Trader PrefabGuid(-1882174403)`

- **[16]**
  - `RecipeGuid: Recipe_Gem_Ruby_T01_Trader PrefabGuid(2003589362)`

- **[17]**
  - `RecipeGuid: Recipe_Gem_Sapphire_T01_Trader PrefabGuid(1469919230)`
