---
title: AB_Bandit_Fisherman_FishHook_Travel
guid: -56609007
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Bandit_Fisherman_FishHook_Travel
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 1`
  - `Groups: ProjectM.BuffCategoryFlag AirThrow`
  - `KeepOldest: False`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Bandit_Fisherman_FishHook_DownedStun PrefabGuid(-531963043)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 2004786576`
