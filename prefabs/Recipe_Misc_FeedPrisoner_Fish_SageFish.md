---
title: Recipe_Misc_FeedPrisoner_Fish_SageFish
guid: 1800570390
categories:
- All
- Recipe
...
# Recipe_Misc_FeedPrisoner_Fish_SageFish
...
- [RecipeData](/components/RecipeData){:target="_blank"}
  - `Entity: Prefab Recipe_Misc_FeedPrisoner_Fish_SageFish PrefabGuid(1800570390) - Entity(19141:1)`
  - `Guid: Recipe_Misc_FeedPrisoner_Fish_SageFish PrefabGuid(1800570390)`
  - `CraftDuration: 30`
  - `HudSortingOrder: 0`
  - `AlwaysUnlocked: True`
  - `HideInStation: False`
...
- **[0]**
  - `Guid: FakeItem_FeedPrisoner_SageFish PrefabGuid(172410251)`
  - `Amount: 1`
