---
title: Buff_General_Wounded_Tracker
guid: 224060472
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_Wounded_DataShared](/components/Script_Wounded_DataShared){:target="_blank"}
  - `OnDamageTakenListener: ProjectM.Scripting.ListenerId ProjectM.Scripting.ListenerId`
  - `WoundedSequenceState: SequenceState`
  - `Id: Entity(0:0)`
  - `KnockbackModification: Unset`
  - `IsWounded: False`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acgbiiekebj`
