---
title: AB_Bandit_Fisherman_FishHook_Cast
guid: 1802235612
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Bandit_Fisherman_FishHook_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Bandit_Fisherman_FishHook_Cast PrefabGuid(1802235612)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Fisherman_FishHook_Throw PrefabGuid(-406761191)`
...
- **[1]**
  - `SpawnPrefab: AB_Bandit_Fisherman_FishHook_Buff PrefabGuid(1578560559)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
