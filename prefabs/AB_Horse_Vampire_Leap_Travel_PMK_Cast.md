---
title: AB_Horse_Vampire_Leap_Travel_PMK_Cast
guid: -114006154
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Horse_Vampire_Leap_Travel_PMK_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Horse_Vampire_Leap_Travel_PMK_Cast PrefabGuid(-114006154)`
...
- **[0]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_PMK_Phase PrefabGuid(-1552400564)`
...
- **[1]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_PMK_Buff PrefabGuid(-1718116915)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
