...
- [ProjectM.SpawnPhysicsObjectOnDeath](/components/SpawnPhysicsObjectOnDeath){:target="_blank"}
  - `PhysicsObjectPrefab: Dynamic_Militia_Barricade_01 PrefabGuid(729192032)`
  - `AlwaysSpawn: False`
...
- [Unity.Transforms.LocalTransform](/components/LocalTransform){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(0.0090746f, 0f, 0f)`
  - `Scale: 1`
  - `Rotation: Unity.Mathematics.quaternion quaternion(0f, 0f, 0f, 1f)`

- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1.075f, 0f, 0f, 0f,  0f, 1f, 0f, 0f,  0f, 0f, 1f, 0f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1141141276`
