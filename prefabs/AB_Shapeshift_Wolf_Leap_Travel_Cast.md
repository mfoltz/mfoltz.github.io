---
title: AB_Shapeshift_Wolf_Leap_Travel_Cast
guid: 2108303474
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Shapeshift_Wolf_Leap_Travel_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Shapeshift_Wolf_Leap_Travel_Cast PrefabGuid(2108303474)`
...
- **[0]**
  - `SpawnPrefab: AB_Shapeshift_Wolf_Leap_Travel_Phase PrefabGuid(113772695)`
...
- **[1]**
  - `SpawnPrefab: AB_Shapeshift_Wolf_Leap_Travel_Buff PrefabGuid(-1882904996)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
