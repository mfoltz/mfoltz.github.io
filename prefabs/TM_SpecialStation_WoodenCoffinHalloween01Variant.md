---
title: TM_SpecialStation_WoodenCoffinHalloween01Variant
guid: 1567106242
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Residency](/components/Residency){:target="_blank"}
  - `InsideBuff: AB_Interact_GetInside_Owner_Buff_Base PrefabGuid(381160212)`
  - `Resident: Entity(0:0)`

- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_WoodenCoffinHalloween01Variant PrefabGuid(1567106242) - Entity(41178:2)`
  - `Guid: TM_SpecialStation_WoodenCoffinHalloween01Variant PrefabGuid(1567106242)`
...
- [ProjectM.RespawnPoint](/components/RespawnPoint){:target="_blank"}
  - `SpawnExitOffset: Unity.Mathematics.float3 float3(0f, 0f, -2.5f)`
  - `SpawnDelayBuff: AB_Interact_WoodenCoffinSpawn_Travel_Delay PrefabGuid(-246207628)`
  - `SpawnSleepingBuff: AB_Interact_CoffinSleeping PrefabGuid(845443603)`
  - `RespawnPointType: ProjectM.RespawnPointType WoodenCoffin`
...
- [ProjectM.GiveAchievementOnSpawn](/components/GiveAchievementOnSpawn){:target="_blank"}
  - `Achievement: TM_SpecialStation_WoodenCoffin PrefabGuid(1523835471)`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_GetInside_AbilityGroup_Base PrefabGuid(1013114237)`
  - `Importance: 5`
...
- **[1]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_BindCoffin_AbilityGroup PrefabGuid(1372470796)`
  - `Importance: 0`
  - `HideInteractHUDWhileCasting: False`
...
- **[0]**
  - `PrefabGUID: Item_Ingredient_Wood_Standard PrefabGuid(-1593377811)`
  - `Amount: 180`

- [ProjectM.ProgressionDependencyElement](/components/ProgressionDependencyElement){:target="_blank"}

- **[0]**
  - `PrefabGuid: TM_SpecialStation_WoodenCoffinHalloween01Variant PrefabGuid(1567106242)`

- [ProjectM.AttachMapIconsToEntity](/components/AttachMapIconsToEntity){:target="_blank"}

- **[0]**
  - `Prefab: MapIcon_WoodenCoffin PrefabGuid(1636226671)`
