---
title: AB_Gloomrot_Monster_SideStepInit_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_Monster_SideStepInit_Cast

**Prefab GUID:** `230471096`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_Monster_SideStepInit_Cast PrefabGuid(230471096)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_Monster_SideStepInit_FakeProjectileRight PrefabGuid(385902419)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_Monster_SideStepInit_FakeProjectileLeft PrefabGuid(552241592)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
