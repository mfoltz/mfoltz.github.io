---
title: AB_Storm_Discharge_SpellMod_Recast_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Storm_Discharge_SpellMod_Recast_Buff

**Prefab GUID:** `1659814621`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Storm_Discharge_AbilityGroup PrefabGuid(1952703098)`
  - `NewGroupId: AB_Storm_Discharge_SpellMod_Recast_AbilityGroup PrefabGuid(1816495876)`
  - `Priority: 1`
  - `Condition: None`
