---
title: AB_Militia_Scribe_WhackAScribe_Init_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Militia_Scribe_WhackAScribe_Init_Cast

**Prefab GUID:** `-610093433`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Militia_Scribe_WhackAScribe_Init_Cast PrefabGuid(-610093433)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Scribe_WhackAScribe_Init_Buff PrefabGuid(2005485465)`
