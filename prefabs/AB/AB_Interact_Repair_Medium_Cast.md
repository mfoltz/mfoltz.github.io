---
title: AB_Interact_Repair_Medium_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_Repair_Medium_Cast

**Prefab GUID:** `-701769181`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Interact_Repair_Medium_Cast PrefabGuid(-701769181)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag IgnoreSpellBlock, Primary`
