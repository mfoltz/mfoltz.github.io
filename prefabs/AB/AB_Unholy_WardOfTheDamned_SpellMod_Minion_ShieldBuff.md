---
title: AB_Unholy_WardOfTheDamned_SpellMod_Minion_ShieldBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Unholy_WardOfTheDamned_SpellMod_Minion_ShieldBuff

**Prefab GUID:** `1378825977`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_WardOfTheDamned_ShieldSkeletonsOnRecast PrefabGuid(-1840862497)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
