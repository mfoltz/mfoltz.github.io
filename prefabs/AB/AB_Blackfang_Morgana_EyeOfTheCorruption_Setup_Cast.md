---
title: AB_Blackfang_Morgana_EyeOfTheCorruption_Setup_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_Morgana_EyeOfTheCorruption_Setup_Cast

**Prefab GUID:** `229127513`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Blackfang_Morgana_EyeOfTheCorruption_Setup_Cast PrefabGuid(229127513)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DiscoBeams_CenterSpinner01 PrefabGuid(1137468146)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DiscoBeams_CenterSpinner02 PrefabGuid(-1741464220)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
