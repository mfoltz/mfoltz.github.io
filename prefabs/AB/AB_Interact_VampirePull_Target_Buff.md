---
title: AB_Interact_VampirePull_Target_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_VampirePull_Target_Buff

**Prefab GUID:** `-1347981489`
...
- **[0]**
  ...
  - `CustomKnockbackBuff: Buff_General_Knockback_Ally PrefabGuid(-2099203048)`
  - `UseMinMaxRange: True`
  - `MinDistanceToTarget: 0.5`
  - `MaxDistanceToTarget: 3.5`
  - `CloseRange: 0.1`
  - `FarRange: 3.5`
