---
title: AB_ChurchOfLight_Paladin_HolyFlackCannon_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_ChurchOfLight_Paladin_HolyFlackCannon_Cast

**Prefab GUID:** `-949919142`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_ChurchOfLight_Paladin_HolyFlackCannon_Cast PrefabGuid(-949919142)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_Spinner01 PrefabGuid(297275019)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_Spinner02 PrefabGuid(512131254)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_HolyFlackCannon_ChannelBuff PrefabGuid(-443754441)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
