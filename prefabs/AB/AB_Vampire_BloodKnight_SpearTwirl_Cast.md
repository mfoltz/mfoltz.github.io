---
title: AB_Vampire_BloodKnight_SpearTwirl_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_BloodKnight_SpearTwirl_Cast

**Prefab GUID:** `1317898066`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Vampire_BloodKnight_SpearTwirl_Cast PrefabGuid(1317898066)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_SpearTwirl_Buff01 PrefabGuid(5431060)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_SpearTwirl_Buff02 PrefabGuid(1702060331)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
