---
title: AB_Gloomrot_SentryOfficer_PlaceTurret_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_SentryOfficer_PlaceTurret_Cast

**Prefab GUID:** `989758231`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_SentryOfficer_PlaceTurret_Cast PrefabGuid(989758231)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SentryOfficer_PlaceTurret_MinionSpawn PrefabGuid(457111010)`
