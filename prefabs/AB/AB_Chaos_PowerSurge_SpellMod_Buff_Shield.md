---
title: AB_Chaos_PowerSurge_SpellMod_Buff_Shield
nav_order: 1
parent: AB Prefabs
---
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_PowerSurge_Shield PrefabGuid(-581430582)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Multiply`
  - `ValueIndex: 0`
