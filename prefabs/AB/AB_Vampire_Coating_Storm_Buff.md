---
title: AB_Vampire_Coating_Storm_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Coating_Storm_Buff

**Prefab GUID:** `1711652978`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Storm_Vampire_Static_ChainLightning_HitBuff PrefabGuid(-543256675)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 752617637`
...
- **[1]**
  - `SequenceGuid: SequenceGUID 202465040`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID 1142896899`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
...
- **[0]**
  - `SpawnPrefab: Storm_Vampire_Static_ChainLightning_AreaCheck PrefabGuid(-2101801592)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget EventTarget`
