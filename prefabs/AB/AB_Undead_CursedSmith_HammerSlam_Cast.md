---
title: AB_Undead_CursedSmith_HammerSlam_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_CursedSmith_HammerSlam_Cast

**Prefab GUID:** `-846010733`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Undead_CursedSmith_HammerSlam_Cast PrefabGuid(-846010733)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_HammerSlam_Phase PrefabGuid(1400962626)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_CursedSmith_HammerBuff PrefabGuid(1238601516)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
