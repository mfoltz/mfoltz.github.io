---
title: AB_Frost_ColdSnap_Shield
nav_order: 1
parent: AB Prefabs
---

# AB_Frost_ColdSnap_Shield

**Prefab GUID:** `-557933420`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_ColdSnap_BonusAbsorb PrefabGuid(1336836422)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_ColdSnap_HasteWhileShielded PrefabGuid(986977415)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Add`
  - `ValueIndex: 0`
