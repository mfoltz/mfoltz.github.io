---
title: AB_Unholy_Shared_SpellMod_SkeletonBomb_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Unholy_Shared_SpellMod_SkeletonBomb_Buff

**Prefab GUID:** `-1089313032`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Unholy_SkeletonBomb PrefabGuid(715404066)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_VeilOfBones_SkeletonBomb PrefabGuid(1795974165)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget LifeTime_Duration`
  - `TargetIndex: -1`
