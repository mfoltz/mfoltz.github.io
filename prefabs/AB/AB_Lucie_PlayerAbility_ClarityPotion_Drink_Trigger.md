---
title: AB_Lucie_PlayerAbility_ClarityPotion_Drink_Trigger
nav_order: 1
parent: AB Prefabs
---

# AB_Lucie_PlayerAbility_ClarityPotion_Drink_Trigger

**Prefab GUID:** `-125440500`
...
- **[2]**
  - `EventIndex: 2`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-412969916)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
