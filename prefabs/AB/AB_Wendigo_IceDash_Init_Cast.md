---
title: AB_Wendigo_IceDash_Init_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Wendigo_IceDash_Init_Cast

**Prefab GUID:** `-1639900640`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Wendigo_IceDash_Init_Cast PrefabGuid(-1639900640)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IceDash_Init_MoveBehaviourBuff PrefabGuid(-81468142)`
...
- **[1]**
  - `SpawnPrefab: AB_Wendigo_IceDash_Travel_AggroBuff PrefabGuid(312861120)`
