---
title: AB_Chaos_MercilessCharge_StopPause
nav_order: 1
parent: AB Prefabs
---

# AB_Chaos_MercilessCharge_StopPause

**Prefab GUID:** `-1801218516`
...
- **ProjectM.BuffCategory**
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag RemoveOnDisconnect`
  - `KeepOldest: False`
...
- **[0]**
  - `SpawnPrefab: AB_Chaos_MercilessCharge_EndImpact PrefabGuid(1068025228)`
