---
title: AB_Vampire_Coating_Unholy_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_Coating_Unholy_Buff

**Prefab GUID:** `-650951987`
...
- **[0]**
  ...
  - `Buff1: AB_Vampire_Coating_Unholy_BoneSpirit PrefabGuid(2106369097)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1397330676`
...
- **[1]**
  - `SequenceGuid: SequenceGUID -370040995`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID -1438189458`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
