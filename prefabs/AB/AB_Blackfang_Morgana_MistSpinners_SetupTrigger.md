---
title: AB_Blackfang_Morgana_MistSpinners_SetupTrigger
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_Morgana_MistSpinners_SetupTrigger

**Prefab GUID:** `1092461475`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_MistSpinners_HomingPosition01 PrefabGuid(708863087)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_MistSpinners_HomingPosition02 PrefabGuid(169986938)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Self`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Morgana_MistSpinners_HomingPosition03 PrefabGuid(-1359040628)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Self`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[3]**
  - `SpawnPrefab: AB_Blackfang_Morgana_MistSpinners_HomingPosition04 PrefabGuid(-1763877514)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Self`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
