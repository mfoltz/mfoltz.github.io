---
title: AB_Vampire_TwinBlades_Primary_MeleeAttack_Cast02
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_TwinBlades_Primary_MeleeAttack_Cast02

**Prefab GUID:** `1999458981`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Vampire_TwinBlades_Primary_MeleeAttack_Cast02 PrefabGuid(1999458981)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_TwinBlades_Primary_MeleeAttack_Hit02 PrefabGuid(-2005740545)`
...
- **ProjectM.AbilitySpawnPrefabOnCastFactor**
  - *(No fields)*

- **[0]**
  - `CastData: ProjectM.AbilitySpawnPrefabOnCast ProjectM.AbilitySpawnPrefabOnCast`
  - `Factor: 0.5`
  - `Triggered: False`
