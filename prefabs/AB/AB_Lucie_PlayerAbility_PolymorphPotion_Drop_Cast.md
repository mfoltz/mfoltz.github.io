---
title: AB_Lucie_PlayerAbility_PolymorphPotion_Drop_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Lucie_PlayerAbility_PolymorphPotion_Drop_Cast

**Prefab GUID:** `2102576864`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Lucie_PlayerAbility_PolymorphPotion_Drop_Cast PrefabGuid(2102576864)`
...
- **[0]**
  - `SpawnPrefab: AB_Lucie_PlayerAbility_PolymorphPotion_Drop_Trigger PrefabGuid(562974809)`
