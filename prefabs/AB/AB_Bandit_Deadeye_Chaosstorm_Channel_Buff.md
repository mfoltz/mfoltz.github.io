---
title: AB_Bandit_Deadeye_Chaosstorm_Channel_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Bandit_Deadeye_Chaosstorm_Channel_Buff

**Prefab GUID:** `-1625210735`
...
- **ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer**
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Bandit_Deadeye_Chaosstorm_Projectile PrefabGuid(659256615)`
