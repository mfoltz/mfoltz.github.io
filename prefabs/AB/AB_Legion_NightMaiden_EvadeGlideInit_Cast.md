---
title: AB_Legion_NightMaiden_EvadeGlideInit_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Legion_NightMaiden_EvadeGlideInit_Cast

**Prefab GUID:** `-1862737063`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Legion_NightMaiden_EvadeGlideInit_Cast PrefabGuid(-1862737063)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_NightMaiden_EvadeGlideInit_FakeProjectileRight PrefabGuid(-1855067328)`
...
- **[1]**
  - `SpawnPrefab: AB_Legion_NightMaiden_EvadeGlideInit_FakeProjectileLeft PrefabGuid(836480447)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
