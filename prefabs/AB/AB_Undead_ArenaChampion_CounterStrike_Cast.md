---
title: AB_Undead_ArenaChampion_CounterStrike_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_ArenaChampion_CounterStrike_Cast

**Prefab GUID:** `-90603923`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Undead_ArenaChampion_CounterStrike_Cast PrefabGuid(-90603923)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_ArenaChampion_CounterStrike_Buff PrefabGuid(-1651889429)`
