---
title: AB_Legion_Vargulf_MaulSetup_Init_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Legion_Vargulf_MaulSetup_Init_Cast

**Prefab GUID:** `1993389565`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Legion_Vargulf_MaulSetup_Init_Cast PrefabGuid(1993389565)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_Vargulf_MaulSetup_Init_FakeProjectileRight PrefabGuid(-1228913539)`
...
- **[1]**
  - `SpawnPrefab: AB_Legion_Vargulf_MaulSetup_Init_FakeProjectileLeft PrefabGuid(178669065)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Legion_Vargulf_MaulSetup_Init_AggroBuff PrefabGuid(267863357)`
