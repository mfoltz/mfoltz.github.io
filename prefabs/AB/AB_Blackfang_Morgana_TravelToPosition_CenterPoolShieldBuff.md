---
title: AB_Blackfang_Morgana_TravelToPosition_CenterPoolShieldBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_Morgana_TravelToPosition_CenterPoolShieldBuff

**Prefab GUID:** `-1733669874`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1137468146)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1741464220)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
