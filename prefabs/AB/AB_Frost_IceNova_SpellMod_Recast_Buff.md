---
title: AB_Frost_IceNova_SpellMod_Recast_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Frost_IceNova_SpellMod_Recast_Buff

**Prefab GUID:** `-369121853`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Frost_IceNova_AbilityGroup PrefabGuid(91249849)`
  - `NewGroupId: AB_Frost_IceNova_SpellMod_Recast_AbilityGroup PrefabGuid(1473095785)`
  - `Priority: 1`
  - `Condition: None`
