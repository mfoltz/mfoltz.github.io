---
title: AB_Gloomrot_RailgunSergeant_CloneWarpRight_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_RailgunSergeant_CloneWarpRight_Cast

**Prefab GUID:** `1949236453`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_RailgunSergeant_CloneWarpRight_Cast PrefabGuid(1949236453)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_CloneWarpRight_InitPhase PrefabGuid(314949045)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_CloneWarpRight_MinionSpawn PrefabGuid(1926609225)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
