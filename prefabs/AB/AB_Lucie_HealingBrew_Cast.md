---
title: AB_Lucie_HealingBrew_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Lucie_HealingBrew_Cast

**Prefab GUID:** `31591934`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Lucie_HealingBrew_Cast PrefabGuid(31591934)`
...
- **[0]**
  - `SpawnPrefab: AB_Lucie_HealingBrew_Buff PrefabGuid(44786898)`
...
- **[1]**
  - `SpawnPrefab: AB_Lucie_HealingBrew_ClaritySelfThrow PrefabGuid(684598909)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
