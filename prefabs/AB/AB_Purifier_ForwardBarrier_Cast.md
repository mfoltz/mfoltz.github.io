---
title: AB_Purifier_ForwardBarrier_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Purifier_ForwardBarrier_Cast

**Prefab GUID:** `1772596288`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Purifier_ForwardBarrier_Cast PrefabGuid(1772596288)`
...
- **[0]**
  - `SpawnPrefab: AB_Purifier_ForwardBarrier_RightBuff PrefabGuid(1075662022)`
...
- **[1]**
  - `SpawnPrefab: AB_Purifier_ForwardBarrier_LeftBuff PrefabGuid(593446973)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
