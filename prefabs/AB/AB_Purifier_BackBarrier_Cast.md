---
title: AB_Purifier_BackBarrier_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Purifier_BackBarrier_Cast

**Prefab GUID:** `119196949`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Purifier_BackBarrier_Cast PrefabGuid(119196949)`
...
- **[0]**
  - `SpawnPrefab: AB_Purifier_BackBarrier_RightBuff PrefabGuid(960501997)`
...
- **[1]**
  - `SpawnPrefab: AB_Purifier_BackBarrier_LeftBuff PrefabGuid(569251826)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
