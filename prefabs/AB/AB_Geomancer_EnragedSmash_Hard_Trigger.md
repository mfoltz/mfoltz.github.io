---
title: AB_Geomancer_EnragedSmash_Hard_Trigger
nav_order: 1
parent: AB Prefabs
---

# AB_Geomancer_EnragedSmash_Hard_Trigger

**Prefab GUID:** `1339796748`
...
- **ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer**
  ...
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Geomancer_EnragedSmash_Hard_Projectile PrefabGuid(395344242)`
