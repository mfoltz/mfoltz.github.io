---
title: AB_Gloomrot_TheProfessor_ImplodingOrb_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Gloomrot_TheProfessor_ImplodingOrb_Cast

**Prefab GUID:** `1345178156`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Gloomrot_TheProfessor_ImplodingOrb_Cast PrefabGuid(1345178156)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_ImplodingOrb_Projectile PrefabGuid(-1355631149)`
