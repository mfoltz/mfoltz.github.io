---
title: AB_Vampire_VeilOfIllusion_Recast_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_VeilOfIllusion_Recast_Buff

**Prefab GUID:** `1426492570`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Vampire_VeilOfIllusion_AbilityGroup PrefabGuid(-935015750)`
  - `NewGroupId: AB_Vampire_VeilOfIllusion_Recast_AbilityGroup PrefabGuid(1994950191)`
  - `Priority: 2`
  - `Condition: None`
