---
title: AB_Lucie_Player_LiquidLuckPotion_HoldingBuff
nav_order: 1
parent: AB Prefabs
---

# AB_Lucie_Player_LiquidLuckPotion_HoldingBuff

**Prefab GUID:** `-377632550`
...
- **[0]**
  ...
  - `NewGroupId: AB_Lucie_PlayerAbility_LiquidLuckPotion_Throw_AbilityGroup PrefabGuid(362512593)`
  - `Priority: 1`
  - `Condition: None`
