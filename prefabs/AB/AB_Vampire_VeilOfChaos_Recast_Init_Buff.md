---
title: AB_Vampire_VeilOfChaos_Recast_Init_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Vampire_VeilOfChaos_Recast_Init_Buff

**Prefab GUID:** `-1206989621`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Vampire_VeilOfChaos_Group PrefabGuid(711231628)`
  - `NewGroupId: AB_Vampire_VeilOfChaos_Recast_Group PrefabGuid(1711943933)`
  - `Priority: 2`
  - `Condition: None`
