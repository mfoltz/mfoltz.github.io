---
title: AB_Blackfang_CarverBoss_MegaCleave_ProjectileLauncher
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_CarverBoss_MegaCleave_ProjectileLauncher

**Prefab GUID:** `911035600`
...
- **ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer**
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Blackfang_CarverBoss_MegaCleave_Projectile PrefabGuid(-619652431)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_CorruptionSpill_Area_Melee PrefabGuid(-303466414)`
