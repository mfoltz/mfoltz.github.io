---
title: AB_Blackfang_CarverBoss_SummonCarvers_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Blackfang_CarverBoss_SummonCarvers_Cast

**Prefab GUID:** `-806722104`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Blackfang_CarverBoss_SummonCarvers_Cast PrefabGuid(-806722104)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_SummonCarvers_Summon PrefabGuid(-2104854704)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_SummonCarvers_StandBack_Buff PrefabGuid(861028343)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
