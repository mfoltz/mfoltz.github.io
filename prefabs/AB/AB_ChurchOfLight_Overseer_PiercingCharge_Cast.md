---
title: AB_ChurchOfLight_Overseer_PiercingCharge_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_ChurchOfLight_Overseer_PiercingCharge_Cast

**Prefab GUID:** `-310802745`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_ChurchOfLight_Overseer_PiercingCharge_Cast PrefabGuid(-310802745)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_PiercingCharge_Phase PrefabGuid(-343967306)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_PiercingCharge_FakeTarget PrefabGuid(-2059791223)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
