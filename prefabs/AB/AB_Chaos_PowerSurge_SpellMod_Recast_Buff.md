---
title: AB_Chaos_PowerSurge_SpellMod_Recast_Buff
nav_order: 1
parent: AB Prefabs
---

# AB_Chaos_PowerSurge_SpellMod_Recast_Buff

**Prefab GUID:** `-287562542`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Chaos_PowerSurge_AbilityGroup PrefabGuid(1112116762)`
  - `NewGroupId: AB_Chaos_PowerSurge_SpellMod_Recast_AbilityGroup PrefabGuid(1576686583)`
  - `Priority: 1`
  - `Condition: None`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_PowerSurge_Lifetime PrefabGuid(-842072895)`
