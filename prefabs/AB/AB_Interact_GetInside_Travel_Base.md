---
title: AB_Interact_GetInside_Travel_Base
nav_order: 1
parent: AB Prefabs
---

# AB_Interact_GetInside_Travel_Base

**Prefab GUID:** `-1194613929`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Interact_GetInside_Owner_Init_Buff_Base PrefabGuid(-785333140)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Interact_GetInside_Target_Buff_Base PrefabGuid(-2068156603)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
