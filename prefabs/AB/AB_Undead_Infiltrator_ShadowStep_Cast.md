---
title: AB_Undead_Infiltrator_ShadowStep_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Undead_Infiltrator_ShadowStep_Cast

**Prefab GUID:** `1524824733`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Undead_Infiltrator_ShadowStep_Cast PrefabGuid(1524824733)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Infiltrator_ShadowStep_Travel PrefabGuid(-181608834)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_Infiltrator_ShadowStep_TargetedBuff PrefabGuid(-1411423820)`
...
- **[2]**
  - `SpawnPrefab: AB_Undead_Infiltrator_ShadowStep_AggroBuff PrefabGuid(1800200320)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
