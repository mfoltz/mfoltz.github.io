---
title: AB_Wendigo_IceBeam_Second_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_Wendigo_IceBeam_Second_Cast

**Prefab GUID:** `1834593836`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Wendigo_IceBeam_Second_Cast PrefabGuid(1834593836)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IceBeam_Second_Channel PrefabGuid(617598110)`
...
- **[1]**
  - `SpawnPrefab: AB_Wendigo_IceBeam_TargetedBuff PrefabGuid(668297145)`
...
- **[2]**
  - `SpawnPrefab: AB_Wendigo_IceBeam_AggroBuff PrefabGuid(1038174719)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
