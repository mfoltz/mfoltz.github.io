---
title: AB_ArchMage_FlamingIce_Cast
nav_order: 1
parent: AB Prefabs
---

# AB_ArchMage_FlamingIce_Cast

**Prefab GUID:** `1890249378`
...
- **ProjectM.AbilityState**
  - `AbilityId: AB_ArchMage_FlamingIce_Cast PrefabGuid(1890249378)`
...
- **[0]**
  - `SpawnPrefab: AB_ArchMage_FlamingIce_Trigger PrefabGuid(-1488767962)`
...
- **[1]**
  - `SpawnPrefab: AB_ArchMage_FlamingIce_Area PrefabGuid(379217467)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
