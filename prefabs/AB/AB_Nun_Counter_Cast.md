...
- **ProjectM.AbilityState**
  - `AbilityId: AB_Nun_Counter_Cast PrefabGuid(-1347852248)`
...
- **[0]**
  - `SpawnPrefab: AB_Nun_Counter_Buff PrefabGuid(-309950314)`
