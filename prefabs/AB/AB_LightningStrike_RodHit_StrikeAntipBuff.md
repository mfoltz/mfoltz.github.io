---
title: AB_LightningStrike_RodHit_StrikeAntipBuff
nav_order: 1
parent: AB Prefabs
---

# AB_LightningStrike_RodHit_StrikeAntipBuff

**Prefab GUID:** `1817037486`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_LightningStrike_RodHit_WasHitBuff PrefabGuid(-1130377813)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 46419494`
...
- **[0]**
  - `SpawnPrefab: AB_LightningStrike_LightMoodTrigger PrefabGuid(-268718160)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
