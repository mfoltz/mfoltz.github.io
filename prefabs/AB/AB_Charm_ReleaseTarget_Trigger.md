---
title: AB_Charm_ReleaseTarget_Trigger
nav_order: 1
parent: AB Prefabs
---

# AB_Charm_ReleaseTarget_Trigger

**Prefab GUID:** `-1692072908`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1606534848`
...
- **[1]**
  - `SequenceGuid: SequenceGUID 19291606`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`

- **[2]**
  - `SequenceGuid: SequenceGUID 2059916414`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
