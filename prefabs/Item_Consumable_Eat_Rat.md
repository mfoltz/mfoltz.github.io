...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Consumable_Eat_Rat PrefabGuid(-869864524)`
...
- [CastAbilityOnConsume](/components/CastAbilityOnConsume){:target="_blank"}
  - `AbilityGuid: AB_Consumable_Eat_Rat_AbilityGroup PrefabGuid(2034689434)`
