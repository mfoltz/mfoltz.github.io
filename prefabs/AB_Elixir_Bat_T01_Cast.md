...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Elixir_Bat_T01_Cast PrefabGuid(367600723)`
...
- **[0]**
  - `SpawnPrefab: AB_Elixir_Bat_T01_Activate PrefabGuid(1583830465)`
