---
title: CHAR_Blackfang_Peon_Miner
guid: -699233841
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-442265123)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Peon PrefabGuid(207507785)`
...
- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Peon_Mining_MeleeAttack_AbilityGroup PrefabGuid(-459395643)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
