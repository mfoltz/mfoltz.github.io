---
title: CHAR_VHunter_Leader_VBlood
guid: -1449631170
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1073819632)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_VHunter_Leader_VBlood PrefabGuid(-1449631170)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_VHunter_Leader_VBlood PrefabGuid(-2142076474)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_MeleeHorizontal_Group PrefabGuid(1552780633)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_MeleeHorizontal_Hard_Group PrefabGuid(-1417141477)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Whirlwind_Init_AbilityGroup PrefabGuid(-343320686)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_MeleeStraight_Group PrefabGuid(224496996)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_LeapThrust_Group PrefabGuid(1501188283)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Roll_Group PrefabGuid(-175257190)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Crossbow_Group PrefabGuid(-737556373)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Crossbow_Group_Fast PrefabGuid(-23281706)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_FireRain_Group PrefabGuid(985201241)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Whirlwind_AbilityGroup PrefabGuid(-1503146131)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_VHunter_Leader_Crossbow_Group_Hard PrefabGuid(-1330984343)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  - `Guid: Tech_Collection_VBlood_T04_VampireHunter_GreatSword PrefabGuid(2076894288)`
...
- **[0]**
  - `BuffGuid: Buff_VHunter_Leader_InCombat PrefabGuid(521682636)`
