---
title: TM_GemCrude_01_Stage0_Resource
guid: -1069591701
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_GemCrude_01_Stage0_Resource
...
- [Unity.Transforms.PostTransformMatrix](/components/PostTransformMatrix){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0f,  0f, 1.0001f, 0f, 0f,  0f, 0f, 1f, 0f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `DropTableGuid: DT_Resource_Vein_Gem_Destroy_T01 PrefabGuid(-1469889648)`
