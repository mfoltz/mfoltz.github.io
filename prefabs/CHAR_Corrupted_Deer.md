...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 49.810284`
  - `SpellPower: 49.810284`
  - `ResourcePower: 30.1`
  - `SiegePower: 18`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Forest_Deer PrefabGuid(725817843)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Corrupted_Deer PrefabGuid(897170906)`
