---
title: AB_Undead_Priest_Elite_RaiseDead_ChannelBuff
guid: -611324031
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_Priest_Elite_RaiseDead_ChannelBuff
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Priest_Elite_RaiseDead_Summon_Melee PrefabGuid(1907343961)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_Priest_Elite_RaiseDead_Summon_Ranged PrefabGuid(626506163)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
