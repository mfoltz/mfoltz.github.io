---
title: AB_ChurchOfLight_Overseer_IceRecovery_FreezeBuff
guid: 548966542
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ChurchOfLight_Overseer_IceRecovery_FreezeBuff
...
- [ProjectM.AbsorbCapStackModifier](/components/AbsorbCapStackModifier){:target="_blank"}
  - `BaseValue: 0`
  - `Modifier: 0.2`
...
- [ProjectM.DestroyBuffOnDamageTaken](/components/DestroyBuffOnDamageTaken){:target="_blank"}
  - `IncludeDoTs: False`

- [ProjectM.SetDynamicCollisionHardnessBuff](/components/SetDynamicCollisionHardnessBuff){:target="_blank"}
  - `Hardness: 1`
  - `Targets: ProjectM.SetDynamicCollisionHardnessBuffTargets Players, Units`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_ChurchOfLight_Overseer_IceRecovery_PostCast PrefabGuid(-1214567161)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 2116627954`
