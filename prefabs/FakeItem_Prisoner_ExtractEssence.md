---
title: FakeItem_Prisoner_ExtractEssence
guid: -911541799
categories: ['All', 'Fake']
nav_exclude: true
search_exclude: true
...
# FakeItem_Prisoner_ExtractEssence
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: FakeItem_Prisoner_ExtractEssence PrefabGuid(-911541799)`
...
- [DealDamageToPrisoner](/components/DealDamageToPrisoner){:target="_blank"}
  - `DealPercentualDamage_Min: 0.1`
  - `DealPercentualDamage_Max: 0.3`
  - `DealPercentualTorture_Min: 0.02`
  - `DealPercentualTorture_Max: 0.06`
