---
title: AB_WerewolfChieftain_ShadowDash_Clone_Cast
guid: -295839337
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_WerewolfChieftain_ShadowDash_Clone_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_WerewolfChieftain_ShadowDash_Clone_Cast PrefabGuid(-295839337)`
...
- **[0]**
  - `SpawnPrefab: AB_WerewolfChieftain_ShadowDash_Clone_Phase PrefabGuid(-2055451559)`
...
- **[0]**
  - `SpawnPrefab: AB_WerewolfCheiftain_ShadowDash_MaterialBuff PrefabGuid(-570236147)`
  - `BuffDuration: 0`
  - `Condition: None`
