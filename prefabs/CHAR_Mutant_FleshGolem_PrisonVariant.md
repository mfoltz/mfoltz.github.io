---
title: CHAR_Mutant_FleshGolem_PrisonVariant
guid: -1025552087
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Mutant_FleshGolem_PrisonVariant
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1472737467)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(-210606557)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(1821108694)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Mutant_FleshGolem PrefabGuid(663193340)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_MeleeAttack_AbilityGroup PrefabGuid(-736079997)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_Bulldoze_AbilityGroup PrefabGuid(340686786)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_Grab_AbilityGroup PrefabGuid(1459248190)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_Bulldoze_Scream_AbilityGroup PrefabGuid(-1766338327)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_BodySlam_AbilityGroup PrefabGuid(-79098693)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Mutant_FleshGolem_Grab_Followup_AbilityGroup PrefabGuid(-1485105952)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: Mutant_FleshGolem_Spawn_PoolJump PrefabGuid(290549683)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Mutant_Golem_PrisonVariant PrefabGuid(-916730493)`
