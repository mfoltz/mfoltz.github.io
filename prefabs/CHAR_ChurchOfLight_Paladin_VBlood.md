---
title: CHAR_ChurchOfLight_Paladin_VBlood
guid: -740796338
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 23`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_ChurchOfLight_Paladin_VBlood_Downed PrefabGuid(351185022)`
  - `TriggerSequence: SequenceGUID 425308879`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1475114753)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(2395673)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_ChurchOfLight_Paladin_VBlood PrefabGuid(-740796338)`
...
- [ProjectM.VBloodUnit](/components/VBloodUnit){:target="_blank"}
  ...
  - `UnlocksTrophyOnFeed: ProjectM.Trophy CompleteAct4`
  - `UnlocksTrophyOnFeedBrutal: ProjectM.Trophy BrutalCompleteAct4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_Paladin_VBlood PrefabGuid(433100409)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_Melee_AbilityGroup PrefabGuid(1673497547)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_Dash_AbilityGroup PrefabGuid(-1720407974)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_HolyBubble_Beam_AbilityGroup PrefabGuid(998464144)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_AngelicAscent_AbilityGroup PrefabGuid(-422683973)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_HolySpinners_AbilityGroup PrefabGuid(-1852467646)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_HolyFlackCannon_AbilityGroup PrefabGuid(834886466)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_SummonAngel_AbilityGroup PrefabGuid(1825130923)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_ChargedSwing_AbilityGroup PrefabGuid(922419960)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_CentreTravel_AbilityGroup PrefabGuid(1145861576)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_HealAngel_AbilityGroup PrefabGuid(-552723816)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_DivineRays_AbilityGroup PrefabGuid(51772774)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_Hard_Dash_AbilityGroup PrefabGuid(-1172099204)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Paladin_HolyFlackCannon_Hard_AbilityGroup PrefabGuid(699013677)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_ChurchOfLight_Paladin_FinalStageBuff PrefabGuid(2144624015)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 1`
  - `GameplayEventId: Local - 1829991382`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T08_Paladin PrefabGuid(-1627795309)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_ChurchOfLight_Paladin PrefabGuid(-158349491)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: Buff_ChurchOfLight_Paladin_Return PrefabGuid(-1435372081)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_Relic_Paladin_Unique PrefabGuid(-1629745461)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
