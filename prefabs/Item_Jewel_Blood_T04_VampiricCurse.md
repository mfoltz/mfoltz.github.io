...
# Item_Jewel_Blood_T04_VampiricCurse
...
- [ProjectM.JewelLevelSource](/components/JewelLevelSource){:target="_blank"}
  - `Level: 100`
...
- [ProjectM.Shared.JewelInstance](/components/JewelInstance){:target="_blank"}
