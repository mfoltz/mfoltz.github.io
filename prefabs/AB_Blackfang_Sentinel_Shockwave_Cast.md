---
title: AB_Blackfang_Sentinel_Shockwave_Cast
guid: -535619588
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Blackfang_Sentinel_Shockwave_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Blackfang_Sentinel_Shockwave_Cast PrefabGuid(-535619588)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Sentinel_Shockwave_Spinner PrefabGuid(1186910615)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Sentinel_Shockwave_Hit PrefabGuid(484664521)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
