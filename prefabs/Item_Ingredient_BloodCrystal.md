---
title: Item_Ingredient_BloodCrystal
guid: -1913156733
categories:
- All
- Item
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_BloodCrystal PrefabGuid(-1913156733)`
  - `DropItemPrefab: Resource_Drop_BloodCrystal PrefabGuid(-2134166369)`
