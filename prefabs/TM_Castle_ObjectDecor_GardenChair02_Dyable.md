---
title: TM_Castle_ObjectDecor_GardenChair02_Dyable
guid: 1020401996
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_Castle_ObjectDecor_GardenChair02_Dyable
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_ObjectDecor_GardenChair02_Dyable PrefabGuid(1020401996) - Entity(12174:3)`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_General_Sit_AbilityGroup PrefabGuid(-91023537)`
  - `Importance: 1`
