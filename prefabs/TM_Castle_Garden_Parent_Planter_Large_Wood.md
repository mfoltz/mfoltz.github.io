---
title: TM_Castle_Garden_Parent_Planter_Large_Wood
guid: -1132434077
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_Castle_Garden_Parent_Planter_Large_Wood
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Garden_Parent_Planter_Large_Wood PrefabGuid(-1132434077) - Entity(14075:3)`
...
- [PlacementLimitToSet](/components/PlacementLimitToSet){:target="_blank"}
  - `LimitToPrefabSet: Castle_Modules_Garden_Planter_Large PrefabGuid(-1843221037)`
