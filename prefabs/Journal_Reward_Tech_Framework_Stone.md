---
title: Journal_Reward_Tech_Framework_Stone
guid: -823914122
...
# Journal_Reward_Tech_Framework_Stone
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ackchfegcjc`
...
- [ProjectM.ProgressionBookRecipeElement](/components/ProgressionBookRecipeElement){:target="_blank"}
  - *(No fields)*

- [ProjectM.ProgressionBookTechElement](/components/ProgressionBookTechElement){:target="_blank"}

- **[0]**
  - `Tech: Tech_Collection_Framework_T02_Stone PrefabGuid(1908774048)`

- **[1]**
  - `Tech: Tech_Collection_Framework_T02_Stone_DLC_Dracula PrefabGuid(-447888984)`

- **[2]**
  - `Tech: Tech_Collection_Framework_T02_Stone_Halloween2022 PrefabGuid(-729522822)`

- **[3]**
  - `Tech: Tech_Collection_Framework_T02_Stone_DLC_Gloomrot PrefabGuid(-1485413430)`

- **[4]**
  - `Tech: Tech_Collection_Framework_T02_Stone_DLC_ProjectK PrefabGuid(763319653)`

- **[5]**
  - `Tech: Tech_Collection_Framework_T02_Stone_DLC_Strongblade PrefabGuid(-2146477131)`

- **[6]**
  - `Tech: Tech_Collection_Framework_Gargoyles_and_DLC PrefabGuid(-2118176472)`

- **[7]**
  - `Tech: Tech_Collection_Statues_Vampire PrefabGuid(192335890)`

- **[8]**
  - `Tech: Tech_Collection_BustStatues_Vampire PrefabGuid(-1045980026)`

- [ProjectM.ProgressionBookBlueprintElement](/components/ProgressionBookBlueprintElement){:target="_blank"}
  - *(No fields)*
...
- [ProjectM.ProgressionGain](/components/ProgressionGain){:target="_blank"}
  - *(No fields)*
