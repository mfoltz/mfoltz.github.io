---
title: AB_Legion_Vargulf_MaulKnockdown_StunBuff_Lesser
guid: 1772748887
categories:
- AB
- All
...
# AB_Legion_Vargulf_MaulKnockdown_StunBuff_Lesser
...
- [CreateEventOnHealthChangeAmount](/components/CreateEventOnHealthChangeAmount){:target="_blank"}
  - `TriggerEventId: Local - 1867353831`
  - `TriggerEventThreshold: 120`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cddffkihhh`
...
- [Script_Buff_Stealth_DataServer](/components/Script_Buff_Stealth_DataServer){:target="_blank"}
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Legion_Vargulf_MaulKnockdown_ChannelBuff_Lesser PrefabGuid(-1568733509)`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1867353831`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `PrimarySequenceGuid: SequenceGUID -355211509`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1568733509)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-398835659)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[2]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1942510877)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
