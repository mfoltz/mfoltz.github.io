---
title: AB_VampireMountAthleticDismount_Travel_Phase_01
guid: 506053449
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_VampireMountAthleticDismount_Travel_Phase_01
...
- [ProjectM.TravelBuffSpawn](/components/TravelBuffSpawn){:target="_blank"}
  ...
  - `MinDuration: 1`
  - `MaxDuration: 0.6`
  - `TravelTargetMode: ProjectM.TravelTargetMode AimPositionEntityInput`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_VampireMountAthleticDismount_Travel_End PrefabGuid(-1991455007)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Vampire_Horse_Severance_Buff PrefabGuid(-735669130)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(854656674)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-978792376)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[2]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-2000859158)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[3]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1936451181)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[4]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1627838818)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
