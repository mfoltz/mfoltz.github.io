---
title: Storm_Vampire_Buff_Static_Stun
guid: -1590232453
...
# Storm_Vampire_Buff_Static_Stun
...
- **[0]**
  - `SequenceGuid: SequenceGUID 145527821`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Storm_ConsumeStaticIntoStun PrefabGuid(1215957974)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Storm_ConsumeStaticIntoStun_Explode PrefabGuid(292333199)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 0`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget LifeTime_Duration`
  - `TargetIndex: -1`
