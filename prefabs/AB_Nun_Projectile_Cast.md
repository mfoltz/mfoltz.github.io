...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Nun_Projectile_Cast PrefabGuid(-1501966038)`
...
- **[0]**
  - `SpawnPrefab: AB_Nun_Projectile PrefabGuid(764919055)`
