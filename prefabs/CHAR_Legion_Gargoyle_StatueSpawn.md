---
title: CHAR_Legion_Gargoyle_StatueSpawn
guid: 280858720
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Legion_Gargoyle_StatueSpawn
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1967095783)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(1328126535)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  ...
  - `KnockbackRange: 0.5`
  - `WoundedKnockbackResistanceIndex: 3`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Gargoyle_StatueSpawn PrefabGuid(1122749186)`
...
- [ProjectM.CreateGameplayEventOnBehaviourStateChanged](/components/CreateGameplayEventOnBehaviourStateChanged){:target="_blank"}
...
- **[2]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Gargoyle_Return_Fly PrefabGuid(57563218)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 31225110`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[1]**
  - `Kind: ProjectM.SpawnBuffKind FromAbove`
  - `Buff: Buff_Gargoyle_Spawn_StoneForm PrefabGuid(1308173333)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_Legion_Normal_T02 PrefabGuid(1220995205)`
