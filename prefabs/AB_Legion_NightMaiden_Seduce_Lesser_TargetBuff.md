---
title: AB_Legion_NightMaiden_Seduce_Lesser_TargetBuff
guid: -1942510877
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Legion_NightMaiden_Seduce_Lesser_TargetBuff
...
- [ProjectM.CreateEventOnHealthChangeAmount](/components/CreateEventOnHealthChangeAmount){:target="_blank"}
  - `TriggerEventId: Local - 2128009801`
  - `TriggerEventThreshold: 40`
  - `IgnoreOwnerDamageSources: False`
  - `Triggered: False`
  - `DamageTaken: 0`
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag Fear`
  - `KeepOldest: False`
...
- [ProjectM.BuffModificationFlagData](/components/BuffModificationFlagData){:target="_blank"}
  - `ModificationTypes: 35184405643776`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ackjcijjifg`
...
- [ProjectM.CreateGameplayEventOnDistanceReached](/components/CreateGameplayEventOnDistanceReached){:target="_blank"}

- **[0]**
  - `DistanceSqThreshold: 4`
  - `TriggerWhen: ProjectM.CreateGameplayEventOnDistanceReachedTriggerWhen Closer`
  - `TriggerContinously: True`
  ...
  - `EventId: Local - 348166213`
  - `Entity0: ProjectM.GameplayEventTarget Owner`
  - `Entity1: ProjectM.GameplayEventTarget BuffTarget`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Legion_NightMaiden_Seduce_Lesser_ChannelingBuff PrefabGuid(-56075190)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Legion_NightMaiden_Seduce_Lesser_EndTargetBuff PrefabGuid(2063053331)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[2]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Legion_NightMaiden_Seduce_Lesser_TargetBuff_Delay PrefabGuid(1575793893)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 2128009801`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[3]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: External - 765195532`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[6]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 348166213`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-56075190)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- [ProjectM.MoveTowardsPositionBuff_PathElement](/components/MoveTowardsPositionBuff_PathElement){:target="_blank"}
  - *(No fields)*
