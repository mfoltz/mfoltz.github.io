---
title: AB_Militia_Scribe_InkFuel_InkTravelBuff
guid: -2098450523
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Scribe_InkFuel_InkTravelBuff
...
- [ProjectM.TravelBuffSpawn](/components/TravelBuffSpawn){:target="_blank"}
  ...
  - `MinDuration: 3.5`
  - `MaxDuration: 8`
  - `TravelTargetMode: ProjectM.TravelTargetMode OwnerPosition`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Militia_Scribe_InkFuel_ScribeFinishBuff PrefabGuid(1160005762)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Militia_Scribe_InkFuel_InkFinishBuff PrefabGuid(2088711774)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1947371829)`
