---
title: AB_Undead_Banshee_MorganaDash_Dash_Cast
guid: 2056013475
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_Banshee_MorganaDash_Dash_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Undead_Banshee_MorganaDash_Dash_Cast PrefabGuid(2056013475)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Banshee_MorganaDash_Dash_Phase PrefabGuid(1296363096)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_Banshee_MorganaDash_Dash_EffectBuff PrefabGuid(-151527278)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
