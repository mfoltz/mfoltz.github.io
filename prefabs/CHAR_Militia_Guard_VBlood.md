---
title: CHAR_Militia_Guard_VBlood
guid: -29797003
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Militia_Guard_VBlood_Downed PrefabGuid(-756124314)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-257184246)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Militia_Guard_VBlood PrefabGuid(-29797003)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Guard_VBlood PrefabGuid(1054288433)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_MeleeAttack_AbilityGroup PrefabGuid(-841402173)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_IceBoltsThrow_Group PrefabGuid(-1110188840)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_FrostShield_AbilityGroup PrefabGuid(308360499)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_IceBreaker_AbilityGroup PrefabGuid(-743963442)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_FrostNova_Group PrefabGuid(1624827356)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_IceBreakerInit_AbilityGroup PrefabGuid(1607170837)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_VBlood_IceBoltsThrow_Hard_Group PrefabGuid(-1634136571)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T04_FrostGuard PrefabGuid(627388312)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T04_FrostGuard_PrisonFramework PrefabGuid(1286356808)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Militia_Guard PrefabGuid(-1953643558)`
