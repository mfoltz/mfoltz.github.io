---
title: CHAR_Vampire_Dracula_VeilOfBatsIllusion
guid: 1809382006
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Vampire_Dracula_VeilOfBatsIllusion
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1609674788)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vampire_Dracula_VeilOfBatsIllusion PrefabGuid(441362636)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Vampire_Dracula_VeilOfBatsIllusion_EvolvedBuff PrefabGuid(-874481425)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1156449364`
