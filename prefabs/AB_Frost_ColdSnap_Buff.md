...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Frost_ColdSnap_Shield PrefabGuid(-557933420)`
...
- **[1]**
  ...
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `EntityOwner: ProjectM.SetEntityOwner Default`
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 0.5`
  - `Stacks: 1`
  - `Buff0: AB_Frost_ColdSnap_ImmaterialBuff PrefabGuid(2082543045)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 207521948`
...
- **[0]**
  - `SpawnPrefab: AB_Frost_ColdSnap_Area PrefabGuid(-1314524417)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_ColdSnap_Immaterial PrefabGuid(1616797198)`
