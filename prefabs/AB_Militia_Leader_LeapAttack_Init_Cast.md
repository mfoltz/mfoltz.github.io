---
title: AB_Militia_Leader_LeapAttack_Init_Cast
guid: -1006504748
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Leader_LeapAttack_Init_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Militia_Leader_LeapAttack_Init_Cast PrefabGuid(-1006504748)`
...
- **[0]**
  - `SpawnPrefab: Ab_Militia_Leader_LeapAttack_Init_Buff PrefabGuid(1185694153)`
...
- **[1]**
  - `SpawnPrefab: AB_Militia_Leader_LeapAttack_Init_Hit PrefabGuid(-1269635519)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
