---
title: AB_ApplyWeaponCoating_Illusion_AbilityGroup
guid: -1063090297
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ApplyWeaponCoating_Illusion_AbilityGroup
...
- [ProjectM.AbilityGroupConsumeItemOnCast](/components/AbilityGroupConsumeItemOnCast)
  - `ConsumableId: GUID Not Found`
  - `ItemEntity: Entity(0:0)`
...
- **ProjectM.WeaponCoating.StoredWeaponCoating**
  - `CoatingId: GUID Not Found`
...
- **[0]**
  - `PrefabGUID: AB_ApplyWeaponCoating_Illusion_Cast PrefabGuid(-237809887)`
