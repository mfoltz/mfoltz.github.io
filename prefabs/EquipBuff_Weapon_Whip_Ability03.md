---
title: EquipBuff_Weapon_Whip_Ability03
guid: -1414560949
...
# EquipBuff_Weapon_Whip_Ability03
...
- [ProjectM.WeaponLevel](/components/WeaponLevel){:target="_blank"}
  - `Level: 0`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_Vampire_Whip_HideAnimationWhip PrefabGuid(-1005561637)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(-1005561637)`
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Whip_Primary_AbilityGroup PrefabGuid(1752758196)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Whip_Dash_AbilityGroup PrefabGuid(1420346034)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Whip_Entangle_AbilityGroup PrefabGuid(-313732628)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
