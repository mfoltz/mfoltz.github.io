...
- [ProjectM.AmplifyBuff](/components/AmplifyBuff)
  - `AmplifyModifier: 0.01`

- [ProjectM.AmplifyStackModifier](/components/AmplifyStackModifier)
  - `BaseValue: 0.01`
  - `Modifier: 1`
...
- [ProjectM.WeakenBuff](/components/WeakenBuff)
  - `WeakenModifier: 0.005`

- [ProjectM.WeakenStackModifier](/components/WeakenStackModifier)
  - `BaseValue: 0.005`
  - `Modifier: 1`
...
- [ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataServer](/components/Script_GarlicAreaDebuff_DataServer)
  - `DynamicStacks: 0`
...
- [ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataShared](/components/Script_GarlicAreaDebuff_DataShared)
  - `IsInArea: False`
