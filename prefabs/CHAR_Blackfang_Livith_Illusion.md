---
title: CHAR_Blackfang_Livith_Illusion
guid: 1254601307
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Blackfang_Livith_Illusion
...
- **[1]**
  - `BuffTarget: ProjectM.ApplyBuffTarget MinionMaster`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `EntityOwner: ProjectM.SetEntityOwner Default`
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Livith_CloneNinjutsu_IllusionKilledBuff PrefabGuid(-548966732)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -797066368`
...
- [ProjectM.Gameplay.Scripting.Script_SetHealthToOwnerPercentage_DataServer](/components/Script_SetHealthToOwnerPercentage_DataServer){:target="_blank"}
  - *(No fields)*
