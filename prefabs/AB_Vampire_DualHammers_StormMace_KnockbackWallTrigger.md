---
title: AB_Vampire_DualHammers_StormMace_KnockbackWallTrigger
guid: 794780413
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_DualHammers_StormMace_KnockbackWallTrigger
...
- [ProjectM.Knockback](/components/Knockback){:target="_blank"}
  - `CanCastModId: Unset`
  - `CanMoveModId: Unset`
  - `Importance: 0`
  - `ApplyStun: False`
...
- [ProjectM.Gameplay.Scripting.Script_Knockback_Wall_Buff_DataServer](/components/Script_Knockback_Wall_Buff_DataServer){:target="_blank"}
  - `LastPosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `HitOffset: Unity.Mathematics.float3 float3(0f, 1f, 0f)`
  - `BuffDuration: 0.8`
  - `HitRadius: 1`
  - `BuffType: Buff_General_Incapacitate PrefabGuid(-211448091)`
