---
title: CHAR_Blackfang_PeonCarryingBarrel
guid: 1924724671
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Blackfang_PeonCarryingBarrel
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(316993000)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_Peon_Servant PrefabGuid(-39008356)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_PeonCarryingBarrel PrefabGuid(-1734299562)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_PeonCarryingBarrel_Melee_AbilityGroup PrefabGuid(596395337)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_PeonCarryingBarrel_CarryBarrel_AbilityGroup PrefabGuid(112453727)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_AbilityGroup PrefabGuid(-1869018808)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff2: AB_Blackfang_PeonCarryingBarrel_CarryBarrel_Buff PrefabGuid(1714696616)`
