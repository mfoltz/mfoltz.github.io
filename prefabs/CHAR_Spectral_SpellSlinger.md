---
title: CHAR_Spectral_SpellSlinger
guid: 2065149172
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1869651851)`
...
- [ProjectM.Script_ConfuseDummy_DataServer](/components/Script_ConfuseDummy_DataServer){:target="_blank"}
  - `DestroyOnCreatorDestroyed: False`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Spectral_SpellSlinger PrefabGuid(1908024378)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Spectral_SpellSlinger_Projectile_AbilityGroup PrefabGuid(-1298478938)`
  - `ShowOnBar: True`
...
- [ProjectM.Script_ConfuseDummy_BuffedEntitiesBuffer](/components/Script_ConfuseDummy_BuffedEntitiesBuffer){:target="_blank"}
  - *(No fields)*
...
- [ProjectM.GenerateAggroOnGameplayEvent](/components/GenerateAggroOnGameplayEvent){:target="_blank"}

- **[0]**
  - `From: ProjectM.AggroGameplayEventWho Self`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1087632285`
