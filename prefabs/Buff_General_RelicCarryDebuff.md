---
title: Buff_General_RelicCarryDebuff
guid: -714279777
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ShapeshiftImpairBuff](/components/ShapeshiftImpairBuff){:target="_blank"}
  - `FailKey: 7f69a9cd-5448-4493-b437-1768d193e277 - Blocked by soul shard`
  - `Condition: None`

- [ProjectM.AmplifyBuff](/components/AmplifyBuff){:target="_blank"}
  - `AmplifyModifier: 0.25`
...
- **[0]**
  ...
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag Shapeshift, Mount`
  - `IncludeSelf: False`
