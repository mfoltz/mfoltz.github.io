---
title: Buff_InCombat_Npc_Blackfang
guid: 1787445817
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyDynamicCollision_DataServer](/components/Script_Buff_ModifyDynamicCollision_DataServer){:target="_blank"}
  - `Targets: ProjectM.Gameplay.Scripting.ModifyDynamicCollisionTargets Units`
  - `Hardness: 0`
  - `PushStrengthMin: 0.3`
  - `PushStrengthMax: 1`
  - `AgainstPlayerMods: ProjectM.Gameplay.Scripting.Script_Buff_ModifyDynamicCollision_DataServer+Modifications ProjectM.Gameplay.Scripting.Script_Buff_ModifyDynamicCollision_DataServer+Modifications`
  - `AgainstUnitsMods: ProjectM.Gameplay.Scripting.Script_Buff_ModifyDynamicCollision_DataServer+Modifications ProjectM.Gameplay.Scripting.Script_Buff_ModifyDynamicCollision_DataServer+Modifications`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_General_WeaponCoatingRecharge PrefabGuid(981131442)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1815945310)`
...
- **[2]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(532646688)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
...
- [ProjectM.InCombatBuff](/components/InCombatBuff){:target="_blank"}
  - *(No fields)*

- [ProjectM.UseCombatAnimationState](/components/UseCombatAnimationState){:target="_blank"}
  - *(No fields)*
