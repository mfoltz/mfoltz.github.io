---
title: CHAR_ChurchOfLight_Sommelier_VBlood
guid: 192051202
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_ChurchOfLight_Sommelier_VBlood_Downed PrefabGuid(-2037971116)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1421383092)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_ChurchOfLight_Sommelier_VBlood PrefabGuid(192051202)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_Sommelier PrefabGuid(1662698420)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_MeleeHorizontal_AbilityGroup PrefabGuid(1078822594)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_HorizontalBarrel_AbilityGroup PrefabGuid(22199616)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_BloodBolt_AbilityGroup PrefabGuid(215933642)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_Flurry_AbilityGroup PrefabGuid(-1537007486)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_BarrelDance_AbilityGroup PrefabGuid(1074442576)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_BarrelFountain_AbilityGroup PrefabGuid(-616794756)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_MeleeSwing_AbilityGroup PrefabGuid(-1157907958)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_GroundStab_AbilityGroup PrefabGuid(1168210403)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Sommelier_HorizontalBarrel_Hard_AbilityGroup PrefabGuid(1129782597)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(467920537)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(38721678)`
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag None`
  - `IncludeSelf: False`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Sommelier PrefabGuid(2086705669)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T07_Sommelier_Bloodwine PrefabGuid(-797717364)`

- **[2]**
  - `Guid: Tech_Collection_VBlood_T07_Sommelier_MagicSource PrefabGuid(134700304)`

- **[3]**
  - `Guid: Tech_Collection_Fence_Rural PrefabGuid(1194397556)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Sommelier PrefabGuid(978693389)`
