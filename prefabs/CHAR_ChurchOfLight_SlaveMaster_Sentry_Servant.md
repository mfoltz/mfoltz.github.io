---
title: CHAR_ChurchOfLight_SlaveMaster_Sentry_Servant
guid: -442412464
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1352035587)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_SlaveMaster_Sentry_Servant PrefabGuid(-109653865)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_RangedAttack_AbilityGroup PrefabGuid(80712753)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_PistolFan_AbilityGroup PrefabGuid(97206555)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_SlaveMaster_KnockbackWhip_AbilityGroup PrefabGuid(-1879864480)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_SlaveMaster_Roll_AbilityGroup PrefabGuid(-1255881274)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
