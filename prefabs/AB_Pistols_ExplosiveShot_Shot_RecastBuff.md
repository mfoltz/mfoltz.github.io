---
title: AB_Pistols_ExplosiveShot_Shot_RecastBuff
guid: -246775707
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Pistols_ExplosiveShot_Shot_RecastBuff
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Pistols_ExplosiveShot_AbilityGroup PrefabGuid(66606146)`
  - `NewGroupId: AB_Pistols_ExplosiveShot_Shot_Recast_AbilityGroup PrefabGuid(1913579080)`
  - `Priority: 0`
  - `Condition: None`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Pistols_ExplosiveShot_DoubleBarrel PrefabGuid(1658350517)`
