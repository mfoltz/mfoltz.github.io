...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Blackfang_Striker_Servant PrefabGuid(-274383877)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(804798592)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_Striker PrefabGuid(470705829)`
...
- **[0]**
  ...
  - `Buff1: Buff_General_ChanceToCorruptBlood PrefabGuid(1524978405)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_StrongBlade_Rank02 PrefabGuid(2115747457)`
