---
title: CHAR_Blackfang_WoodCarver_Servant
guid: -2089362645
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1286702157)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Blackfang_WoodCarver_Servant PrefabGuid(1648366455)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_WoodCarver_Melee_AbilityGroup PrefabGuid(1074626555)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_WoodCarver_Drink_AbilityGroup PrefabGuid(-1472848281)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_WoodCarver_FuriousSwipes_AbilityGroup PrefabGuid(-1698228064)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_WoodCarver_CarveTree_AbilityGroup PrefabGuid(628133433)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: Buff_General_Spawn_VBlood_WorshippersOfMorgana PrefabGuid(746755827)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
