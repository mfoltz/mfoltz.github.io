---
title: AB_Undead_BishopOfShadows_Projectile_Hard_Cast
guid: 1827884481
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_BishopOfShadows_Projectile_Hard_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Undead_BishopOfShadows_Projectile_Hard_Cast PrefabGuid(1827884481)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_Projectile_Hard_Piercing01 PrefabGuid(1813631664)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_Projectile_Hard_Piercing02 PrefabGuid(1403025315)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Undead_BishopOfShadows_Projectile_Hard_Piercing03 PrefabGuid(278080905)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
