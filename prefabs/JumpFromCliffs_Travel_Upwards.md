...
- [JumpFromCliffsTravelBuffConstants](/components/JumpFromCliffsTravelBuffConstants){:target="_blank"}
  - `Height: 5`
  - `MaxSearchAngle: 90`
  - `LengthPerHeightCurve: Unity.Entities.BlobAssetReference`1[CurveBlobData] Unity.Entities.BlobAssetReference`1[CurveBlobData]`
  - `LengthPerSpeedCurve: Unity.Entities.BlobAssetReference`1[CurveBlobData] Unity.Entities.BlobAssetReference`1[CurveBlobData]`
  - `TimePerHeightCurve: Unity.Entities.BlobAssetReference`1[CurveBlobData] Unity.Entities.BlobAssetReference`1[CurveBlobData]`
