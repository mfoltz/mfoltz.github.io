...
- [Wallpaper_Synced_90](/components/Wallpaper_Synced_90){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [Wallpaper_Synced_180](/components/Wallpaper_Synced_180){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [Wallpaper_Synced_270](/components/Wallpaper_Synced_270){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`
...
- [CastleWallPillarImmaterial](/components/CastleWallPillarImmaterial){:target="_blank"}
...
- [CastleWallPillar](/components/CastleWallPillar){:target="_blank"}
  - *(No fields)*
