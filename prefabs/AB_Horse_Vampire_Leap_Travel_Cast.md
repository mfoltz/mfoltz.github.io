---
title: AB_Horse_Vampire_Leap_Travel_Cast
guid: 437005070
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Horse_Vampire_Leap_Travel_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Horse_Vampire_Leap_Travel_Cast PrefabGuid(437005070)`
...
- **[0]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Phase PrefabGuid(1693465568)`
...
- **[1]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Buff PrefabGuid(307775055)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
