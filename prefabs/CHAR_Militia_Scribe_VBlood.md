---
title: CHAR_Militia_Scribe_VBlood
guid: 1945956671
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 19.5`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Militia_Scribe_VBlood_Downed PrefabGuid(394037137)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-366014482)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Militia_Scribe_VBlood PrefabGuid(1945956671)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Scribe PrefabGuid(968212822)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_RangedAttack_AbilityGroup PrefabGuid(-186690512)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_RazorParchment_AbilityGroup PrefabGuid(2019689688)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_InkExplosion_AbilityGroup PrefabGuid(-592301846)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_InkFuel_AbilityGroup PrefabGuid(-1922948406)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_WhackAScribe_Travel_AbilityGroup PrefabGuid(-1008562275)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_CuttingParchment02_AbilityGroup PrefabGuid(-198012170)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_QuickAttack_AbilityGroup PrefabGuid(-1104025162)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Scribe_WhackAScribe_Init_AbilityGroup PrefabGuid(-1332977411)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_Scribe PrefabGuid(1096972300)`

- **[1]**
  - `Guid: Tech_Collection_Fence_Verdant PrefabGuid(-4950312)`

- **[2]**
  - `Guid: Tech_Collection_WallHangingShelves_T02 PrefabGuid(1738542265)`

- **[3]**
  - `Guid: Tech_Collection_VBlood_T04_Ball_Cosmetic PrefabGuid(-1140095741)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Militia_Scribe PrefabGuid(447801882)`
...
- **[2]**
  - `BuffGuid: Buff_Militia_Scribe_HideStaff PrefabGuid(2053361366)`
