...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1357441150)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_WormTerror PrefabGuid(-455838153)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_WormTerror_MeleeAttack_AbilityGroup PrefabGuid(1105185654)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_WormTerror_AcidPuke_AbilityGroup PrefabGuid(-1789897775)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_WormTerror_Dig_Travel_AbilityGroup PrefabGuid(1938535864)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[3]**
  - `BuffGuid: AB_WormTerror_Immaterial_Buff PrefabGuid(-1109086376)`
  - `State: ProjectM.GenericEnemyState Idle`

- [ProjectM.Shared.DropTableBuffer](/components/DropTableBuffer){:target="_blank"}

- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_Worm PrefabGuid(1676869781)`
