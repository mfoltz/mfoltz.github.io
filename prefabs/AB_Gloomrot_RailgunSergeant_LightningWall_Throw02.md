---
title: AB_Gloomrot_RailgunSergeant_LightningWall_Throw02
guid: 1340315458
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_RailgunSergeant_LightningWall_Throw02
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(1.5f, 0f, 5.5f)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_hbeefgbjc`
...
- **[0]**
  ...
  - `ImpactSequence: SequenceGUID 578766332`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_LightningWall_Object PrefabGuid(1407590180)`
