...
- [TechData](/components/TechData){:target="_blank"}
  - `Entity: Prefab Tech_Storage_Blood_T02 PrefabGuid(977509050) - Entity(21437:1)`
  - `Guid: Tech_Storage_Blood_T02 PrefabGuid(977509050)`
...
- **[0]**
  - `Guid: Item_Ingredient_Book_Structure_Storage_BloodCase_T02 PrefabGuid(-130369231)`
  - `Stacks: 1`
