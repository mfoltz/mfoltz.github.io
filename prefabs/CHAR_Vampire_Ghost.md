...
- [ProjectM.Equipment](/components/Equipment)
  - `WeaponLevel: 0`
  - `ArmorLevel: 0`
  - `SpellLevel: 0`
  - `WeaponRunCycle: 0`
...
- [ProjectM.CustomizationFeatures](/components/CustomizationFeatures)
  - `GenderIndex: 0`
  - `SkintoneIndex: 0`
  - `FaceIndex: 0`
  - `EyeColorIndex: 0`
...
- [ProjectM.EquipmentSetBuff](/components/EquipmentSetBuff)
