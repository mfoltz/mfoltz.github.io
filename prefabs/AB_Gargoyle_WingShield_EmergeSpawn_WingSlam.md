...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acikghjjgki`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Legion_Gargoyle_Relocate_Forward_Travel_Phase PrefabGuid(1419206335)`
...
- **[0]**
  - `ForceCastAbility: AB_Legion_Gargoyle_Relocate_Forward_Travel_AbilityGroup PrefabGuid(1741189817)`
