...
- [CastleBuildingAttachmentActiveBuffsBuffer](/components/CastleBuildingAttachmentActiveBuffsBuffer){:target="_blank"}
  - *(No fields)*

- [BuffBuffer](/components/BuffBuffer){:target="_blank"}
  - *(No fields)*

- [CastleBuildingAttachmentApplyBuff](/components/CastleBuildingAttachmentApplyBuff){:target="_blank"}
