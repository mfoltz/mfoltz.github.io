---
title: EquipBuff_Weapon_Reaper_Ability03
guid: -244154805
...
# EquipBuff_Weapon_Reaper_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Reaper_Primary_MeleeAttack_AbilityGroup PrefabGuid(784360484)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Reaper_TendonSwing_Twist_AbilityGroup PrefabGuid(-345652149)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Reaper_HowlingReaper_AbilityGroup PrefabGuid(1461754263)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
