...
- **ProjectM.CastleBuilding.CastleRoomWall**
...
- **ProjectM.Wallpaper_Synced_0**
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- **ProjectM.Wallpaper_Synced_180**
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- **ProjectM.WallpaperStyles**
...
- **ProjectM.CastleBuilding.WallRoofOrnament**
...
- **ProjectM.CastleBuilding.CastleWall**
  - *(No fields)*
