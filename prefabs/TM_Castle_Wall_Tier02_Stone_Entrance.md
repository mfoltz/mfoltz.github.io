...
- [CastleRoomWall](/components/CastleRoomWall){:target="_blank"}
...
- [Wallpaper_Synced_0](/components/Wallpaper_Synced_0){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [Wallpaper_Synced_180](/components/Wallpaper_Synced_180){:target="_blank"}
  - `Server: ProjectM.WallpaperDescription ProjectM.WallpaperDescription`

- [WallpaperStyles](/components/WallpaperStyles){:target="_blank"}
...
- [WallRoofOrnament](/components/WallRoofOrnament){:target="_blank"}
...
- [ImmaterialWhileRaided](/components/ImmaterialWhileRaided){:target="_blank"}
  - `BuffStateId: Unset`
  - `TileModelId: Unset`
...
- [AssetSwapColliderBuffer](/components/AssetSwapColliderBuffer){:target="_blank"}

- **[0]**
  - `AssetSwapConfig: Unity.Entities.BlobAssetReference`1[AssetSwapConfig] Unity.Entities.BlobAssetReference`1[AssetSwapConfig]`
...
- [CastleWall](/components/CastleWall){:target="_blank"}
  - *(No fields)*
...
- [AnnounceCastleBreached](/components/AnnounceCastleBreached){:target="_blank"}
  - *(No fields)*
