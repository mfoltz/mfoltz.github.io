---
title: AB_Wolf_Boss_Pounce_Phase
guid: 564871207
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.SpawnPrefabOnDestroy](/components/SpawnPrefabOnDestroy){:target="_blank"}
  - `SpawnPrefab: AB_Wolf_Boss_Pounce_EndPhase PrefabGuid(295888298)`
...
- [ProjectM.TravelBuffSpawn](/components/TravelBuffSpawn){:target="_blank"}
  - `TargetRangeOffset: -1.4`
  - `MinRange: 5`
  - `MaxRange: 11`
  - `RandomOffsetRadius: 0`
  - `MinDuration: 0.5`
  - `MaxDuration: 0.6`
  - `TravelTargetMode: ProjectM.TravelTargetMode OwnerTargetAimPosition`
