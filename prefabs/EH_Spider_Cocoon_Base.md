...
- [SpiderCocoon_DataShared](/components/SpiderCocoon_DataShared){:target="_blank"}
  - `SpawnChance: 0.25`
...
- [SpiderCocoonSpawns_DataServer](/components/SpiderCocoonSpawns_DataServer){:target="_blank"}
  - *(No fields)*
