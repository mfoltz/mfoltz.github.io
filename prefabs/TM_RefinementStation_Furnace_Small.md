---
title: TM_RefinementStation_Furnace_Small
guid: -1150411622
categories:
- All
- TM
...
# TM_RefinementStation_Furnace_Small
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_RefinementStation_Furnace_Small PrefabGuid(-1150411622) - Entity(41416:2)`
  - `Guid: TM_RefinementStation_Furnace_Small PrefabGuid(-1150411622)`
...
- [Refinementstation](/components/Refinementstation){:target="_blank"}
  ...
  - `ActiveSequenceGuid: SequenceGUID 1512352109`
  - `InactiveSequenceGuid: SequenceGUID 465330382`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 0f, -0.044f,  0f, 1f, 0f, 0f,  0f, 0f, -1f, 2.07f,  0f, 0f, 0f, 1f)`
...
- **[1]**
  - `PrefabGUID: Item_Ingredient_Mineral_CopperOre PrefabGuid(-1805325497)`
  - `Amount: 60`
