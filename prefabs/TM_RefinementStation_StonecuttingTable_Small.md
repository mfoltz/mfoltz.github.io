---
title: TM_RefinementStation_StonecuttingTable_Small
guid: -600683642
categories:
- All
- TM
...
# TM_RefinementStation_StonecuttingTable_Small
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_RefinementStation_StonecuttingTable_Small PrefabGuid(-600683642) - Entity(12099:3)`
  - `Guid: TM_RefinementStation_StonecuttingTable_Small PrefabGuid(-600683642)`
...
- [Refinementstation](/components/Refinementstation){:target="_blank"}
  ...
  - `ActiveSequenceGuid: SequenceGUID -559128395`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 0f, 0f,  0f, 1f, 0f, 0f,  0f, 0f, -1f, 1.859f,  0f, 0f, 0f, 1f)`
...
- **664 total elements but only showing the first 36**
  - *(No fields)*
...
- **[2]**
  - `PrefabGUID: Item_Ingredient_Whetstone PrefabGuid(1252507075)`
  - `Amount: 4`
...
- **39 total elements but only showing the first 36**
  - *(No fields)*
