---
title: FakeItem_FeedPrisoner_SwampDweller
guid: -314251399
categories:
- All
- Fake
...
# FakeItem_FeedPrisoner_SwampDweller
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: FakeItem_FeedPrisoner_SwampDweller PrefabGuid(-314251399)`
...
- [FeedPrisoner](/components/FeedPrisoner){:target="_blank"}
  - `RecoverHealth_Min: 0.1`
  - `RecoverHealth_Max: 1`
  - `RecoverMisery_Min: 0.2`
  - `RecoverMisery_Max: 0.4`
