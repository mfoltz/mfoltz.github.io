---
title: AB_Purifier_ScatterLob_Gateboss_Trigger
guid: -1033556590
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Purifier_ScatterLob_Gateboss_Trigger
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(-0.8f, 0f, 2.2f)`
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer){:target="_blank"}
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Purifier_ScatterLob_Gateboss_Projectile PrefabGuid(1838114950)`
