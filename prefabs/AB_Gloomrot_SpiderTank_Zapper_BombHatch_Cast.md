---
title: AB_Gloomrot_SpiderTank_Zapper_BombHatch_Cast
guid: 1602542447
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_SpiderTank_Zapper_BombHatch_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Gloomrot_SpiderTank_Zapper_BombHatch_Cast PrefabGuid(1602542447)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_BombHatch_TickBuff PrefabGuid(-425020231)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_BombHatch_PilotTrigger PrefabGuid(-953046129)`
  - `BuffDuration: 0`
  - `Condition: None`
