...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1573194738)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 56.453465`
  - `SpellPower: 56.453465`
  - `ResourcePower: 34.4`
  - `SiegePower: 16.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Cursed_ToadSpitter PrefabGuid(-1310611967)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadSpitter_Projectile_Group PrefabGuid(-2117925151)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_ToadSpitter_PoisonRain_AbilityGroup PrefabGuid(193936844)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Cursed_ToadSpitter PrefabGuid(-929463755)`
