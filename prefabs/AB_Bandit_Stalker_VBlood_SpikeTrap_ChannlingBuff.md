---
title: AB_Bandit_Stalker_VBlood_SpikeTrap_ChannlingBuff
guid: 1659131783
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Bandit_Stalker_VBlood_SpikeTrap_ChannlingBuff
...
- [ProjectM.Gameplay.Scripting.EvenSpreadCluster_Tick_DataServer](/components/EvenSpreadCluster_Tick_DataServer)
  - `OffsetAngle: 0`
  - `RandomAngle: 0.6981317`
  - `RotationPerTick: 1.0471976`
  - `Count: 10`
  - `TicksDone: 0`
  - `IndividualRandom: True`
  - `UseAimDirection: True`
  - `UseSelfRotation: False`
  - `UseAIReturnPosAsOrigo: True`
...
- **[0]**
  - `Value: AB_Bandit_Stalker_VBlood_SpikeTrap_ThrowShort PrefabGuid(849433643)`

- **[1]**
  - `Value: AB_Bandit_Stalker_VBlood_SpikeTrap_Throw PrefabGuid(-1312236901)`

- **[2]**
  - `Value: AB_Bandit_Stalker_VBlood_SpikeTrap_ThrowLong PrefabGuid(-1463258350)`
