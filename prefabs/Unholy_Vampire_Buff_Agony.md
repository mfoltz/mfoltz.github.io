...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -2143078663`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1149271910`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Unholy_ApplyAgony PrefabGuid(-1111601927)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Unholy_ApplyAgony_OnAttack PrefabGuid(-1103091347)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 0`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget DealDamageOnGameplayEvent_MainFactor`
  - `TargetIndex: 0`
