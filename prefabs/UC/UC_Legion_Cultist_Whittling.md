---
title: UC_Legion_Cultist_Whittling
nav_order: 1
parent: UC Prefabs
---

# UC_Legion_Cultist_Whittling

**Prefab GUID:** `1938887558`
...
- **[0]**
  - `Unit: CHAR_Vampire_Cultist_Whittling PrefabGuid(-19416663)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Vampire_Cultist_Whittling_Female PrefabGuid(-1925881340)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
