---
title: UC_Global_Carriage_Blackfang_Bastion
nav_order: 1
parent: UC Prefabs
---

# UC_Global_Carriage_Blackfang_Bastion

**Prefab GUID:** `26594244`
...
- **[0]**
  - `Unit: CHAR_CarriageHorse_BlackfangBastion PrefabGuid(731857280)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Blackfang_Sentinel PrefabGuid(1531777139)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
