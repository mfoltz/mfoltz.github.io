---
title: UC_CursedForest_Cultists_Medium
nav_order: 1
parent: UC Prefabs
---

# UC_CursedForest_Cultists_Medium

**Prefab GUID:** `2038582842`
...
- **[0]**
  - `Unit: CHAR_Cultist_Pyromancer PrefabGuid(2055824593)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Cultist_Slicer PrefabGuid(1807491570)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
