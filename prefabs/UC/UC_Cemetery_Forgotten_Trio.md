---
title: UC_Cemetery_Forgotten_Trio
nav_order: 1
parent: UC Prefabs
---

# UC_Cemetery_Forgotten_Trio

**Prefab GUID:** `624593046`
...
- **[1]**
  - `Unit: CHAR_Undead_ArmoredSkeletonCrossbow_Farbane PrefabGuid(-195077008)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[2]**
  - `Unit: CHAR_Undead_SkeletonApprentice PrefabGuid(-1789347076)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
...
- **[4]**
  - `Unit: CHAR_Undead_SkeletonSoldier_Armored_Farbane PrefabGuid(-837329073)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`
...
- **[6]**
  - `Unit: CHAR_Undead_Priest PrefabGuid(-1653554504)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
