---
title: UC_Bandits_General_SuperTrash_Single
nav_order: 1
parent: UC Prefabs
---

# UC_Bandits_General_SuperTrash_Single

**Prefab GUID:** `-2098437895`
...
- **[0]**
  - `Unit: CHAR_Bandit_Rascal PrefabGuid(-1194643220)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[1]**
  - `Unit: CHAR_Bandit_Scout PrefabGuid(1220569089)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`
