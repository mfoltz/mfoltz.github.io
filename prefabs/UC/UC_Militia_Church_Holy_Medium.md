---
title: UC_Militia_Church_Holy_Medium
nav_order: 1
parent: UC Prefabs
---

# UC_Militia_Church_Holy_Medium

**Prefab GUID:** `-297352795`
...
- **[0]**
  - `Unit: CHAR_Militia_Nun PrefabGuid(-700632469)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Militia_Devoted PrefabGuid(1660801216)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
...
- **[3]**
  - `Unit: CHAR_Farmlands_Villager_Female_Sister PrefabGuid(1772642154)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
