---
title: UC_Legion_Cultist_Patrolling
nav_order: 1
parent: UC Prefabs
---

# UC_Legion_Cultist_Patrolling

**Prefab GUID:** `-542818642`
...
- **[0]**
  - `Unit: CHAR_Vampire_Cultist_Patrolling PrefabGuid(2018586909)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Vampire_Cultist_Patrolling_Female PrefabGuid(-1610391169)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
