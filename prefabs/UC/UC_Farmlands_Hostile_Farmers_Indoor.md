---
title: UC_Farmlands_Hostile_Farmers_Indoor
nav_order: 1
parent: UC Prefabs
---

# UC_Farmlands_Hostile_Farmers_Indoor

**Prefab GUID:** `-1444744826`
...
- **[1]**
  - `Unit: CHAR_Farmlands_HostileVillager_Female_FryingPan PrefabGuid(729746981)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`
