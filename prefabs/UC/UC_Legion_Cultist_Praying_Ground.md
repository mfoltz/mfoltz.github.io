---
title: UC_Legion_Cultist_Praying_Ground
nav_order: 1
parent: UC Prefabs
---

# UC_Legion_Cultist_Praying_Ground

**Prefab GUID:** `-1633791438`
...
- **[0]**
  - `Unit: CHAR_Vampire_Cultist_PrayingGround PrefabGuid(-1832935107)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[1]**
  - `Unit: CHAR_Vampire_Cultist_PrayingGround_Female PrefabGuid(-2086433846)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`
