---
title: UC_Blackfang_Wildlife_Corrupted_Assault_CarverCamp
nav_order: 1
parent: UC Prefabs
---

# UC_Blackfang_Wildlife_Corrupted_Assault_CarverCamp

**Prefab GUID:** `2124515598`
...
- **[0]**
  - `Unit: CHAR_Corrupted_Wolf PrefabGuid(616274140)`
  - `IsVBloodUnit: False`
...
- **[5]**
  - `Unit: CHAR_Corrupted_Bear_Standard PrefabGuid(-1697944553)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Normal`

- **[6]**
  - `Unit: CHAR_Treant_Corrupted PrefabGuid(1496810447)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
