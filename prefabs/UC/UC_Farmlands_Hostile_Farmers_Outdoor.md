---
title: UC_Farmlands_Hostile_Farmers_Outdoor
nav_order: 1
parent: UC Prefabs
---

# UC_Farmlands_Hostile_Farmers_Outdoor

**Prefab GUID:** `706176529`
...
- **[0]**
  - `Unit: CHAR_Farmlands_HostileVillager_Male_Club PrefabGuid(-164116132)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[1]**
  - `Unit: CHAR_Farmlands_HostileVillager_Male_Shovel PrefabGuid(-864975423)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[2]**
  - `Unit: CHAR_Farmlands_HostileVillager_Female_Pitchfork PrefabGuid(1576267559)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`

- **[3]**
  - `Unit: CHAR_Farmlands_HostileVillager_Male_Torch PrefabGuid(-81727312)`
  - `IsVBloodUnit: False`
  - `CustomVBloodUnit: GUID Not Found`
  - `UnitBaseStatsType: ProjectM.UnitBaseStatsType Trash`
