---
title: AB_Vampire_VeilOfShadow_DashCast
guid: 1414033551
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_VeilOfShadow_DashCast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_VeilOfShadow_DashCast PrefabGuid(1414033551)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_VeilOfShadow_Buff PrefabGuid(924979264)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_VeilOfShadow_Immaterial PrefabGuid(-834088508)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
