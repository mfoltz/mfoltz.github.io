---
title: Item_Gloves_T08_DarkSilver_Rogue
nav_order: 1
parent: Item Prefabs
---

# Item_Gloves_T08_DarkSilver_Rogue

**Prefab GUID:** `-1752332712`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Prefab Item_Gloves_T08_DarkSilver_Rogue PrefabGuid(-1752332712) - Entity(60315:2)`
  - `ItemTypeGUID: Item_Gloves_T08_DarkSilver_Rogue PrefabGuid(-1752332712)`
...
- **ProjectM.EquippableData**
  ...
  - `EquipmentSet: SetBonus_T08_DarkSilver_Rogue PrefabGuid(-2006015924)`
...
- **ProjectM.Shared.Durability**
  ...
  - `RepairRecipe: Recipe_Armor_Gloves_T08_DarkSilver_Rogue PrefabGuid(894482163)`
