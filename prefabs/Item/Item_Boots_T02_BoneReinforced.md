---
title: Item_Boots_T02_BoneReinforced
nav_order: 1
parent: Item Prefabs
---

# Item_Boots_T02_BoneReinforced

**Prefab GUID:** `1241831522`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Prefab Item_Boots_T02_BoneReinforced PrefabGuid(1241831522) - Entity(60261:2)`
  - `ItemTypeGUID: Item_Boots_T02_BoneReinforced PrefabGuid(1241831522)`
...
- **ProjectM.EquippableData**
  ...
  - `EquipmentSet: SetBonus_T02_BoneguardReinforced PrefabGuid(1581003665)`
...
- **ProjectM.Shared.Durability**
  ...
  - `RepairRecipe: Recipe_Armor_Boots_T02_Bone_Reinforced PrefabGuid(785023263)`
  - `LossType: ProjectM.Shared.DurabilityLossType LossOnDamageTaken, LossOnDamageDealt`
