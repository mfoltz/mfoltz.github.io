...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_Gem_Miststone_T03 PrefabGuid(-1963826510)`
  - `DropItemPrefab: Resource_Drop_GemOpal_T03 PrefabGuid(1167189460)`
