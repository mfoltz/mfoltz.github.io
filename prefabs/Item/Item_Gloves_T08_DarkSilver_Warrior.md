---
title: Item_Gloves_T08_DarkSilver_Warrior
nav_order: 1
parent: Item Prefabs
---

# Item_Gloves_T08_DarkSilver_Warrior

**Prefab GUID:** `-1296203752`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Prefab Item_Gloves_T08_DarkSilver_Warrior PrefabGuid(-1296203752) - Entity(60309:2)`
  - `ItemTypeGUID: Item_Gloves_T08_DarkSilver_Warrior PrefabGuid(-1296203752)`
...
- **ProjectM.EquippableData**
  ...
  - `EquipmentSet: SetBonus_T08_DarkSilver_Warrior PrefabGuid(523774634)`
...
- **ProjectM.Shared.Durability**
  ...
  - `RepairRecipe: Recipe_Armor_Gloves_T08_DarkSilver_Warrior PrefabGuid(1193907705)`
