---
title: Item_Weapon_Axe_T02_Bone_Reinforced
nav_order: 1
parent: Item Prefabs
---

# Item_Weapon_Axe_T02_Bone_Reinforced

**Prefab GUID:** `-1391446205`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Axe_T02_Bone_Reinforced PrefabGuid(-1391446205) - Entity(52551:2)`
  - `ItemTypeGUID: Item_Weapon_Axe_T02_Bone_Reinforced PrefabGuid(-1391446205)`
...
- **ProjectM.EquippableData**
  - `BuffGuid: EquipBuff_Weapon_Axe_Ability01 PrefabGuid(1708326236)`
...
- **ProjectM.Shared.Durability**
  ...
  - `RepairRecipe: Recipe_Weapon_Axe_T02_Bone_Reinforced PrefabGuid(1031414138)`
