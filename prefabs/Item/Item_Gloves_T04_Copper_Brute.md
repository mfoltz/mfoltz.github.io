---
title: Item_Gloves_T04_Copper_Brute
nav_order: 1
parent: Item Prefabs
---

# Item_Gloves_T04_Copper_Brute

**Prefab GUID:** `-258808647`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Prefab Item_Gloves_T04_Copper_Brute PrefabGuid(-258808647) - Entity(60257:2)`
  - `ItemTypeGUID: Item_Gloves_T04_Copper_Brute PrefabGuid(-258808647)`
...
- **ProjectM.EquippableData**
  ...
  - `EquipmentSet: SetBonus_T04_Copper_Brute PrefabGuid(1121142849)`
...
- **ProjectM.Shared.Durability**
  ...
  - `RepairRecipe: Recipe_Armor_Gloves_T04_Copper_Brute PrefabGuid(928177888)`
