---
title: Item_Ingredient_Book_Floor_Library
nav_order: 1
parent: Item Prefabs
---

# Item_Ingredient_Book_Floor_Library

**Prefab GUID:** `-946177070`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_Book_Floor_Library PrefabGuid(-946177070)`
