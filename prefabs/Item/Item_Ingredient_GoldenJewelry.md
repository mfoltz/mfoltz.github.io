---
title: Item_Ingredient_GoldenJewelry
nav_order: 1
parent: Item Prefabs
---

# Item_Ingredient_GoldenJewelry

**Prefab GUID:** `-1749304196`
...
- **ProjectM.ItemData**
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_GoldenJewelry PrefabGuid(-1749304196)`
