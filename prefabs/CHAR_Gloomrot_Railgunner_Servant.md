---
title: CHAR_Gloomrot_Railgunner_Servant
guid: -1070366200
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1300154463)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Gloomrot_Railgunner_Servant PrefabGuid(505746425)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Railgunner_Snipe_AbilityGroup PrefabGuid(1779758273)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Railgunner_Cloak_AbilityGroup PrefabGuid(101220113)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Railgunner_WideShot_AbilityGroup PrefabGuid(286182923)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
