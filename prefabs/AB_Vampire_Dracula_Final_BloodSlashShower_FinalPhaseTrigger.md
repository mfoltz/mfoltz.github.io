---
title: AB_Vampire_Dracula_Final_BloodSlashShower_FinalPhaseTrigger
guid: 1051184823
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Dracula_Final_BloodSlashShower_FinalPhaseTrigger
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 0f, -8f)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_Final_BloodSlashShower_MainProjectile_01 PrefabGuid(-107896611)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_Final_BloodSlashShower_MainProjectile_02 PrefabGuid(725398701)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
