---
title: CHAR_ChurchOfLight_Lightweaver
guid: 1185952775
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(1476452791)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_ChurchOfLight_Lightweaver PrefabGuid(162424158)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Silver_Town_Rank03 PrefabGuid(162031204)`
