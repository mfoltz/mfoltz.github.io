---
title: CHAR_Militia_Fabian_VBlood
guid: 619948378
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- **ProjectM.UnitMounter**
  - `MaxAngleFromOwner: 3.1415927`
  - `UnitSpawnsMount: True`
  - `MountEntity: NetworkedEntity(0:0)`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Militia_Fabian_Downed PrefabGuid(1614390358)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(910768551)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Militia_Fabian_VBlood PrefabGuid(619948378)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cfbeffddf`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Fabian PrefabGuid(-1156763706)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Fabian_MountedSwing_Right_AbilityGroup PrefabGuid(-618550771)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Fabian_MountedSwing_Left_AbilityGroup PrefabGuid(-1379598377)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Fabian_Mountup_AbilityGroup PrefabGuid(-1623080868)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Fabian_CallLightning_AbilityGroup PrefabGuid(-409778117)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Fabian_LightningOrb_AbilityGroup PrefabGuid(1631838527)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Fabian_Mountup_SpawnMount PrefabGuid(1615695021)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T05_Fabian PrefabGuid(-1659396939)`

- **[1]**
  - `Guid: Tech_Collection_Stables_Furnishing PrefabGuid(2128476081)`
...
- **ProjectM.UnitMounterSharedBuffs**

- **[0]**
  - `BuffGuid: Buff_General_Spawn_VBlood_MidGame PrefabGuid(-184730451)`
...
- **[0]**
  - `BuffGuid: Buff_Militia_Fabian_InCombat PrefabGuid(-898392533)`
