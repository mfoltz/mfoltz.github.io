...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_MountainBeast_Enrage_Travel_Cast PrefabGuid(-1777058490)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_Enrage_Travel_Phase PrefabGuid(675891131)`
