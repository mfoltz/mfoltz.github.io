---
title: AB_Vampire_Spear_Harpoon_Throw_Cast
guid: 414243770
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Spear_Harpoon_Throw_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Spear_Harpoon_Throw_Cast PrefabGuid(414243770)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Spear_Harpoon_Throw_Projectile PrefabGuid(1649391651)`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Spear_Harpoon_DragSelf PrefabGuid(2065538060)`
...
- **[1]**
  ...
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 3`
  - `Target: ProjectM.Shared.SpellModArithmeticModifiableTarget AbilityMoveDuringCastData_Duration`
  - `TargetIndex: 0`
