---
title: AB_Monster_LightningSlam_LiftOff_Cast
guid: 747401276
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Monster_LightningSlam_LiftOff_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Monster_LightningSlam_LiftOff_Cast PrefabGuid(747401276)`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_LightningSlam_LiftOff_Phase PrefabGuid(817492469)`
...
- **[1]**
  - `SpawnPrefab: AB_Monster_LightningSlam_AreaKnockback PrefabGuid(620098819)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
