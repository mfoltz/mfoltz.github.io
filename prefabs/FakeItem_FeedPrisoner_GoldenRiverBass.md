---
title: FakeItem_FeedPrisoner_GoldenRiverBass
guid: -684874624
categories: ['All', 'Fake']
nav_exclude: true
search_exclude: true
...
# FakeItem_FeedPrisoner_GoldenRiverBass
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: FakeItem_FeedPrisoner_GoldenRiverBass PrefabGuid(-684874624)`
...
- [FeedPrisoner](/components/FeedPrisoner){:target="_blank"}
  - `RecoverHealth_Min: 0.8`
  - `RecoverHealth_Max: 1`
  - `RecoverMisery_Min: 0.15`
