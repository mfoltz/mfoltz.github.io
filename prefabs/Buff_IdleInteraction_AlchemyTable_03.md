---
title: Buff_IdleInteraction_AlchemyTable_03
guid: 887057265
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
# Buff_IdleInteraction_AlchemyTable_03
...
- **ProjectM.IdleInteractionBuff**
  - `PointIndex: 0`
  - `Interaction: ProjectM.IdleInteractionId ProjectM.IdleInteractionId`
  - `InteractionTilePosition: Unity.Mathematics.int2 int2(0, 0)`
  - `InteractionEntity_Client: Entity(0:0)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_aihjdhidkb`
