---
title: TM_CraftingStation_Smithy
guid: -1840926436
categories:
- All
- TM
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_Smithy PrefabGuid(-1840926436) - Entity(7173:3)`
  - `Guid: TM_CraftingStation_Smithy PrefabGuid(-1840926436)`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 6.55651E-07f, -0.501f,  0f, 1f, 0f, 0.174f,  -6.55651E-07f, 0f, -1f, 1.089f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `RecipeGuid: Recipe_Weapon_Sword_T05_Iron PrefabGuid(-2098625697)`

- **[1]**
  - `RecipeGuid: Recipe_Weapon_Axe_T05_Iron PrefabGuid(305819079)`

- **[2]**
  - `RecipeGuid: Recipe_Weapon_Mace_T05_Iron PrefabGuid(-612459251)`

- **[3]**
  - `RecipeGuid: Recipe_Weapon_Spear_T05_Iron PrefabGuid(239811022)`

- **[4]**
  - `RecipeGuid: Recipe_Weapon_Reaper_T05_Iron PrefabGuid(1109951557)`

- **[5]**
  - `RecipeGuid: Recipe_Weapon_Slashers_T05_Iron PrefabGuid(-808348493)`

- **[6]**
  - `RecipeGuid: Recipe_Weapon_Crossbow_T05_Iron PrefabGuid(1268051742)`

- **[7]**
  - `RecipeGuid: Recipe_Weapon_Longbow_T05_Iron PrefabGuid(-80393444)`

- **[8]**
  - `RecipeGuid: Recipe_Weapon_GreatSword_T05_Iron PrefabGuid(1731901666)`

- **[9]**
  - `RecipeGuid: Recipe_Weapon_Daggers_T05_Iron PrefabGuid(908837210)`

- **[10]**
  - `RecipeGuid: Recipe_Weapon_TwinBlades_T05_Iron PrefabGuid(-496801516)`

- **[11]**
  - `RecipeGuid: Recipe_Weapon_Claws_T05_Iron PrefabGuid(-1520452495)`

- **[12]**
  - `RecipeGuid: Recipe_Weapon_Pistols_T05_Iron PrefabGuid(1314793960)`

- **[13]**
  - `RecipeGuid: Recipe_Weapon_Whip_T05_Iron PrefabGuid(688528978)`

- **[14]**
  - `RecipeGuid: Recipe_Weapon_Sword_T06_Iron_Reinforced PrefabGuid(-1052674868)`

- **[15]**
  - `RecipeGuid: Recipe_Weapon_Axe_T06_Iron_Reinforced PrefabGuid(690858507)`

- **[16]**
  - `RecipeGuid: Recipe_Weapon_Mace_T06_Iron_Reinforced PrefabGuid(-1538728965)`

- **[17]**
  - `RecipeGuid: Recipe_Weapon_Spear_T06_Iron_Reinforced PrefabGuid(-499925914)`

- **[18]**
  - `RecipeGuid: Recipe_Weapon_Reaper_T06_Iron_Reinforced PrefabGuid(537685806)`

- **[19]**
  - `RecipeGuid: Recipe_Weapon_Slashers_T06_Iron_Reinforced PrefabGuid(1469893872)`

- **[20]**
  - `RecipeGuid: Recipe_Weapon_Crossbow_T06_Iron_Reinforced PrefabGuid(1341382268)`

- **[21]**
  - `RecipeGuid: Recipe_Weapon_Longbow_T06_Iron_Reinforced PrefabGuid(-149592989)`

- **[22]**
  - `RecipeGuid: Recipe_Weapon_GreatSword_T06_Iron_Reinforced PrefabGuid(648459378)`

- **[23]**
  - `RecipeGuid: Recipe_Weapon_Daggers_T06_Iron_Reinforced PrefabGuid(-328931595)`

- **[24]**
  - `RecipeGuid: Recipe_Weapon_TwinBlades_T06_Iron_Reinforced PrefabGuid(1687058710)`

- **[25]**
  - `RecipeGuid: Recipe_Weapon_Claws_T06_Iron_Reinforced PrefabGuid(-1690827442)`

- **[26]**
  - `RecipeGuid: Recipe_Weapon_Pistols_T06_Iron_Reinforced PrefabGuid(-1015239074)`

- **[27]**
  - `RecipeGuid: Recipe_Weapon_Whip_T06_Iron_Reinforced PrefabGuid(465080212)`

- **[28]**
  - `RecipeGuid: Recipe_Ingredient_CastleKey_T03 PrefabGuid(690675608)`
