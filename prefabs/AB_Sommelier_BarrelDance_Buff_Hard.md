---
title: AB_Sommelier_BarrelDance_Buff_Hard
guid: 38721678
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Sommelier_BarrelDance_Buff_Hard
...
- [ProjectM.Gameplay.Scripting.Script_SommelierBarrelDance_DataServer](/components/Script_SommelierBarrelDance_DataServer){:target="_blank"}
  - `SpawnEntity: AB_Sommelier_HorizontalBarrel_Hard_Projectile PrefabGuid(673647636)`
  - `Amount: 50`
  - `Spacing: 2.5`
  - `DelayBetween_Min: 0.01`
  - `DelayBetween_Max: 0.05`
  - `RoomSizeOffset: 14`
  - `Timer: 0`
