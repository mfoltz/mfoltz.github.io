---
title: CHAR_Gloomrot_AceIncinerator_Servant
guid: -1897484769
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BuffResistances](/components/BuffResistances)
  ...
  - `InitialSettingGuid: BuffResistance_IgniteResistant PrefabGuid(-992427880)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1333543242)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Gloomrot_AceIncinerator_Servant PrefabGuid(-485884150)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_AceIncinerator_FlameShot_AbilityGroup PrefabGuid(-297165667)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_AceIncinerator_CarpetIncineration_AbilityGroup PrefabGuid(-1954926268)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_AceIncinerator_FlameSpreader_AbilityGroup PrefabGuid(-1462866563)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
