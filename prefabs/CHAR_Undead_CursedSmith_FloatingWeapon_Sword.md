---
title: CHAR_Undead_CursedSmith_FloatingWeapon_Sword
guid: -2020619708
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `CircleChangeDirectionFrequencyMax: 16`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-968957939)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cjidihkkgf`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_CursedSmith_FloatingWeapon_Base PrefabGuid(-1408876099)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingSword_MeleeAttack_AbilityGroup PrefabGuid(1323999965)`
  - `ShowOnBar: True`
...
- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_FloatingSword_DashAttack_AbilityGroup PrefabGuid(-1058201566)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Undead_CursedSmith_FloatingWeapon_Hard_StatBoost PrefabGuid(1672630457)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 2110906012`
