---
title: AB_Manticore_ChaosBreath_Trigger2
guid: 1534857464
categories:
- AB
- All
...
# AB_Manticore_ChaosBreath_Trigger2
...
- **[0]**
  - `SpawnPrefab: AB_Manticore_ChaosBreath_Projectile_Fast PrefabGuid(856076233)`
...
- **[1]**
  - `SpawnPrefab: AB_Manticore_ChaosBreath_Projectile_Slow PrefabGuid(-1758744546)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
