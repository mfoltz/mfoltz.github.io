---
title: TM_Relic_SoulShard_Manticore
guid: 4777796
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Relic_SoulShard_Manticore PrefabGuid(4777796) - Entity(41493:2)`
  - `Guid: TM_Relic_SoulShard_Manticore PrefabGuid(4777796)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ihgjfjkdk`
...
- [ProjectM.Shared.Relic](/components/Relic){:target="_blank"}
...
- **[0]**
  - `Entity: Prefab GUID Not Found - Entity(11953:3)`
  - `BlobIndex: 9`
...
- **[0]**
  - `Value: Prefab TM_Relic_SoulShard_Manticore PrefabGuid(4777796) - Entity(41493:2)`

- **[1]**
  - `Value: Prefab GUID Not Found - Entity(11953:3)`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseRelic_Manticore_AbilityGroup PrefabGuid(-2054010438)`
  - `Importance: 1`
...
��b���@  `
  - `ConditionalElements`
  - `Ability: AB_Interact_RetrieveRelic_AbilityGroup PrefabGuid(1654467658)`
  - `Importance: 1`
  - `HideInteractHUDWhileCasting: False`
...
- **[0]**
  - `PrefabGUID: Item_Building_Relic_Manticore PrefabGuid(-222860772)`
  - `Amount: 1`

- [ProjectM.AttachMapIconsToEntity](/components/AttachMapIconsToEntity){:target="_blank"}

- **[0]**
  - `Prefab: MapIcon_Relic_Standard_WingedHorror PrefabGuid(622223699)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Relic_Manticore PrefabGuid(-2091539428)`
...
- [ProjectM.Shared.DropTableOnDestroy](/components/DropTableOnDestroy){:target="_blank"}
  - *(No fields)*
