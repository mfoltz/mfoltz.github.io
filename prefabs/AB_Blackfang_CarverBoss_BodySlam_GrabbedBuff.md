---
title: AB_Blackfang_CarverBoss_BodySlam_GrabbedBuff
guid: 957938484
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Blackfang_CarverBoss_BodySlam_GrabbedBuff
...
- [ProjectM.BuffCategory](/components/BuffCategory){:target="_blank"}
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag Knockback, Grab`
  - `KeepOldest: False`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_GrabToOwner_DataServer](/components/Script_Buff_GrabToOwner_DataServer){:target="_blank"}
  - `PositionOffset: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `Offset: 1.5`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_CarverBoss_BodySlam_PinBuff PrefabGuid(434680966)`
...
- [ProjectM.GrabBuff](/components/GrabBuff){:target="_blank"}
  - *(No fields)*
