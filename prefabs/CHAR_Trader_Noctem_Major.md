---
title: CHAR_Trader_Noctem_Major
guid: 1631713257
categories:
- All
- CHAR
...
- [CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1982843701)`
...
- [BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Trader_Noctem_Major PrefabGuid(-1999051184)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Noctem_Trader_Attack_AbilityGroup PrefabGuid(-1981491221)`
  - `ShowOnBar: True`
...
- **[2]**
  - `BuffGuid: Buff_Noctem_Trader_IdleBuff PrefabGuid(-1516516418)`
