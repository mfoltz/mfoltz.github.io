---
title: CHAR_Legion_NightMaiden_Lesser_Servant
guid: -1099047820
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-467026945)`
...
- [ProjectM.ServantTypeData](/components/ServantTypeData)
  ...
  - `GenderType: ProjectM.GenderType Female`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 62.989914`
  - `SpellPower: 62.989914`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Legion_NightMaiden_Lesser_Servant PrefabGuid(1881256503)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_NightMaiden_WhipTwirl_AbilityGroup PrefabGuid(-324538848)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_NightMaiden_Seduce_Lesser_AbilityGroup PrefabGuid(1941093851)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Legion_NightMaiden_EvadeGlide_Travel_AbilityGroup PrefabGuid(-2036638378)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Legion_NightMaiden_EvadeGlideInit_AbilityGroup PrefabGuid(951198708)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Nightmaiden_JumpBackward_AbilityGroup PrefabGuid(-1262881470)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_NightMaiden_MeleeAttack_AbilityGroup PrefabGuid(175670852)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
