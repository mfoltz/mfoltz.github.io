...
- [Script_CreateGameplayEventOnAreaEnterExit_DataServer](/components/Script_CreateGameplayEventOnAreaEnterExit_DataServer){:target="_blank"}
  - `Radius: 8`
...
- [Script_CreateGameplayEventOnAreaEnterExit_Entry](/components/Script_CreateGameplayEventOnAreaEnterExit_Entry){:target="_blank"}
  - *(No fields)*
