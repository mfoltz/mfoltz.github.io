---
title: TM_SpecialStation_ArenaFlag_04_Purple
guid: 1513357066
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
# TM_SpecialStation_ArenaFlag_04_Purple
...
- **ProjectM.Contest.Arena.CastleArenaFlag_Server**
  - `Team: 4`
  - `ConnectedArenaStation: Entity(0:0)`
  - `FlagJoinBuffPrefabGuid: AB_Interact_ArenaFlag_Team04_Buff PrefabGuid(450184126)`
  - `FlagLeavingAreaBuffPrefabGuid: Buff_Arena_LeavingArea PrefabGuid(-274872479)`

- [ProjectM.BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_ArenaFlag_04_Purple PrefabGuid(1513357066) - Entity(41252:2)`
  - `Guid: TM_SpecialStation_ArenaFlag_04_Purple PrefabGuid(1513357066)`
...
- **ProjectM.Contest.Arena.CastleArenaStationRuleObject**
  - `ArenaStationEntity: Entity(0:0)`
  - `MaxCount: 8`
...
- **ProjectM.Contest.Arena.CastleArenaFlag_Shared**
  - `OccupiedSlots: 0`
  - `ContestStatus: ProjectM.Contest.ContestStatus Inactive`
  - `SlotsBlob: Unity.Entities.BlobAssetReference`1[ProjectM.Contest.Arena.CastleArenaFlagSlotsBlob] Unity.Entities.BlobAssetReference`1[ProjectM.Contest.Arena.CastleArenaFlagSlotsBlob]`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ckdjhidigg`
...
- **ProjectM.Contest.Arena.CastleArenaFlagParticipant**
  - *(No fields)*
...
��  �.`
  - `ConditionalElements`
  - `Ability: AB_Interact_ArenaFlag_Leave_AbilityGroup PrefabGuid(-312796240)`
  - `Importance: 1`
...
��  �.`
  - `ConditionalElements`
  - `Ability: AB_Interact_ArenaFlag_Team04_AbilityGroup PrefabGuid(919946085)`
  - `Importance: 0`
  - `HideInteractHUDWhileCasting: False`
...
- [ProjectM.CastleBuilding.Rebuilding.CastleRebuildHiddenTag](/components/CastleRebuildHiddenTag){:target="_blank"}
  - *(No fields)*
