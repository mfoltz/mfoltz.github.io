...
- **ProjectM.Contest.Arena.CastleArenaFlag_Shared**
  ...
  - `SlotsBlob: Unity.Entities.BlobAssetReference`1[CastleArenaFlagSlotsBlob] Unity.Entities.BlobAssetReference`1[CastleArenaFlagSlotsBlob]`
...
- [CastleRebuildHiddenTag](/components/CastleRebuildHiddenTag){:target="_blank"}
  - *(No fields)*
