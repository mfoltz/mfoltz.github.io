---
title: AB_Cursed_ToadSpitter_PoisonRain_Cast
guid: 280831224
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Cursed_ToadSpitter_PoisonRain_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_ToadSpitter_PoisonRain_Cast PrefabGuid(280831224)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiThrow_Cast_DataServer](/components/Script_MultiThrow_Cast_DataServer){:target="_blank"}
  ...
  - `OffsetAngle: 0`
  - `RandomAngle: 0`
  - `NewThrowEntity: AB_Cursed_ToadSpitter_PoisonRain_Throw PrefabGuid(633294112)`
  - `Count: 3`
