---
title: CHAR_Legion_BatSwarm_Lesser
guid: -1055380229
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1667362368)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 37.438232`
  - `SpellPower: 37.438232`
  - `ResourcePower: 25.15`
  - `SiegePower: 15`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_BatSwarm PrefabGuid(-843205201)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_BatSwarm_Melee_AbilityGroup PrefabGuid(5164221)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_BatSwarm_BehaviourVariationApproch_Group PrefabGuid(-292632051)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_BatSwarm_BehaviourVariationCircleClose_Group PrefabGuid(1493606342)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_BatSwarm_BehaviourVariationCircleMid_Group PrefabGuid(417450031)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_BatSwarm_BehaviourVariationCircleFar_Group PrefabGuid(1407801281)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
