---
title: ScrollingCombatTextMessage
guid: -1661525964
...
- [ProjectM.ScrollingCombatTextMessage](/components/ScrollingCombatTextMessage){:target="_blank"}
  - `Position: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `OverrideColor: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
  - `Value: 0`
  - `OverrideLocalizedText: Il2CppSystem.Guid 00000000-0000-0000-0000-000000000000`
  - `Type: GUID Not Found`
  - `Source: NetworkedEntity(0:0)`
  - `SourceObjectType: GUID Not Found`
  - `BloodQuality: 0`
  - `Target: NetworkedEntity(0:0)`
  - `OverrideText: Unity.Collections.FixedString512Bytes`
  - `CreateTime: 0`
  - `ShowForAll: False`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_idjfhgckc`
