---
title: AB_Gloomrot_SpiderTank_Gattler_BombHatch_Cast
guid: 600234590
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_SpiderTank_Gattler_BombHatch_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Gloomrot_SpiderTank_Gattler_BombHatch_Cast PrefabGuid(600234590)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Gattler_BombHatch_TickBuff PrefabGuid(1032571050)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Gattler_BombHatch_PilotTrigger PrefabGuid(30671144)`
  - `BuffDuration: 0`
  - `Condition: None`
