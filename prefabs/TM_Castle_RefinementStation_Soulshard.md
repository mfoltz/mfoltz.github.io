---
title: TM_Castle_RefinementStation_Soulshard
guid: 1794206684
categories:
- All
- TM
...
# TM_Castle_RefinementStation_Soulshard
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_RefinementStation_Soulshard PrefabGuid(1794206684) - Entity(30272:4)`
  - `Guid: TM_Castle_RefinementStation_Soulshard PrefabGuid(1794206684)`
...
- [Refinementstation](/components/Refinementstation){:target="_blank"}
  ...
  - `InventoryPrefabGuid: Refinementstation_Inventory_Soulshard PrefabGuid(-1814907421)`
...
- **[0]**
  - `Entity: Prefab GUID Not Found - Entity(11951:3)`
  - `BlobIndex: 2`
...
- **[0]**
  - `Value: Prefab TM_Castle_RefinementStation_Soulshard PrefabGuid(1794206684) - Entity(30272:4)`

- **[1]**
  - `Value: Prefab GUID Not Found - Entity(11951:3)`
...
- **61 total elements but only showing the first 36**
  - *(No fields)*
