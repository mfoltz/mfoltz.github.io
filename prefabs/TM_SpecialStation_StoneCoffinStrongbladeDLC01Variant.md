---
title: TM_SpecialStation_StoneCoffinStrongbladeDLC01Variant
guid: 18293671
categories:
- All
- TM
...
- [Residency](/components/Residency){:target="_blank"}
  - `InsideBuff: AB_Interact_GetInside_Owner_Buff_Stone PrefabGuid(569692162)`
  - `Resident: Entity(0:0)`

- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_StoneCoffinStrongbladeDLC01Variant PrefabGuid(18293671) - Entity(12179:3)`
  - `Guid: TM_SpecialStation_StoneCoffinStrongbladeDLC01Variant PrefabGuid(18293671)`
...
- [RespawnPoint](/components/RespawnPoint){:target="_blank"}
  ...
  - `SpawnDelayBuff: AB_Interact_StoneCoffinSpawn_Travel_Delay PrefabGuid(1290990039)`
  - `SpawnSleepingBuff: AB_Interact_CoffinSleeping PrefabGuid(845443603)`
  - `RespawnPointType: ProjectM.RespawnPointType StoneCoffin`
...
- [CastleWorkstation](/components/CastleWorkstation){:target="_blank"}
  - `MatchingFloorType: ProjectM.CastleBuilding.CastleFloorTypes Hallway`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acdhgjfedcg`
...
- **[0]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_BindCoffin_Stone_AbilityGroup PrefabGuid(-1020324236)`
  - `Importance: 0`
...
- **[1]**
  ...
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_Interact_GetInside_AbilityGroup_Stone PrefabGuid(1335616296)`
  - `Importance: 0`
  - `HideInteractHUDWhileCasting: False`
...
- **[1]**
  - `PrefabGUID: Item_Ingredient_Gravedust PrefabGuid(-608131642)`
  - `Amount: 4`

- **[2]**
  - `PrefabGUID: Item_Ingredient_Gem_Amethyst_T01 PrefabGuid(225530658)`
  - `Amount: 2`

- [ProgressionDependencyElement](/components/ProgressionDependencyElement){:target="_blank"}

- **[0]**
  - `PrefabGuid: TM_SpecialStation_StoneCoffinDLC01Variant PrefabGuid(-750982654)`

- **[1]**
  - `PrefabGuid: TM_SpecialStation_StoneCoffinDLC02Variant PrefabGuid(-390082555)`

- **[2]**
  - `PrefabGuid: TM_SpecialStation_StoneCoffinProjectKVariant PrefabGuid(-1746633144)`

- **[3]**
  - `PrefabGuid: TM_SpecialStation_StoneCoffinStrongbladeDLC01Variant PrefabGuid(18293671)`

- [AttachMapIconsToEntity](/components/AttachMapIconsToEntity){:target="_blank"}

- **[0]**
  - `Prefab: MapIcon_StoneCoffin PrefabGuid(985620050)`
