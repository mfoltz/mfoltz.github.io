---
title: AB_Vampire_Slashers_ElusiveStrike_Dash_Cast
guid: -1731625958
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Slashers_ElusiveStrike_Dash_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Slashers_ElusiveStrike_Dash_Cast PrefabGuid(-1731625958)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Slashers_ElusiveStrike_Dash_PhaseOut PrefabGuid(1109256146)`
...
- **[1]**
  - `SpawnPrefab: Buff_General_Immaterial PrefabGuid(227784838)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
