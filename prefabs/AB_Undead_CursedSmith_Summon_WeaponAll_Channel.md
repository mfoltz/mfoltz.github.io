---
title: AB_Undead_CursedSmith_Summon_WeaponAll_Channel
guid: 29874824
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Undead_CursedSmith_Summon_WeaponAll_Channel
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_Summon_WeaponSword_Trigger PrefabGuid(856838433)`
...
- **[1]**
  - `SpawnPrefab: AB_Undead_CursedSmith_Summon_WeaponMace_Trigger PrefabGuid(-1487130754)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_Undead_CursedSmith_Summon_WeaponSpear_Trigger PrefabGuid(-1721868281)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[3]**
  - `SpawnPrefab: AB_Undead_CursedSmith_Summon_WeaponSlashers_Trigger PrefabGuid(618637519)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[4]**
  - `SpawnPrefab: AB_Undead_CursedSmith_Summon_WeaponAxe_Trigger PrefabGuid(-1270010004)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
