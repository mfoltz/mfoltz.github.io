---
title: CHAR_ChurchOfLight_SlaveRuffian_Servant
guid: -1416355128
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiPointOfInterestTarget](/components/AiPointOfInterestTarget)
  - `TypeModifiable: 4`
  - `Range: 4`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2005177329)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_SlaveRuffian_Servant PrefabGuid(-1623592371)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SlaveRuffian_Swing_AbilityGroup PrefabGuid(-983491078)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Buff1: Buff_General_SilverSlave PrefabGuid(103615205)`
