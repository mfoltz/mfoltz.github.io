...
- [ProjectM.Gameplay.Scripting.Script_ModifyAbilityCooldownOnGameplayEvent_DataServer](/components/Script_ModifyAbilityCooldownOnGameplayEvent_DataServer)
  - `AbilityGroupType: AB_Chaos_Barrier_AbilityGroup PrefabGuid(-1016145613)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Chaos_Barrier_Charges PrefabGuid(-673905030)`
...
- [ProjectM.ForceCastOnGameplayEvent](/components/ForceCastOnGameplayEvent)

- **[0]**
  - `ForceCastAbility: AB_Chaos_Barrier_Recast_AbilityGroup PrefabGuid(2070140125)`
...
- **[10]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -507066569`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -125103725`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Chaos_Barrier_AbilityGroup PrefabGuid(-1016145613)`
  - `NewGroupId: AB_Chaos_Barrier_Recast_AbilityGroup PrefabGuid(2070140125)`
  - `Priority: 1`
  - `Condition: None`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_Chaos_Barrier_ConsumeAttackReduceCooldownXTimes PrefabGuid(-1611128617)`
