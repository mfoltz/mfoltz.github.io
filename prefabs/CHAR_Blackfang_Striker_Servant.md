---
title: CHAR_Blackfang_Striker_Servant
guid: -274383877
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-522998802)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 86.310394`
  - `SpellPower: 86.310394`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Blackfang_Striker_Servant PrefabGuid(265120836)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Striker_Smash_AbilityGroup PrefabGuid(1126476370)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Striker_FistBlock_AbilityGroup PrefabGuid(-2096054164)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Striker_DefendAlly_AbilityGroup PrefabGuid(1125833271)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Striker_PowerPunch_AbilityGroup PrefabGuid(1105771640)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Striker_ChargeAttack_AbilityGroup PrefabGuid(1213228171)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  - `Kind: ProjectM.SpawnBuffKind Hiding`
  - `Buff: AB_Bandit_Ambush_Buff PrefabGuid(614276301)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[2]**
  - `Kind: ProjectM.SpawnBuffKind Sit`
  - `Buff: Buff_LittleGuy_Sit PrefabGuid(-1861980964)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[3]**
  - `Kind: ProjectM.SpawnBuffKind Sleep`
  - `Buff: Buff_LittleGuy_Sleep PrefabGuid(1572800727)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[4]**
  - `Kind: ProjectM.SpawnBuffKind Tinkering`
  - `Buff: Buff_LittleGuy_Tinkering PrefabGuid(1163726516)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
