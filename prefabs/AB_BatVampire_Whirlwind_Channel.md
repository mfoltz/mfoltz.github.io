...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer)
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_BatVampire_Whirlwind_Projectile PrefabGuid(-2115186527)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_BatVampire_Whirlwind_End PrefabGuid(2092565960)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -2138450094`
...
- **[0]**
  - `SpawnPrefab: AB_BatVampire_Whirlwind_Hit PrefabGuid(689442495)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
