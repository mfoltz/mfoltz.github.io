---
title: AB_Treant_Corrupted_WakeUp_Cast
guid: -895284846
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Treant_Corrupted_WakeUp_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Treant_Corrupted_WakeUp_Cast PrefabGuid(-895284846)`
...
- [ProjectM.ChangeKnockbackResistanceDuringCast](/components/ChangeKnockbackResistanceDuringCast)
...
- [ProjectM.Gameplay.Scripting.Script_RemoveBuffOnAbilityUseData](/components/Script_RemoveBuffOnAbilityUseData)
  - `Buff: AB_Treant_Corrupted_FallAsleep_Buff_SleepingIdle PrefabGuid(-293207555)`
