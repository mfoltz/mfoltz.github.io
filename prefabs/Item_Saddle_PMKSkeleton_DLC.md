---
title: Item_Saddle_PMKSkeleton_DLC
guid: -1270904319
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Saddle_PMKSkeleton_DLC PrefabGuid(-1270904319)`
  - `DropItemPrefab: Resource_Drop_General PrefabGuid(-1221682951)`
  - `DropItemArc: GUID Not Found`
  - `MaxAmount: 1`
  - `ItemType: ProjectM.ItemType Saddle`
  - `ItemCategory: ProjectM.ItemCategory Saddle`
  - `RemoveOnConsume: False`
  - `SortOrder: 0`

- [ProjectM.SaddleData](/components/SaddleData){:target="_blank"}
  - `MountBuff: AB_Interact_Mount_Owner_Buff_Horse_Vampire_PMKSkeleton PrefabGuid(-1627838818)`
  - `MaxSpeed: 1`
  - `RotationSpeed: 0`
  - `Acceleration: 1`
