---
title: TM_SpecialStation_ServantCoffin
guid: 723455393
categories:
- All
- TM
...
# TM_SpecialStation_ServantCoffin
...
- [ServantCoffinEffects](/components/ServantCoffinEffects){:target="_blank"}
  ...
  - `ActiveConversionGuid: SequenceGUID -1732018925`
  - `ActiveConversionState: SequenceState`
  - `Id: Entity(0:0)`
  - `ActiveServantGuid: SequenceGUID -1964290775`
  - `ActiveServantState: SequenceState`
  - `Id: Entity(0:0)`
  - `WakeUpReadyGuid: SequenceGUID 789516790`
  - `WakeUpReadyState: SequenceState`
  - `Id: Entity(0:0)`

- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_ServantCoffin PrefabGuid(723455393) - Entity(6871:3)`
  - `Guid: TM_SpecialStation_ServantCoffin PrefabGuid(723455393)`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_giijbgiic`
...
- **[0]**
  - `PrefabGuid: TM_SpecialStation_ServantCoffin_StrongbladeDLC PrefabGuid(1789222770)`
