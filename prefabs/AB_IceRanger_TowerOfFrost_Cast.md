---
title: AB_IceRanger_TowerOfFrost_Cast
guid: 1668005661
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_IceRanger_TowerOfFrost_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_IceRanger_TowerOfFrost_Cast PrefabGuid(1668005661)`
...
- **[0]**
  - `SpawnPrefab: AB_IceRanger_TowerOfFrost_IcicleSpawnThrow PrefabGuid(1573363803)`
...
- **[1]**
  - `SpawnPrefab: AB_IceRanger_TowerOfFrost_Area PrefabGuid(-317564656)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
