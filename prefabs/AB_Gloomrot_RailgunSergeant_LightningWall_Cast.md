---
title: AB_Gloomrot_RailgunSergeant_LightningWall_Cast
guid: 909375776
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_RailgunSergeant_LightningWall_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Gloomrot_RailgunSergeant_LightningWall_Cast PrefabGuid(909375776)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_LightningWall_Throw01 PrefabGuid(1067690371)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_LightningWall_Throw02 PrefabGuid(1340315458)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_LightningWall_Throw03 PrefabGuid(-1730813353)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_LightningWall_StationBuff PrefabGuid(-167853768)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
