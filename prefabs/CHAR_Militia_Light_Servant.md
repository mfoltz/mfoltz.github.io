---
title: CHAR_Militia_Light_Servant
guid: 169329980
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1604030641)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Militia_Light_Servant PrefabGuid(169329980)`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData)
  - `MinDistance: 0`
  - `GoalDistanceInner: 1.4`
  - `GoalDistanceOuter: 1.4`
  - `MaxDistance: 1.7`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Militia_Torchbearer_Servant PrefabGuid(1220761582)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Light_MeleeAttack_Group PrefabGuid(994921501)`
  - `ShowOnBar: True`
