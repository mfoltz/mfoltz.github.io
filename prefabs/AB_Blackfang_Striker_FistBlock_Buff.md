...
- [ProjectM.Network.ModifyRotation](/components/ModifyRotation)
  ...
  - `TargetDirectionType: ProjectM.Network.TargetDirectionType TowardsAggroTarget`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Blackfang_Striker_FistBlock_SuccessfulBlockBuff PrefabGuid(1517666230)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 191278539`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Striker_FistBlock_Hit PrefabGuid(-1358214253)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- [ProjectM.Gameplay.Scripting.Script_SetAbilityCooldownOnGameplayEvent_DataServer](/components/Script_SetAbilityCooldownOnGameplayEvent_DataServer)

- **[0]**
  - `Cooldown: 6`
  - `AbilityIndex: 2`
  - `ListenerEventId: Local - -136930912`
