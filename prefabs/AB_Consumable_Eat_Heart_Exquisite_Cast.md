---
title: AB_Consumable_Eat_Heart_Exquisite_Cast
guid: 1368552679
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Consumable_Eat_Heart_Exquisite_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Consumable_Eat_Heart_Exquisite_Cast PrefabGuid(1368552679)`
...
- [ProjectM.AbilityInterruptData](/components/AbilityInterruptData){:target="_blank"}
  ...
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, OnMove, GameplayAbilities`
...
- **[0]**
  - `SpawnPrefab: AB_Consumable_Eat_Heart_Exquisite_Activate PrefabGuid(-932656733)`
