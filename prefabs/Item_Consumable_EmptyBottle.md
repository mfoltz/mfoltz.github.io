---
title: Item_Consumable_EmptyBottle
guid: -437611596
categories:
- All
- Item
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Consumable_EmptyBottle PrefabGuid(-437611596)`
...
- [Salvageable](/components/Salvageable){:target="_blank"}
  - `RecipeGUID: Recipe_Consumable_EmptyBottle_T02_Refinement_Hidden PrefabGuid(394757670)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
