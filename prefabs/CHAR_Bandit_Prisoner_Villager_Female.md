---
title: CHAR_Bandit_Prisoner_Villager_Female
guid: 1069072707
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(1977351396)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 12.884452`
  - `SpellPower: 12.884452`
  - `ResourcePower: 11.62`
  - `SiegePower: 6.8`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Villager_Female PrefabGuid(-1982127263)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Prisoner_VillagerFemale_OnAggro_AbilityGroup_01 PrefabGuid(394173239)`
  - `ShowOnBar: True`
...
- **[1]**
  - `BuffGuid: Buff_Prisoner_Flee_Villager_Female PrefabGuid(-524901271)`
  - `State: ProjectM.GenericEnemyState Flee`

- **[2]**
  - `BuffGuid: Buff_Prisoner_Villager_Cover_Female PrefabGuid(1216826981)`
  - `State: ProjectM.GenericEnemyState Villager_Cover`

- **[3]**
  - `BuffGuid: Buff_Prisoner_Villager PrefabGuid(626943474)`
