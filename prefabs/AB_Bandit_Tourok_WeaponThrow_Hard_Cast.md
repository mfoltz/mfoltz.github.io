---
title: AB_Bandit_Tourok_WeaponThrow_Hard_Cast
guid: 210911413
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Bandit_Tourok_WeaponThrow_Hard_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Bandit_Tourok_WeaponThrow_Hard_Cast PrefabGuid(210911413)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Tourok_WeaponThrow_Hard_Projectile PrefabGuid(1327750581)`
...
- **[1]**
  - `SpawnPrefab: AB_Bandit_Tourok_WeaponThrow_Hard_HideWeapon_Buff PrefabGuid(1114144111)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
