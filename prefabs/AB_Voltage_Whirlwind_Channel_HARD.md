---
title: AB_Voltage_Whirlwind_Channel_HARD
guid: -1527520550
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Voltage_Whirlwind_Channel_HARD
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer)
  - `Angle: 240`
  - `OffsetAngle: -1.3962634`
  - `RandomOffset: 0`
  - `IndividualRandom: 1.9198622`
  - `NewProjectileEntity: AB_Voltage_Stage2_MoteOfLightning_WhirlwindProjectile PrefabGuid(468345692)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Voltage_Whirlwind_Travel PrefabGuid(-1416300207)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Voltage_Whirlwind_SpeedBuff PrefabGuid(236263098)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 933253719`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(236263098)`
...
- **[0]**
  - `SpawnPrefab: AB_Voltage_Whirlwind_Hit PrefabGuid(381916168)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
