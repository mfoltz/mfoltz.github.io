---
title: TM_Castle_Garden_Parent_Arch_Small_Wood
guid: 1892222213
categories:
- All
- TM
...
# TM_Castle_Garden_Parent_Arch_Small_Wood
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Garden_Parent_Arch_Small_Wood PrefabGuid(1892222213) - Entity(14076:3)`
...
- [DyeableCastleObject](/components/DyeableCastleObject){:target="_blank"}
  - `ColorSwatchAssetGuid: DyeCollection_Wood_Exterior PrefabGuid(-110790076)`
  - `NumColorChoices: 2`
  - `PrevColorIndex: 255`
  - `ActiveColorIndex: 0`
...
- [PlacementLimitToSet](/components/PlacementLimitToSet){:target="_blank"}
  - `LimitToPrefabSet: Castle_Modules_Garden_Arch_Small PrefabGuid(-562325479)`
