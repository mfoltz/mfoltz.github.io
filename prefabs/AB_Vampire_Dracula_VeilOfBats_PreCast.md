---
title: AB_Vampire_Dracula_VeilOfBats_PreCast
guid: -55837364
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Dracula_VeilOfBats_PreCast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Dracula_VeilOfBats_PreCast PrefabGuid(-55837364)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_VeilOfBats_AggroBuff PrefabGuid(450953547)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Dracula_VeilOfBats_PreTrigger PrefabGuid(-1951743028)`
...
- **[2]**
  - `SpawnPrefab: AB_Vampire_Dracula_VeilOfBats_Buff PrefabGuid(81888713)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Vampire_Dracula_VeilOfBats_CircleBuff PrefabGuid(-1942308089)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
