---
title: AB_ChurchOfLight_Paladin_HolyBubble_BeamTrigger
guid: -104940321
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ChurchOfLight_Paladin_HolyBubble_BeamTrigger
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(-2f, 0f, -13f)`
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer){:target="_blank"}
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_ChurchOfLight_Paladin_HolyBubble_Beam PrefabGuid(-1618178798)`
