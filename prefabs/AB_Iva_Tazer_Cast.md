...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Iva_Tazer_Cast PrefabGuid(-971002557)`
...
- **[0]**
  - `SpawnPrefab: AB_Iva_Tazer_Projectile01 PrefabGuid(-1335472990)`
...
- **[1]**
  - `SpawnPrefab: AB_Iva_Tazer_SelfKnockback PrefabGuid(-814883978)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
