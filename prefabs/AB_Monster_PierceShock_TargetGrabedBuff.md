---
title: AB_Monster_PierceShock_TargetGrabedBuff
guid: 745999782
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Monster_PierceShock_TargetGrabedBuff
...
- [ProjectM.AttachToCharacterTransformBuff](/components/AttachToCharacterTransformBuff){:target="_blank"}
  ...
  - `ServerPositionOffset: Unity.Mathematics.float3 float3(0.5f, 3.8f, 1.5f)`
  - `HybridBone: 8`
  - `CopyPosition: True`
  - `CopyRotation: True`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Monster_PierceShock_DamageBuff PrefabGuid(-2052458973)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_Monster_PierceShock_HasGrabedBuff PrefabGuid(-1419903558)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
