---
title: CHAR_Militia_Leader_VBlood_GateBoss_Major
guid: 1990744594
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Militia_Leader_VBlood_GateBoss_Major
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1583235120)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource){:target="_blank"}
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(910644396)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 102.427864`
  - `SpellPower: 102.427864`
  - `ResourcePower: 52.800003`
  - `SiegePower: 21`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Generic_GateBoss_Melee PrefabGuid(-1215716718)`
...
- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_CallAdds_Legion_AbilityGroup PrefabGuid(1244670975)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **C���  �.��           (8��<   **
  - `Component                      `
  - `ConditionalElements`
  - `Ability: AB_FeedGateBoss_01_Initiate_AbilityGroup PrefabGuid(-1695763915)`
  - `Importance: 3`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Legendary_VBlood_GateBoss_Major PrefabGuid(1057873848)`
