---
title: AB_ChurchOfLight_Paladin_EmpoweredMelee_AbilityGroup
guid: -947518364
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ChurchOfLight_Paladin_EmpoweredMelee_AbilityGroup
...
- [ProjectM.Shared.IgnoreHitsPerTarget](/components/IgnoreHitsPerTarget)
  - `HitResetTimer: 0.2`
  - `ReductionModifier: 0`
...
- [ProjectM.Shared.IgnoreHitsPerTargetElement](/components/IgnoreHitsPerTargetElement)
...
- **[0]**
  - `PrefabGUID: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast01 PrefabGuid(-697413038)`

- **[1]**
  - `PrefabGUID: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast02 PrefabGuid(-2097945594)`

- **[2]**
  - `PrefabGUID: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast03 PrefabGuid(-89562779)`

- **[3]**
  - `PrefabGUID: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast04 PrefabGuid(397691284)`
