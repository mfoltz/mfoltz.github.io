---
title: Item_Ingredient_Gem_Miststone_T02
guid: 802050789
categories:
- All
- Item
...
# Item_Ingredient_Gem_Miststone_T02
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Ingredient_Gem_Miststone_T02 PrefabGuid(802050789)`
  - `DropItemPrefab: Resource_Drop_GemOpal_T02 PrefabGuid(1351986583)`
