---
title: TM_CraftingStation_Altar_Spectral
guid: -64110296
categories:
- All
- TM
...
# TM_CraftingStation_Altar_Spectral
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_Altar_Spectral PrefabGuid(-64110296) - Entity(18218:3)`
  - `Guid: TM_CraftingStation_Altar_Spectral PrefabGuid(-64110296)`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0f,  0f, 1f, 0f, 1f,  0f, 0f, 1f, -1.25f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `Entity: Entity(12316:3)`
  - `BlobIndex: 8`

- **[1]**
  - `Entity: Entity(12569:3)`
  - `BlobIndex: 9`

- **[2]**
  - `Entity: Entity(12568:3)`
  - `BlobIndex: 12`
...
- **[0]**
  - `RendererEntity: Entity(12316:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(12569:3)`
  - `Mask: 128`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[2]**
  - `RendererEntity: Entity(12568:3)`
  - `Mask: 128`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_CraftingStation_Altar_Spectral PrefabGuid(-64110296) - Entity(18218:3)`

- **[1]**
  - `Value: Entity(12316:3)`

- **[2]**
  - `Value: Entity(12569:3)`

- **[3]**
  - `Value: Entity(12568:3)`
...
- **[2]**
  - `PrefabGUID: Item_Ingredient_Plant_BloodRose PrefabGuid(1726420644)`
  - `Amount: 30`
