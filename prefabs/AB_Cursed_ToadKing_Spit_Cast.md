---
title: AB_Cursed_ToadKing_Spit_Cast
guid: 107004412
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Cursed_ToadKing_Spit_Cast PrefabGuid(107004412)`
...
- [ProjectM.AbilityPositionInaccuracy](/components/AbilityPositionInaccuracy){:target="_blank"}
...
- [ProjectM.Behaviours.AbilityRange](/components/AbilityRange){:target="_blank"}
  - `Min: 1`
  - `Max: 1`

- [ProjectM.Gameplay.Scripting.Script_ApplyBuffOnAllWithBuff_Cast_DataServer](/components/Script_ApplyBuffOnAllWithBuff_Cast_DataServer){:target="_blank"}
  - `Radius: 5`
  - `HitFilter: ProjectM.Scripting.HitFilter IncludeImmaterial`
  - `BuffRequired: AB_Cursed_ToadKing_Swallow_TargetSwallowedBuff PrefabGuid(-915145807)`
  - `BuffToApply: AB_Cursed_ToadKing_Spit_LaunchBuff PrefabGuid(1750172438)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_ToadKing_Spit_HideHUDCastBuff PrefabGuid(-1976656728)`
  - `BuffDuration: 0`
  - `Condition: None`
