...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Prefab Item_Consumable_PrisonPotion_Mixed PrefabGuid(2063723255) - Entity(3789:1)`
  - `ItemTypeGUID: Item_Consumable_PrisonPotion_Mixed PrefabGuid(2063723255)`
