---
title: CHAR_Bandit_Fisherman_VBlood
guid: -2122682556
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 24`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Bandit_Fisherman_VBlood_Downed PrefabGuid(1759053294)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(588595323)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Bandit_Fisherman_VBlood PrefabGuid(-2122682556)`
  - `JournalCategory: ProjectM.JournalCategoryType FarbaneWoods`
  - `QuestFlavorTextOverride: 00000000-0000-0000-0000-000000000000 - <Localization not found!>`
  - `TooltipGUID: JournalAsset_VBlood_Ability PrefabGuid(1808963981)`
  - `SpellSchool: FrostSpellSchoolAsset PrefabGuid(-823811825)`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 34.546818`
  - `SpellPower: 34.546818`
  - `ResourcePower: 27.36`
  - `SiegePower: 10.4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Bandit_Fisherman_VBlood PrefabGuid(-386860528)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_SwingAttack_AbilityGroup PrefabGuid(1516349451)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FishHook_AbilityGroup PrefabGuid(643209588)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_SpinAttack_AbilityGroup PrefabGuid(-1807544727)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_SerpentFeed_AbilityGroup PrefabGuid(571532506)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FishingBlowfish_AbilityGroup PrefabGuid(-2096565232)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FeedSerpentLineup_01_AbilityGroup PrefabGuid(-1601441951)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FishingLineup_AbilityGroup PrefabGuid(-82547339)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FishingPiranhas_AbilityGroup PrefabGuid(647582679)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FishingOldBoot_AbilityGroup PrefabGuid(396802528)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FeedSerpentLineup_02_AbilityGroup PrefabGuid(-1657698157)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FeedSerpentLineup_03_AbilityGroup PrefabGuid(-228936316)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_FeedSerpentLineup_Hard_AbilityGroup PrefabGuid(514628041)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Fisherman_SerpentFeed_Hard_AbilityGroup PrefabGuid(-405467076)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T03_Fisherman PrefabGuid(-1955769660)`

- [ProjectM.SpawnBuffElement](/components/SpawnBuffElement){:target="_blank"}

- **[0]**
  - `Kind: ProjectM.SpawnBuffKind Default`
  - `Buff: Buff_General_Spawn_VBlood_EarlyGame PrefabGuid(-703593639)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Fisherman PrefabGuid(-1878882476)`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_VBlood_T01_Early PrefabGuid(-2111574931)`
