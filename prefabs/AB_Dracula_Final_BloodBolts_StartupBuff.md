---
title: AB_Dracula_Final_BloodBolts_StartupBuff
guid: -1480733950
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Dracula_Final_BloodBolts_StartupBuff
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 0f, -14f)`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_achddjeefgi`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Dracula_Final_BloodBolts_Buff PrefabGuid(2127839743)`
