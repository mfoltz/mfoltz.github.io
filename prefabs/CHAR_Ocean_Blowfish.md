...
- [ProjectM.Gameplay.Scripting.Script_ApplyDashOnDamageTaken_DataServer](/components/Script_ApplyDashOnDamageTaken_DataServer){:target="_blank"}
  - `NewDashEntity: Buff_OnHitDash PrefabGuid(-2050859372)`
  - `OnStatChangeListener: ProjectM.Scripting.ListenerId ProjectM.Scripting.ListenerId`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1270888987)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Ocean_Blowfish PrefabGuid(1385481259)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Ocean_Blowfish_Swim_AbilityGroup PrefabGuid(177071276)`
  - `ShowOnBar: True`
...
- **[0]**
  ...
  - `Buff1: Buff_Ocean_Blowfish_DamageArea PrefabGuid(-835533380)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Ocean_Blowfish_DestroyNovaTrigger PrefabGuid(-1425606752)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1265420796`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
