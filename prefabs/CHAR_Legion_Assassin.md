...
- [ProjectM.ServantConvertable](/components/ServantConvertable){:target="_blank"}
  - `ConvertToUnit: CHAR_Legion_Assassin_Servant PrefabGuid(1502148822)`
...
- [ProjectM.WoundedConstants](/components/WoundedConstants){:target="_blank"}
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID 1772507088`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_Assassin PrefabGuid(1140793879)`
