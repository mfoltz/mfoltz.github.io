---
title: AB_Paladin_FallenAngel_BubblePopper_Cast
guid: 863095122
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Paladin_FallenAngel_BubblePopper_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Paladin_FallenAngel_BubblePopper_Cast PrefabGuid(863095122)`
...
- **[0]**
  - `SpawnPrefab: AB_Paladin_FallenAngel_BubblePopper_Projectile PrefabGuid(882224304)`
...
- **[0]**
  - `SpawnPrefab: AB_Paladin_FallenAngel_BubblePopper_SelfBuff PrefabGuid(1191955967)`
  - `BuffDuration: 0`
  - `Condition: None`
