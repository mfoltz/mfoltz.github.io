---
title: CHAR_Vampire_BloodKnight_VBlood
guid: 495971434
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer](/components/AggroConsumer){:target="_blank"}
  ...
  - `MaxDistanceFromPreCombatPosition: 27`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Highlord_VBlood_Downed PrefabGuid(-820699991)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-574750765)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Vampire_BloodKnight_VBlood PrefabGuid(495971434)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vampire_BloodKnight PrefabGuid(-1750899949)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_BasicSpearDance_AbilityGroup PrefabGuid(992015964)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_HighKick_Abilitygroup PrefabGuid(-1638937811)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_HookingSpear_Abilitygroup PrefabGuid(1199769322)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_MaidenLineup_AbilityGroup PrefabGuid(-503137581)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_LineupDash_AbilityGroup PrefabGuid(-1069881409)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_ThousandSpears_AbilityGroup PrefabGuid(1295370119)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_SpearTwirl_AbilityGroup PrefabGuid(1730729556)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_FieldOfSpears_AbilityGroup PrefabGuid(-1730693034)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_SummonCrimsonMaiden_AbilityGroup PrefabGuid(-1920828971)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_SkeweringLeap_AbilityGroup PrefabGuid(1826128809)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_BloodKnight_SkeweringLeap_Disengage_AbilityGroup PrefabGuid(-1759227484)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T08_BloodKnight PrefabGuid(90328407)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_JewelsT04 PrefabGuid(514472877)`

- **[2]**
  - `Guid: Tech_Collection_CoatOfArms PrefabGuid(-1637580865)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_BloodKnight PrefabGuid(1985952650)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: Buff_Vampire_BloodKnight_Return PrefabGuid(-1049988817)`
