---
title: AB_Gloomrot_TheProfessor_MultiLazer_Cast
guid: -1664716277
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_TheProfessor_MultiLazer_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Gloomrot_TheProfessor_MultiLazer_Cast PrefabGuid(-1664716277)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Projectile_01 PrefabGuid(435849363)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Projectile_02 PrefabGuid(-1892950511)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Projectile_03 PrefabGuid(-60897631)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_MultiLazer_Projectile_04 PrefabGuid(559619826)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
