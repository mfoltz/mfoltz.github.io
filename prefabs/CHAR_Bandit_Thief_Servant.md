---
title: CHAR_Bandit_Thief_Servant
guid: -872078546
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2014475190)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Bandit_Thief_Servant PrefabGuid(-872078546)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 22.951681`
  - `SpellPower: 22.951681`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Bandit_Thief_Servant PrefabGuid(1399382478)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Thief_MeleeAttack01_Group PrefabGuid(1734839687)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Thief_Rush_Group PrefabGuid(-1956103113)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Thief_HeavyAttack_Group PrefabGuid(-691814641)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Thief_MeleeAttack02_Group PrefabGuid(-2106739571)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
