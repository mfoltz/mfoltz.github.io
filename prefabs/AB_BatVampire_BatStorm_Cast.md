---
title: AB_BatVampire_BatStorm_Cast
guid: 2070624298
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_BatVampire_BatStorm_Cast PrefabGuid(2070624298)`
...
- **[0]**
  - `SpawnPrefab: AB_BatVampire_BatStorm_ProjectileSpawnerBuff PrefabGuid(1280015305)`
...
- **[1]**
  - `SpawnPrefab: AB_BatVampire_BatStorm_Trigger PrefabGuid(1292017056)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
