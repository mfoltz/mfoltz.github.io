---
title: CHAR_ChurchOfLight_Knight_Shield_Servant
guid: -694328454
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-428162790)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_ChurchOfLight_Knight_Shield_Servant PrefabGuid(-694328454)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_Knight_Shield_Servant PrefabGuid(-1925940112)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Knight_Shield_MeleeAttack_Group PrefabGuid(-1900214847)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_KnightShield_DirectionalShield_AbilityGroup PrefabGuid(-386968650)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_KnightShield_SideStep_Back_AbilityGroup PrefabGuid(157070105)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_KnightShield_SideStep_Left_AbilityGroup PrefabGuid(-2012449382)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_KnightShield_SideStep_Right_AbilityGroup PrefabGuid(1703351456)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Knight_Shield_ShieldHeavyAttack_Group PrefabGuid(377144854)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
