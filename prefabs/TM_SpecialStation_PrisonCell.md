---
title: TM_SpecialStation_PrisonCell
guid: -1253061408
categories:
- All
- TM
...
- [PrisonCell](/components/PrisonCell){:target="_blank"}
  - `ImprisonedEntity: NetworkedEntity(0:0)`
  - `Blob: Unity.Entities.BlobAssetReference`1[ProjectM.PrisonCell+BlobData] Unity.Entities.BlobAssetReference`1[ProjectM.PrisonCell+BlobData]`

- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_PrisonCell PrefabGuid(-1253061408) - Entity(12430:3)`
  - `Guid: TM_SpecialStation_PrisonCell PrefabGuid(-1253061408)`
...
- [StaticHierarchyData](/components/StaticHierarchyData){:target="_blank"}
  - `Blob: StaticHierarchyBlobAsset`
  - `LocalToParents: Unity.Entities.BlobArray`1[float4x4] Unity.Entities.BlobArray`1[float4x4]`
...
- [CastleLimited](/components/CastleLimited){:target="_blank"}
  - `Type: ProjectM.CastleLimitedType PrisonCell`

- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-0.95f, 0f, 0f, -0.01f,  0f, 0.95f, 0f, 0.122f,  0f, 0f, -0.95f, 2.263f,  0f, 0f, 0f, 1f)`
...
- [CastleWorkstation](/components/CastleWorkstation){:target="_blank"}
  - `MatchingFloorType: ProjectM.CastleBuilding.CastleFloorTypes Prison`
...
- [Prisonstation](/components/Prisonstation){:target="_blank"}
  ...
  - `Progress: 0`
  - `Status: ProjectM.RefinementStatus Processing`
  - `IsWorking: False`
  - `LastInventoryChangedVersion: 0`
  - `HasPrisoner: False`
  - `NewCraftAction: False`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acfhdehhccb`
...
- [StaticHierarchyBuffer](/components/StaticHierarchyBuffer){:target="_blank"}

- **[0]**
  - `Entity: Entity(12318:3)`
  - `BlobIndex: 2`

- **[1]**
  - `Entity: Entity(12565:3)`
  - `BlobIndex: 3`

- **[2]**
  - `Entity: Entity(12322:3)`
  - `BlobIndex: 4`

- **[3]**
  - `Entity: Entity(12564:3)`
  - `BlobIndex: 6`

- **[4]**
  - `Entity: Entity(12320:3)`
  - `BlobIndex: 7`

- **[5]**
  - `Entity: Entity(12563:3)`
  - `BlobIndex: 8`

- **[6]**
  - `Entity: Entity(12319:3)`
  - `BlobIndex: 9`
...
- **[0]**
  - `RendererEntity: Entity(12318:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(12565:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[2]**
  - `RendererEntity: Entity(12322:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[3]**
  - `RendererEntity: Entity(12564:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[4]**
  - `RendererEntity: Entity(12320:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[5]**
  - `RendererEntity: Entity(12563:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[6]**
  - `RendererEntity: Entity(12319:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_SpecialStation_PrisonCell PrefabGuid(-1253061408) - Entity(12430:3)`

- **[1]**
  - `Value: Entity(12318:3)`

- **[2]**
  - `Value: Entity(12565:3)`

- **[3]**
  - `Value: Entity(12322:3)`

- **[4]**
  - `Value: Entity(12564:3)`

- **[5]**
  - `Value: Entity(12320:3)`

- **[6]**
  - `Value: Entity(12563:3)`

- **[7]**
  - `Value: Entity(12319:3)`
...
- **[0]**
  ...
  - `Component   �Ҁ�<         �s`
  - `ConditionalElements`
  - `Ability: AB_Interact_UsePrisonStation_AbilityGroup PrefabGuid(-2143553487)`
  - `Importance: 1`
...
- **[0]**
  - `PrefabGuid: TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732)`

- [StationBonusBuffer](/components/StationBonusBuffer){:target="_blank"}

- **[0]**
  - `StationBonusGuid: StationBonus_Prison_BloodEssence_Power PrefabGuid(-1550842326)`

- **[1]**
  - `StationBonusGuid: StationBonus_Prison_MatchingFloor PrefabGuid(1792532014)`

- [WorkstationRecipesBuffer](/components/WorkstationRecipesBuffer){:target="_blank"}

- **[0]**
  - `RecipeGuid: Recipe_Consumable_PrisonPotion PrefabGuid(1839006118)`

- **[1]**
  - `RecipeGuid: Recipe_Consumable_PrisonPotion_Bloodwine PrefabGuid(1930190516)`

- **[2]**
  - `RecipeGuid: Recipe_Misc_ExtractEssencePrisoner PrefabGuid(1716338316)`

- **[3]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Rat PrefabGuid(1469101010)`

- **[4]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_FatGoby PrefabGuid(-2047246570)`

- **[5]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_RainbowTrout PrefabGuid(-1206171767)`

- **[6]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_FierceStinger PrefabGuid(-37587809)`

- **[7]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_TwilightSnapper PrefabGuid(-252411567)`

- **[8]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_SageFish PrefabGuid(1800570390)`

- **[9]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_BloodSnapper PrefabGuid(956953141)`

- **[10]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_SwampDweller PrefabGuid(-460272822)`

- **[11]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_GoldenRiverBass PrefabGuid(1816434122)`

- **[12]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_Fish_Corrupted PrefabGuid(493259323)`

- **[13]**
  - `RecipeGuid: Recipe_Misc_FeedPrisoner_IrradiantGruel PrefabGuid(-279936313)`
...
- **176 total elements but only showing the first 36**
  - *(No fields)*
