---
title: CHAR_Bandit_Worker_Gatherer_Servant
guid: 48283616
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(690141917)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Bandit_Worker_Gatherer_Servant PrefabGuid(-1025208190)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Worker_Gatherer_MeleeAttack_AbilityGroup PrefabGuid(-1826323796)`
  - `ShowOnBar: True`
