---
title: AB_Shapeshift_Spider_Unburrow_Cast
guid: -1735332389
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Shapeshift_Spider_Unburrow_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Shapeshift_Spider_Unburrow_Cast PrefabGuid(-1735332389)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag Interact`
...
- [ProjectM.Gameplay.Scripting.Script_RemoveBuffOnAbilityUseData](/components/Script_RemoveBuffOnAbilityUseData)
  - `Buff: AB_Shapeshift_Spider_Burrow_Buff PrefabGuid(-1665328650)`
