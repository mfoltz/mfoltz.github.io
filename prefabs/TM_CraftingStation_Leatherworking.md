---
title: TM_CraftingStation_Leatherworking
guid: 1779320855
categories:
- All
- TM
...
# TM_CraftingStation_Leatherworking
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_Leatherworking PrefabGuid(1779320855) - Entity(14158:3)`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 0f, 0f,  0f, 1f, 0f, 0.02f,  0f, 0f, -1f, 0.84f,  0f, 0f, 0f, 1f)`
...
- **[0]**
  - `RecipeGuid: Recipe_Saddle_Basic_T01 PrefabGuid(367529732)`

- **[1]**
  - `RecipeGuid: Recipe_Saddle_Gloomrot_DLC_T01 PrefabGuid(-2076606690)`

- **[2]**
  - `RecipeGuid: Recipe_Saddle_ProjectK_DLC_T01 PrefabGuid(841431479)`

- **[3]**
  - `RecipeGuid: Recipe_Saddle_Blackfang_DLC_T01 PrefabGuid(1477520375)`
