...
- [Script_CursedAreaDebuff_DataServer](/components/Script_CursedAreaDebuff_DataServer){:target="_blank"}
  - `DynamicStacks: 0`
...
- [Script_CurseAreaDebuff_DataShared](/components/Script_CurseAreaDebuff_DataShared){:target="_blank"}
  - `IsInArea: False`
  - `StackSize: 0`
