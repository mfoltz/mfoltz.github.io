---
title: AB_Gloomrot_SpiderTank_Zapper_BombHatch_BombTrigger
guid: 1552172886
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_SpiderTank_Zapper_BombHatch_BombTrigger
...
- [ProjectM.Gameplay.Scripting.Script_SpawnThrowTowardsNearbyVampires_DataServer](/components/Script_SpawnThrowTowardsNearbyVampires_DataServer){:target="_blank"}
  - `ThrowType: AB_Gloomrot_SpiderTank_Zapper_BombHatch_BombThrow PrefabGuid(33131505)`
  - `MaximumCount: 4`
  - `CountPerTarget: 1`
  - `Radius: 14`
  - `OffsetMin: 1.5`
