---
title: AB_GoldGolem_Molten_Buff
guid: 36716419
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CreateEventOnHealthChangeAmount](/components/CreateEventOnHealthChangeAmount)
  ...
  - `TriggerEventThreshold: 180`
  - `IgnoreOwnerDamageSources: False`
  - `Triggered: False`
  - `DamageTaken: 0`

- [ProjectM.ModifyImpactMaterialBuff](/components/ModifyImpactMaterialBuff)
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_GoldGolem_Invulnerability_Buff PrefabGuid(-748498013)`
  - `Buff1: AB_GoldGolem_PostVulnerableBuff PrefabGuid(848542975)`
