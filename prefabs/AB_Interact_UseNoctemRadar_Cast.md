---
title: AB_Interact_UseNoctemRadar_Cast
guid: 1724072860
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Interact_UseNoctemRadar_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Interact_UseNoctemRadar_Cast PrefabGuid(1724072860)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag Interact, Interact_BreakMount, IgnoreSpellBlock`
...
- **[0]**
  - `SpawnPrefab: AB_Interact_UseNoctemRadar PrefabGuid(-1430472112)`
