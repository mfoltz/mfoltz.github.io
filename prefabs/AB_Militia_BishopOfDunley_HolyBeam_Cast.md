---
title: AB_Militia_BishopOfDunley_HolyBeam_Cast
guid: -1691121147
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_BishopOfDunley_HolyBeam_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Militia_BishopOfDunley_HolyBeam_Cast PrefabGuid(-1691121147)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_BishopOfDunley_HolyBeam_Channel PrefabGuid(-875312828)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_BishopOfDunley_HolyBeam_Area_Knockback PrefabGuid(-1124194001)`
  - `BuffDuration: 0`
  - `Condition: None`
