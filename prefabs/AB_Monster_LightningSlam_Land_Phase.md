---
title: AB_Monster_LightningSlam_Land_Phase
guid: 1938864208
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Monster_LightningSlam_Land_Phase
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Monster_LightningSlam_PostTravelBuff PrefabGuid(-519019712)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1890619022)`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_GroundSlam_Hit PrefabGuid(-1683451014)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
