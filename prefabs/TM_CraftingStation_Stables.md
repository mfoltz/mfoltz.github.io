---
title: TM_CraftingStation_Stables
guid: 472278220
categories:
- All
- TM
...
- **ProjectM.Stables_Shared**
  - `Blob: Unity.Entities.BlobAssetReference`1[ProjectM.Stables_Shared+BlobData] Unity.Entities.BlobAssetReference`1[ProjectM.Stables_Shared+BlobData]`
  - `MountEntity: NetworkedEntity(0:0)`
  - `StatUpgrade_CurrentStat: ProjectM.StablesStat None`

- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_Stables PrefabGuid(472278220) - Entity(13867:3)`
  - `Guid: TM_CraftingStation_Stables PrefabGuid(472278220)`
...
- **ProjectM.InteractLookPositionOffset**
  - `Value: Unity.Mathematics.float3 float3(1.27f, 1.07f, -1.19f)`
...
- **ProjectM.Stables_Server**
  - `StatUpgrade_StartTicks: 0`
  - `StatUpgrade_CurrentItem: GUID Not Found`
  - `PerkUnlockSequence: SequenceGUID 206046532`
  - `MountBindSequence: SequenceGUID 2127751073`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_jjdhcjdfe`
...
- **[0]**
  ...
  - `Component �<  �Ҁ�<         `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseStables_AbilityGroup PrefabGuid(-1309114324)`
  - `Importance: 1`
