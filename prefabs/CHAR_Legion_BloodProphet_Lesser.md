---
title: CHAR_Legion_BloodProphet_Lesser
guid: -2080231735
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Legion_BloodProphet_Lesser
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(673522035)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Legion_BloodProphet PrefabGuid(73854851)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Legion_BloodProphet_ProjectileAOE_AbilityGroup PrefabGuid(-347082762)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_BloodProphet_BloodBurn_AbilityGroup PrefabGuid(-1717961213)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_BloodPropher_Hover_Buff PrefabGuid(-1083643277)`
