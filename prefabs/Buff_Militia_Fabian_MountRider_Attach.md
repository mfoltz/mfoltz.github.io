---
title: Buff_Militia_Fabian_MountRider_Attach
guid: 105565888
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
# Buff_Militia_Fabian_MountRider_Attach
...
- **ProjectM.MilitiaRiderBuff**
  - `ModId: Unset`
  - `ShouldForceDirection: False`
  - `LastCastTime: 0`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_Militia_Fabian_MountRider_LaunchRider PrefabGuid(1182509317)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1867175859`
...
- **ProjectM.SetBuffTargetBehaviourTreeStateToOwner**
  - *(No fields)*
