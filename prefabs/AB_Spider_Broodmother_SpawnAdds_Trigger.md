---
title: AB_Spider_Broodmother_SpawnAdds_Trigger
guid: -1238737320
categories:
- AB
- All
...
- Rotation
- Translation
- Script_ClusterBomb_Cast_DataServer
- LocalToWorld
- LocalTransform
- TeamReference
- NetworkId
...
# AB_Spider_Broodmother_SpawnAdds_Trigger
...
- [Script_ClusterBomb_Cast_DataServer](/components/Script_ClusterBomb_Cast_DataServer){:target="_blank"}
  - `NewThrowEntity: AB_Spider_Broodmother_SpawnAdds_SummonThrow PrefabGuid(-1997270727)`
  - `Count: 2`
