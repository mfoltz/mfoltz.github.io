---
title: AB_Militia_Guard_VBlood_IceBoltsThrow_Cast
guid: -923781186
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Guard_VBlood_IceBoltsThrow_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Militia_Guard_VBlood_IceBoltsThrow_Cast PrefabGuid(-923781186)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer](/components/Script_MultiShot_Cast_DataServer){:target="_blank"}
  - `Angle: 1.0471976`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Militia_Guard_VBlood_IceBoltsThrow_Projectile PrefabGuid(-1598751634)`
  - `Count: 5`
  - `Condition: None`
