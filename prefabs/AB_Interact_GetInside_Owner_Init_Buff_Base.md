---
title: AB_Interact_GetInside_Owner_Init_Buff_Base
guid: -785333140
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Interact_GetInside_Owner_Init_Buff_Base
...
- [ProjectM.InsideInitBuff](/components/InsideInitBuff){:target="_blank"}
  - *(No fields)*
