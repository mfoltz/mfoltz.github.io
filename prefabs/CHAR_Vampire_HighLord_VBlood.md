---
title: CHAR_Vampire_HighLord_VBlood
guid: -496360395
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(529148870)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Vampire_HighLord_VBlood PrefabGuid(-496360395)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Vampire_HighLord_VBlood PrefabGuid(-767647397)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_SwordPrimary_MeleeAttack_AbilityGroup PrefabGuid(-328302080)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_CorpseStorm_AbilityGroup PrefabGuid(1006960825)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_PullPlayers_AbilityGroup PrefabGuid(851287157)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_SwordDashCleave_AbilityGroup PrefabGuid(-2126197617)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_LeapStrike_AbilityGroup PrefabGuid(938684260)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_PBAE_AbilityGroup PrefabGuid(-1139777657)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_UnholyWarp_AbilityGroup PrefabGuid(-604910466)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_RaiseDead_AbilityGroup PrefabGuid(416744805)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_HighLord_UnholySkill_AbilityGroup PrefabGuid(-1298764600)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_HighLord PrefabGuid(2003830913)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_HighLord PrefabGuid(1138541416)`
