---
title: AB_Dreadhorn_Trample_Init_Cast
guid: 918875818
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Dreadhorn_Trample_Init_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Dreadhorn_Trample_Init_Cast PrefabGuid(918875818)`
...
- **[0]**
  - `SpawnPrefab: AB_Dreadhorn_Trample_AggroBuff PrefabGuid(-1435714402)`
...
- **[0]**
  - `SpawnPrefab: AB_Dreadhorn_Trample_DisableEvaluation_Buff PrefabGuid(-541538259)`
  - `BuffDuration: 0`
  - `Condition: None`
