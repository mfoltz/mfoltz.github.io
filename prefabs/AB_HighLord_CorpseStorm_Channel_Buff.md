---
title: AB_HighLord_CorpseStorm_Channel_Buff
guid: -11300078
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_HighLord_CorpseStorm_Channel_Buff
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnTick_DataServer](/components/AbilityProjectileFanOnTick_DataServer){:target="_blank"}
  - `Angle: 4.712389`
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_HighLord_CorpseStorm_Projectile PrefabGuid(2144484523)`
...
- **[0]**
  - `SpawnPrefab: AB_HighLord_CorpseStorm_AreaThrow PrefabGuid(-616249927)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Target`
