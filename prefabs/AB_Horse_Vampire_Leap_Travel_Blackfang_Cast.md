---
title: AB_Horse_Vampire_Leap_Travel_Blackfang_Cast
guid: 1938218550
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Horse_Vampire_Leap_Travel_Blackfang_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Horse_Vampire_Leap_Travel_Blackfang_Cast PrefabGuid(1938218550)`
...
- **[0]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Blackfang_Phase PrefabGuid(842087260)`
...
- **[1]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Blackfang_Buff PrefabGuid(985538529)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
