---
title: AB_Militia_Rider_Crossbow_Cast
guid: 858823255
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Rider_Crossbow_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Militia_Rider_Crossbow_Cast PrefabGuid(858823255)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Rider_Crossbow_Projectile PrefabGuid(305403942)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Rider_Crossbow_Trigger PrefabGuid(191767448)`
  - `BuffDuration: 0`
  - `Condition: None`
