---
title: AB_FrostBarrier_SpellMod_SpellPowerBuff
guid: 1663992026
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_FrostBarrier_SpellMod_SpellPowerBuff
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_FrostBarrier_BonusSpellPowerOnAbsorb PrefabGuid(-581148490)`
...
- **[2]**
  ...
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget ModifyUnitStats_ByStackValue`
  - `TargetIndex: 0`

- [ProjectM.ModifyUnitStatBuff_IncreaseWithStacks](/components/ModifyUnitStatBuff_IncreaseWithStacks){:target="_blank"}
  - *(No fields)*
