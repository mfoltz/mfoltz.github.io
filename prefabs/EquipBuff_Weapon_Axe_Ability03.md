---
title: EquipBuff_Weapon_Axe_Ability03
guid: 1164259129
...
# EquipBuff_Weapon_Axe_Ability03
...
- **[0]**
  ...
  - `NewGroupId: AB_Vampire_Axe_Primary_MeleeAttack_AbilityGroup PrefabGuid(1691491221)`
  - `Priority: 0`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Axe_Frenzy_Dash_AbilityGroup PrefabGuid(-1968364229)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
...
- **[2]**
  ...
  - `Slot: 4`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_Vampire_Axe_XStrike_Toss_AbilityGroup PrefabGuid(-898001858)`
  - `Priority: 0`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
