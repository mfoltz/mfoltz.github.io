---
title: AB_Vampire_IceRanger_VeilOfFrost_DashCast
guid: -123221568
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_IceRanger_VeilOfFrost_DashCast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_IceRanger_VeilOfFrost_DashCast PrefabGuid(-123221568)`
...
- [ProjectM.AbilityIgnoreSettings](/components/AbilityIgnoreSettings)
  - `IgnorePostCast: True`
...
- [ProjectM.HideWeaponDuringCast](/components/HideWeaponDuringCast)
  - `CastStartTime: 0`
  - `Duration: 1`
  - `CastStartCounter: 0`
  - `Type: ProjectM.HideWeaponDuringCastType CastAndPostCast`

- [ProjectM.AbilityRemoveBuffCategoryOnStartCast](/components/AbilityRemoveBuffCategoryOnStartCast)
...
- [ProjectM.AbilitySpawnPrefabOnStartCast](/components/AbilitySpawnPrefabOnStartCast)

- **[0]**
  - `SpawnPrefab: AB_Vampire_IceRanger_VeilOfFrost_Buff PrefabGuid(-1577668019)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_IceRanger_VeilOfFrost_Immaterial PrefabGuid(-1465627289)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
...
- [ProjectM.Shared.SpellModArithmeticModifiable](/components/SpellModArithmeticModifiable)
...
- [ProjectM.IgnoreInCombatBuff](/components/IgnoreInCombatBuff)
