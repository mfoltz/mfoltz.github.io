---
title: CHAR_Militia_Leader_VBlood
guid: 1688478381
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Militia_Leader_VBlood_Downed PrefabGuid(1348079791)`
  - `TriggerSequence: SequenceGUID 420611259`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2063835629)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Militia_Leader_VBlood PrefabGuid(1688478381)`
  - `JournalCategory: ProjectM.JournalCategoryType DunleyFarmlands`
...
- [ProjectM.VBloodUnit](/components/VBloodUnit){:target="_blank"}
  ...
  - `UnlocksTrophyOnFeed: ProjectM.Trophy CompleteAct2`
  - `UnlocksTrophyOnFeedBrutal: ProjectM.Trophy BrutalCompleteAct2`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 0`
  - `GoalDistanceInner: 1.8`
  - `GoalDistanceOuter: 1.8`
  - `MaxDistance: 2.3`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Militia_Leader PrefabGuid(-1176340520)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeHorizontal_AbilityGroup PrefabGuid(-241312231)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeStraight_AbilityGroup PrefabGuid(2142000031)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_LeapAttack_AbilityGroup PrefabGuid(-930424159)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_Whirlwind_v2_AbilityGroup PrefabGuid(-213757827)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_CallAdds_AbilityGroup PrefabGuid(1870073064)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_Whirlwind_v2_Init_AbilityGroup PrefabGuid(-1802655130)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_LeapAttack_Init_AbilityGroup PrefabGuid(-2015856259)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeHorizontal_Hard_AbilityGroup PrefabGuid(976341724)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeHorizontal_HardFollowup_AbilityGroup PrefabGuid(-1228302737)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeStraight_Hard_AbilityGroup PrefabGuid(-746972983)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Militia_MeleeStraight_HardFollowup_AbilityGroup PrefabGuid(-735966107)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_LeapAttack_Hard_AbilityGroup PrefabGuid(-2003945269)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[12]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_DodgeRoll_Right_AbilityGroup PrefabGuid(1946568656)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[13]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Leader_DodgeRoll_Left_AbilityGroup PrefabGuid(-1843696472)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T06_MilitiaCommander PrefabGuid(-1747434949)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T06_MilitiaCommander_WideGate PrefabGuid(2053355293)`

- **[2]**
  - `Guid: Tech_Storage_Pack_Equipment_T02 PrefabGuid(-1605857820)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_VBlood_Militia_Leader PrefabGuid(-882307775)`
...
- **[1]**
  - `DropTableGuid: DT_Unit_VBlood_MilitiaLeader_Armor PrefabGuid(-546249947)`
  - `DropTrigger: ProjectM.Shared.DropTriggerType OnDeath`
  - `RelicType: ProjectM.Shared.RelicType None`
