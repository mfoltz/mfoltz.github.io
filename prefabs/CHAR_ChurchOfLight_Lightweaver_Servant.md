---
title: CHAR_ChurchOfLight_Lightweaver_Servant
guid: -383158562
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server)
  ...
  - `CircleChangeDirectionFrequencyMax: 8`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2147038016)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_ChurchOfLight_Lightweaver_Servant PrefabGuid(-383158562)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 89.195206`
  - `SpellPower: 89.195206`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_Lightweaver_Servant PrefabGuid(1762861569)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_HolyBoltSpray_AbilityGroup PrefabGuid(-839571202)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_HolyBolt_AbilityGroup PrefabGuid(1761660947)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_TeleportRight_AbilityGroup PrefabGuid(-281576382)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_TeleportLeft_AbilityGroup PrefabGuid(1891756809)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_TeleportInit_AbilityGroup PrefabGuid(-284360089)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Lightweaver_HolyTrinity_AbilityGroup PrefabGuid(1876841142)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
