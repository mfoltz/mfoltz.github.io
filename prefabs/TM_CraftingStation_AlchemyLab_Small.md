---
title: TM_CraftingStation_AlchemyLab_Small
guid: 181938440
categories:
- All
- TM
...
# TM_CraftingStation_AlchemyLab_Small
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_AlchemyLab_Small PrefabGuid(181938440) - Entity(7172:3)`
  - `Guid: TM_CraftingStation_AlchemyLab_Small PrefabGuid(181938440)`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 1.16229E-06f, 0f,  0f, 1f, 0f, 0f,  -1.16229E-06f, 0f, -1f, 2.08f,  0f, 0f, 0f, 1f)`
...
- **[2]**
  - `PrefabGUID: Item_Ingredient_Mineral_Sulfur PrefabGuid(880699252)`
  - `Amount: 12`
...
- **[7]**
  - `RecipeGuid: Recipe_Consumable_PhysicalPowerPotion_T01 PrefabGuid(2007269714)`

- **[8]**
  - `RecipeGuid: Recipe_Consumable_SpellPowerPotion_T01 PrefabGuid(1292082146)`

- **[9]**
  - `RecipeGuid: Recipe_Consumable_SilverResistancePotion_T01 PrefabGuid(-1391967609)`

- **[10]**
  - `RecipeGuid: Recipe_Consumable_Explosives_Minor_T01 PrefabGuid(-854411210)`

- **[11]**
  - `RecipeGuid: Recipe_Consumable_EmptyBottle_T02_Crafting PrefabGuid(-97893307)`

- **[12]**
  - `RecipeGuid: Recipe_Consumable_HealingPotion_T02 PrefabGuid(-1715555190)`

- **[13]**
  - `RecipeGuid: Recipe_Consumable_HolyResistancePotion_T01 PrefabGuid(2121527776)`

- **[14]**
  - `RecipeGuid: Recipe_Consumable_GarlicResistancePotion_T02 PrefabGuid(600697104)`

- **[15]**
  - `RecipeGuid: Recipe_Consumable_SilverResistancePotion_T02 PrefabGuid(-878651797)`

- **[16]**
  - `RecipeGuid: Recipe_Consumable_WranglerPotion_T01 PrefabGuid(-1728254159)`

- **[17]**
  - `RecipeGuid: Recipe_Consumable_DuskCaller PrefabGuid(232213040)`

- **[18]**
  - `RecipeGuid: Recipe_Consumable_Explosives_Major_T02 PrefabGuid(-1848951671)`

- **[19]**
  - `RecipeGuid: Recipe_Consumable_IrradiantGruel PrefabGuid(-1031042460)`

- **[20]**
  - `RecipeGuid: Recipe_Consumable_HolyResistancePotion_T02 PrefabGuid(-1672850870)`

- **[21]**
  - `RecipeGuid: Recipe_Consumable_PhysicalPowerPotion_T02 PrefabGuid(-1336809713)`

- **[22]**
  - `RecipeGuid: Recipe_Consumable_SpellPowerPotion_T02 PrefabGuid(-739203329)`

- **[23]**
  - `RecipeGuid: Recipe_Elixir_Crow_T01 PrefabGuid(155374920)`

- **[24]**
  - `RecipeGuid: Recipe_Elixir_Bat_T01 PrefabGuid(-1617853548)`

- **[25]**
  - `RecipeGuid: Recipe_Elixir_Werewolf_T01 PrefabGuid(198966224)`

- **[26]**
  - `RecipeGuid: Recipe_Elixir_Beast_T01 PrefabGuid(-663811339)`

- **[27]**
  - `RecipeGuid: Recipe_Elixir_Prowler_T01 PrefabGuid(79253993)`

- **[28]**
  - `RecipeGuid: Recipe_Elixir_Raven_T01 PrefabGuid(-109469679)`

- **[29]**
  - `RecipeGuid: Recipe_Elixir_Blasphemous_T01 PrefabGuid(654360877)`

- **[30]**
  - `RecipeGuid: Recipe_Elixir_Twisted_T01 PrefabGuid(-2138549072)`

- **[31]**
  - `RecipeGuid: Recipe_WeaponCoating_Blood PrefabGuid(-1487423952)`

- **[32]**
  - `RecipeGuid: Recipe_WeaponCoating_Chaos PrefabGuid(-338717708)`

- **[33]**
  - `RecipeGuid: Recipe_WeaponCoating_Frost PrefabGuid(-789668816)`

- **[34]**
  - `RecipeGuid: Recipe_WeaponCoating_Illusion PrefabGuid(405829513)`

- **[35]**
  - `RecipeGuid: Recipe_WeaponCoating_Storm PrefabGuid(-2034775483)`

- **[36]**
  - `RecipeGuid: Recipe_WeaponCoating_Unholy PrefabGuid(216972181)`
