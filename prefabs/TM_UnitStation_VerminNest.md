---
title: TM_UnitStation_VerminNest
guid: 150776081
categories:
- All
- TM
...
- [UnitSpawnerstation](/components/UnitSpawnerstation){:target="_blank"}
  ...
  - `ActiveSequenceGuid: SequenceGUID -1893989133`
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_UnitStation_VerminNest PrefabGuid(150776081) - Entity(14095:3)`
  - `Guid: TM_UnitStation_VerminNest PrefabGuid(150776081)`
...
- [CastleLimited](/components/CastleLimited){:target="_blank"}
  - `Type: ProjectM.CastleLimitedType VerminNest`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ajdbbbdehe`
...
- [SpawnedUnitsBuffer](/components/SpawnedUnitsBuffer){:target="_blank"}
  - *(No fields)*
...
- [UnitSpawnPointBuffer](/components/UnitSpawnPointBuffer){:target="_blank"}

- **[0]**
  - `Point: Unity.Mathematics.float3 float3(-1.689987f, 0.2f, 4.430005f)`
  - `Rotation: 90.00017`

- **[1]**
  - `Point: Unity.Mathematics.float3 float3(0.7000119f, 0.2f, 4.069998f)`
  - `Rotation: 90.00017`

- **[2]**
  - `Point: Unity.Mathematics.float3 float3(2.030013f, 0.2f, 4.409994f)`
  - `Rotation: 90.00017`
...
- [Snapshot_SpawnedUnitsBuffer](/components/Snapshot_SpawnedUnitsBuffer){:target="_blank"}
  - *(No fields)*
...
- **[0]**
  - `RecipeGuid: Recipe_UnitSpawn_Rat PrefabGuid(255936441)`
  - `Unlocked: True`
  - `Disabled: False`

- **[1]**
  - `RecipeGuid: Recipe_UnitSpawn_GiantRat PrefabGuid(-1953870432)`
  - `Unlocked: True`
  - `Disabled: False`

- **[2]**
  - `RecipeGuid: Recipe_UnitSpawn_PutridRat PrefabGuid(-753029646)`
  - `Unlocked: True`
  - `Disabled: False`

- **[3]**
  - `RecipeGuid: Recipe_UnitSpawn_Mutant PrefabGuid(-591009330)`
  - `Unlocked: False`
  - `Disabled: False`

- **[4]**
  - `RecipeGuid: Recipe_UnitSpawn_Spiderling PrefabGuid(1172635875)`
  - `Unlocked: False`
  - `Disabled: False`

- **[5]**
  - `RecipeGuid: Recipe_UnitSpawn_Mosquito PrefabGuid(-614781206)`
  - `Unlocked: False`
  - `Disabled: False`
