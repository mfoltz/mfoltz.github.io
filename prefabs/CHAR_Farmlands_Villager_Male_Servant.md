---
title: CHAR_Farmlands_Villager_Male_Servant
guid: 1426964824
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Farmlands_Villager_Male_Servant PrefabGuid(1426964824)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_VillagerMale_OnAggro_AbilityGroup_01 PrefabGuid(1055785998)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Villager_Male_MeleeAttack_Group PrefabGuid(-1617717290)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  - `BuffGuid: Buff_ChurchOfLight_Flee_Villager_Male PrefabGuid(1904904415)`
  - `State: ProjectM.GenericEnemyState Flee`

- **[2]**
  - `BuffGuid: Buff_ChurchOfLight_Villager_Cover_Male PrefabGuid(-167087059)`
