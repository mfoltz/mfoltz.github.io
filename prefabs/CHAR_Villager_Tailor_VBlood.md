---
title: CHAR_Villager_Tailor_VBlood
guid: -1942352521
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Villager_Tailor_VBlood_Downed PrefabGuid(-1781284090)`
  - `TriggerSequence: SequenceGUID 418094677`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(482413851)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(1094603131)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Villager_Tailor_VBlood PrefabGuid(-1942352521)`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData){:target="_blank"}
  - `MinDistance: 2`
  - `GoalDistanceInner: 2.75`
  - `GoalDistanceOuter: 2.75`
  - `MaxDistance: 3.5`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Tailor_VBlood PrefabGuid(-1029011269)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Tailor_Shapeshift_AbilityGroup PrefabGuid(1637511208)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Gargoyle_ForwardSwipe_AbilityGroup PrefabGuid(-915929892)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Gargoyle_Relocate_ForwardInit_AbilityGroup PrefabGuid(701450949)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Gargoyle_Relocate_Forward_Travel_AbilityGroup PrefabGuid(1741189817)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Gargoyle_WingShield_AbilityGroup PrefabGuid(1460741503)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Gargoyle_FlyStart_AbilityGroup PrefabGuid(-382913708)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Gargoyle_FlyEnd_AbilityGroup PrefabGuid(1563014858)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Gargoyle_WingShield_Emerge_AbilityGroup PrefabGuid(88850785)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Legion_Gargoyle_Relocate_ForwardInit_ApplyTargetbuff_AbilityGroup PrefabGuid(183752077)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Gargoyle_FlyEnd_Tailor_Hard_AbilityGroup PrefabGuid(1551140710)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1817721948`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -477060600`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T04_Tailor PrefabGuid(1748243393)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T04_Tailor_Curtains PrefabGuid(-1291119657)`
...
- **[0]**
  - `BuffGuid: Buff_Tailor_VBlood_Flee PrefabGuid(-530519474)`
