---
title: TM_RefinementStation_BloodPress_Small
guid: -300823465
categories:
- All
- TM
...
# TM_RefinementStation_BloodPress_Small
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_RefinementStation_BloodPress_Small PrefabGuid(-300823465) - Entity(14179:3)`
  - `Guid: TM_RefinementStation_BloodPress_Small PrefabGuid(-300823465)`
...
- [Refinementstation](/components/Refinementstation){:target="_blank"}
  ...
  - `ActiveSequenceGuid: SequenceGUID 49054500`
