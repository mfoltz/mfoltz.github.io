---
title: AB_Consumable_GarlicResistancePotion_T02_Cast
guid: 834299611
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Consumable_GarlicResistancePotion_T02_Cast
...
- [ProjectM.AbilityState](/components/AbilityState){:target="_blank"}
  - `AbilityId: AB_Consumable_GarlicResistancePotion_T02_Cast PrefabGuid(834299611)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag AbilityKit_IgnoreInCombat, AbilityKit_BreakStealth`
...
- **[0]**
  - `SpawnPrefab: AB_Consumable_GarlicResistancePotion_T02_Activate PrefabGuid(-1077520069)`
