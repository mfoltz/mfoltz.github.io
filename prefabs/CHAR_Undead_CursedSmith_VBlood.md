---
title: CHAR_Undead_CursedSmith_VBlood
guid: 326378955
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server](/components/AiMove_Server){:target="_blank"}
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 0.5`
  - `CircleChangeDirectionFrequencyMax: 2`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Undead_CursedSmith_VBlood_Downed PrefabGuid(126339959)`
  - `TriggerSequence: SequenceGUID 424973335`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(268974871)`
...
- [ProjectM.FactionReference](/components/FactionReference){:target="_blank"}
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(1522496317)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Undead_CursedSmith_VBlood PrefabGuid(326378955)`
...
- [ProjectM.VBloodUnit](/components/VBloodUnit){:target="_blank"}
  ...
  - `UnlocksTrophyOnFeed: ProjectM.Trophy CompleteAct3`
  - `UnlocksTrophyOnFeedBrutal: ProjectM.Trophy BrutalCompleteAct3`
...
- [ProjectM.UnitStats](/components/UnitStats){:target="_blank"}
  - `PhysicalPower: 73.663246`
  - `SpellPower: 73.663246`
  - `ResourcePower: 43.199997`
  - `SiegePower: 17`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Undead_CursedSmith_VBlood PrefabGuid(1590018798)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_MeleeAttack_AbilityGroup PrefabGuid(1700777111)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_HammerSlam_AbilityGroup PrefabGuid(-1502523453)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_SpearThrust_AbilityGroup PrefabGuid(-943061757)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_SwordDash_AbilityGroup PrefabGuid(-668888775)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_MultiDash_AbilityGroup PrefabGuid(-329078808)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_MultiDash_Charge_AbilityGroup PrefabGuid(340003308)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponSlashers_AbilityGroup PrefabGuid(151173850)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponMace_AbilityGroup PrefabGuid(546685538)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponSword_AbilityGroup PrefabGuid(-332863103)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponSpear_AbilityGroup PrefabGuid(1162725480)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponAxe_AbilityGroup PrefabGuid(-1889094547)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Undead_CursedSmith_Summon_WeaponAll_AbilityGroup PrefabGuid(847476786)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_CursedSmith PrefabGuid(-1633289177)`
...
- **[0]**
  - `BuffGuid: Buff_Undead_CursedSmith_InCombat PrefabGuid(-1977989346)`
