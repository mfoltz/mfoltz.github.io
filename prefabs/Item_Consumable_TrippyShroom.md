---
title: Item_Consumable_TrippyShroom
guid: -1566269773
categories:
- All
- Item
...
- [ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Consumable_TrippyShroom PrefabGuid(-1566269773)`
  - `DropItemPrefab: Resource_Drop_General PrefabGuid(-1221682951)`
  - `DropItemArc: GUID Not Found`
  - `MaxAmount: 5`
  - `ItemType: ProjectM.ItemType Consumable`
  - `ItemCategory: ProjectM.ItemCategory Consumable, Herb`
  - `RemoveOnConsume: True`
  - `SortOrder: 25`

- [CastAbilityOnConsume](/components/CastAbilityOnConsume){:target="_blank"}
  - `AbilityGuid: AB_Consumable_Eat_TrippyShroom_AbilityGroup PrefabGuid(-1072457678)`
