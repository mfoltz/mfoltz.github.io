---
title: TM_RefinementStation_Loom_Large
guid: 1299929048
categories:
- All
- TM
...
# TM_RefinementStation_Loom_Large
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_RefinementStation_Loom_Large PrefabGuid(1299929048) - Entity(12096:3)`
  - `Guid: TM_RefinementStation_Loom_Large PrefabGuid(1299929048)`
...
- [Refinementstation](/components/Refinementstation){:target="_blank"}
  ...
  - `ActiveSequenceGuid: SequenceGUID 1952935225`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 0f, -0.044f,  0f, 1f, 0f, 0.12f,  0f, 0f, -1f, 1.671f,  0f, 0f, 0f, 1f)`
...
- **168 total elements but only showing the first 36**
  - *(No fields)*
...
- **[1]**
  - `PrefabGUID: Item_Ingredient_Silk PrefabGuid(702067317)`
  - `Amount: 4`
...
- **[8]**
  - `RecipeGuid: Recipe_Ingredient_GhostYarn PrefabGuid(-312139320)`
  - `Unlocked: False`
  - `Disabled: False`

- **[9]**
  - `RecipeGuid: Recipe_Ingredient_ShadowWeave PrefabGuid(-279454572)`
  - `Unlocked: False`
  - `Disabled: False`
