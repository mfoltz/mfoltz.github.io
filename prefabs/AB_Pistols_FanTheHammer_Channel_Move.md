---
title: AB_Pistols_FanTheHammer_Channel_Move
guid: -1028216735
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Pistols_FanTheHammer_Channel_Move
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnTick_DataServer](/components/AbilityProjectileFanOnTick_DataServer)
  - `Angle: 0`
  - `RandomOffset: 0`
  - `IndividualRandom: 0.20943952`
  - `NewProjectileEntity: AB_Pistols_FanTheHammer_Projectile PrefabGuid(-1279354734)`
...
- [ProjectM.CreateGameplayEventOnItemEquipped](/components/CreateGameplayEventOnItemEquipped)
...
- **[0]**
  - `SequenceGuid: SequenceGUID -982273592`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Pistols_FanTheHammer_Move PrefabGuid(1311781547)`
