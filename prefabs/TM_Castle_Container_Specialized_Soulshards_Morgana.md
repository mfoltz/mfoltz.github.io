---
title: TM_Castle_Container_Specialized_Soulshards_Morgana
guid: 1724128982
categories:
- All
- TM
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_Container_Specialized_Soulshards_Morgana PrefabGuid(1724128982) - Entity(41466:2)`
  - `Guid: TM_Castle_Container_Specialized_Soulshards_Morgana PrefabGuid(1724128982)`
...
- **[0]**
  - `Entity: Prefab GUID Not Found - Entity(11948:3)`
  - `BlobIndex: 1`

- **[1]**
  - `Entity: Prefab GUID Not Found - Entity(11947:3)`
  - `BlobIndex: 4`
...
- **[0]**
  ...
  - `RestrictedType: Item_MagicSource_SoulShard_Morgana PrefabGuid(1286615355)`
...
- **[0]**
  - `Value: Prefab TM_Castle_Container_Specialized_Soulshards_Morgana PrefabGuid(1724128982) - Entity(41466:2)`

- **[1]**
  - `Value: Prefab GUID Not Found - Entity(11948:3)`

- **[2]**
  - `Value: Prefab GUID Not Found - Entity(11947:3)`
