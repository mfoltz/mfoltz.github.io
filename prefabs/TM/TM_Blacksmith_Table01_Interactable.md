---
title: TM_Blacksmith_Table01_Interactable
nav_order: 1
parent: TM Prefabs
---

# TM_Blacksmith_Table01_Interactable

**Prefab GUID:** `-1639959073`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Blacksmith_Table_Destory01 PrefabGuid(-399565792)`
  - `AlwaysSpawn: False`
