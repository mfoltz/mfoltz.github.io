---
title: TM_TargetDummy_01_IdleInteraction
nav_order: 1
parent: TM Prefabs
---

# TM_TargetDummy_01_IdleInteraction

**Prefab GUID:** `-963995563`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Bandit_TargetDummy01 PrefabGuid(-140896529)`
  - `AlwaysSpawn: False`
