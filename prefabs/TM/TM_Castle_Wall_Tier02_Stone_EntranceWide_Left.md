...
- **ProjectM.BlueprintData**
  - `Entity: Prefab TM_Castle_Wall_Tier02_Stone_EntranceWide_Left PrefabGuid(1960255814) - Entity(10107:2)`
...
- **[0]**
  - `Entity: Entity(8897:2)`
  - `BlobIndex: 15`

- **[1]**
  - `Entity: Entity(8898:2)`
  - `BlobIndex: 17`
...
- **[0]**
  - `Value: Prefab TM_Castle_Wall_Tier02_Stone_EntranceWide_Left PrefabGuid(1960255814) - Entity(10107:2)`
