...
- **ProjectM.BlueprintData**
  - `Entity: Prefab TM_SpecialStation_StablePen PrefabGuid(-336743839) - Entity(10109:2)`
...
- **[0]**
  - `Entity: Entity(9067:2)`
  - `BlobIndex: 11`

- **[1]**
  - `Entity: Entity(8813:2)`
  - `BlobIndex: 12`

- **[2]**
  - `Entity: Entity(8814:2)`
  - `BlobIndex: 13`

- **[3]**
  - `Entity: Entity(8453:2)`
  - `BlobIndex: 14`

- **[4]**
  - `Entity: Entity(8452:2)`
  - `BlobIndex: 15`

- **[5]**
  - `Entity: Entity(8815:2)`
  - `BlobIndex: 16`

- **[6]**
  - `Entity: Entity(9068:2)`
  - `BlobIndex: 17`

- **[7]**
  - `Entity: Entity(8459:2)`
  - `BlobIndex: 19`

- **[8]**
  - `Entity: Entity(8461:2)`
  - `BlobIndex: 20`
...
- **[0]**
  - `RendererEntity: Entity(9067:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(8813:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[2]**
  - `RendererEntity: Entity(8814:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[3]**
  - `RendererEntity: Entity(8453:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[4]**
  - `RendererEntity: Entity(8452:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[5]**
  - `RendererEntity: Entity(8815:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[6]**
  - `RendererEntity: Entity(9068:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[7]**
  - `RendererEntity: Entity(8459:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[8]**
  - `RendererEntity: Entity(8461:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_SpecialStation_StablePen PrefabGuid(-336743839) - Entity(10109:2)`
