...
- **ProjectM.BlueprintData**
  - `Entity: Prefab TM_BloodAltar_T01 PrefabGuid(1819321433) - Entity(8752:2)`
...
- **[0]**
  - `Entity: Entity(8460:2)`
  - `BlobIndex: 7`

- **[1]**
  - `Entity: Entity(8457:2)`
  - `BlobIndex: 8`
...
- **[0]**
  - `RendererEntity: Entity(8460:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(8457:2)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_BloodAltar_T01 PrefabGuid(1819321433) - Entity(8752:2)`
