---
title: TM_Destructible_DraculasCastle_Pillar01
nav_order: 1
parent: TM Prefabs
---

# TM_Destructible_DraculasCastle_Pillar01

**Prefab GUID:** `1934867279`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Destructible_DraculasCastle_Pillar01 PrefabGuid(1457203023)`
  - `AlwaysSpawn: True`

- **ProjectM.AiPointOfInterest**
  - `Type: ProjectM.AiPointOfInterestType PowerTower`
...
- **ProjectM.Network.NetworkSnapshot**
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cbkihjjigc`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1259649141`
