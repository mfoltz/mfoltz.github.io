---
title: TM_Gloomrot_MonsterCastle_Breakable_Gate01
nav_order: 1
parent: TM Prefabs
---

# TM_Gloomrot_MonsterCastle_Breakable_Gate01

**Prefab GUID:** `1896589649`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_MonsterCastle_Gate_Destroy01 PrefabGuid(-773439332)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `TargetUnitCategory: ProjectM.UnitCategory PlayerVampire`
  ...
  - `IsBuffTarget: False`
  - `IsStatChangeTarget: True`
  - `TriggerOnZeroDamage: True`
  - `TriggerOnDots: True`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Stun_MonsterGateTrigger PrefabGuid(1884055278)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1811791126`
