---
title: TM_Strongblade_Carvers_Workbench03_IdleInteraction
nav_order: 1
parent: TM Prefabs
---

# TM_Strongblade_Carvers_Workbench03_IdleInteraction

**Prefab GUID:** `-1272496655`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Strongblade_Carvers_Workbench03 PrefabGuid(2032984241)`
  - `AlwaysSpawn: False`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -314380286`
