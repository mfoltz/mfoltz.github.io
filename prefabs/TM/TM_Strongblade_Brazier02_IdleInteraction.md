---
title: TM_Strongblade_Brazier02_IdleInteraction
nav_order: 1
parent: TM Prefabs
---

# TM_Strongblade_Brazier02_IdleInteraction

**Prefab GUID:** `-1263494766`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Strongblade_Brazier02 PrefabGuid(-814672745)`
  - `AlwaysSpawn: False`
