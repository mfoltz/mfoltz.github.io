---
title: TM_Stump_Werewolf_Sapling
nav_order: 1
parent: TM Prefabs
---

# TM_Stump_Werewolf_Sapling

**Prefab GUID:** `297309266`

## Components

- **ProjectM.DestroyWhenNoCharacterNearbyAfterDuration**
  - `RemoveAtTime: 3600`
  - `MinimumRemoveDurationIfNearby: 300`
  - `RandomAdditionalDuration: 900`
...
- **Unity.Transforms.LocalTransform**
  - `Position: Unity.Mathematics.float3 float3(-0.89509f, -0.183f, 0.0080417f)`
  - `Scale: 1`
  - `Rotation: Unity.Mathematics.quaternion quaternion(0f, 0f, 0f, 1f)`

- **Unity.Transforms.PostTransformMatrix**
  - `Value: Unity.Mathematics.float4x4 float4x4(1.3134f, 0f, 0f, 0f,  0f, 1.3134f, 0f, 0f,  0f, 0f, 1.435152f, 0f,  0f, 0f, 0f, 1f)`
