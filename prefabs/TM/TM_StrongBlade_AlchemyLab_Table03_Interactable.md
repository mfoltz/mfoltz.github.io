---
title: TM_StrongBlade_AlchemyLab_Table03_Interactable
nav_order: 1
parent: TM Prefabs
---

# TM_StrongBlade_AlchemyLab_Table03_Interactable

**Prefab GUID:** `-426257034`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_StrongBlade_AlchemyLab_Table03 PrefabGuid(-617997049)`
  - `AlwaysSpawn: False`
