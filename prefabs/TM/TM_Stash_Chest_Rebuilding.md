...
- **ProjectM.BlueprintData**
  - `Entity: Prefab TM_Stash_Chest_Rebuilding PrefabGuid(-220201461) - Entity(28169:2)`
...
- **ProjectM.ShrinkInventoryWhenWithdrawn**
  - *(No fields)*
...
- **ProjectM.CastleBuilding.CastleRebuildTransferContainer**
  - *(No fields)*
