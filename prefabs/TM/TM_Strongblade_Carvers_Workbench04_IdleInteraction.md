---
title: TM_Strongblade_Carvers_Workbench04_IdleInteraction
nav_order: 1
parent: TM Prefabs
---

# TM_Strongblade_Carvers_Workbench04_IdleInteraction

**Prefab GUID:** `-349886488`

## Components

- **ProjectM.SpawnPhysicsObjectOnDeath**
  - `PhysicsObjectPrefab: Dynamic_Strongblade_Carvers_Workbench04 PrefabGuid(-1564346557)`
  - `AlwaysSpawn: False`
...
- **ProjectM.IdleInteractionPointBuffer**
  - *(No fields)*

- **[0]**
  - `Blob: Unity.Entities.BlobAssetReference`1[ProjectM.IdleInteractionPointBuffer+BlobData] Unity.Entities.BlobAssetReference`1[ProjectM.IdleInteractionPointBuffer+BlobData]`
  - `Occupier: Entity(0:0)`
  - `NextValidInteractionTime: 0`

- **ProjectM.PlaySequenceOnDeath**
  - *(No fields)*

- **[0]**
  - `SequenceGuid: SequenceGUID 1691723496`
