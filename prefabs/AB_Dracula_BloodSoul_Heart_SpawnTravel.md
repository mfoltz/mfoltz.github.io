---
title: AB_Dracula_BloodSoul_Heart_SpawnTravel
guid: -1860630814
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Dracula_BloodSoul_Heart_SpawnTravel
...
- [ProjectM.OffsetTranslationOnSpawn](/components/OffsetTranslationOnSpawn){:target="_blank"}
  - `Offset: Unity.Mathematics.float3 float3(0f, 10f, 0f)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Dracula_BloodSoul_Heart_MoveTowardsOwnerBuff PrefabGuid(1540104932)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1001789586`
