---
title: TM_SpecialStation_PrisonCell_StrongbladeDLC
guid: 371396732
categories:
- All
- TM
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732) - Entity(6867:3)`
  - `Guid: TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732)`
...
- [DyeableCastleObject](/components/DyeableCastleObject){:target="_blank"}
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cfhefejgci`
...
- **[0]**
  - `Entity: Entity(12328:3)`
  - `BlobIndex: 13`

- **[1]**
  - `Entity: Entity(12329:3)`
  - `BlobIndex: 14`
...
- **[0]**
  - `RendererEntity: Entity(12328:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(12329:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_SpecialStation_PrisonCell_StrongbladeDLC PrefabGuid(371396732) - Entity(6867:3)`

- **[1]**
  - `Value: Entity(12328:3)`

- **[2]**
  - `Value: Entity(12329:3)`
