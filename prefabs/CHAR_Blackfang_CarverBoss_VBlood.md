---
title: CHAR_Blackfang_CarverBoss_VBlood
guid: -1669199769
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
# CHAR_Blackfang_CarverBoss_VBlood
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer](/components/Script_ApplyBuffUnderHealthThreshold_DataServer){:target="_blank"}
  - `HealthFactor: 0`
  - `NewBuffEntity: Buff_Downed_CarverBoss_VBlood PrefabGuid(-2026519961)`
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser){:target="_blank"}
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-2054066259)`
...
- [ProjectM.VBloodConsumeSource](/components/VBloodConsumeSource){:target="_blank"}
  - `Source: CHAR_Blackfang_CarverBoss_VBlood PrefabGuid(-1669199769)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding){:target="_blank"}
  - `PrefabGUID: BEH_Blackfang_CarverBoss_VBlood PrefabGuid(-1322551720)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_WildSwings_AbilityGroup PrefabGuid(-1457510412)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_ChopLeap_AbilityGroup PrefabGuid(-1796211602)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_BodySlam_AbilityGroup PrefabGuid(1798105602)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_CoatWeapon_AbilityGroup PrefabGuid(964878669)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_MegaCleave_AbilityGroup PrefabGuid(2102431676)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_MegaChopLeap_AbilityGroup PrefabGuid(1147924409)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_SpewCorruption_AbilityGroup PrefabGuid(-833255541)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[7]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_SummonCarvers_AbilityGroup PrefabGuid(-1592003626)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[8]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_SpewCorruption_Small_AbilityGroup PrefabGuid(684024768)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[9]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_WeaponThrow_Intense_AbilityGroup PrefabGuid(1705726981)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[10]**
  - `BaseAbilityGroupOnSlot: AB_CarverBoss_Whirlwind_Init_AbilityGroup PrefabGuid(2103931135)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[11]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_CarverBoss_UltraMegaChopLeap_AbilityGroup PrefabGuid(-1808411682)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- [ProjectM.CreateGameplayEventOnMinionDeath](/components/CreateGameplayEventOnMinionDeath){:target="_blank"}
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(861028343)`
...
- **[0]**
  - `Guid: Tech_Collection_VBlood_T07_Carver PrefabGuid(1092543000)`

- **[1]**
  - `Guid: Tech_Collection_VBlood_T07_Carver_Coating PrefabGuid(-1318816407)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_CarverBoss_VBlood PrefabGuid(1650885803)`
