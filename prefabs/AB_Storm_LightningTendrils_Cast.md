---
title: AB_Storm_LightningTendrils_Cast
guid: -396872793
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Storm_LightningTendrils_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Storm_LightningTendrils_Cast PrefabGuid(-396872793)`
...
- **[0]**
  - `SpawnPrefab: AB_Storm_LightningTendrils_Channel_Move PrefabGuid(259467316)`
...
- **[1]**
  ...
  - `ValueIndex: 0`
  - `Target: ProjectM.Shared.SpellModArithmeticModifiableTarget AbilityMoveDuringCastData_MovementSpeedMultiplier`
  - `TargetIndex: 0`
