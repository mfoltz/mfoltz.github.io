---
title: Item_Saddle_Gloomrot_DLC
guid: -554782766
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData](/components/ItemData){:target="_blank"}
  - `SilverValue: 1`
  - `Entity: Entity(0:0)`
  - `ItemTypeGUID: Item_Saddle_Gloomrot_DLC PrefabGuid(-554782766)`
...
- [ProjectM.SaddleData](/components/SaddleData){:target="_blank"}
  - `MountBuff: AB_Interact_Mount_Owner_Buff_Horse_Vampire_Gloomrot PrefabGuid(-1936451181)`
  - `MaxSpeed: 1`
  - `RotationSpeed: 0`
  - `Acceleration: 1`
