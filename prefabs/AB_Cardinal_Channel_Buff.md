...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1220630514`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[0]**
  - `PrimarySequenceGuid: SequenceGUID 12085657`
...
- **[0]**
  - `Value: AB_Cardinal_Channel_Throw PrefabGuid(-1890273561)`
