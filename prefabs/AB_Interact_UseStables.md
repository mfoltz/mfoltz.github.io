...
- [ProjectM.UI.GoToHUDMenu](/components/GoToHUDMenu){:target="_blank"}
  - `Delay: 0`
  - `IsHandled: False`
  - `MenuType: ProjectM.UI.HUDMenuType StablesMenu`
...
- [ProjectM.Network.ModifyRotation](/components/ModifyRotation){:target="_blank"}
  ...
  - `TargetDirectionType: ProjectM.Network.TargetDirectionType TowardsSpellTargetInteractPosition`
