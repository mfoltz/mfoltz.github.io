---
title: TM_SpecialStation_MusicPlayer
guid: 1278389141
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData](/components/BlueprintData)
  - `Entity: Prefab TM_SpecialStation_MusicPlayer PrefabGuid(1278389141) - Entity(12162:3)`
  - `Guid: TM_SpecialStation_MusicPlayer PrefabGuid(1278389141)`
...
- [ProjectM.MusicPlayerStation_Server](/components/MusicPlayerStation_Server)
  - `StateStartTime: -3.4028234663852886E+38`

- [ProjectM.MusicPlayer_Shared](/components/MusicPlayer_Shared)
  - `State: ProjectM.MusicPlayerState Playback_Music`
...
- [ProjectM.CastleLimited](/components/CastleLimited)
  - `Type: ProjectM.CastleLimitedType MusicPlayer`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot)
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_jdhhjbfbf`
...
- **[0]**
  ...
  - `Component   �Ҁ�<         �s`
  - `ConditionalElements`
  - `Ability: AB_Interact_UseMusicPlayerStation_AbilityGroup PrefabGuid(2145896190)`
  - `Importance: 1`
...
- [ProjectM.MusicPlayerStation_PlaylistElement](/components/MusicPlayerStation_PlaylistElement)

- [ProjectM.MusicPlayerStation_UnlockedTrackElement](/components/MusicPlayerStation_UnlockedTrackElement)
...
- [ProjectM.Network.Snapshot_MusicPlayerStation_PlaylistElement](/components/Snapshot_MusicPlayerStation_PlaylistElement)

- [ProjectM.Network.Snapshot_MusicPlayerStation_UnlockedTrackElement](/components/Snapshot_MusicPlayerStation_UnlockedTrackElement)
