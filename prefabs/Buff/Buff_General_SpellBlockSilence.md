---
title: Buff_General_SpellBlockSilence
nav_order: 1
parent: Buff Prefabs
---

# Buff_General_SpellBlockSilence

**Prefab GUID:** `-1351580266`
...
- **[0]**
  - `EventId: Local - -442757436`
  - `Type: ProjectM.AbilityTriggerEventType Cast`
  - `Target: ProjectM.GameplayEventTarget BuffTarget`
  - `Condition: None`
  - `AbilityTypes: ProjectM.AbilityTypeFlag 4294967281`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Silence PrefabGuid(385404312)`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -442757436`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
