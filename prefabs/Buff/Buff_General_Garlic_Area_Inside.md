...
- **ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataServer**
  - `DynamicStacks: 0`
...
- **ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataShared**
  - `IsInArea: False`
