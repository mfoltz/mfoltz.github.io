---
title: Buff_General_Disconnected
nav_order: 1
parent: Buff Prefabs
---

# Buff_General_Disconnected

**Prefab GUID:** `1769215014`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_DisconnectedTemporaryImmunity PrefabGuid(915954162)`
...
- **[0]**
  ...
  - `BuffCategoryFlag: ProjectM.BuffCategoryFlag RemoveOnDisconnect`
  - `IncludeSelf: False`

- **[1]**
  - `EventIndex: 1`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(915954162)`
