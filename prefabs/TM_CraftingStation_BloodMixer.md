---
title: TM_CraftingStation_BloodMixer
guid: -969931747
categories:
- All
- TM
...
- **ProjectM.BloodMixer_Shared**
  - `PrimaryPotionEntity: NetworkedEntity(0:0)`
  - `SecondaryPotionEntity: NetworkedEntity(0:0)`
  - `State: ProjectM.BloodMixerState NotReadyToMix`
  - `MixStartTime: 0`
  - `Blob: Unity.Entities.BlobAssetReference`1[ProjectM.BloodMixer_Shared+BlobData] Unity.Entities.BlobAssetReference`1[ProjectM.BloodMixer_Shared+BlobData]`
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_CraftingStation_BloodMixer PrefabGuid(-969931747) - Entity(7166:3)`
  - `Guid: TM_CraftingStation_BloodMixer PrefabGuid(-969931747)`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_aedkcidggd`
...
- **[0]**
  ...
  - `Component   �Ҁ�<         �s`
  - `ConditionalElements`
  - `Ability: AB_Interact_UseBloodMixer_AbilityGroup PrefabGuid(922855296)`
  - `Importance: 1`
...
- **[3]**
  - `PrefabGUID: Item_Ingredient_CorruptedSap PrefabGuid(2012771684)`
  - `Amount: 32`
