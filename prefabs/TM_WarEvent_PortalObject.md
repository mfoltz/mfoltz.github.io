...
- [ProjectM.Shared.WarEvents.Script_WarEvent_PortalToGateSequenceData](/components/Script_WarEvent_PortalToGateSequenceData)
  - `SequenceState: SequenceState`
  - `Id: Entity(0:0)`
  - `SequenceGuid: SequenceGUID -288098879`
  - `GatePosition: Unity.Mathematics.float3 float3(0f, 0f, 0f)`

- [ProjectM.Shared.WarEvents.WarEvent_ActivePortal](/components/WarEvent_ActivePortal)
  - `Entity: Entity(0:0)`
...
- [ProjectM.Shared.WarEvents.WarEvent_NetworkedPortal](/components/WarEvent_NetworkedPortal)
  - `Progress: 0`
