---
title: TM_Castle_ObjectDecor_Parent_Metal_Vase03
guid: -1227210056
categories:
- All
- TM
...
# TM_Castle_ObjectDecor_Parent_Metal_Vase03
...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_Castle_ObjectDecor_Parent_Metal_Vase03 PrefabGuid(-1227210056) - Entity(14091:3)`
...
- [DyeableCastleObject](/components/DyeableCastleObject){:target="_blank"}
  - `ColorSwatchAssetGuid: DyeCollection_Default_Metal PrefabGuid(-592971806)`
  - `NumColorChoices: 4`
  - `PrevColorIndex: 255`
  - `ActiveColorIndex: 0`
