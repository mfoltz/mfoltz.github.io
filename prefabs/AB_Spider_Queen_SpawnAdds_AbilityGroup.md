---
title: AB_Spider_Queen_SpawnAdds_AbilityGroup
guid: -1779071085
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Spider_Queen_SpawnAdds_AbilityGroup
...
- **[0]**
  - `PrefabGUID: AB_Spider_Queen_SpawnAdds_Cast_Melee PrefabGuid(-728018205)`

- **[1]**
  - `PrefabGUID: AB_Spider_Queen_SpawnAdds_Cast_Explosive PrefabGuid(-91153538)`

- **[2]**
  - `PrefabGUID: AB_Spider_Queen_SpawnAdds_Cast_Ranged PrefabGuid(1616741584)`

- **[3]**
  - `PrefabGUID: AB_Spider_Queen_SpawnAdds_Cast_Small PrefabGuid(-1650304246)`
