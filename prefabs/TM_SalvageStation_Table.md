...
- [BlueprintData](/components/BlueprintData){:target="_blank"}
  - `Entity: Prefab TM_SalvageStation_Table PrefabGuid(-1719849142) - Entity(12080:3)`
...
- [Salvagestation](/components/Salvagestation){:target="_blank"}
  ...
  - `Progress: 0`
  - `CurrentItemGuid: GUID Not Found`
  - `Status: ProjectM.SalvageStatus Normal`
  - `InventoryPrefabGuid: Refinementstation_Inventory PrefabGuid(-534407618)`
  - `ActiveSequenceGuid: SequenceGUID 272405597`
...
- [ServantInteractPointLocalTransform](/components/ServantInteractPointLocalTransform){:target="_blank"}
  - `Value: Unity.Mathematics.float4x4 float4x4(-1f, 0f, 0f, 0f,  0f, 1f, 0f, 0f,  0f, 0f, -1f, 1.609f,  0f, 0f, 0f, 1f)`
...
- [NetworkSnapshot](/components/NetworkSnapshot){:target="_blank"}
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cgggkhkhhg`
...
- **[0]**
  ...
  - `Component ��X�<  �Ҁ�<      `
  - `ConditionalElements`
  - `Ability: AB_Interact_UseSalvageStation_AbilityGroup PrefabGuid(-3758365)`
  - `Importance: 1`
...
- **[0]**
  - `StationBonusGuid: StationBonus_Salvagestation_4_BloodEssence_Power PrefabGuid(596857655)`

- **[1]**
  - `StationBonusGuid: StationBonus_Salvagestation_1_ConfinedRoom PrefabGuid(-610002994)`
