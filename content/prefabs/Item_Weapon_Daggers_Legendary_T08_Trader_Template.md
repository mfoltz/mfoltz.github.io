---
title: Item_Weapon_Daggers_Legendary_T08_Trader_Template
guid: 1719144622
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Daggers_Legendary_T08_Trader_Template PrefabGuid(1719144622) - Entity(19529:1)`
  - `ItemTypeGUID: Item_Weapon_Daggers_Legendary_T08_Trader_Template PrefabGuid(1719144622)`
...
- [ProjectM.Shared.LegendaryItemTemplate]({{% relref "components/LegendaryItemTemplate.md" %}})
  - `TemplateLevel: 88`
  - `TemplateWeaponType: ProjectM.WeaponType Daggers`
