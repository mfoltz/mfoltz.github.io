---
title: AB_Blackfang_Venomblade_Venomstrike_Cast01
guid: 1686276280
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Venomblade_Venomstrike_Cast01 PrefabGuid(1686276280)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Venomblade_Venomstrike_Hit01 PrefabGuid(-1151037369)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Venomblade_Venomstrike_CoatingRemovalBuff PrefabGuid(-1258648411)`
  - `BuffDuration: 0`
  - `Condition: None`
