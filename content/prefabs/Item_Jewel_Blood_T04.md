...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Blood_T04 PrefabGuid(271061481) - Entity(11731:1)`
  - `ItemTypeGUID: Item_Jewel_Blood_T04 PrefabGuid(271061481)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Blood_T04 PrefabGuid(-1589272885)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
