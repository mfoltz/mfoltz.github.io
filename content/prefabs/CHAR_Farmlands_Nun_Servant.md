---
title: CHAR_Farmlands_Nun_Servant
guid: -1788957652
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1521472556)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Farmlands_Nun_Servant PrefabGuid(-1788957652)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 49.434765`
  - `SpellPower: 49.434765`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Farmlands_Nun_Servant PrefabGuid(1736342550)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Nun_Projectile_Group PrefabGuid(-1199987827)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Nun_AoE_AbilityGroup PrefabGuid(919394375)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Nun_MeleeAttack_Group PrefabGuid(22263894)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
