---
title: AB_Mutant_Rat_Scratch_MutantBlood_Cast
guid: 298951273
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Mutant_Rat_Scratch_MutantBlood_Cast PrefabGuid(298951273)`
...
- **[0]**
  - `SpawnPrefab: AB_Mutant_Rat_Scratch_MutantBlood_Hit PrefabGuid(1568098360)`
