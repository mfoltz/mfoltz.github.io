---
title: AB_Vampire_Dracula_WolfAttack_Cast
guid: -1271478385
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Dracula_WolfAttack_Cast PrefabGuid(-1271478385)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfAttack_Hit PrefabGuid(29118071)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_WolfAttack_StartCastBuff PrefabGuid(1681410652)`
  - `BuffDuration: 0`
  - `Condition: None`
