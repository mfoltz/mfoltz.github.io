---
title: AB_Undead_CursedSmith_SpearThrust_Cast
guid: 2005022536
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_CursedSmith_SpearThrust_Cast PrefabGuid(2005022536)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_SpearThrust_Projectile PrefabGuid(-420853520)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_SpearBuff PrefabGuid(1926914760)`
  - `BuffDuration: 0`
  - `Condition: None`
