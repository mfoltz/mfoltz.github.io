...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Respawn_TombCoffin PrefabGuid(1398472022) - Entity(12005:3)`
  - `Guid: TM_Respawn_TombCoffin PrefabGuid(1398472022)`
...
- [ProjectM.RespawnPoint]({{% relref "components/RespawnPoint.md" %}})
  ...
  - `SpawnDelayBuff: AB_Interact_TombCoffinSpawn_Travel_Delay PrefabGuid(-165284501)`
