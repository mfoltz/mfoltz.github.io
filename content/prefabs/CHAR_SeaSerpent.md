...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(204893615)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_MeleeAttack_AbilityGroup PrefabGuid(1115346958)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_FrostProjectile_AbilityGroup PrefabGuid(1506479890)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
