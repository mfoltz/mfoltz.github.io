---
title: AB_Cursed_MountainBeast_WhackAVampBuff_Cast
guid: -163700765
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_MountainBeast_WhackAVampBuff_Cast PrefabGuid(-163700765)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_WhackAVampBuff_Buff PrefabGuid(446453312)`
...
- **[1]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_WhackAVamp_AggroBuff PrefabGuid(-387360817)`
...
- **[2]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_WhackAVampBuff_InteruptBuff PrefabGuid(-1693341097)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
