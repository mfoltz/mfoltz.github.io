...
- [ProjectM.Sequencer.ImpactMaterialMappingBuffer]({{% relref "components/ImpactMaterialMappingBuffer.md" %}})

- **[0]**
  - `Type: ProjectM.Sequencer.ImpactMaterialType Flesh`
  - `Sequence: SequenceGUID 1520509618`

- **[1]**
  - `Type: ProjectM.Sequencer.ImpactMaterialType Rock`
  - `Sequence: SequenceGUID -1338181542`

- **[2]**
  - `Type: ProjectM.Sequencer.ImpactMaterialType Metal`
  - `Sequence: SequenceGUID -288201061`

- **[3]**
  - `Type: ProjectM.Sequencer.ImpactMaterialType Wood`
  - `Sequence: SequenceGUID -834075926`
...
- **[5]**
  ...
  - `Sequence: SequenceGUID -566381382`
...
- **[9]**
  ...
  - `Sequence: SequenceGUID -1710827012`
...
- **[14]**
  ...
  - `Sequence: SequenceGUID -784859877`
...
- **[16]**
  ...
  - `Sequence: SequenceGUID 694741325`
