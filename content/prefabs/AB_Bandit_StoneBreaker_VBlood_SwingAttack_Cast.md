---
title: AB_Bandit_StoneBreaker_VBlood_SwingAttack_Cast
guid: 26586665
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_StoneBreaker_VBlood_SwingAttack_Cast PrefabGuid(26586665)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_VBlood_SwingAttack_Hit PrefabGuid(207297823)`
