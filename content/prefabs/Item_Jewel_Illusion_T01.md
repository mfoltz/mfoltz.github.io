...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Illusion_T01 PrefabGuid(1387124262) - Entity(11737:1)`
  - `ItemTypeGUID: Item_Jewel_Illusion_T01 PrefabGuid(1387124262)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Illusion_T01 PrefabGuid(1885790026)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- [ProjectM.Shared.JewelInstance]({{% relref "components/JewelInstance.md" %}})
  ...
  - `TierIndex: 0`
  - `OverrideAbilityType: GUID Not Found`
  - `Initialized: False`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Miststone_T01 PrefabGuid(-1129708579)`
  - `Amount: 1`
