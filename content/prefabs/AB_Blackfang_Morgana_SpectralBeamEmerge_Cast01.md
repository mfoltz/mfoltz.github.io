---
title: AB_Blackfang_Morgana_SpectralBeamEmerge_Cast01
guid: -811904132
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_SpectralBeamEmerge_Cast01 PrefabGuid(-811904132)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeam_ThrowHit PrefabGuid(2116092559)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeam_AggroBuff PrefabGuid(600294053)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeamEmerge_StartTrigger PrefabGuid(-1430340649)`
  - `BuffDuration: 0`
  - `Condition: None`
