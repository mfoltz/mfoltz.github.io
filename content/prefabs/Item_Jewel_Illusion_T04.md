...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Illusion_T04 PrefabGuid(97169184) - Entity(11689:1)`
  - `ItemTypeGUID: Item_Jewel_Illusion_T04 PrefabGuid(97169184)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Illusion_T04 PrefabGuid(86391798)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
