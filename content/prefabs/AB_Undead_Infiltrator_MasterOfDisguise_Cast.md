---
title: AB_Undead_Infiltrator_MasterOfDisguise_Cast
guid: 2070389139
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_Infiltrator_MasterOfDisguise_Cast PrefabGuid(2070389139)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Infiltrator_MasterOfDisguise_InitBuff PrefabGuid(1493773465)`
