---
title: AB_Purifier_MeleeAttack_Left_Cast
guid: 1964316578
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Purifier_MeleeAttack_Left_Cast PrefabGuid(1964316578)`
...
- **[0]**
  - `SpawnPrefab: AB_Purifier_MeleeAttack_Left_Hit PrefabGuid(378511410)`
