---
title: AB_Gloomrot_TractorBeamer_MeleeAttack_Cast
guid: 1901494574
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Gloomrot_TractorBeamer_MeleeAttack_Cast PrefabGuid(1901494574)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TractorBeamer_MeleeAttack_Hit PrefabGuid(192129816)`
