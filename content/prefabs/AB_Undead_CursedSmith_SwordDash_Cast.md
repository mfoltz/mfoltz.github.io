---
title: AB_Undead_CursedSmith_SwordDash_Cast
guid: 1554742526
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_CursedSmith_SwordDash_Cast PrefabGuid(1554742526)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_SwordDash_Hit PrefabGuid(2126017567)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_SwordDash_Buff PrefabGuid(321665990)`
  - `BuffDuration: 3`
  - `Condition: None`
