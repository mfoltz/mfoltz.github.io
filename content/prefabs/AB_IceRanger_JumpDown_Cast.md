---
title: AB_IceRanger_JumpDown_Cast
guid: -1965997143
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_IceRanger_JumpDown_Cast PrefabGuid(-1965997143)`
...
- **[0]**
  - `SpawnPrefab: AB_IceRanger_JumpDown_Travel PrefabGuid(1937056675)`
...
- **[1]**
  - `SpawnPrefab: AB_IceRanger_JumpDown_Buff PrefabGuid(516505385)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
