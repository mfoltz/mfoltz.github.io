---
title: AB_Wendigo_IcicleThrow_Cast01
guid: 134028684
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Wendigo_IcicleThrow_Cast01 PrefabGuid(134028684)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IcicleThrow_Projectile01 PrefabGuid(1412298771)`
...
- **[1]**
  - `SpawnPrefab: AB_Wendigo_IcicleThrow_TargetedBuff PrefabGuid(397468784)`
...
- **[2]**
  - `SpawnPrefab: AB_Wendigo_IcicleThrow_AggroBuff PrefabGuid(2129114841)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
