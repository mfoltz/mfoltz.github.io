---
title: AB_Militia_Leader_LeapAttack_Hard_Cast
guid: -1166416993
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Leader_LeapAttack_Hard_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Militia_Leader_LeapAttack_Hard_Cast PrefabGuid(-1166416993)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Leader_LeapAttack_Hard_Travel PrefabGuid(-1484576719)`
...
- **[1]**
  - `SpawnPrefab: Ab_Militia_Leader_LeapAttack_WasTargetedBuff PrefabGuid(1012806549)`
