---
title: CHAR_Cursed_MountainBeast_SpiritDouble
guid: -935560085
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-190890945)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_jfbbddgci`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Cursed_MountainBeast_SpiritDouble PrefabGuid(-175078664)`
...
- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Cursed_MountainBeast_SpiritDouble_EngageCircling_AbilityGroup PrefabGuid(2091042632)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Cursed_MountainBeast_SpiritDouble_SpiritBuff PrefabGuid(-1483505218)`
...
- **91 total elements but only showing the first 36**
