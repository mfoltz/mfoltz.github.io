...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1734429955)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 26.644583`
  - `SpellPower: 26.644583`
  - `ResourcePower: 22`
  - `SiegePower: 10`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_ManTrap PrefabGuid(1147513069)`
...
- [Unity.Transforms.LocalTransform]({{% relref "components/LocalTransform.md" %}})
  - `Position: Unity.Mathematics.float3 float3(-3121.306f, 35.89385f, -3073.056f)`
  - `Scale: 1`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ManTrap_MeleeAttack_Group PrefabGuid(1238529741)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ManTrap_Projectile_Group PrefabGuid(780372716)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ManTrap_TrippleProjectile_Group PrefabGuid(-359326766)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `BuffGuid: AB_Mantrap_InCombat_Buff PrefabGuid(1981009430)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[1]**
  - `BuffGuid: AB_Mantrap_Wakeup_Buff PrefabGuid(1972665713)`
  - `State: ProjectM.GenericEnemyState Combat, Relocate_Unstuck`

- **[2]**
  - `BuffGuid: AB_Mantrap_Immaterial_Buff PrefabGuid(-1702571933)`
...
- **[4]**
  - `BuffGuid: Buff_Mantrap_Return PrefabGuid(-1508002208)`
  - `State: ProjectM.GenericEnemyState Return`

- [ProjectM.Shared.DropTableBuffer]({{% relref "components/DropTableBuffer.md" %}})

- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Mantrap PrefabGuid(-188826639)`
