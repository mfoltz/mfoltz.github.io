---
title: AB_Shapeshift_Wolf_Bite_Cast
guid: 990205141
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Shapeshift_Wolf_Bite_Cast PrefabGuid(990205141)`
...
- **[0]**
  - `SpawnPrefab: AB_Shapeshift_Wolf_Bite_Hit PrefabGuid(424140303)`
