---
title: AB_Militia_Horseman_AttackChain_Right_Cast
guid: -1796589505
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Horseman_AttackChain_Right_Cast PrefabGuid(-1796589505)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_AttackChain_Right_Hit PrefabGuid(-1957148417)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_AttackChain_Side_Trigger PrefabGuid(395023610)`
  - `BuffDuration: 0`
  - `Condition: None`
