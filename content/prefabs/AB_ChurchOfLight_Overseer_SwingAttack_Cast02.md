---
title: AB_ChurchOfLight_Overseer_SwingAttack_Cast02
guid: 1537811769
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Overseer_SwingAttack_Cast02 PrefabGuid(1537811769)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 0.7853982`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_ChurchOfLight_Overseer_SwingAttack_Projectile PrefabGuid(600760760)`
  - `Count: 3`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_SwingAttack_Hit02 PrefabGuid(-944896771)`
