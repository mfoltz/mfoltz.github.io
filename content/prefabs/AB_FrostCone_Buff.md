...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Frost_Vampire_Buff_IceShield_SpellMod PrefabGuid(57946762)`
...
- **[0]**
  - `SpawnPrefab: AB_FrostCone_ConeEnd PrefabGuid(701417059)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- **[1]**
  - `SpawnPrefab: AB_FrostCone_Cone PrefabGuid(1298763769)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[2]**
  - `SpawnPrefab: AB_FrostCone_Cone_SpellMod_FrostWave PrefabGuid(855985036)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_FrostCone_BonusSpeed PrefabGuid(1362931942)`
