---
title: CHAR_Undead_ArmoredSkeletonCrossbow_Farbane
guid: -195077008
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server]({{% relref "components/AiMove_Server.md" %}})
  ...
  - `CircleChangeDirectionFrequencyMax: 4`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(313535532)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 14.483912`
  - `SpellPower: 14.483912`
  - `ResourcePower: 12.940001`
  - `SiegePower: 7.6000004`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_ArmoredSkeletonCrossbow_Farbane PrefabGuid(-829484818)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SkeletonCrossbow_Shared_Crossbow_Group PrefabGuid(1601771862)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Undead_Trash_Rank01 PrefabGuid(1954673959)`
