...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Storm_T04 PrefabGuid(2023809276) - Entity(11649:1)`
  - `ItemTypeGUID: Item_Jewel_Storm_T04 PrefabGuid(2023809276)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Storm_T04 PrefabGuid(310567762)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
