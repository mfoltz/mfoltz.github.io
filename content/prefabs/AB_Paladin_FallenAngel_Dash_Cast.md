---
title: AB_Paladin_FallenAngel_Dash_Cast
guid: -1841398888
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Paladin_FallenAngel_Dash_Cast PrefabGuid(-1841398888)`
...
- **[0]**
  - `SpawnPrefab: AB_Paladin_FallenAngel_Dash_Phase PrefabGuid(-1774793471)`
...
- **[1]**
  - `SpawnPrefab: Buff_Paladin_FallenAngel_ChaseBuff PrefabGuid(1586158367)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
