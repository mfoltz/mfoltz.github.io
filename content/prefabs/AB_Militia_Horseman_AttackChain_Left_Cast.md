---
title: AB_Militia_Horseman_AttackChain_Left_Cast
guid: 576955485
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Horseman_AttackChain_Left_Cast PrefabGuid(576955485)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_AttackChain_Left_Hit PrefabGuid(1849140734)`
