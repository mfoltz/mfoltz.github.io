---
title: Buff_General_DraculaTeleport_InPhasing
guid: -1274886518
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_Dracula_ChunkBuff_DataServer]({{% relref "components/Script_Dracula_ChunkBuff_DataServer.md" %}})
  ...
  - `VisionRange: 100`
  - `AffectVision: True`
  - `CheckAgainstDraculaVictoryChunk: False`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: Buff_General_Vampire_DraculaSaveDeath_Buff PrefabGuid(-1463475972)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1230519565`
