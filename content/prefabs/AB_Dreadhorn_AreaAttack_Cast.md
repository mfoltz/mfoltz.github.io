---
title: AB_Dreadhorn_AreaAttack_Cast
guid: -141011341
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Dreadhorn_AreaAttack_Cast PrefabGuid(-141011341)`
...
- **[0]**
  - `SpawnPrefab: AB_Dreadhorn_AreaAttack_Channel PrefabGuid(-359582465)`
...
- **[1]**
  - `SpawnPrefab: AB_Dreadhorn_AreaAttack_ForwardHit_First PrefabGuid(-63238360)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
