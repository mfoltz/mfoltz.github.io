...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Blood_T02 PrefabGuid(-996555621) - Entity(11783:1)`
  - `ItemTypeGUID: Item_Jewel_Blood_T02 PrefabGuid(-996555621)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Blood_T02 PrefabGuid(279714151)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
