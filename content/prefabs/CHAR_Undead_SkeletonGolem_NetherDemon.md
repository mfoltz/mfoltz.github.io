---
title: CHAR_Undead_SkeletonGolem_NetherDemon
guid: -1115032717
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1487249374)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0.001`
  - `WoundedTriggerSequenceGuid: SequenceGUID 1430087990`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_SkeletonGolem PrefabGuid(243382278)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_SkeletonGolem_MeleeAttack_AbilityGroup PrefabGuid(-1104043123)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_SkeletonGolem_Dig_AbilityGroup PrefabGuid(2095802125)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_SkeletonGolem_Swallow_AbilityGroup PrefabGuid(937561987)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_SkeletonGolem_Spit_AbilityGroup PrefabGuid(-386396572)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_NetherDemon_Alchemy_T02 PrefabGuid(611831222)`
