---
title: CHAR_Bandit_Deadeye_Servant
guid: -2086044081
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2056907439)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Bandit_Deadeye_Servant PrefabGuid(-2086044081)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Bandit_Deadeye_Servant PrefabGuid(1968787911)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Deadeye_RangedAttack_Group PrefabGuid(1336193986)`
  - `ShowOnBar: True`
