---
title: CHAR_Unholy_SkeletonApprentice_Summon
guid: 722671522
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1513638469)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 14.411361`
  - `SpellPower: 14.411361`
  - `ResourcePower: 14`
  - `SiegePower: 6`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Unholy_SkeletonApprentice_Summon PrefabGuid(284024603)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Unholy_SkeletonApprentice_Projectile_AbilityGroup PrefabGuid(604882732)`
  - `ShowOnBar: True`
