---
title: AB_Vampire_Axe_Primary_Mounted_Cast
guid: 1716063258
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Axe_Primary_Mounted_Cast PrefabGuid(1716063258)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Axe_Primary_Mounted_Hit PrefabGuid(1213681232)`
