...
- [ProjectM.BuffResistances]({{% relref "components/BuffResistances.md" %}})
  ...
  - `InitialSettingGuid: BuffResistance_GolemRockElemental PrefabGuid(1413952432)`
...
- **ProjectM.Gameplay.Scripting.Script_EmeryVeinBuildupData**
  ...
  - `CurrentCooldown: 0`
  - `AllowNPCDamage: True`
  - `DestroyTargetOnTrigger: True`
  - `SpawnPrefab: AB_Emery_Erruption_Elemental_Object PrefabGuid(1751162820)`
  ...
  - `Id: Entity(0:0)`
  - `DestroySequence: SequenceGUID -1686773479`
  - `TargetFactor: 0`
  - `CurrentFactor: 0`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1685893679)`
...
- [ProjectM.ResistanceData]({{% relref "components/ResistanceData.md" %}})
  ...
  - `FireResistance_DamageReductionPerRating: 999`
  - `FireResistance_RedcuedIgiteChancePerRating: 999`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_achikdjiffb`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_EmeryElemental PrefabGuid(1670858012)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_MeleeAttack_AbilityGroup PrefabGuid(1903010945)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_Rollout_AbilityGroup PrefabGuid(1262525269)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_Leap_AbilityGroup PrefabGuid(488481150)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_FallAsleep_Buff_AbilityGroup PrefabGuid(261951503)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_Awake_AbilityGroup PrefabGuid(-992391256)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_EmeryElemental_SelfDetonate_AbilityGroup PrefabGuid(2110769437)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `EntityOwner: ProjectM.SetEntityOwner Default`
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single] 1.5`
  - `Stacks: 1`
  - `Buff0: Buff_General_Stun PrefabGuid(355774169)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `DropTableGuid: DT_Unit_StrongBlade_EmeryElemental PrefabGuid(-887571934)`
