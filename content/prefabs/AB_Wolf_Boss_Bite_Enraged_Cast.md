---
title: AB_Wolf_Boss_Bite_Enraged_Cast
guid: 305221904
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Wolf_Boss_Bite_Enraged_Cast PrefabGuid(305221904)`
...
- **[0]**
  - `SpawnPrefab: AB_Wolf_Boss_Bite_Hit PrefabGuid(1147355783)`
