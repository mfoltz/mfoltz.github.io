---
title: AB_WerewolfChieftain_MultiBite_Cast03
guid: -805017956
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_WerewolfChieftain_MultiBite_Cast03 PrefabGuid(-805017956)`
...
- **[0]**
  - `SpawnPrefab: AB_WerewolfChieftain_MultiBite_Hit PrefabGuid(-2017510904)`
...
- **[1]**
  - `SpawnPrefab: AB_WerewolfChieftain_MultiBite_RemoveHardModeBuffTrigger PrefabGuid(1712419107)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
