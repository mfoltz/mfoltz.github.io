---
title: AB_Gloomrot_RailgunSergeant_EnergyBurst_Channel
guid: 729954206
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_RailgunSergeant_EnergyBurst_Channel
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer)
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Gloomrot_RailgunSergeant_EnergyBurst_Projectile PrefabGuid(1419132893)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Gloomrot_RailgunSergeant_EnergyBurst_PostCast PrefabGuid(-901041664)`
