---
title: AB_ChurchOfLight_Overseer_IceRecovery_Cast
guid: 707899850
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Overseer_IceRecovery_Cast PrefabGuid(707899850)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_IceRecovery_IcicleTrigger PrefabGuid(-1721885814)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_IceRecovery_FreezeBuffTrigger PrefabGuid(1688682323)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
