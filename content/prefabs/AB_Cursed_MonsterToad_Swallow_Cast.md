---
title: AB_Cursed_MonsterToad_Swallow_Cast
guid: 435795094
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_MonsterToad_Swallow_Cast PrefabGuid(435795094)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_MonsterToad_Swallow_Hit PrefabGuid(2094802783)`
