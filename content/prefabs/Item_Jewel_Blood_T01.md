...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Blood_T01 PrefabGuid(-113436752) - Entity(11657:1)`
  - `ItemTypeGUID: Item_Jewel_Blood_T01 PrefabGuid(-113436752)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Blood_T01 PrefabGuid(-445494585)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Ruby_T01 PrefabGuid(287586809)`
  - `Amount: 1`
