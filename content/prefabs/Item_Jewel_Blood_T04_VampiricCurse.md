---
title: Item_Jewel_Blood_T04_VampiricCurse
guid: -1844141622
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Blood_T04_VampiricCurse PrefabGuid(-1844141622) - Entity(11768:1)`
  - `ItemTypeGUID: Item_Jewel_Blood_T04_VampiricCurse PrefabGuid(-1844141622)`
  - `DropItemPrefab: Resource_Drop_Jewel_T04 PrefabGuid(1345661752)`
  - `DropItemArc: GUID Not Found`
  - `MaxAmount: 1`
  - `ItemType: ProjectM.ItemType Jewel`
  - `ItemCategory: ProjectM.ItemCategory Jewel, Magic`
...
- [ProjectM.JewelLevelSource]({{% relref "components/JewelLevelSource.md" %}})
  - `Level: 100`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cdcjidjceb`

- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Blood_T04_VampiricCurse PrefabGuid(1500294983)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`

- [ProjectM.Shared.JewelInstance]({{% relref "components/JewelInstance.md" %}})
  - `SpellSchool: BloodSpellSchoolAsset PrefabGuid(969332277)`
  - `Ability: GUID Not Found`
  - `TierIndex: 3`
  - `OverrideAbilityType: AB_Blood_VampiricCurse_AbilityGroup PrefabGuid(-326374250)`
  - `Initialized: False`
...
- [ProjectM.Shared.GeneratedName]({{% relref "components/GeneratedName.md" %}})
  - `RandomNamePrefix: 0`
  - `RandomNamePostfix: 0`
  - `NameGeneratorPrefixSource: GUID Not Found`
  - `NameGeneratorPostfixSource: GUID Not Found`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Ruby_T03 PrefabGuid(74811721)`
  - `Amount: 1`
...
- **100 total elements but only showing the first 36**
