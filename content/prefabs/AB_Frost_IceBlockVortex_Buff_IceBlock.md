---
title: AB_Frost_IceBlockVortex_Buff_IceBlock
guid: 1374658841
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot)
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_jcdhbjde`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyBuffResistances_DataServer](/components/Script_Buff_ModifyBuffResistances_DataServer)
  - `AssetPrefabGuid: BuffResistance_IceBlock PrefabGuid(-1747607804)`
  - `ModId: Unset`
...
- **[2]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1952731293`
  - `MaxTriggers: 5`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1856154914`
...
- **[1]**
  - `SequenceGuid: SequenceGUID 1482416128`
  - `SequencePositionTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
  - `SequenceRotationTarget: ProjectM.PlaySequenceOnGameplayEventTarget EventTarget`
...
- **[0]**
  - `SpawnPrefab: AB_Frost_IceBlockVortex_Throw PrefabGuid(1786670136)`
...
- **[0]**
  - `Trophy: ProjectM.Trophy UltimatePower`
