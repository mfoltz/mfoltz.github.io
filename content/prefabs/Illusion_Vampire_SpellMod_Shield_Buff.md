...
- [ProjectM.AbsorbCapStackModifier]({{% relref "components/AbsorbCapStackModifier.md" %}})
  - `BaseValue: 0`
  - `Modifier: 1`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Illusion_WeakenShield PrefabGuid(1610681142)`
...
- **[1]**
  - `Condition: None`
  - `SpellMod: SpellMod_Shared_Illusion_ConsumeWeakenShield_Counter PrefabGuid(-1449937438)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 2`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget LifeTime_Duration`
  - `TargetIndex: -1`
...
- **[2]**
  - `Condition: None`
  - `SpellMod: SpellMod_WraithSpear_ShieldAlly PrefabGuid(-1538705520)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget LifeTime_Duration`
  - `TargetIndex: -1`
...
- **[3]**
  - `Condition: None`
  - `SpellMod: SpellMod_Mosquito_ShieldOnSpawn PrefabGuid(-1673859267)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Set`
  - `ValueIndex: 1`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget LifeTime_Duration`
  - `TargetIndex: -1`
