---
title: AB_SeaSerpent_FrostProjectile_Cast
guid: 281240320
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_SeaSerpent_FrostProjectile_Cast PrefabGuid(281240320)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 0.87266463`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_SeaSerpent_FrostProjectile_Projectile PrefabGuid(-565208290)`
  - `Count: 3`
  - `Condition: None`
