...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Illusion_T02 PrefabGuid(437696083) - Entity(11672:1)`
  - `ItemTypeGUID: Item_Jewel_Illusion_T02 PrefabGuid(437696083)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Illusion_T02 PrefabGuid(-443627358)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
