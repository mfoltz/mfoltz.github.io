---
title: CHAR_Spider_Melee_GateBoss_Summon
guid: -725251219
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(887607259)`
...
- [ProjectM.CanPreventDisableWhenNoPlayersInRange]({{% relref "components/CanPreventDisableWhenNoPlayersInRange.md" %}})
  - `CanDisable: True`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_afbdjhjcdd`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Melee_MeleeAttack_Group PrefabGuid(1820645555)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Melee_Webbing_AbilityGroup PrefabGuid(-915534386)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Melee_BackStep_AbilityGroup PrefabGuid(792257682)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Melee_FastMeleeAttack_Group PrefabGuid(1693120911)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- [ProjectM.CharmSource]({{% relref "components/CharmSource.md" %}})
