...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Respawn_WoodenCoffin PrefabGuid(1217011662) - Entity(12004:3)`
  - `Guid: TM_Respawn_WoodenCoffin PrefabGuid(1217011662)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acjckccegbd`
