---
title: AB_EmeryGolem_RockSlam_Cast
guid: -1831353731
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_EmeryGolem_RockSlam_Cast PrefabGuid(-1831353731)`
...
- **[0]**
  - `SpawnPrefab: AB_EmeryGolem_RockSlam_Trigger PrefabGuid(40567962)`
...
- **[1]**
  - `SpawnPrefab: AB_EmeryGolem_RockSlam_Projectile PrefabGuid(1713307649)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
