---
title: AB_Vampire_Crossbow_RainOfBolts_Cast
guid: -753601678
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Crossbow_RainOfBolts_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Crossbow_RainOfBolts_Cast PrefabGuid(-753601678)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Crossbow_RainOfBolts_Trigger PrefabGuid(198834678)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Crossbow_RainOfBolts_Throw_Center PrefabGuid(1037852406)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
