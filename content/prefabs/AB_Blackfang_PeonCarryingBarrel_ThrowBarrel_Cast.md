---
title: AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_Cast
guid: 1112120717
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_Cast PrefabGuid(1112120717)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_Throw PrefabGuid(-36892102)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_PeonCarryingBarrel_ThrowBarrel_Trigger PrefabGuid(-390653002)`
  - `BuffDuration: 0`
  - `Condition: None`
