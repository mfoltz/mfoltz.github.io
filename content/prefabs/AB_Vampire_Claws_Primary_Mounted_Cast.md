---
title: AB_Vampire_Claws_Primary_Mounted_Cast
guid: 1355391975
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Claws_Primary_Mounted_Cast PrefabGuid(1355391975)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Claws_Primary_Mounted_Hit PrefabGuid(1199194441)`
