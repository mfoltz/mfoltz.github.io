---
title: AB_SeaSerpent_MeleeAttack_Cast
guid: 1011930736
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_SeaSerpent_MeleeAttack_Cast PrefabGuid(1011930736)`
...
- **[0]**
  - `SpawnPrefab: AB_SeaSerpent_MeleeAttack_Hit PrefabGuid(567597112)`
