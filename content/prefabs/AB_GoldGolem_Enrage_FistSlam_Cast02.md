---
title: AB_GoldGolem_Enrage_FistSlam_Cast02
guid: 1192389322
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_GoldGolem_Enrage_FistSlam_Cast02 PrefabGuid(1192389322)`
...
- **[0]**
  - `SpawnPrefab: AB_GoldGolem_Enrage_FistSlam_Hit02 PrefabGuid(1417275299)`
...
- **[0]**
  - `SpawnPrefab: AB_GoldGolem_Enrage_Buff PrefabGuid(127536152)`
  - `BuffDuration: 2`
  - `Condition: None`
