---
title: AB_Cursed_Witch_WickedWhisps_Cast
guid: -561783854
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_Witch_WickedWhisps_Cast PrefabGuid(-561783854)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 2.443461`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Cursed_Witch_WickedWhisps_Projectile PrefabGuid(514604229)`
  - `Count: 7`
  - `Condition: None`
