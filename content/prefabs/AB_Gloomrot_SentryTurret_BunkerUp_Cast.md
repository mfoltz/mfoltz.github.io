---
title: AB_Gloomrot_SentryTurret_BunkerUp_Cast
guid: 172770500
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Gloomrot_SentryTurret_BunkerUp_Cast PrefabGuid(172770500)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SentryTurret_BunkerUp_Trigger PrefabGuid(2065070406)`
