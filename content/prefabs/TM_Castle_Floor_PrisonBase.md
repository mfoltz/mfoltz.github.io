---
title: TM_Castle_Floor_PrisonBase
guid: 90417130
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Floor_PrisonBase PrefabGuid(90417130) - Entity(14206:3)`
  - `Guid: TM_Castle_Floor_PrisonBase PrefabGuid(90417130)`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
  - `FloorType: ProjectM.CastleBuilding.CastleFloorTypes Prison`
