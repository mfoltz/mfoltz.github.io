---
title: AB_ChurchOfLight_Overseer_LanceCharge_Cast
guid: 2002922051
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Overseer_LanceCharge_Cast PrefabGuid(2002922051)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_LanceCharge_HasteBuff PrefabGuid(-1916256107)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_LanceCharge_AggroBuff PrefabGuid(60850608)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
