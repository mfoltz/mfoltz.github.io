...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Frost_T01 PrefabGuid(1908312304) - Entity(11692:1)`
  - `ItemTypeGUID: Item_Jewel_Frost_T01 PrefabGuid(1908312304)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Frost_T01 PrefabGuid(-184777350)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Sapphire_T01 PrefabGuid(552409457)`
  - `Amount: 1`
