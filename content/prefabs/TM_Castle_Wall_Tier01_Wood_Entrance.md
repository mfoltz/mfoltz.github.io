---
title: TM_Castle_Wall_Tier01_Wood_Entrance
guid: -1293632412
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Wall_Tier01_Wood_Entrance PrefabGuid(-1293632412) - Entity(7180:3)`
  - `Guid: TM_Castle_Wall_Tier01_Wood_Entrance PrefabGuid(-1293632412)`
...
- [ProjectM.WallpaperStyles]({{% relref "components/WallpaperStyles.md" %}})
  - `SplitsPerStyle: ProjectM.ObjectSplits NotSplit`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_kfjbcdkhb`
...
- **[1]**
  - `PrefabGUID: Item_Ingredient_Plant_PlantFiber PrefabGuid(-1409142667)`
  - `Amount: 30`
