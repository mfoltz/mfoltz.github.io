---
title: CHAR_Gloomrot_SpiderTank_LightningRod
guid: 1655577903
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(290653629)`
...
- [ProjectM.LightningStorm.LightningConsumer]({{% relref "components/LightningConsumer.md" %}})
  - `ReplacePrefab: True`
  - `Prefab: AB_LightningStorm_Throw_RodConsume_SpiderTank PrefabGuid(-1770079230)`
  - `Radius: 15`
  - `ReplacePrefabIgnoreCollision: True`
  - `AlterPosition: False`
  - `SetConsumerAsOwner: True`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Gloomrot_SpiderTank_LightningRod PrefabGuid(2054858693)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_LightningRod_LightShot_AbilityGroup PrefabGuid(-1537394790)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_LightningRod_HeavyBeam_AbilityGroup PrefabGuid(574933909)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SpawnPrefab: Trigger_General_Tank_SpawnPilot PrefabGuid(1484416767)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
