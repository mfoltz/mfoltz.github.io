---
title: AB_Cursed_MountainBeast_DashAttack_Cast
guid: -1491024547
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_MountainBeast_DashAttack_Cast PrefabGuid(-1491024547)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_DashAttack_Phase PrefabGuid(-1216986584)`
...
- **[1]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_DashAttack_TargetedBuff PrefabGuid(287532724)`
