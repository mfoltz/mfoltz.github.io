---
title: Item_Jewel_Storm_T02_LightningTendrils
guid: 90716564
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Storm_T02_LightningTendrils PrefabGuid(90716564) - Entity(11735:1)`
  - `ItemTypeGUID: Item_Jewel_Storm_T02_LightningTendrils PrefabGuid(90716564)`
...
- [ProjectM.Shared.JewelInstance]({{% relref "components/JewelInstance.md" %}})
  ...
  - `TierIndex: 1`
  - `OverrideAbilityType: AB_Storm_LightningTendrils_AbilityGroup PrefabGuid(-1184139778)`
  - `Initialized: False`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Topaz_T02 PrefabGuid(-2118441460)`
  - `Amount: 1`
