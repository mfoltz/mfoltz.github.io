---
title: TM_Castle_Floor_CryptBase
guid: 1901518512
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Floor_CryptBase PrefabGuid(1901518512) - Entity(14217:3)`
  - `Guid: TM_Castle_Floor_CryptBase PrefabGuid(1901518512)`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
  - `FloorType: ProjectM.CastleBuilding.CastleFloorTypes CryptCastle`
