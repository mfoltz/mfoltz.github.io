---
title: AB_Blackfang_Morgana_SpectralBeamSlow_Cast
guid: 2053458243
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_SpectralBeamSlow_Cast PrefabGuid(2053458243)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeamSlow_ThrowHit PrefabGuid(1353249536)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeamSlow_EffectBuff PrefabGuid(-1756303410)`
  - `BuffDuration: 0`
  - `Condition: None`
