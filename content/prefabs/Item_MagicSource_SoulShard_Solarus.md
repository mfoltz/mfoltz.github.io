---
title: Item_MagicSource_SoulShard_Solarus
guid: -21943750
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_MagicSource_SoulShard_Solarus PrefabGuid(-21943750) - Entity(22666:1)`
  - `ItemTypeGUID: Item_MagicSource_SoulShard_Solarus PrefabGuid(-21943750)`
...
- [ProjectM.EquippableData]({{% relref "components/EquippableData.md" %}})
  - `BuffGuid: Item_EquipBuff_MagicSource_Soulshard_Solarus PrefabGuid(329820611)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 2500`
  - `MaxDurability: 2500`
  - `RepairRecipe: Recipe_MagicSource_General_T09_Solarus PrefabGuid(-958598508)`
