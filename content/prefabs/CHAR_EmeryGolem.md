...
- **ProjectM.Gameplay.Scripting.Script_EmeryVeinBuildupData**
  ...
  - `SpawnPrefab: AB_Emery_Erruption_Golem_Object PrefabGuid(925499603)`
  ...
  - `Id: Entity(0:0)`
  - `DestroySequence: SequenceGUID 124430674`
  - `TargetFactor: 0`
  - `CurrentFactor: 0`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1737701225)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acbghiidj`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_EmeryGolem PrefabGuid(-72754274)`
...
- [ProjectM.Hybrid.DeathRagdollForce]({{% relref "components/DeathRagdollForce.md" %}})
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_EmeryGolem_MeleeAttack_AbilityGroup PrefabGuid(-705534828)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_EmeryGolem_RockSlam_AbilityGroup PrefabGuid(-1882115765)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_EmeryGolem_GroundSlam_AbilityGroup PrefabGuid(107764414)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_EmeryGolem_FallAsleep_Buff_Group PrefabGuid(2080406227)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_StoneGolem_Awake_Group PrefabGuid(-793376955)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `ForceCastAbility: AB_StoneGolem_Awake_Group PrefabGuid(-793376955)`
  - `Target: ProjectM.ForceCastTarget Target`
...
- **[0]**
  - `DropTableGuid: DT_Unit_StrongBlade_EmeryGolem PrefabGuid(-264725405)`
