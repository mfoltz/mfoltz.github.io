---
title: AB_Winter_Yeti_TrippleAttack_Cast3
guid: 638990515
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Winter_Yeti_TrippleAttack_Cast3 PrefabGuid(638990515)`
...
- **[0]**
  - `SpawnPrefab: AB_Winter_Yeti_TrippleAttack_Hit3 PrefabGuid(1417713273)`
...
- **[1]**
  - `SpawnPrefab: AB_Winter_Yeti_TrippleAttack_Hit3_2 PrefabGuid(-533512645)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
