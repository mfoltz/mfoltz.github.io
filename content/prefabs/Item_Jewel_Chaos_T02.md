...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Chaos_T02 PrefabGuid(1083105737) - Entity(11772:1)`
  - `ItemTypeGUID: Item_Jewel_Chaos_T02 PrefabGuid(1083105737)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Chaos_T02 PrefabGuid(-845714536)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
