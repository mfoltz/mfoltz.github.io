---
title: AB_Spectral_Guardian_MeleeAttack_Cast
guid: 2022337060
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Spectral_Guardian_MeleeAttack_Cast PrefabGuid(2022337060)`
...
- **[0]**
  - `SpawnPrefab: AB_Spectral_Guardian_MeleeAttack_Hit PrefabGuid(320741315)`
