---
title: CHAR_Militia_Heavy_Servant
guid: -1773935659
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1959669035)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Militia_Heavy_Servant PrefabGuid(-1773935659)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Militia_Heavy_Servant PrefabGuid(910088041)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Heavy_MeleeAttack_Group PrefabGuid(-1528770669)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Heavy_ShieldBash_Group PrefabGuid(951831242)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Heavy_Dash_AbilityGroup PrefabGuid(892342913)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
