---
title: AB_Vampire_Reaper_Primary_Mounted_Cast
guid: 666559714
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Reaper_Primary_Mounted_Cast PrefabGuid(666559714)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Reaper_Primary_Mounted_Hit PrefabGuid(395001170)`
