---
title: AB_Vampire_BloodKnight_ThousandSpears_Cast
guid: 1694522036
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_BloodKnight_ThousandSpears_Cast PrefabGuid(1694522036)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_ThousandSpears_Channel PrefabGuid(-2011991325)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_ThousandSpears_DashBuff PrefabGuid(647429443)`
  - `BuffDuration: 0`
  - `Condition: None`
