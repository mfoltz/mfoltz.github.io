---
title: AB_Militia_MeleeHorizontal_HardFollowup_Cast
guid: 1319195215
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_MeleeHorizontal_HardFollowup_Cast PrefabGuid(1319195215)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 2.0943952`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Militia_MeleeHorizontal_HardFollowup_Projectile PrefabGuid(1258357382)`
  - `Count: 5`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_MeleeHorizontal_HardFollowup_Hit PrefabGuid(-995058779)`
  - `Target: ProjectM.AbilitySpawnTarget AIAggroTarget`
