---
title: AB_Vampire_Dracula_FeedAttack_Cast
guid: 22198923
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Dracula_FeedAttack_Cast PrefabGuid(22198923)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_FeedAttack_Hit PrefabGuid(1626864909)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_FeedAttack_StartCastBuff PrefabGuid(-702018449)`
  - `BuffDuration: 0`
  - `Condition: None`
