---
title: Buff_General_SilverSlaveRun
guid: 1793107442
categories: ['All', 'Buff']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Script_Buff_MoveToBusStop_DataServer]({{% relref "components/Script_Buff_MoveToBusStop_DataServer.md" %}})
  - `BusStopName: Unity.Collections.FixedString32Bytes SlaveExit`
  - `Speed_Base: 4`
  - `Speed_Variation: 0.2`
  - `MaxOffsetDistance: 3`
  - `DestroyDistanceSq: 196`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyFaction_DataServer]({{% relref "components/Script_Buff_ModifyFaction_DataServer.md" %}})
  - `Faction: Faction_ChurchOfLum_Slaves_Rioters PrefabGuid(877850148)`
  - `ModId: Unset`
...
- [ProjectM.ClearAggroOnGameplayEvent]({{% relref "components/ClearAggroOnGameplayEvent.md" %}})

- **[0]**
  - `Who: ProjectM.AggroGameplayEventWho BuffTarget`
...
- **[0]**
  ...
  - `EventIndexOfType: 0`
  - `ConditionBlob: None`
  - `GameplayEventType: ProjectM.GameplayEventTypeEnum ClearAggro`
  - `GameplayEventId: Local - -112044381`
