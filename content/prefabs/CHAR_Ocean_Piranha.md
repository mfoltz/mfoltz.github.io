...
- [ProjectM.AggroConsumer]({{% relref "components/AggroConsumer.md" %}})
  ...
  - `MaxDistanceFromPreCombatPosition: 80`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1026406957)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 18.271137`
  - `SpellPower: 18.271137`
  - `ResourcePower: 15.58`
  - `SiegePower: 9.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Ocean_Piranha PrefabGuid(1359616056)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Ocean_Piranha_Bite_AbilityGroup PrefabGuid(-1059091794)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Ocean_Piranha_Circle_AbilityGroup PrefabGuid(-1763951497)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Fish_Piranha PrefabGuid(-476884784)`
