---
title: TM_Castle_Stairs_Single_Lower_Mid_CCW
guid: 156372693
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Stairs_Single_Lower_Mid_CCW PrefabGuid(156372693) - Entity(18196:3)`
  - `Guid: TM_Castle_Stairs_Single_Lower_Mid_CCW PrefabGuid(156372693)`
...
- [ProjectM.CastleBuilding.CastleStairs]({{% relref "components/CastleStairs.md" %}})
  - `StairsType: ProjectM.CastleBuilding.CastleStairsType Part`
