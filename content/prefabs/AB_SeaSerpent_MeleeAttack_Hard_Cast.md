---
title: AB_SeaSerpent_MeleeAttack_Hard_Cast
guid: 2003762356
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_SeaSerpent_MeleeAttack_Hard_Cast PrefabGuid(2003762356)`
...
- **[0]**
  - `SpawnPrefab: AB_SeaSerpent_MeleeAttack_Hard_Hit PrefabGuid(24735896)`
