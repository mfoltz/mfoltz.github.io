---
title: AB_Undead_Banshee_Shriek_Cast
guid: 321771995
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_Banshee_Shriek_Cast PrefabGuid(321771995)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Banshee_Shriek_Hit PrefabGuid(2136091756)`
