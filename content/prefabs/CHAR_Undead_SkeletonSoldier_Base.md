---
title: CHAR_Undead_SkeletonSoldier_Base
guid: -603934060
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 41.41998`
  - `SpellPower: 41.41998`
  - `ResourcePower: 26.800001`
  - `SiegePower: 16`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_SkeletonSoldier_Armored_Dunley PrefabGuid(-1483703502)`
