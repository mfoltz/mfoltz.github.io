...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Template PrefabGuid(1075994038) - Entity(11162:1)`
  - `ItemTypeGUID: Item_Jewel_Template PrefabGuid(1075994038)`
...
- [ProjectM.Shared.JewelTemplate]({{% relref "components/JewelTemplate.md" %}})
