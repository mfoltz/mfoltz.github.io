---
title: TM_Castle_Stairs_Single_Upper_Mid_CCW
guid: 223283194
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Stairs_Single_Upper_Mid_CCW PrefabGuid(223283194) - Entity(41449:2)`
  - `Guid: TM_Castle_Stairs_Single_Upper_Mid_CCW PrefabGuid(223283194)`
...
- [ProjectM.CastleBuilding.CastleStairs]({{% relref "components/CastleStairs.md" %}})
  - `StairsType: ProjectM.CastleBuilding.CastleStairsType PartTopFloor`
