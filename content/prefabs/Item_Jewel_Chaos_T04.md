...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Chaos_T04 PrefabGuid(-1796954295) - Entity(11670:1)`
  - `ItemTypeGUID: Item_Jewel_Chaos_T04 PrefabGuid(-1796954295)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Chaos_T04 PrefabGuid(2092747590)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
