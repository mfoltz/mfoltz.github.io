---
title: AB_Blackfang_CarverBoss_MegaCleave_Cast02
guid: 1240343186
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_CarverBoss_MegaCleave_Cast02 PrefabGuid(1240343186)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_MegaCleave_Hit02 PrefabGuid(1370037725)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_MegaCleave_BlockBuff PrefabGuid(1539287677)`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_MegaCleave_ProjectileLauncher PrefabGuid(911035600)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
