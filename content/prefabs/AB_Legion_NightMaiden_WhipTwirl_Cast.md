---
title: AB_Legion_NightMaiden_WhipTwirl_Cast
guid: 1495658666
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Legion_NightMaiden_WhipTwirl_Cast PrefabGuid(1495658666)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_NightMaiden_WhipTwirl_Hit PrefabGuid(790833499)`
