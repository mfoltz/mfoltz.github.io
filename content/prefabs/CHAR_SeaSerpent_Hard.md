...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1007037745)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 25.132265`
  - `SpellPower: 25.132265`
  - `ResourcePower: 21.2`
  - `SiegePower: 9.6`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_SeaSerpent PrefabGuid(-1132970980)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_MeleeAttack_Hard_AbilityGroup PrefabGuid(-938355432)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_MeleeAttack_Hard_Combo01_AbilityGroup PrefabGuid(-1470096516)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_MeleeAttack_Hard_Combo02_AbilityGroup PrefabGuid(163224625)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_SeaSerpent_FishVomit_Group PrefabGuid(-1287271443)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_SeaSerpent_Aggro PrefabGuid(-695441498)`
