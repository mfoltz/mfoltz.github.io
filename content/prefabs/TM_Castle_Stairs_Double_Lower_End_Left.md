---
title: TM_Castle_Stairs_Double_Lower_End_Left
guid: 2044737851
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Stairs_Double_Lower_End_Left PrefabGuid(2044737851) - Entity(18195:3)`
  - `Guid: TM_Castle_Stairs_Double_Lower_End_Left PrefabGuid(2044737851)`
...
- [ProjectM.CastleBuilding.CastleStairs]({{% relref "components/CastleStairs.md" %}})
  - `StairsType: ProjectM.CastleBuilding.CastleStairsType End`
