...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Chaos_T01 PrefabGuid(2130810069) - Entity(11760:1)`
  - `ItemTypeGUID: Item_Jewel_Chaos_T01 PrefabGuid(2130810069)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Chaos_T01 PrefabGuid(-945572632)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Amethyst_T01 PrefabGuid(225530658)`
  - `Amount: 1`
