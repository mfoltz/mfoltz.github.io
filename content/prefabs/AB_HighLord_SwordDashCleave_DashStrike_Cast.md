---
title: AB_HighLord_SwordDashCleave_DashStrike_Cast
guid: 1286990437
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_HighLord_SwordDashCleave_DashStrike_Cast PrefabGuid(1286990437)`
...
- **[0]**
  - `SpawnPrefab: AB_HighLord_SwordDashCleave_DashStrike_Dash PrefabGuid(505601630)`
