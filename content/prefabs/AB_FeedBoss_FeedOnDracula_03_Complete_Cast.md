---
title: AB_FeedBoss_FeedOnDracula_03_Complete_Cast
guid: 1306418337
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_FeedBoss_FeedOnDracula_03_Complete_Cast
...
- [ProjectM.AbilityTarget](/components/AbilityTarget)
  ...
  - `GetTargetType: ProjectM.AbilityTarget+Type GetFromBuffType`
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_FeedBoss_FeedOnDracula_03_Complete_Cast PrefabGuid(1306418337)`
...
- **[0]**
  - `SpawnPrefab: AB_FeedBoss_FeedOnDracula_03_Complete_Trigger PrefabGuid(1229263634)`
