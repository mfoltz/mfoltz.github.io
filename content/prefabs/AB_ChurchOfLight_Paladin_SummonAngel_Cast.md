---
title: AB_ChurchOfLight_Paladin_SummonAngel_Cast
guid: -1447111028
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ChurchOfLight_Paladin_SummonAngel_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_ChurchOfLight_Paladin_SummonAngel_Cast PrefabGuid(-1447111028)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_SummonAngel_Trigger PrefabGuid(-1664243827)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_SummonAngel_Area PrefabGuid(1996768730)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
