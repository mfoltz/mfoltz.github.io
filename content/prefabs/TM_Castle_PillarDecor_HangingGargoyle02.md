---
title: TM_Castle_PillarDecor_HangingGargoyle02
guid: 1952451618
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_PillarDecor_HangingGargoyle02 PrefabGuid(1952451618) - Entity(12343:3)`
...
- [ProjectM.ProgressionUserContentDependency]({{% relref "components/ProgressionUserContentDependency.md" %}})
  - `Value: ProjectM.Shared.UserContentFlags DLC_FoundersPack_EA`
