---
title: AB_CorruptedCrow_FlyStart_Cast
guid: -548375015
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_CorruptedCrow_FlyStart_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_CorruptedCrow_FlyStart_Cast PrefabGuid(-548375015)`
...
- **[0]**
  - `SpawnPrefab: AB_CorruptedCrow_FlyStart_Travel PrefabGuid(-2001013568)`
...
- **[1]**
  - `SpawnPrefab: AB_CorruptedCrow_FlyStart_Hit PrefabGuid(-1533050127)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
