---
title: AB_CarverBoss_Whirlwind_Cast
guid: 862854303
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_CarverBoss_Whirlwind_Cast PrefabGuid(862854303)`
...
- **[0]**
  - `SpawnPrefab: AB_CarverBoss_Whirlwind_Channel PrefabGuid(1647627459)`
