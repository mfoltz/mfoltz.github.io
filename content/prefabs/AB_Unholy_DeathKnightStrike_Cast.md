---
title: AB_Unholy_DeathKnightStrike_Cast
guid: 1506843814
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Unholy_DeathKnightStrike_Cast PrefabGuid(1506843814)`
...
- **[0]**
  - `SpawnPrefab: AB_Unholy_DeathKnightStrike_Hit PrefabGuid(1553964211)`
