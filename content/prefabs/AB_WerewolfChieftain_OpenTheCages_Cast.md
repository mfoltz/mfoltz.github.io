---
title: AB_WerewolfChieftain_OpenTheCages_Cast
guid: 1717394077
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_WerewolfChieftain_OpenTheCages_Cast PrefabGuid(1717394077)`
...
- **[0]**
  - `SpawnPrefab: AB_WerewolfChieftain_OpenTheCages_Trigger PrefabGuid(562613644)`
