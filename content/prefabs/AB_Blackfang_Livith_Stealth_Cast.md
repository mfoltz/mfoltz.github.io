---
title: AB_Blackfang_Livith_Stealth_Cast
guid: 1839796503
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Livith_Stealth_Cast PrefabGuid(1839796503)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Livith_Stealth_Buff PrefabGuid(-361911593)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Livith_Stealth_CircleBuff PrefabGuid(993273548)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Livith_Stealth_AggroBuff PrefabGuid(505048937)`
