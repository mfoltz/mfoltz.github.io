---
title: CHAR_Undead_SkeletonSoldier_TombSummon
guid: -259591573
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-974864084)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_SkeletonSoldier_Withered PrefabGuid(1236989880)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SkeletonSoldier_Shared_Melee_Group PrefabGuid(138513891)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Undead_TombSummon_Skeleton PrefabGuid(-473107370)`
