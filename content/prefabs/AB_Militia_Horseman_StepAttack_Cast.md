---
title: AB_Militia_Horseman_StepAttack_Cast
guid: 1708061035
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Horseman_StepAttack_Cast PrefabGuid(1708061035)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_StepAttack_Hit PrefabGuid(1254730673)`
