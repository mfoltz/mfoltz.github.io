---
title: AB_Monster_MeleeAttack_AbilityGroup
guid: 1853611622
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Monster_MeleeAttack_AbilityGroup
...
- [ProjectM.Shared.DamageReductionPerTarget](/components/DamageReductionPerTarget)
  - `HitResetTimer: 0.3`
...
- [ProjectM.Shared.DamageReductionPerTargetElement](/components/DamageReductionPerTargetElement)
...
- **[0]**
  - `PrefabGUID: AB_Monster_MeleeAttack_Cast_01 PrefabGuid(-1589722260)`

- **[1]**
  - `PrefabGUID: AB_Monster_MeleeAttack_Cast_02 PrefabGuid(1322396789)`

- **[2]**
  - `PrefabGUID: AB_Monster_MeleeAttack_Cast_03 PrefabGuid(-1368555899)`
