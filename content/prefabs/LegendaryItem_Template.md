...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab LegendaryItem_Template PrefabGuid(-1573584970) - Entity(22527:1)`
  - `ItemTypeGUID: LegendaryItem_Template PrefabGuid(-1573584970)`
...
- [ProjectM.Shared.LegendaryItemTemplateBase]({{% relref "components/LegendaryItemTemplateBase.md" %}})
