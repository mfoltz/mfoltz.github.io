---
title: AB_EmeryGolem_GroundSlam_Cast
guid: 804381838
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_EmeryGolem_GroundSlam_Cast PrefabGuid(804381838)`
...
- **[0]**
  - `SpawnPrefab: AB_EmeryGolem_GroundSlam_Hit PrefabGuid(-1880660691)`
...
- **[1]**
  - `SpawnPrefab: AB_EmeryGolem_GroundSlam_Trigger PrefabGuid(282542452)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
