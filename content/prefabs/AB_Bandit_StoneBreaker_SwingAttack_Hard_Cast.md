---
title: AB_Bandit_StoneBreaker_SwingAttack_Hard_Cast
guid: 1832709242
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_StoneBreaker_SwingAttack_Hard_Cast PrefabGuid(1832709242)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_SwingAttack_Hard_Hit PrefabGuid(1646866546)`
