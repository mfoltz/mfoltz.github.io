---
title: CHAR_Vampire_CrimsonIronMaiden
guid: -1884553416
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-404919682)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0`
  - `WoundedTriggerSequenceGuid: SequenceGUID -1794368436`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Vampire_CrimsonIronMaiden PrefabGuid(-579938944)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_CrimsonIronMaiden_Entomb_AbilityGroup PrefabGuid(1636251764)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_CrimsonIronMaiden_LineupBuff_Abilitygroup PrefabGuid(-885902431)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_CrimsonIronMaiden_CrimsonVoid_Abilitygroup PrefabGuid(-1221546136)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_CrimsonIronMaiden_DistanceChecker_Abilitygroup PrefabGuid(560207432)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_CrimsonIronMaiden_PullingChains_Abilitygroup PrefabGuid(566224334)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `EventTarget: ProjectM.GameplayEventTarget MinionOwner`
  - `SpellTarget: ProjectM.GameplayEventTarget MinionOwner`
...
- **[0]**
  ...
  - `Target: ProjectM.GameplayEventTarget MinionOwner`
