---
title: AB_Manticore_TailStrike_Cast
guid: -1269021822
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Manticore_TailStrike_Cast PrefabGuid(-1269021822)`
...
- **[0]**
  - `SpawnPrefab: AB_Manticore_TailStrike_ProjectileSpawner PrefabGuid(691897112)`
...
- **[1]**
  - `SpawnPrefab: AB_Manticore_TailStrike_MeleeHit PrefabGuid(77443250)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
