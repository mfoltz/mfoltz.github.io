---
title: AB_ChurchOfLight_Paladin_ChargedSwing_Cast
guid: 1634116878
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Paladin_ChargedSwing_Cast PrefabGuid(1634116878)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_ChargedSwing_Hit PrefabGuid(246466673)`
