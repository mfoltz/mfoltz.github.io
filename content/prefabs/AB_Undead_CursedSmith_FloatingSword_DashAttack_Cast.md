---
title: AB_Undead_CursedSmith_FloatingSword_DashAttack_Cast
guid: 547781512
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_CursedSmith_FloatingSword_DashAttack_Cast PrefabGuid(547781512)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_CursedSmith_FloatingSword_DashAttack_Hit PrefabGuid(399471754)`
