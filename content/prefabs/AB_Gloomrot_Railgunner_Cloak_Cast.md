---
title: AB_Gloomrot_Railgunner_Cloak_Cast
guid: 290945473
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Gloomrot_Railgunner_Cloak_Cast PrefabGuid(290945473)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_Railgunner_Cloak_Buff PrefabGuid(1361823193)`
