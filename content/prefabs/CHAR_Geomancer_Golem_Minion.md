---
title: CHAR_Geomancer_Golem_Minion
guid: -2092246077
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(857765377)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 51.789906`
  - `SpellPower: 51.789906`
  - `ResourcePower: 35.04`
  - `SiegePower: 13.599999`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Geomancer_Golem_Guardian PrefabGuid(-829692401)`
