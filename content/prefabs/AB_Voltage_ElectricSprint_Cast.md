---
title: AB_Voltage_ElectricSprint_Cast
guid: 1654319550
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Voltage_ElectricSprint_Cast PrefabGuid(1654319550)`
...
- **[0]**
  - `SpawnPrefab: AB_Voltage_ElectricSprint_Trigger PrefabGuid(279957344)`
...
- **[1]**
  - `SpawnPrefab: AB_Voltage_SprintKick_AggroBuff PrefabGuid(97349349)`
