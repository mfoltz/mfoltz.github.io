---
title: AB_Trader_Farbane_Stalker_MeleeAttack_Cast
guid: 1030533396
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Trader_Farbane_Stalker_MeleeAttack_Cast PrefabGuid(1030533396)`
...
- **[0]**
  - `SpawnPrefab: AB_Trader_Farbane_Stalker_MeleeAttack_Hit PrefabGuid(751441829)`
