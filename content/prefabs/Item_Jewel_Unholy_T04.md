...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Unholy_T04 PrefabGuid(1412786604) - Entity(11708:1)`
  - `ItemTypeGUID: Item_Jewel_Unholy_T04 PrefabGuid(1412786604)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Unholy_T04 PrefabGuid(-459320498)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
