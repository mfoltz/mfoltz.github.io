---
title: AB_Vampire_VeilOfIllusion_AbilityGroup
guid: -935015750
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityGroupInfo]({{% relref "components/AbilityGroupInfo.md" %}})
  ...
  - `InputType: ProjectM.AbilityInputCastType PressCast`
  - `Target: ProjectM.AbilitySpawnTarget Owner`

- [ProjectM.VBloodAbilityData]({{% relref "components/VBloodAbilityData.md" %}})
  - `AbilityType: ProjectM.AbilityTypeEnum Travel`
  - `AbilitySchool: ProjectM.AbilitySchoolType Illusion`
  - `AbilityTooltipType: ProjectM.AbilityTooltipType Dash`
...
- **ProjectM.Gameplay.Scripting.Script_VeilOfIllusion_Recast_PositionSource_Data**
...
- **[0]**
  - `PrefabGUID: AB_Vampire_VeilOfIllusion_DashCast PrefabGuid(-1854440738)`
...
- [ProjectM.RunScriptOnCastStarted]({{% relref "components/RunScriptOnCastStarted.md" %}})
