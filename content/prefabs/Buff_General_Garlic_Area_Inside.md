...
- [ProjectM.AmplifyStackModifier]({{% relref "components/AmplifyStackModifier.md" %}})
  - `BaseValue: 0.01`
  - `Modifier: 1`
...
- [ProjectM.WeakenBuff]({{% relref "components/WeakenBuff.md" %}})
  - `WeakenModifier: 0.005`

- [ProjectM.WeakenStackModifier]({{% relref "components/WeakenStackModifier.md" %}})
  - `BaseValue: 0.005`
  - `Modifier: 1`
...
- [ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataServer]({{% relref "components/Script_GarlicAreaDebuff_DataServer.md" %}})
  - `DynamicStacks: 0`
...
- [ProjectM.Gameplay.Scripting.Script_GarlicAreaDebuff_DataShared]({{% relref "components/Script_GarlicAreaDebuff_DataShared.md" %}})
  - `IsInArea: False`
