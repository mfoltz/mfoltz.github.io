...
- [ProjectM.Gameplay.Scripting.EvenSpreadCluster_DataServer]({{% relref "components/EvenSpreadCluster_DataServer.md" %}})
  ...
  - `NewThrowEntity: AB_Vampire_Crossbow_RainOfBolts_Throw PrefabGuid(-239491085)`
  - `Count: 4`
...
- **[0]**
  - `Sequence: SequenceGUID 159633750`
...
- **[0]**
  - `Condition: None`
  - `SpellMod: SpellMod_Crossbow_RainOfBolts_BonusArrows PrefabGuid(-281838471)`
  - `Operation: ProjectM.Shared.SpellModArithmeticOperation Add`
  - `ValueIndex: 0`
  - `Target: ProjectM.Shared.SpellModArithmeticTarget EvenSpreadCluster_Count`
  - `TargetIndex: -1`
