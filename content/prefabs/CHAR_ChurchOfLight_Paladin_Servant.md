---
title: CHAR_ChurchOfLight_Paladin_Servant
guid: 1649578802
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1709264932)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_ChurchOfLight_Paladin_Servant PrefabGuid(1649578802)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_Paladin_Servant PrefabGuid(-2136359319)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_MeleeAttack_AbilityGroup PrefabGuid(1212343160)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_HolyNuke_AbilityGroup PrefabGuid(1926314891)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_Dash_AbilityGroup PrefabGuid(413176017)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_ChargeMeleeAttack_AbilityGroup PrefabGuid(-448018551)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_ShockWaveSlam_AbilityGroup PrefabGuid(-626021308)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
