---
title: AB_Vampire_Sword_Shockwave_Recast_Cast
guid: 1541111960
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Sword_Shockwave_Recast_Cast
...
- [ProjectM.AbilityTarget](/components/AbilityTarget)
  ...
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(864593896)`
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_Sword_Shockwave_Recast_Cast PrefabGuid(1541111960)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Sword_Shockwave_Recast_TravelToTargetFirstStrike PrefabGuid(-438334309)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Sword_Shockwave_Recast_ImmaterialBuff PrefabGuid(998177393)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
