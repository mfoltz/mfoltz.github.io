---
title: CHAR_Harpy_FeatherDuster
guid: -1407234470
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1450875093)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 64.464165`
  - `SpellPower: 64.464165`
  - `ResourcePower: 37.2`
  - `SiegePower: 17.6`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_akbkgcijik`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Harpy_FeatherDuster PrefabGuid(1565444532)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Harpy_FeatherDuster_Spin_AbilityGroup PrefabGuid(1678557149)`
  - `ShowOnBar: True`
...
- **312 total elements but only showing the first 36**
...
- **74 total elements but only showing the first 36**
