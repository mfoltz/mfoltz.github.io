...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-733407084)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 30.675417`
  - `SpellPower: 30.675417`
  - `ResourcePower: 24`
  - `SiegePower: 11`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Pixie PrefabGuid(-80440015)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Pixie_Projectile_Group PrefabGuid(-259433272)`
  - `ShowOnBar: True`
