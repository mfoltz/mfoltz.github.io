---
title: CHAR_Militia_Horseman_Mount
guid: -1914181232
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server]({{% relref "components/AiMove_Server.md" %}})
  ...
  - `CircleChangeDirectionFrequencyMax: 20`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1822127791)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Militia_Horseman_Mount PrefabGuid(153897816)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_Mount_RunAway_AbilityGroup PrefabGuid(-680710725)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Horseman_Mount_Charge_AbilityGroup PrefabGuid(-1630648333)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SpawnPrefab: Trigger_Horseman_SpawnRider PrefabGuid(1145925607)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
