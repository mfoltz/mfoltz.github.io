---
title: AB_CorruptedCrow_IdleFlyStart_Cast
guid: 70052349
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_CorruptedCrow_IdleFlyStart_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_CorruptedCrow_IdleFlyStart_Cast PrefabGuid(70052349)`
...
- **[0]**
  - `SpawnPrefab: AB_CorruptedCrow_IdleFlyStart_Travel PrefabGuid(826655304)`
...
- **[1]**
  - `SpawnPrefab: AB_CorruptedCrow_IdleFlyStart_Hit PrefabGuid(775969354)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
