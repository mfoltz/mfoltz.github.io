---
title: CHAR_ChurchOfLight_EnchantedCross
guid: -1449314709
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-26174327)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID 546000628`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_chbgjikkhe`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_ChurchOfLight_EnchantedCross PrefabGuid(1885205310)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_EnchantedCross_LightWave_AbilityGroup PrefabGuid(-401259144)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_EnchantedCross_Beam_Hard_AbilityGroup PrefabGuid(-1637210619)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: InfiniteInvulnerabilityBuff PrefabGuid(454502690)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_Npc_Invulernable PrefabGuid(544892542)`
