---
title: AB_Bear_Mutant_MeleeAttack_Cast
guid: 899195461
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bear_Mutant_MeleeAttack_Cast PrefabGuid(899195461)`
...
- **[0]**
  - `SpawnPrefab: AB_Bear_Mutant_MeleeAttack_Hit PrefabGuid(557784151)`
