---
title: AB_Spider_Queen_MeleeAttack_Cast
guid: 1980911243
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Spider_Queen_MeleeAttack_Cast PrefabGuid(1980911243)`
...
- **[0]**
  - `SpawnPrefab: AB_Spider_Queen_MeleeAttack_Hit PrefabGuid(582407450)`
