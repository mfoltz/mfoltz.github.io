...
- [ProjectM.Gameplay.Scripting.Script_Buff_GrabToOwner_DataServer]({{% relref "components/Script_Buff_GrabToOwner_DataServer.md" %}})
...
- [ProjectM.GrabBuff]({{% relref "components/GrabBuff.md" %}})
