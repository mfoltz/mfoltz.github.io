---
title: AB_Blackfang_Livith_PermanentStealth_Cast
guid: 72289721
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Livith_PermanentStealth_Cast PrefabGuid(72289721)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Livith_PermanentStealth_Buff PrefabGuid(-1387196851)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Livith_PermanentStealth_CircleBuff PrefabGuid(-683082530)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
