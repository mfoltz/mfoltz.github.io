---
title: AB_Legion_Vargulf_SlicingArm_Cast02
guid: 1434709206
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Legion_Vargulf_SlicingArm_Cast02 PrefabGuid(1434709206)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_Vargulf_SlicingArm_Hit PrefabGuid(-43822092)`
...
- **[1]**
  - `SpawnPrefab: AB_Legion_vargulf_SlicingArm_ApproachBuff PrefabGuid(300462306)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
