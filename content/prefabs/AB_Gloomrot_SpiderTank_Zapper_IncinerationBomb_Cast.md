---
title: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_Cast
guid: -1127621357
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_Cast PrefabGuid(-1127621357)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_BombThrow PrefabGuid(-433790922)`
...
- **[1]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_MoveBuff PrefabGuid(-1633459560)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_PilotTrigger PrefabGuid(833973196)`
  - `BuffDuration: 0`
  - `Condition: None`
