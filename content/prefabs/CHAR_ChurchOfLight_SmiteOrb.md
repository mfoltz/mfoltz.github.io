---
title: CHAR_ChurchOfLight_SmiteOrb
guid: 1917502536
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-302131499)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_ChurchOfLight_SmiteOrb PrefabGuid(-1017206735)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_SmiteOrb_Smite_AbilityGroup PrefabGuid(2005435470)`
  - `ShowOnBar: True`
