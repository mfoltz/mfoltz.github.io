---
title: AB_Gloomrot_RailgunSergeant_CloakField_Cast
guid: 217522295
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Gloomrot_RailgunSergeant_CloakField_Cast PrefabGuid(217522295)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_CloakField_Trigger PrefabGuid(2139211512)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_RailgunSergeant_CloakField_InitTrigger PrefabGuid(1056196434)`
  - `BuffDuration: 0`
  - `Condition: None`
