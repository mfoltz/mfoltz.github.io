...
- [ProjectM.VBloodAbilityData]({{% relref "components/VBloodAbilityData.md" %}})
  ...
  - `AbilityTooltipType: ProjectM.AbilityTooltipType Channeling`
...
- [ProjectM.Shared.IgnoreHitsPerTarget]({{% relref "components/IgnoreHitsPerTarget.md" %}})
  - `HitResetTimer: 0.4`
  - `ReductionModifier: 0`
...
- [ProjectM.Shared.IgnoreHitsPerTargetElement]({{% relref "components/IgnoreHitsPerTargetElement.md" %}})
...
- **[0]**
  - `PrefabGUID: AB_Unholy_ChainsOfDeath_Cast PrefabGuid(-1188505466)`
