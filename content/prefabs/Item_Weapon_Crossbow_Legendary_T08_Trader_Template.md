---
title: Item_Weapon_Crossbow_Legendary_T08_Trader_Template
guid: 517296275
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Crossbow_Legendary_T08_Trader_Template PrefabGuid(517296275) - Entity(19523:1)`
  - `ItemTypeGUID: Item_Weapon_Crossbow_Legendary_T08_Trader_Template PrefabGuid(517296275)`
...
- [ProjectM.Shared.LegendaryItemTemplate]({{% relref "components/LegendaryItemTemplate.md" %}})
  - `TemplateLevel: 88`
  - `TemplateWeaponType: ProjectM.WeaponType Crossbow`
