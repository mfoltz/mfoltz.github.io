---
title: AB_Winter_Yeti_GrabIcicle_Hard_Cast
guid: 1614720198
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Winter_Yeti_GrabIcicle_Hard_Cast PrefabGuid(1614720198)`
...
- **[0]**
  - `SpawnPrefab: AB_Winter_Yeti_GrabIcicle_Hit PrefabGuid(2133990995)`
