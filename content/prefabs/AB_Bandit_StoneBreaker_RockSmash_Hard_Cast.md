---
title: AB_Bandit_StoneBreaker_RockSmash_Hard_Cast
guid: -54449418
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_StoneBreaker_RockSmash_Hard_Cast PrefabGuid(-54449418)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_RockSmash_Hard_Projectile PrefabGuid(-1856356338)`
...
- **[1]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_RockSmash_Hard_Hit PrefabGuid(616126562)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
