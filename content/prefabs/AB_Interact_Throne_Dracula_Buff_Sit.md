---
title: AB_Interact_Throne_Dracula_Buff_Sit
guid: -13752172
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Interact_Throne_Dracula_Buff_Sit
...
- [ProjectM.DestroyBuffOnMove](/components/DestroyBuffOnMove)
  - `minAge: 3`
...
- [ProjectM.BuffCategory](/components/BuffCategory)
  - `Level: 0`
  - `Groups: ProjectM.BuffCategoryFlag Sit`
  - `KeepOldest: False`
...
- [ProjectM.BuffModificationFlagData](/components/BuffModificationFlagData)
  - `ModificationTypes: 2849456`
  - `ModificationId: Unset`

- [ProjectM.UI.GoToHUDMenu](/components/GoToHUDMenu)
  - `Delay: 2`
  - `IsHandled: False`
  - `MenuType: ProjectM.UI.HUDMenuType MapMenu`
...
- [ProjectM.Gameplay.Scripting.Script_Buff_ModifyBuffResistances_DataServer](/components/Script_Buff_ModifyBuffResistances_DataServer)
  - `AssetPrefabGuid: BuffResistance_Structures PrefabGuid(-641281679)`
  - `ModId: Unset`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Interact_Throne_Dracula_Recast_Return PrefabGuid(-2124138742)`
...
- **[0]**
  - `EventIndex: 0`
  - `Buff: Stunlock.Core.PrefabIdentifier PrefabIdentifier(1845376969)`
...
- **[0]**
  ...
  - `NewGroupId: AB_Interact_Throne_Recast_Shared_AbilityGroup PrefabGuid(-1385465144)`
  - `Priority: 20`
  - `Condition: None`
