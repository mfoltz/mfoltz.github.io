---
title: MapIcon_POI_Spawn_WaypointSelect
guid: -2098609826
categories: ['All', 'Map']
nav_exclude: true
search_exclude: true
...
- [ProjectM.MapIconData]({{% relref "components/MapIconData.md" %}})
  - `HeaderLocalizedKey: 0896f140-8c61-451a-9531-a2cd2905a4c5 - Vampire Waygate`
  ...
  - `AllySetting: ProjectM.MapIconShowSettings Global`
  - `EnemySetting: ProjectM.MapIconShowSettings Global`
...
- [ProjectM.SpawnLocationSelector]({{% relref "components/SpawnLocationSelector.md" %}})
  - `LocationType: ProjectM.Network.SpawnLocationType Waypoint`
  - `IsLocked: False`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_fjkikekhi`
