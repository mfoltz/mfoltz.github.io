---
title: CHAR_Unholy_SkeletonWarrior_Summon
guid: 1604500740
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1706155107)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Unholy_SkeletonWarrior_Summon PrefabGuid(1638449571)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Unholy_SkeletonWarrior_MeleeAttack_Group PrefabGuid(537620937)`
  - `ShowOnBar: True`
