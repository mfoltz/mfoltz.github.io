---
title: AB_Bear_Dire_AreaAttack_Cast
guid: -1332081065
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bear_Dire_AreaAttack_Cast PrefabGuid(-1332081065)`
...
- **[0]**
  - `SpawnPrefab: AB_Bear_Dire_AreaAttack_Hit PrefabGuid(1684028547)`
...
- **[1]**
  - `SpawnPrefab: AB_Bear_Dire_AreaAttack_ThrowSpawnerBuff PrefabGuid(-283916213)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
