---
title: AB_Monster_LightningShield_Buff
guid: -2118254056
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Monster_LightningShield_Buff
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer)
  - `Angle: 360`
  - `OffsetAngle: 0`
  - `RandomOffset: 0.08726646`
  - `IndividualRandom: 0.2617994`
  - `NewProjectileEntity: AB_Monster_LightningShield_Projectile PrefabGuid(2064540259)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0.3`
  - `GameplayEventId: Local - -449847331`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_LightningShield_AreaKnockback PrefabGuid(-1639043330)`
