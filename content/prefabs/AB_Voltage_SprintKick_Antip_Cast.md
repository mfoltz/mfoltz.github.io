---
title: AB_Voltage_SprintKick_Antip_Cast
guid: -1801875745
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Voltage_SprintKick_Antip_Cast PrefabGuid(-1801875745)`
...
- [ProjectM.ChangeKnockbackResistanceDuringCast]({{% relref "components/ChangeKnockbackResistanceDuringCast.md" %}})
...
- **[0]**
  - `SpawnPrefab: AB_Voltage_SprintKick_Antip_Trigger PrefabGuid(13762758)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Voltage_SprintKick_Antip_TriggerAggroRemove PrefabGuid(1029687104)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
...
- **[2]**
  - `SpawnPrefab: AB_Voltage_SprintKick_Antip_RelocateImpair PrefabGuid(-351960871)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
