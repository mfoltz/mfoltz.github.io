---
title: CHAR_Blackfang_MorganasTail
guid: -1075824048
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-741121296)`
...
- [ProjectM.MapCollision]({{% relref "components/MapCollision.md" %}})
  - `Radius: 0.4`
  - `CollidesAgainstMapFlags: ProjectM.Tiles.MapCollisionFlags CollideAirMovement`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ccjdccchfe`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_MorganasTail_TailSlam_AbilityGroup PrefabGuid(62301155)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelToPosition_Tail_AbilityGroup PrefabGuid(690549364)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_MorganasTail_Dive_AbilityGroup PrefabGuid(-2140645618)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Morgana_TravelToPosition_TailEmerge_AbilityGroup PrefabGuid(438919203)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_MorganasTail_Stinger_AbilityGroup PrefabGuid(-1859321594)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_MorganasTail_Stinger_Single_AbilityGroup PrefabGuid(29969582)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: AB_Blackfang_Morgana_DisableCollisionBuff PrefabGuid(582104639)`
