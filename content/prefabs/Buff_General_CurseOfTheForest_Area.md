...
- [ProjectM.Gameplay.Scripting.Script_CursedAreaDebuff_DataServer]({{% relref "components/Script_CursedAreaDebuff_DataServer.md" %}})
  - `DynamicStacks: 0`
...
- [ProjectM.Gameplay.Scripting.Script_CurseAreaDebuff_DataShared]({{% relref "components/Script_CurseAreaDebuff_DataShared.md" %}})
  - `IsInArea: False`
  - `StackSize: 0`
