---
title: CHAR_Spider_Spiderling_VerminNest
guid: 1767714956
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2140239000)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Spider_Spiderling PrefabGuid(1227531048)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Spider_Spiderling_Attack_Group PrefabGuid(-1655641312)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Unit_VerminNest_Spiderling PrefabGuid(-2086173662)`
