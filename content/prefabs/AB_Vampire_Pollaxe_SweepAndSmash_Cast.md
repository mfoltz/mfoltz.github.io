---
title: AB_Vampire_Pollaxe_SweepAndSmash_Cast
guid: 62714130
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Pollaxe_SweepAndSmash_Cast PrefabGuid(62714130)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Pollaxe_SweepAndSmash_Hit PrefabGuid(-107199836)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Pollaxe_SweepAndSmash_Buff PrefabGuid(400969473)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
