---
title: AB_Blackfang_Morgana_DownHorizontalSlash_Left_Cast
guid: 805360002
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_DownHorizontalSlash_Left_Cast PrefabGuid(805360002)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DownHorizontalSlash_Left_InitialHit PrefabGuid(-1286355674)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DownHorizontalSlash_Left_FollowupHitBuff PrefabGuid(-718813882)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
