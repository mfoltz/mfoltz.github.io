---
title: AB_Militia_MeleeHorizontal_Hard_Cast
guid: 1718899753
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_MeleeHorizontal_Hard_Cast PrefabGuid(1718899753)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 2.0943952`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Militia_MeleeHorizontal_Hard_Projectile PrefabGuid(-2051750779)`
  - `Count: 5`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_MeleeHorizontal_Hard_Hit PrefabGuid(-619949765)`
