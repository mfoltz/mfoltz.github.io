---
title: AB_Blackfang_MorganasTail_Dive_Cast
guid: 683761386
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_MorganasTail_Dive_Cast PrefabGuid(683761386)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_MorganasTail_Dive_Trigger PrefabGuid(1946628258)`
