---
title: AB_Bandit_Thief_Rush_Elite_Cast
guid: 388863053
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_Thief_Rush_Elite_Cast PrefabGuid(388863053)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Thief_Rush_Elite_Buff PrefabGuid(2070247233)`
