...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-442719468)`
...
- [ProjectM.DestroyWhenNoCharacterNearbyAfterDuration]({{% relref "components/DestroyWhenNoCharacterNearbyAfterDuration.md" %}})
  - `RemoveAtTime: 1200`
  - `MinimumRemoveDurationIfNearby: 10`
  - `RandomAdditionalDuration: 2`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 48.831085`
  - `SpellPower: 48.831085`
  - `ResourcePower: 31.6`
  - `SiegePower: 14.8`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Scarecrow PrefabGuid(-776127089)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Scarecrow_MeleeAttack_Group PrefabGuid(-1436929556)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Scarecrow_Scream_Group PrefabGuid(382761265)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Scarecrow_Counter_AbilityGroup PrefabGuid(741783094)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Scarecrow_Projectile_Group PrefabGuid(594778109)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[2]**
  - `BuffGuid: Buff_General_LockRotation PrefabGuid(-814835059)`
  - `State: ProjectM.GenericEnemyState Idle`

- **[3]**
  - `BuffGuid: Buff_General_LockRotation PrefabGuid(-814835059)`
  - `State: ProjectM.GenericEnemyState 1`

- [ProjectM.Shared.DropTableBuffer]({{% relref "components/DropTableBuffer.md" %}})

- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_Scarecrow PrefabGuid(-2046528903)`
