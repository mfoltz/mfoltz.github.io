...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Blood_T03 PrefabGuid(-41686151) - Entity(11714:1)`
  - `ItemTypeGUID: Item_Jewel_Blood_T03 PrefabGuid(-41686151)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Blood_T03 PrefabGuid(1484442015)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
