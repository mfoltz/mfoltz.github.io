---
title: TM_Castle_Stairs_Double_Upper_End_Right
guid: -1867747921
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Stairs_Double_Upper_End_Right PrefabGuid(-1867747921) - Entity(6874:3)`
  - `Guid: TM_Castle_Stairs_Double_Upper_End_Right PrefabGuid(-1867747921)`
  ...
  - `BuildingSequence: SequenceGUID -896748135`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
...
- [ProjectM.CastleBuilding.CastleFloorRoof]({{% relref "components/CastleFloorRoof.md" %}})
...
- [ProjectM.GiveAchievementOnSpawn]({{% relref "components/GiveAchievementOnSpawn.md" %}})
...
- [ProjectM.CastleBuilding.CastleStairs]({{% relref "components/CastleStairs.md" %}})
  - `StairsType: ProjectM.CastleBuilding.CastleStairsType EndTopFloor`
  - `Direction: ProjectM.CastleBuilding.CardinalDirection North`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ahdccfgdhi`
...
- [ProjectM.CastleBuilding.Rebuilding.CastleRebuildHiddenTag]({{% relref "components/CastleRebuildHiddenTag.md" %}})
