---
title: CHAR_Militia_Miner_Standard_Servant
guid: -1363137425
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-804962426)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Militia_Miner_Standard_Servant PrefabGuid(-1363137425)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Miner_MeleeAttack_Group01 PrefabGuid(-2107123661)`
  - `ShowOnBar: True`
...
- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Miner_Mine_AbilityGroup PrefabGuid(1599972576)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
