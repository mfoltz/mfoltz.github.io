---
title: CHAR_Dracula_SpellStone_LargeBlood
guid: 32692466
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-698740959)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Dracula_SpellStone_Shared PrefabGuid(1416080810)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Dracula_SpellStone_CirclingBlood_AbilityGroup PrefabGuid(2079740557)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Dracula_SpellStone_BoltSpray_AbilityGroup PrefabGuid(1957691133)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID 1174520759`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_SummonBats_Trigger PrefabGuid(1634717069)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Owner`
