---
title: CHAR_Farmlands_Villager_Female_Servant
guid: 1532829342
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1141755924)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Farmlands_Villager_Female_Servant PrefabGuid(1532829342)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 29.133768`
  - `SpellPower: 29.133768`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Villager_Servant PrefabGuid(611181297)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_VillagerFemale_OnAggro_AbilityGroup_01 PrefabGuid(-119427343)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Villager_Female_MeleeAttack_Group PrefabGuid(1397338806)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: Buff_LittleGuy_Pray PrefabGuid(-111291969)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[1]**
  - `BuffGuid: Buff_ChurchOfLight_Flee_Villager_Female PrefabGuid(111464415)`
  - `State: ProjectM.GenericEnemyState Flee`

- **[2]**
  - `BuffGuid: Buff_ChurchOfLight_Villager_Cover_Female PrefabGuid(1423858323)`
