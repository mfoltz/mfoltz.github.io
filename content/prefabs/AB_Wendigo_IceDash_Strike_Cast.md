---
title: AB_Wendigo_IceDash_Strike_Cast
guid: 1588496367
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Wendigo_IceDash_Strike_Cast PrefabGuid(1588496367)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IceDash_Strike_Hit PrefabGuid(177876428)`
