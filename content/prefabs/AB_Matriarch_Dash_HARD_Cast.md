---
title: AB_Matriarch_Dash_HARD_Cast
guid: 2057134722
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Matriarch_Dash_HARD_Cast PrefabGuid(2057134722)`
...
- **[0]**
  - `SpawnPrefab: AB_Matriarch_Dash_Phase PrefabGuid(1989001748)`
