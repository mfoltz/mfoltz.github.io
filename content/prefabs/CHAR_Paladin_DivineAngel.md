---
title: CHAR_Paladin_DivineAngel
guid: -1737346940
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AiMove_Server]({{% relref "components/AiMove_Server.md" %}})
  ...
  - `CircleChangeDirectionFrequencyMax: 12`
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer]({{% relref "components/Script_ApplyBuffUnderHealthThreshold_DataServer.md" %}})
  - `HealthFactor: 0.01`
  - `NewBuffEntity: AB_ChurchOfLight_Paladin_SummonDivineAngel_DeathBuff PrefabGuid(-1934189109)`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-227563644)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Paladin_DivineAngel PrefabGuid(1767142686)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_DivineAngel_MeleeAttack_AbilityGroup PrefabGuid(-105601189)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_DivineAngel_Dash_AbilityGroup PrefabGuid(124285667)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_DivineAngel_HolyBarrage_AbilityGroup PrefabGuid(31826871)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_DivineAngel_AngelicFlackCannon_AbilityGroup PrefabGuid(1927100043)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_DivineAngel_HolySpearField_AbilityGroup PrefabGuid(985669672)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `BuffGuid: Buff_InCombat_DivineAngel PrefabGuid(1420967901)`
