---
title: CHAR_ChurchOfLight_SlaveMaster_Enforcer_Servant
guid: -2114140065
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1675010838)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_SlaveMaster_Enforcer_Servant PrefabGuid(1262415316)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_Swing_AbilityGroup PrefabGuid(-1969627539)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_Hook_AbilityGroup PrefabGuid(1423169435)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_Knockdown_AbilityGroup PrefabGuid(-725150213)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_SlaveMaster_ChargeAttack_AbilityGroup PrefabGuid(401195214)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: Buff_ChurchOfLight_SlaveMaster_HideWhip_Buff PrefabGuid(-1104282069)`
...
- **[1]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -1703963031`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: False`
...
- **[0]**
  - `SpawnPrefab: AB_ReleaseSlaves_AoECheck PrefabGuid(-1520552223)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
...
- **[2]**
  - `BuffGuid: Buff_ChurchOfLight_SlaveMaster_HideWhip_Buff PrefabGuid(-1104282069)`
