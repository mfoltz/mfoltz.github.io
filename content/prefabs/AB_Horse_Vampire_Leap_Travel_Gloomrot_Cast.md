---
title: AB_Horse_Vampire_Leap_Travel_Gloomrot_Cast
guid: -1319599432
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Horse_Vampire_Leap_Travel_Gloomrot_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Horse_Vampire_Leap_Travel_Gloomrot_Cast PrefabGuid(-1319599432)`
...
- **[0]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Gloomrot_Phase PrefabGuid(-494679061)`
...
- **[1]**
  - `SpawnPrefab: AB_Horse_Vampire_Leap_Travel_Gloomrot_Buff PrefabGuid(-1593300903)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
