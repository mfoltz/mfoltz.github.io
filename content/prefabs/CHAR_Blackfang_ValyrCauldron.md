---
title: CHAR_Blackfang_ValyrCauldron
guid: 1439742793
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-542600961)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Blackfang_ValyrCauldron PrefabGuid(-701803855)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_ValyrCauldron_Errupt_AbilityGroup PrefabGuid(-1375787055)`
  - `ShowOnBar: True`
