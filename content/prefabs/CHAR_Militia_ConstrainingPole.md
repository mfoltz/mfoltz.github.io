---
title: CHAR_Militia_ConstrainingPole
guid: 85290673
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1541249097)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Militia_ConstrainingPole PrefabGuid(1505662121)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_ConstrainingPole_MeleeAttack_AbilityGroup PrefabGuid(-893194478)`
  - `ShowOnBar: True`
