---
title: CHAR_Gloomrot_SentryTurret
guid: -1082044089
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1917424726)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ckgbgdhjhi`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Gloomrot_SentryTurret PrefabGuid(610665701)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryTurret_RangedAttack_AbilityGroup PrefabGuid(1024156492)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryTurret_ShockField_AbilityGroup PrefabGuid(342417296)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryTurret_BunkerDown_AbilityGroup PrefabGuid(-325335847)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SentryTurret_BunkerUp_AbilityGroup PrefabGuid(-1060298293)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
