---
title: AB_Sommelier_MeleeHorizontal_Cast
guid: 1922303328
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Sommelier_MeleeHorizontal_Cast PrefabGuid(1922303328)`
...
- **[0]**
  - `SpawnPrefab: AB_Sommelier_MeleeHorizontal_Hit PrefabGuid(1143646341)`
