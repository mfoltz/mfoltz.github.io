---
title: CHAR_Undead_ZealousCultist_Ghost
guid: 128488545
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1002310319)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_ZealousCultist_Ghost PrefabGuid(1395639297)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_ZealousCultist_Ghost_Possess_AbilityGroup PrefabGuid(-1912093062)`
  - `ShowOnBar: True`
...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - -829174193`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
