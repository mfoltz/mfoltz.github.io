---
title: CHAR_Undead_SkeletonSoldier_Unholy_Minion
guid: -1779239433
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(183365368)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 11.522155`
  - `SpellPower: 11.522155`
  - `ResourcePower: 10.8`
  - `SiegePower: 4.4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_SkeletonSoldier_Armored_Farbane PrefabGuid(-1892242369)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_SkeletonSoldier_Minion_MeleeAttack_Group PrefabGuid(1772194590)`
  - `ShowOnBar: True`
