...
- [ProjectM.Gameplay.Scripting.Script_ProfessorProjectileOnGameplayEvent_DataServer]({{% relref "components/Script_ProfessorProjectileOnGameplayEvent_DataServer.md" %}})
  - `Angle: 3.4906585`
