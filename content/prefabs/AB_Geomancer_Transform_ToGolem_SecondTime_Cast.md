---
title: AB_Geomancer_Transform_ToGolem_SecondTime_Cast
guid: 1624823778
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Geomancer_Transform_ToGolem_SecondTime_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Geomancer_Transform_ToGolem_SecondTime_Cast PrefabGuid(1624823778)`
...
- **[0]**
  - `SpawnPrefab: AB_Geomancer_Transform_ToGolem_SecondTime_Buff PrefabGuid(1704488108)`
...
- **[1]**
  - `SpawnPrefab: AB_Geomancer_AwakeBuff PrefabGuid(1144293329)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[0]**
  - `SpawnPrefab: InvulnerabilityBuff PrefabGuid(1811209060)`
  - `BuffDuration: 5`
  - `Condition: None`
