---
title: AB_Militia_MeleeHorizontal_Cast
guid: -1198099916
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_MeleeHorizontal_Cast PrefabGuid(-1198099916)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 1.9198622`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_Militia_MeleeHorizontal_Projectile PrefabGuid(1458430574)`
  - `Count: 4`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_MeleeHorizontal_Hit PrefabGuid(2088724204)`
