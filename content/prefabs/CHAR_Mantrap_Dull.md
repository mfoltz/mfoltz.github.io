...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 15.359041`
  - `SpellPower: 15.359041`
  - `ResourcePower: 13.6`
  - `SiegePower: 8`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_ManTrap_Dull PrefabGuid(-2017108869)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ManTrap_Dull_MeleeAttack_Group PrefabGuid(105274396)`
  - `ShowOnBar: True`
