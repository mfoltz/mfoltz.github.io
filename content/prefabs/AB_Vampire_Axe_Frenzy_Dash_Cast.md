---
title: AB_Vampire_Axe_Frenzy_Dash_Cast
guid: 1671733210
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Axe_Frenzy_Dash_Cast PrefabGuid(1671733210)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Axe_Frenzy_Dash_Hit PrefabGuid(706730253)`
