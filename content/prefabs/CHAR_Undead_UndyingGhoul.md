---
title: CHAR_Undead_UndyingGhoul
guid: 1640311129
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.Gameplay.Scripting.Script_ApplyBuffUnderHealthThreshold_DataServer]({{% relref "components/Script_ApplyBuffUnderHealthThreshold_DataServer.md" %}})
  - `HealthFactor: 0.01`
  - `NewBuffEntity: AB_Undead_Ghoul_RiseAgain_Death_Buff PrefabGuid(-765776365)`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(927263869)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_achckejjee`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_Ghoul PrefabGuid(-709027789)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Ghoul_MeleeAttack_Group PrefabGuid(1382585346)`
  - `ShowOnBar: True`
...
- **98 total elements but only showing the first 36**
