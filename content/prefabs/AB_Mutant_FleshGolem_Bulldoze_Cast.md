---
title: AB_Mutant_FleshGolem_Bulldoze_Cast
guid: -1598726478
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Mutant_FleshGolem_Bulldoze_Cast PrefabGuid(-1598726478)`
...
- **[0]**
  - `SpawnPrefab: AB_Mutant_FleshGolem_Bulldoze_ChargeBuff PrefabGuid(-662560439)`
  - `BuffDuration: 0`
  - `Condition: None`
