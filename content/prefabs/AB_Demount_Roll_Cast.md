...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Demount_Roll_Cast PrefabGuid(94016139)`
  - `GroupEntity: NetworkedEntity(0:0)`
  - `AbilityTypeFlag: ProjectM.AbilityTypeFlag AbilityKit, AbilityKit_BreakStealth, Demount`
...
- **[0]**
  - `SpawnPrefab: Buff_General_Daze PrefabGuid(792451792)`
