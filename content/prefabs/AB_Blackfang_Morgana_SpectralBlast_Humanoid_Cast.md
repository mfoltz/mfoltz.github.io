---
title: AB_Blackfang_Morgana_SpectralBlast_Humanoid_Cast
guid: 1754994413
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_SpectralBlast_Humanoid_Cast PrefabGuid(1754994413)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBlast_Humanoid_Hit PrefabGuid(-1685351564)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBlast_Humanoid_MoveBehBuff PrefabGuid(-1216556711)`
  - `BuffDuration: 0`
  - `Condition: None`
