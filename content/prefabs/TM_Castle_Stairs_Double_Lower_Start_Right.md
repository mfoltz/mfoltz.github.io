---
title: TM_Castle_Stairs_Double_Lower_Start_Right
guid: -791433293
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Stairs_Double_Lower_Start_Right PrefabGuid(-791433293) - Entity(18190:3)`
  - `Guid: TM_Castle_Stairs_Double_Lower_Start_Right PrefabGuid(-791433293)`
...
- [ProjectM.CastleBuilding.CastleStairs]({{% relref "components/CastleStairs.md" %}})
  - `StairsType: ProjectM.CastleBuilding.CastleStairsType Start`
