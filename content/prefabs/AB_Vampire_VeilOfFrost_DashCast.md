---
title: AB_Vampire_VeilOfFrost_DashCast
guid: -1869058934
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Vampire_VeilOfFrost_DashCast PrefabGuid(-1869058934)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_VeilOfFrost_Buff PrefabGuid(-879243806)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_VeilOfFrost_Immaterial PrefabGuid(-969825650)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
