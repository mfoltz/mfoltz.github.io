---
title: AB_Militia_Horseman_UnlockRotation_Cast
guid: -221807068
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Horseman_UnlockRotation_Cast PrefabGuid(-221807068)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_UnlockRotation_SelfBuff PrefabGuid(2140175849)`
...
- **[1]**
  - `SpawnPrefab: AB_Militia_Horseman_UnlockRotation_TargetBuff PrefabGuid(2103090040)`
