...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Storm_T03 PrefabGuid(189228039) - Entity(11704:1)`
  - `ItemTypeGUID: Item_Jewel_Storm_T03 PrefabGuid(189228039)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Storm_T03 PrefabGuid(-1901900501)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
