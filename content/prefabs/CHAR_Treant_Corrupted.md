...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1613164129)`
...
- [ProjectM.FactionReference]({{% relref "components/FactionReference.md" %}})
  - `FactionGuid: ModifiablePrefabGUID PrefabGuid(-1414061934)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Treant_Corrupted PrefabGuid(-1633968667)`
...
- [Unity.Transforms.LocalTransform]({{% relref "components/LocalTransform.md" %}})
  - `Position: Unity.Mathematics.float3 float3(-3118.152f, 16.87786f, -3116.594f)`
  - `Scale: 1`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Treant_Corrupted_MeleeAttack_AbilityGroup PrefabGuid(680554094)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Treant_Corrupted_Projectile_Group PrefabGuid(-891864538)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Treant_Corrupted_WakeUp_Group PrefabGuid(-1858935493)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Treant_Corrupted_FallAsleep_Group PrefabGuid(1957509060)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SpawnPrefab: AB_TreantMantrap_Corrupted_Setup_SpawnMinion01 PrefabGuid(1389644802)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- **[1]**
  - `SpawnPrefab: AB_TreantMantrap_Corrupted_Setup_SpawnMinion02 PrefabGuid(-1776466828)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Strongblade_CorruptedTreant PrefabGuid(-465235630)`
