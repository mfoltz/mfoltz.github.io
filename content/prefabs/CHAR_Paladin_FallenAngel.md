---
title: CHAR_Paladin_FallenAngel
guid: -76116724
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1214705499)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Paladin_FallenAngel PrefabGuid(-134491427)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_FallenAngel_MeleeAttack_AbilityGroup PrefabGuid(-8655403)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_FallenAngel_Dash_AbilityGroup PrefabGuid(-1364891068)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_FallenAngel_UnholyBarrage_AbilityGroup PrefabGuid(-1847055470)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Paladin_FallenAngel_BubblePopper_AbilityGroup PrefabGuid(1309712000)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
