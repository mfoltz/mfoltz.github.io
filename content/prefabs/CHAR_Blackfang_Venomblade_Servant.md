---
title: CHAR_Blackfang_Venomblade_Servant
guid: 1906807803
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1878237917)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Blackfang_Venomblade_Servant PrefabGuid(-443635394)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Venomblade_Melee_AbilityGroup PrefabGuid(323806214)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Venomblade_Sprint_AbilityGroup PrefabGuid(1944086996)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Venomblade_Leap_AbilityGroup PrefabGuid(1797731340)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Venomblade_ApplyWeaponCoating_AbilityGroup PrefabGuid(71067886)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Blackfang_Venomblade_Venomstrike_AbilityGroup PrefabGuid(940071564)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
