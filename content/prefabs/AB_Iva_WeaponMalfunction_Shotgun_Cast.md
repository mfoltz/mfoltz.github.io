---
title: AB_Iva_WeaponMalfunction_Shotgun_Cast
guid: 1609832009
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Iva_WeaponMalfunction_Shotgun_Cast PrefabGuid(1609832009)`
...
- **[0]**
  - `SpawnPrefab: AB_Iva_WeaponMalfunction_Shotgun_PostCast PrefabGuid(685090209)`
