...
**Categories:** [All]({{% relref "prefabs/All.md" %}}), [Resource]({{% relref "prefabs/Resource.md" %}})
...
- [ProjectM.ItemPickup]({{% relref "components/ItemPickup.md" %}})
  - `Radius: 1`
...
- **[0]**
  - `Condition: None`
  - `Ability: AB_Interact_OpenContainer_AllowShapeshift_AbilityGroup PrefabGuid(-1912437283)`
  - `Importance: 1`
...
- [ProjectM.DestroyWhenInventoryIsEmpty]({{% relref "components/DestroyWhenInventoryIsEmpty.md" %}})
