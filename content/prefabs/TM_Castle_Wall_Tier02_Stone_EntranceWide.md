---
title: TM_Castle_Wall_Tier02_Stone_EntranceWide
guid: 996421136
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Wall_Tier02_Stone_EntranceWide PrefabGuid(996421136) - Entity(14071:3)`
  - `Guid: TM_Castle_Wall_Tier02_Stone_EntranceWide PrefabGuid(996421136)`
  ...
  - `BuildingSequence: SequenceGUID -264278975`
...
- [ProjectM.Tiles.NetworkedPrefabChildren]({{% relref "components/NetworkedPrefabChildren.md" %}})
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_chjdiidjkg`
...
- [ProjectM.CastleBuilding.CastleBuildingFusedChildrenBuffer]({{% relref "components/CastleBuildingFusedChildrenBuffer.md" %}})
...
- [ProjectM.Network.Snapshot_CastleBuildingFusedChildrenBuffer]({{% relref "components/Snapshot_CastleBuildingFusedChildrenBuffer.md" %}})
...
- [ProjectM.CastleBuilding.CastleBuildingFusedRoot]({{% relref "components/CastleBuildingFusedRoot.md" %}})
