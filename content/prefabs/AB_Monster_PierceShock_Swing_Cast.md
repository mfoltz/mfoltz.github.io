---
title: AB_Monster_PierceShock_Swing_Cast
guid: 911471600
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Monster_PierceShock_Swing_Cast PrefabGuid(911471600)`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_PierceShock_Swing_Hit PrefabGuid(348375790)`
