---
title: AB_Legion_Nightmare_Taunt_Cast
guid: 2104884190
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Legion_Nightmare_Taunt_Cast PrefabGuid(2104884190)`
...
- **[0]**
  - `SpawnPrefab: AB_Legion_Nightmare_Taunt_Buff PrefabGuid(1363656805)`
