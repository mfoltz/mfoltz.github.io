---
title: CHAR_Manticore_FarbaneSuprise
guid: -767167590
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AggroConsumer]({{% relref "components/AggroConsumer.md" %}})
  ...
  - `MaxDistanceFromPreCombatPosition: 90`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-853428837)`
...
- [ProjectM.CanFly]({{% relref "components/CanFly.md" %}})
  - `FlyingHeight: 14`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cbfgcfkkji`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Manticore_Airborne PrefabGuid(1741096858)`
...
- [ProjectM.Shared.FallToHeight]({{% relref "components/FallToHeight.md" %}})
  - `Speed: 0`
  - `Gravity: 20`
  - `IsGrounded: False`
...
- **[1]**
  ...
  - `Buff: Manticore_Spawn_FromSide PrefabGuid(1236029872)`
  - `OriginPositionFactor: 0.5`
  - `Weight: 1`
...
- [ProjectM.VisibleFromFlight]({{% relref "components/VisibleFromFlight.md" %}})
