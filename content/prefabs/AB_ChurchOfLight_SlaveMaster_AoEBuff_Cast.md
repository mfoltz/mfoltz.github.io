---
title: AB_ChurchOfLight_SlaveMaster_AoEBuff_Cast
guid: 683679778
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_SlaveMaster_AoEBuff_Cast PrefabGuid(683679778)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_SlaveMaster_AoEBuff_Area PrefabGuid(1688066724)`
