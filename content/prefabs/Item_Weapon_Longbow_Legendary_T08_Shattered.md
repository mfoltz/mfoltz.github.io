---
title: Item_Weapon_Longbow_Legendary_T08_Shattered
guid: 285875674
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Longbow_Legendary_T08_Shattered PrefabGuid(285875674) - Entity(11169:1)`
  - `ItemTypeGUID: Item_Weapon_Longbow_Legendary_T08_Shattered PrefabGuid(285875674)`
...
- [ProjectM.ShatteredItem]({{% relref "components/ShatteredItem.md" %}})
  - `RequiredItem: Item_Weapon_Longbow_T08_Sanguine PrefabGuid(1860352606)`
  - `OutputItem: Item_Weapon_Longbow_Legendary_T08 PrefabGuid(1177453385)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 3800`
  - `MaxDurability: 3800`
  - `RepairRecipe: Recipe_Weapon_Longbow_T08_Sanguine PrefabGuid(-603557479)`
...
- [ProjectM.Shared.GeneratedName]({{% relref "components/GeneratedName.md" %}})
  - `RandomNamePrefix: 0`
  - `RandomNamePostfix: 0`
  - `NameGeneratorPrefixSource: Item_Weapon_Longbow_Legendary_NameGenerator_T08 PrefabGuid(288292636)`
  - `NameGeneratorPostfixSource: Item_Weapon_Longbow_Legendary_NameGenerator_T08 PrefabGuid(288292636)`
...
- **[0]**
  - `ItemId: Item_Weapon_Longbow_T08_Sanguine PrefabGuid(1860352606)`
  - `Amount: 1`
