---
title: CHAR_Bandit_Miner_Standard_Servant
guid: 1112903312
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-821621347)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Bandit_Miner_Standard_Servant PrefabGuid(1112903312)`
...
- [ProjectM.UnitStats](/components/UnitStats)
  - `PhysicalPower: 20.340797`
  - `SpellPower: 20.340797`
  - `ResourcePower: 0`
  - `SiegePower: 0`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Miner_Servant PrefabGuid(1748248643)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Worker_Shared_MeleeAttack_AbilityGroup PrefabGuid(2039677643)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Worker_Shared_Flee_AbilityGroup PrefabGuid(1340319300)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Bandit_Worker_Miner_Mine_AbilityGroup PrefabGuid(900927411)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
