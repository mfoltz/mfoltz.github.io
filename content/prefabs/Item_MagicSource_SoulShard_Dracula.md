---
title: Item_MagicSource_SoulShard_Dracula
guid: 666638454
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_MagicSource_SoulShard_Dracula PrefabGuid(666638454) - Entity(22664:1)`
  - `ItemTypeGUID: Item_MagicSource_SoulShard_Dracula PrefabGuid(666638454)`
...
- [ProjectM.EquippableData]({{% relref "components/EquippableData.md" %}})
  - `BuffGuid: Item_EquipBuff_MagicSource_Soulshard_Dracula PrefabGuid(-504120321)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 2500`
  - `MaxDurability: 2500`
  - `RepairRecipe: Recipe_MagicSource_General_T09_Dracula PrefabGuid(-414358988)`
...
- **[0]**
  - `Prefab: MapIcon_Relic_Standard_Dracula PrefabGuid(1082059027)`
