---
title: CHAR_Undead_GhostMilitia_Light
guid: -1618703048
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1044101479)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 42.23479`
  - `SpellPower: 42.23479`
  - `ResourcePower: 27.130001`
  - `SiegePower: 16.2`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_GhostMilitia_Light PrefabGuid(335836727)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostMilitia_Light_MeleeAttack_Group PrefabGuid(-1967657578)`
  - `ShowOnBar: True`
...
- **[0]**
  - `DropTableGuid: DT_Shared_Unit_Cursed_Ghost_Rank01 PrefabGuid(-808592560)`
