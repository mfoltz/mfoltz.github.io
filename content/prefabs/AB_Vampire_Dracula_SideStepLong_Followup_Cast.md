---
title: AB_Vampire_Dracula_SideStepLong_Followup_Cast
guid: 1003887738
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Dracula_SideStepLong_Followup_Cast PrefabGuid(1003887738)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_SideStepLong_Followup_Hit PrefabGuid(2041239910)`
