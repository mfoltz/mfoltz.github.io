...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-881694794)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 24.398386`
  - `SpellPower: 24.398386`
  - `ResourcePower: 20.800001`
  - `SiegePower: 9.400001`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_Priest PrefabGuid(1373194052)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_Projectile_Group PrefabGuid(-1047491293)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Priest_RaiseDead_AbilityGroup PrefabGuid(-1742500275)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Farbane_Undead_Normal_Rank01 PrefabGuid(875214906)`
