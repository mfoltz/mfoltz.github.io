---
title: CHAR_Gloomrot_Pyro_Servant
guid: 1304434816
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1387745375)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Gloomrot_Pyro_Servant PrefabGuid(-1164304327)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Pyro_FlameStrafer_AbilityGroup PrefabGuid(288608511)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Pyro_FlameLine_AbilityGroup PrefabGuid(-635085409)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
