---
title: AB_Undead_GhostGuardian_AttackChain_Cast_Right
guid: 566726913
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_GhostGuardian_AttackChain_Cast_Right PrefabGuid(566726913)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_GhostGuardian_AttackChain_Hit PrefabGuid(611800697)`
