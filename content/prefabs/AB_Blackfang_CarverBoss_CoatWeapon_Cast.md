---
title: AB_Blackfang_CarverBoss_CoatWeapon_Cast
guid: 2062119815
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_CarverBoss_CoatWeapon_Cast PrefabGuid(2062119815)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_CoatWeapon_Buff PrefabGuid(242858653)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_CoatWeapon_Trigger PrefabGuid(-1796297364)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
