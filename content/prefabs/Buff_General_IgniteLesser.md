...
- [ProjectM.Gameplay.Scripting.Script_IgniteDebuff_DataServer]({{% relref "components/Script_IgniteDebuff_DataServer.md" %}})
  - `TotalTicks: 3`
...
- [ProjectM.YieldResourceDisable]({{% relref "components/YieldResourceDisable.md" %}})
