---
title: CHAR_TreantMantrap_Corrupted_Minion_Right
guid: 2107764370
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(422251091)`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 58.640457`
  - `SpellPower: 58.640457`
  - `ResourcePower: 33.4`
  - `SiegePower: 20`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_TrantMantrap_Corrupted PrefabGuid(1891425561)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_TreantMantrap_Corrupted_Spit_AbilityGroup PrefabGuid(-802865471)`
  - `ShowOnBar: True`
