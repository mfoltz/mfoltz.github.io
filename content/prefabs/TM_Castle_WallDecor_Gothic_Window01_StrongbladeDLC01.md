...
- [ProjectM.CastleBuilding.CastleBuildingAttachmentActiveBuffsBuffer]({{% relref "components/CastleBuildingAttachmentActiveBuffsBuffer.md" %}})

- [ProjectM.BuffBuffer]({{% relref "components/BuffBuffer.md" %}})

- [ProjectM.CastleBuilding.CastleBuildingAttachmentApplyBuff]({{% relref "components/CastleBuildingAttachmentApplyBuff.md" %}})
