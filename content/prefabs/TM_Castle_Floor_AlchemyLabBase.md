---
title: TM_Castle_Floor_AlchemyLabBase
guid: 1049312363
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Floor_AlchemyLabBase PrefabGuid(1049312363) - Entity(14191:3)`
  - `Guid: TM_Castle_Floor_AlchemyLabBase PrefabGuid(1049312363)`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
  - `FloorType: ProjectM.CastleBuilding.CastleFloorTypes AlchemyLab`
