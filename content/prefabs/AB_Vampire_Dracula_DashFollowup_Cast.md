---
title: AB_Vampire_Dracula_DashFollowup_Cast
guid: 1753038398
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Dracula_DashFollowup_Cast PrefabGuid(1753038398)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_DashFollowup_Hit PrefabGuid(291587872)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Dracula_DashFollowup_StartCastBuff PrefabGuid(2099264257)`
  - `BuffDuration: 0`
  - `Condition: None`
