---
title: CHAR_Militia_FabiansSteed
guid: 826666431
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- **ProjectM.UnitMount**
  - `UnitSpawnsMount: True`
  - `MounterEntity: NetworkedEntity(0:0)`
...
- [ProjectM.AiMove_Server]({{% relref "components/AiMove_Server.md" %}})
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 999`
  - `CircleChangeDirectionFrequencyMax: 999`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1351736781)`

- [ProjectM.AimRotationParameters]({{% relref "components/AimRotationParameters.md" %}})
  - `Constant: 1.99`
  - `CoreModifier: 0.99`
...
- [ProjectM.LegDirection_Shared]({{% relref "components/LegDirection_Shared.md" %}})
...
- [ProjectM.YieldEssenceOnDeath]({{% relref "components/YieldEssenceOnDeath.md" %}})
  - `EssenceGain: 18`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 40.688587`
  - `SpellPower: 40.688587`
  - `ResourcePower: 28.4`
  - `SiegePower: 13.2`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acbdhcfegii`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Militia_FabiansSteed PrefabGuid(-2090924587)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Militia_FabiansSteed_RunClose_AbilityGroup PrefabGuid(-469608333)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Militia_FabiansSteed_Charge_AbilityGroup PrefabGuid(1246326726)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_FabiansSteed_Leap_AbilityGroup PrefabGuid(1220301459)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Militia_FabiansSteed_AggroTarget_AbilityGroup PrefabGuid(-715615220)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Militia_FabiansSteed_MultiCharge_AbilityGroup PrefabGuid(325658714)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `DeathTarget: ProjectM.EventOnDeathTarget Target`
  - `EventTarget: ProjectM.GameplayEventTarget UnitMounter`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: Buff_Militia_FabiansSteed_Trample PrefabGuid(1136393298)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **368 total elements but only showing the first 36**
...
- **[1]**
  - `BuffGuid: Buff_Militia_Fabian_Return PrefabGuid(1054832087)`
  - `State: ProjectM.GenericEnemyState Return`

- [ProjectM.Shared.DropTableBuffer]({{% relref "components/DropTableBuffer.md" %}})

- **[0]**
  - `DropTableGuid: DT_Shared_Unit_Human_Normal_T01 PrefabGuid(-991578659)`
