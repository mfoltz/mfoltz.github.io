...
- [ProjectM.DestroyOnAbilityCast]({{% relref "components/DestroyOnAbilityCast.md" %}})
  - `CastCount: 0`
...
- [ProjectM.Gameplay.Scripting.Script_SetAbilityCooldownOnGameplayEvent_DataServer]({{% relref "components/Script_SetAbilityCooldownOnGameplayEvent_DataServer.md" %}})
