---
title: AB_Undead_Infiltrator_ArmyOfShadows_Cast
guid: 1760437256
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_Infiltrator_ArmyOfShadows_Cast PrefabGuid(1760437256)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Infiltrator_ArmyOfShadows_InitBuff PrefabGuid(958910942)`
