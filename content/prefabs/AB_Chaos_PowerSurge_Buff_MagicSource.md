...
- [ProjectM.Gameplay.Scripting.Buff_ApplyBuffOnDamageTypeDealt_DataShared]({{% relref "components/Buff_ApplyBuffOnDamageTypeDealt_DataShared.md" %}})
  - `ProcChance: 1`
...
- [ProjectM.CreateGameplayEventOnBuffReapply]({{% relref "components/CreateGameplayEventOnBuffReapply.md" %}})
