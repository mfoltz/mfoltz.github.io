---
title: AB_Militia_FabiansSteed_Leap_Cast
guid: -450565827
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_FabiansSteed_Leap_Cast PrefabGuid(-450565827)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_FabiansSteed_Leap_Phase PrefabGuid(-1946670460)`
...
- **[1]**
  - `SpawnPrefab: AB_Militia_FabiansSteed_Leap_RiderBuff PrefabGuid(2054840798)`
  - `BuffDuration: 6`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Unit_Mounter`
