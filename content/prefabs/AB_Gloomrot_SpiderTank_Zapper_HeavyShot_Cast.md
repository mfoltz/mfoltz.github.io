---
title: AB_Gloomrot_SpiderTank_Zapper_HeavyShot_Cast
guid: 971050267
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Gloomrot_SpiderTank_Zapper_HeavyShot_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Gloomrot_SpiderTank_Zapper_HeavyShot_Cast PrefabGuid(971050267)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_HeavyShot_MainProjectile PrefabGuid(1156886082)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_SpiderTank_Zapper_HeavyShot_MoveBuff PrefabGuid(-554336743)`
  - `BuffDuration: 0`
  - `Condition: None`
