...
- [ProjectM.AbilityOwner]({{% relref "components/AbilityOwner.md" %}})
...
- [ProjectM.Gameplay.Scripting.Script_Buff_Shapeshift_DataShared]({{% relref "components/Script_Buff_Shapeshift_DataShared.md" %}})
...
- [ProjectM.Gameplay.Scripting.Script_Buff_AggroRangeFactor_DataShared]({{% relref "components/Script_Buff_AggroRangeFactor_DataShared.md" %}})
  - `AggroRangeFactor: 0.5`
  - `AggroRangeFactorModificationId: Unset`

- [ProjectM.Gameplay.Scripting.Script_SetFlyingHeightVision_Buff_DataShared]({{% relref "components/Script_SetFlyingHeightVision_Buff_DataShared.md" %}})
...
- [ProjectM.UnlockTrophyOnGameplayEvent]({{% relref "components/UnlockTrophyOnGameplayEvent.md" %}})
