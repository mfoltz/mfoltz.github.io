...
- [ProjectM.ModifyEntityCategoryBuff]({{% relref "components/ModifyEntityCategoryBuff.md" %}})
...
- **ProjectM.Gameplay.Scripting.Script_Lucie_ModifyPotionDropTable_DataServer**
  - `SpecificPotionPrefab: AB_Lucie_Player_ClarityPotion_Resource_Throw PrefabGuid(778857257)`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Lucie_Barrier_HasHadBarrier PrefabGuid(1962565411)`
