...
- [ProjectM.MapIconData]({{% relref "components/MapIconData.md" %}})
  - `HeaderLocalizedKey: 2df68eef-f6d0-449a-8c5a-7f60d161ba54 - Wooden Coffin`
  ...
  - `EnemySetting: ProjectM.MapIconShowSettings InVision`
...
- [ProjectM.SpawnLocationSelector]({{% relref "components/SpawnLocationSelector.md" %}})
  - `LocationType: ProjectM.Network.SpawnLocationType WoodenCoffin`
  - `IsLocked: False`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ahbgechgbk`
