---
title: AB_Vampire_Slashers_Primary_MeleeAttack_AbilityGroup
guid: 1470213751
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_Slashers_Primary_MeleeAttack_AbilityGroup
...
- **[0]**
  - `PrefabGUID: AB_Vampire_Slashers_Primary_MeleeAttack_Cast01 PrefabGuid(2138997168)`

- **[1]**
  - `PrefabGUID: AB_Vampire_Slashers_Primary_MeleeAttack_Cast02 PrefabGuid(-538471976)`

- **[2]**
  - `PrefabGUID: AB_Vampire_Slashers_Primary_MeleeAttack_Cast03 PrefabGuid(-553275783)`
...
- [ProjectM.Gameplay.Scripting.AbilityChargeResetOnUse](/components/AbilityChargeResetOnUse)
