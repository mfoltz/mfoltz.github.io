---
title: AB_Blackfang_Morgana_CrossWindSlash_Cast
guid: 2124769465
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_CrossWindSlash_Cast PrefabGuid(2124769465)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_CrossWindSlash_Right_InitialHit PrefabGuid(1727302918)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_CrossWindSlash_Right_FollowupHitBuff PrefabGuid(961740099)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Morgana_CrossWindSlash_Left_InitialHit PrefabGuid(-1812098607)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Blackfang_Morgana_CrossWindSlash_Left_FollowupHitBuff PrefabGuid(-1430472663)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
