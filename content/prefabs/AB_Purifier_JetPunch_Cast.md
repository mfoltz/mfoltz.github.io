---
title: AB_Purifier_JetPunch_Cast
guid: 1517153912
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Purifier_JetPunch_Cast PrefabGuid(1517153912)`
...
- **[0]**
  - `SpawnPrefab: AB_Purifier_JetPunch_Dash PrefabGuid(-982975585)`
...
- **[1]**
  - `SpawnPrefab: AB_Purifier_JetPunch_AggroBuff PrefabGuid(-1063958665)`
...
- **[2]**
  - `SpawnPrefab: AB_Purifier_Barrier_PurgeBarriers PrefabGuid(-1144410559)`
  - `Target: ProjectM.AbilitySpawnTarget HoverTarget`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
