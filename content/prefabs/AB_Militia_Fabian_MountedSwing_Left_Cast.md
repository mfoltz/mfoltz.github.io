---
title: AB_Militia_Fabian_MountedSwing_Left_Cast
guid: -1843693678
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Fabian_MountedSwing_Left_Cast PrefabGuid(-1843693678)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Fabian_MountedSwing_Left_Trigger PrefabGuid(1801016041)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Fabian_MountedSwing_MountForceCastTrigger PrefabGuid(1491333787)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: Buff_Militia_FabiansSteed_CastImpair PrefabGuid(-1205493484)`
  - `BuffDuration: 1.8`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Unit_Mount`
...
- **ProjectM.IgnoreMountedUnitRotationRules**
