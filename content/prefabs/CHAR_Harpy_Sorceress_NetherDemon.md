---
title: CHAR_Harpy_Sorceress_NetherDemon
guid: 1405099312
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(741489686)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_iigkgjkfh`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Harpy_Sorceress PrefabGuid(-1716102506)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Sorceress_Projectile_AbilityGroup PrefabGuid(1075000607)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Sorceress_AoE_AbilityGroup PrefabGuid(725170243)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Sorceress_Relocate_AbilityGroup PrefabGuid(-420953378)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[1]**
  ...
  - `Buff: AB_Harpy_Spawn_FlyDown PrefabGuid(888932733)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[2]**
  - `Kind: ProjectM.SpawnBuffKind FromAbove`
  - `Buff: AB_Harpy_Spawn_FlyDownSmoothly PrefabGuid(2038513138)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`

- **[3]**
  - `Kind: ProjectM.SpawnBuffKind FromSide`
  - `Buff: AB_Harpy_Spawn_SideCharge PrefabGuid(-1105315493)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
...
- **[0]**
  - `DropTableGuid: DT_Unit_NetherDemon_Knowledge_T01 PrefabGuid(1734056745)`
