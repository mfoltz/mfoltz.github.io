---
title: TM_SpecialStation_StablePen
guid: -336743839
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_SpecialStation_StablePen PrefabGuid(-336743839) - Entity(7169:3)`
  - `Guid: TM_SpecialStation_StablePen PrefabGuid(-336743839)`
...
- [ProjectM.ServantInteractPointLocalTransform]({{% relref "components/ServantInteractPointLocalTransform.md" %}})
  - `Value: Unity.Mathematics.float4x4 float4x4(1f, 0f, 0f, 0.01f,  0f, 1f, 0f, 0.49f,  0f, 0f, 1f, -3.12f,  0f, 0f, 0f, 1f)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cekbcbegeg`
...
- **[0]**
  - `Entity: Entity(12163:3)`
  - `BlobIndex: 11`

- **[1]**
  - `Entity: Entity(12167:3)`
  - `BlobIndex: 12`

- **[2]**
  - `Entity: Entity(12165:3)`
  - `BlobIndex: 13`

- **[3]**
  - `Entity: Entity(12325:3)`
  - `BlobIndex: 14`

- **[4]**
  - `Entity: Entity(12324:3)`
  - `BlobIndex: 15`

- **[5]**
  - `Entity: Entity(12166:3)`
  - `BlobIndex: 16`

- **[6]**
  - `Entity: Entity(12164:3)`
  - `BlobIndex: 17`

- **[7]**
  - `Entity: Entity(12323:3)`
  - `BlobIndex: 19`

- **[8]**
  - `Entity: Entity(12321:3)`
  - `BlobIndex: 20`
...
- [ProjectM.InventoryInstanceElement]({{% relref "components/InventoryInstanceElement.md" %}})
...
- **[0]**
  - `RendererEntity: Entity(12163:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[1]**
  - `RendererEntity: Entity(12167:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[2]**
  - `RendererEntity: Entity(12165:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[3]**
  - `RendererEntity: Entity(12325:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[4]**
  - `RendererEntity: Entity(12324:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[5]**
  - `RendererEntity: Entity(12166:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[6]**
  - `RendererEntity: Entity(12164:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[7]**
  - `RendererEntity: Entity(12323:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`

- **[8]**
  - `RendererEntity: Entity(12321:3)`
  - `Mask: 64`
  - `IsLineOfSightVisible: True`
  - `IsMaterialVisible: True`
...
- **[0]**
  - `Value: Prefab TM_SpecialStation_StablePen PrefabGuid(-336743839) - Entity(7169:3)`

- **[1]**
  - `Value: Entity(12163:3)`

- **[2]**
  - `Value: Entity(12167:3)`

- **[3]**
  - `Value: Entity(12165:3)`

- **[4]**
  - `Value: Entity(12325:3)`

- **[5]**
  - `Value: Entity(12324:3)`

- **[6]**
  - `Value: Entity(12166:3)`

- **[7]**
  - `Value: Entity(12164:3)`

- **[8]**
  - `Value: Entity(12323:3)`

- **[9]**
  - `Value: Entity(12321:3)`
...
- [ProjectM.Network.Snapshot_InventoryInstanceElement]({{% relref "components/Snapshot_InventoryInstanceElement.md" %}})
