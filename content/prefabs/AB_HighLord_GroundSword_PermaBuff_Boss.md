...
- [ProjectM.ModifyTargetHUDBuff]({{% relref "components/ModifyTargetHUDBuff.md" %}})
  - `Priority: 0`
  - `Height: 0.3`
...
- [ProjectM.Gameplay.Scripting.Script_ModifyAbilityCooldownOnGameplayEvent_DataServer]({{% relref "components/Script_ModifyAbilityCooldownOnGameplayEvent_DataServer.md" %}})
  - `AbilityGroupType: AB_HighLord_PullPlayers_AbilityGroup PrefabGuid(851287157)`
...
- **[0]**
  ...
  - `NewGroupId: AB_HighLord_UnholySkill_AbilityGroup PrefabGuid(-1298764600)`
  - `Priority: 1`
  - `Condition: None`
...
- **[1]**
  ...
  - `Slot: 1`
  - `ReplaceGroupId: GUID Not Found`
  - `NewGroupId: AB_HighLord_RaiseDead_AbilityGroup PrefabGuid(416744805)`
  - `Priority: 1`
  - `Condition: None`
  - `CastBlockType: ProjectM.GroupSlotModificationCastBlockType WholeCast`
  - `CopyCooldown: False`
