---
title: AB_VHunter_Leader_MeleeHorizontal_Hard_Cast
guid: 1193298493
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_VHunter_Leader_MeleeHorizontal_Hard_Cast PrefabGuid(1193298493)`
...
- **[0]**
  - `SpawnPrefab: AB_VHunter_Leader_MeleeHorizontal_Hit PrefabGuid(1349892586)`
