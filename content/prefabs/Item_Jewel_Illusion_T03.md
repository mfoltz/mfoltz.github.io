...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Illusion_T03 PrefabGuid(1540217782) - Entity(11706:1)`
  - `ItemTypeGUID: Item_Jewel_Illusion_T03 PrefabGuid(1540217782)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Illusion_T03 PrefabGuid(-1638077703)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
