...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Paladin_ShockWaveSlam_Cast PrefabGuid(-1734736354)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 0.61086524`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_PaladinShockWave_Projectile PrefabGuid(-480497639)`
  - `Count: 3`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_Paladin_ShockWaveSlam_Hit PrefabGuid(-996778647)`
