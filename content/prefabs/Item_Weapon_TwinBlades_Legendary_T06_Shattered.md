---
title: Item_Weapon_TwinBlades_Legendary_T06_Shattered
guid: 1579758125
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_TwinBlades_Legendary_T06_Shattered PrefabGuid(1579758125) - Entity(20150:1)`
  - `ItemTypeGUID: Item_Weapon_TwinBlades_Legendary_T06_Shattered PrefabGuid(1579758125)`
  - `DropItemPrefab: Resource_Drop_Weapon_Cluster_Rare PrefabGuid(1349020541)`
...
- [ProjectM.EquippableData]({{% relref "components/EquippableData.md" %}})
  - `BuffGuid: EquipBuff_Weapon_TwinBlades_Ability03 PrefabGuid(-1138655105)`
  - `EquipmentType: ProjectM.EquipmentType Weapon`
  - `WeaponType: ProjectM.WeaponType Twinblades`
...
- [ProjectM.ShatteredItem]({{% relref "components/ShatteredItem.md" %}})
  - `RequiredItem: Item_Weapon_TwinBlades_T06_Iron_Reinforced PrefabGuid(-1651990235)`
  - `OutputItem: Item_Weapon_TwinBlades_Legendary_T06 PrefabGuid(-1634108038)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  ...
  - `RepairRecipe: Recipe_Weapon_TwinBlades_T06_Iron_Reinforced PrefabGuid(1687058710)`
...
- [ProjectM.Shared.UpgradeableLegendaryItem]({{% relref "components/UpgradeableLegendaryItem.md" %}})
  - `CurrentTier: 0`
  - `MaxTiers: 2`

- [ProjectM.Shared.LegendaryItemSpellModSetComponent]({{% relref "components/LegendaryItemSpellModSetComponent.md" %}})
...
- [ProjectM.Shared.LegendaryItemGeneratorTemplate]({{% relref "components/LegendaryItemGeneratorTemplate.md" %}})
...
- [ProjectM.Shared.GeneratedName]({{% relref "components/GeneratedName.md" %}})
  - `RandomNamePrefix: 0`
  - `RandomNamePostfix: 0`
  - `NameGeneratorPrefixSource: Item_Weapon_TwinBlades_Legendary_NameGenerator_T06 PrefabGuid(1835208468)`
  - `NameGeneratorPostfixSource: Item_Weapon_TwinBlades_Legendary_NameGenerator_T06 PrefabGuid(1835208468)`
...
- [ProjectM.Shared.JewelArithmeticModification]({{% relref "components/JewelArithmeticModification.md" %}})

- [ProjectM.ReplaceAbilityOnSlotWhenMountedBuffElement]({{% relref "components/ReplaceAbilityOnSlotWhenMountedBuffElement.md" %}})

- **[0]**
  - `AbilitySlotIndex: 0`
  - `NewGroupId: AB_Vampire_TwinBlades_Primary_Mounted_AbilityGroup PrefabGuid(1364381862)`
  - `Priority: 5`
...
- [ProjectM.ShatteredItemRepairCost]({{% relref "components/ShatteredItemRepairCost.md" %}})

- **[0]**
  - `ItemId: Item_Weapon_TwinBlades_T06_Iron_Reinforced PrefabGuid(-1651990235)`
  - `Amount: 1`

- **[1]**
  - `ItemId: Item_Ingredient_RadiumAlloy PrefabGuid(2116142390)`
  - `Amount: 8`

- **[2]**
  - `ItemId: Item_BloodEssence_T02_Greater PrefabGuid(271594022)`
  - `Amount: 1`
...
- [ProjectM.Shared.UpgradeableLegendaryItemTiers]({{% relref "components/UpgradeableLegendaryItemTiers.md" %}})

- **[0]**
  - `TierPrefab: Item_Weapon_TwinBlades_Legendary_T06_Shattered PrefabGuid(1579758125)`
  - `AdditionalLevel: 0`

- **[1]**
  - `TierPrefab: Item_Weapon_TwinBlades_T07_DarkSilver PrefabGuid(-1595292245)`
  - `AdditionalLevel: 3.3333333`

- **[2]**
  - `TierPrefab: Item_Weapon_TwinBlades_T08_Sanguine PrefabGuid(-297349982)`
  - `AdditionalLevel: 3.3333333`
