---
title: AB_Vampire_Cultist_StopChannel_Cast
guid: 139302722
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Cultist_StopChannel_Cast PrefabGuid(139302722)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Cultist_StopChannel_RemoveBuff PrefabGuid(-214584331)`
