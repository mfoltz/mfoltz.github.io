---
title: AB_GoldGolem_RockSlam_Cast
guid: 1359059929
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_GoldGolem_RockSlam_Cast PrefabGuid(1359059929)`
...
- **[0]**
  - `SpawnPrefab: AB_GoldGolem_RockSlam_Projectile PrefabGuid(188459696)`
