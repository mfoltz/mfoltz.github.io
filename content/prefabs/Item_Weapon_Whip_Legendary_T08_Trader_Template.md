---
title: Item_Weapon_Whip_Legendary_T08_Trader_Template
guid: 1340494453
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Whip_Legendary_T08_Trader_Template PrefabGuid(1340494453) - Entity(19532:1)`
  - `ItemTypeGUID: Item_Weapon_Whip_Legendary_T08_Trader_Template PrefabGuid(1340494453)`
...
- [ProjectM.Shared.LegendaryItemTemplate]({{% relref "components/LegendaryItemTemplate.md" %}})
  - `TemplateLevel: 88`
  - `TemplateWeaponType: ProjectM.WeaponType Whip`
