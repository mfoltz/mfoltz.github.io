---
title: AB_Undead_Banshee_Teleport_Cast
guid: 2049375272
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_Banshee_Teleport_Cast PrefabGuid(2049375272)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Banshee_TravelPhase PrefabGuid(1523180455)`
