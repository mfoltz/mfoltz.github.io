---
title: AB_Vampire_Pollaxe_Lunge_Cast
guid: 1922346691
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Pollaxe_Lunge_Cast PrefabGuid(1922346691)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Pollaxe_Lunge_Hit PrefabGuid(1635063712)`
