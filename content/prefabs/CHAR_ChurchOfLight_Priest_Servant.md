---
title: CHAR_ChurchOfLight_Priest_Servant
guid: -1728284448
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1504358745)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_ChurchOfLight_Priest_Servant PrefabGuid(-1728284448)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_Priest_Servant PrefabGuid(-2080114153)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Priest_Projectile_AbilityGroup PrefabGuid(-292542362)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Priest_HealBomb_AbilityGroup PrefabGuid(-1282606238)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_ChurchOfLight_Priest_SummonPillar_AbilityGroup PrefabGuid(943885425)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
