...
- [ProjectM.MapIconData]({{% relref "components/MapIconData.md" %}})
  - `HeaderLocalizedKey: 4a519e2f-4667-4921-8959-f73af3cbe9fa - Stone Coffin`
...
- [ProjectM.SpawnLocationSelector]({{% relref "components/SpawnLocationSelector.md" %}})
  - `LocationType: ProjectM.Network.SpawnLocationType StoneCoffin`
  - `IsLocked: False`
