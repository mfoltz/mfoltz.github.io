...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Unholy_T02 PrefabGuid(-860388090) - Entity(11659:1)`
  - `ItemTypeGUID: Item_Jewel_Unholy_T02 PrefabGuid(-860388090)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Unholy_T02 PrefabGuid(1628896277)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
