---
title: AB_Undead_Infiltrator_ShadowFlurry_Cast
guid: 1717054384
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_Infiltrator_ShadowFlurry_Cast PrefabGuid(1717054384)`
...
- [ProjectM.RotateTowardsAimDirectionDuringCastData]({{% relref "components/RotateTowardsAimDirectionDuringCastData.md" %}})
  ...
  - `TargetRotationCanChangeDuringCast: False`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_Infiltrator_ShadowFlurry_Hit PrefabGuid(258177675)`
