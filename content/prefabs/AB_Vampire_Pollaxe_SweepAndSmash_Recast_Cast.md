---
title: AB_Vampire_Pollaxe_SweepAndSmash_Recast_Cast
guid: -1370960512
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Vampire_Pollaxe_SweepAndSmash_Recast_Cast PrefabGuid(-1370960512)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_Pollaxe_SweepAndSmash_Recast_Hit PrefabGuid(1174236120)`
...
- **[1]**
  - `SpawnPrefab: AB_Vampire_Pollaxe_SweepAndSmash_Trigger PrefabGuid(13393243)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
