...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Unholy_T01 PrefabGuid(803445709) - Entity(11730:1)`
  - `ItemTypeGUID: Item_Jewel_Unholy_T01 PrefabGuid(803445709)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Unholy_T01 PrefabGuid(-1841149251)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Emerald_T01 PrefabGuid(-237441421)`
  - `Amount: 1`
