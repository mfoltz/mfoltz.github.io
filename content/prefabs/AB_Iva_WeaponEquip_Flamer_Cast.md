---
title: AB_Iva_WeaponEquip_Flamer_Cast
guid: 1642953750
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Iva_WeaponEquip_Flamer_Cast PrefabGuid(1642953750)`
...
- **[0]**
  - `SpawnPrefab: Buff_Iva_WeaponEquip_Flamer PrefabGuid(847337272)`
