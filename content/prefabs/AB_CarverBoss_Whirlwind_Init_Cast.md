---
title: AB_CarverBoss_Whirlwind_Init_Cast
guid: -909226674
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_CarverBoss_Whirlwind_Init_Cast PrefabGuid(-909226674)`
...
- **[0]**
  - `SpawnPrefab: AB_CarverBoss_Whirlwind_Init_Trigger PrefabGuid(-690555778)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_Whirlwind_Buff PrefabGuid(-1463517253)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
