---
title: CHAR_Gloomrot_SpiderTank_Zapper
guid: -2018710724
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BuffResistances]({{% relref "components/BuffResistances.md" %}})
  ...
  - `InitialSettingGuid: BuffResistance_SpiderTanks PrefabGuid(-1513114390)`
...
- [ProjectM.AiMove_Server]({{% relref "components/AiMove_Server.md" %}})
  ...
  - `GoalDistanceOuter: 0`
  - `MaxDistance: 0`
  - `CircleChangeDirectionFrequencyMin: 30`
  - `CircleChangeDirectionFrequencyMax: 40`
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2035229253)`
...
- [ProjectM.LegDirection_Server]({{% relref "components/LegDirection_Server.md" %}})
  ...
  - `SpeedModId: Unset`
  - `OnlyUserCharacterRotation: False`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 76.43737`
  - `SpellPower: 76.43737`
  - `ResourcePower: 41.199997`
  - `SiegePower: 19.599998`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ghifdjkci`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Gloomrot_SpiderTank_Zapper PrefabGuid(1006621956)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_Zapper_RapidShot_AbilityGroup PrefabGuid(-1081890077)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_Zapper_BombHatch_AbilityGroup PrefabGuid(-1126624947)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_Zapper_HeavyShot_AbilityGroup PrefabGuid(-730217983)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_SpiderTank_Zapper_IncinerationBomb_AbilityGroup PrefabGuid(-568845499)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `SpawnPrefab: Trigger_Tank_Standing_SpawnPilot PrefabGuid(197259186)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
...
- **93 total elements but only showing the first 36**
