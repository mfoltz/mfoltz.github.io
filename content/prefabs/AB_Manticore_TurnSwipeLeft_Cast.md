---
title: AB_Manticore_TurnSwipeLeft_Cast
guid: 1366892358
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Manticore_TurnSwipeLeft_Cast PrefabGuid(1366892358)`
...
- [ProjectM.RotateTowardsAimDirectionDuringCastData]({{% relref "components/RotateTowardsAimDirectionDuringCastData.md" %}})
  - `RotationAngle: 0`
  - `MinDegrees: 45`
  - `MaxDegrees: 135`
  - `ManualDuration: 1`
  - `Curve: ProjectM.CurveReference ProjectM.CurveReference`
  - `Clockwise: ProjectM.RotateDirectionType CounterClockwise`
...
- **[0]**
  - `SpawnPrefab: AB_Manticore_TurnSwipeLeft_ProjectileSpawner PrefabGuid(1757976740)`
...
- **[1]**
  - `SpawnPrefab: AB_Manticore_TurnSwipeLeft_MeleeHit PrefabGuid(84210889)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
