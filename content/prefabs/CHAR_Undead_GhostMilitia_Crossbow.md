---
title: CHAR_Undead_GhostMilitia_Crossbow
guid: -85729652
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1545459275)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_GhostMilitia_Crossbow PrefabGuid(911962163)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_GhostMilitia_Crossbow_Group PrefabGuid(-932485064)`
  - `ShowOnBar: True`
