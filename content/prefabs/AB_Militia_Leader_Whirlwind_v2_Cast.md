---
title: AB_Militia_Leader_Whirlwind_v2_Cast
guid: -1606487203
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Leader_Whirlwind_v2_Cast PrefabGuid(-1606487203)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Leader_Whirlwind_v2_Channel PrefabGuid(158253791)`
  - `BuffDuration: 10`
  - `Condition: None`
