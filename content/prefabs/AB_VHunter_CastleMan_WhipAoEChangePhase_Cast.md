---
title: AB_VHunter_CastleMan_WhipAoEChangePhase_Cast
guid: 482129992
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_VHunter_CastleMan_WhipAoEChangePhase_Cast PrefabGuid(482129992)`
...
- **[0]**
  - `SpawnPrefab: AB_VHunter_CastleMan_WhipAoEChangePhase_Area PrefabGuid(1719711838)`
...
- **[1]**
  - `SpawnPrefab: AB_VHunter_CastleMan_WhipAoEChangePhase_Area_IgniteHolyWater PrefabGuid(-1594176811)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
