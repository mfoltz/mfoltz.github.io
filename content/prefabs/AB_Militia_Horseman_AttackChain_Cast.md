---
title: AB_Militia_Horseman_AttackChain_Cast
guid: -464739015
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Horseman_AttackChain_Cast PrefabGuid(-464739015)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_AttackChain_Hit PrefabGuid(1946864385)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Horseman_AttackChain_Trigger PrefabGuid(1191742412)`
  - `BuffDuration: 0`
  - `Condition: None`
