---
title: CHAR_Militia_Guard_Servant
guid: -1447279513
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-997126525)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Militia_Guard_Servant PrefabGuid(-1447279513)`
...
- **[1]**
  - `BaseAbilityGroupOnSlot: GUID Not Found`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Militia_Guard_Block_AbilityGroup PrefabGuid(-485166585)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
