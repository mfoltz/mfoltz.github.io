---
title: AB_ChurchOfLight_Overseer_IceRink_Cast
guid: 741418411
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Overseer_IceRink_Cast PrefabGuid(741418411)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_IceRink_IceAreaThrow PrefabGuid(-114379501)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Overseer_IceRink_IcicleTrigger PrefabGuid(-2059503476)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
