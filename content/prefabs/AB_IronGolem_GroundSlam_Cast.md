---
title: AB_IronGolem_GroundSlam_Cast
guid: 1053556192
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_IronGolem_GroundSlam_Cast PrefabGuid(1053556192)`
...
- **[0]**
  - `SpawnPrefab: AB_IronGolem_GroundSlam_Hit PrefabGuid(1137710018)`
