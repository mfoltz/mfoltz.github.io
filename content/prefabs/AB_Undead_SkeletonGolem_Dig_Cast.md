---
title: AB_Undead_SkeletonGolem_Dig_Cast
guid: 454659105
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Undead_SkeletonGolem_Dig_Cast PrefabGuid(454659105)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_SkeletonGolem_Dig_UndergroudBuff PrefabGuid(580160506)`
...
- **[0]**
  - `SpawnPrefab: AB_Undead_SkeletonGolem_Dig_TailBuff PrefabGuid(892457475)`
  - `BuffDuration: 0`
  - `Condition: None`
