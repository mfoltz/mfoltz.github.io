---
title: AB_Militia_Heavy_ShieldBash_Cast
guid: 2095640768
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Heavy_ShieldBash_Cast PrefabGuid(2095640768)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Heavy_ShieldBash_Hit PrefabGuid(734492476)`
