...
- **[0]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 1110856426`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
...
- **[4]**
  - `NextTriggerTime: 0`
  - `TriggerCooldown: 0`
  - `GameplayEventId: Local - 199234326`
  - `MaxTriggers: 0`
  - `CurrentTriggers: 0`
  - `TriggerMultipleTimes: True`
...
- **[0]**
  - `SpawnPrefab: AB_Chaos_Volley_Projectile_First PrefabGuid(-2086760208)`
...
- **[1]**
  - `SpawnPrefab: AB_Chaos_Volley_Projectile_Second PrefabGuid(173993548)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
  - `Owner: ProjectM.SpawnPrefabOnGameplayEventOwner Inherit`
  - `Creator: ProjectM.SpawnPrefabOnGameplayEventCreator Inherit`
