---
title: Item_Weapon_Crossbow_Legendary_T08_Shattered
guid: 2061238391
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Crossbow_Legendary_T08_Shattered PrefabGuid(2061238391) - Entity(11172:1)`
  - `ItemTypeGUID: Item_Weapon_Crossbow_Legendary_T08_Shattered PrefabGuid(2061238391)`
...
- [ProjectM.ShatteredItem]({{% relref "components/ShatteredItem.md" %}})
  - `RequiredItem: Item_Weapon_Crossbow_T08_Sanguine PrefabGuid(1389040540)`
  - `OutputItem: Item_Weapon_Crossbow_Legendary_T08 PrefabGuid(935392085)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 3800`
  - `MaxDurability: 3800`
  - `RepairRecipe: Recipe_Weapon_Crossbow_T08_Sanguine PrefabGuid(-1064000514)`
...
- [ProjectM.Shared.GeneratedName]({{% relref "components/GeneratedName.md" %}})
  - `RandomNamePrefix: 0`
  - `RandomNamePostfix: 0`
  - `NameGeneratorPrefixSource: Item_Weapon_Crossbow_Legendary_NameGenerator_T08 PrefabGuid(1716435762)`
  - `NameGeneratorPostfixSource: Item_Weapon_Crossbow_Legendary_NameGenerator_T08 PrefabGuid(1716435762)`
...
- **[0]**
  - `ItemId: Item_Weapon_Crossbow_T08_Sanguine PrefabGuid(1389040540)`
  - `Amount: 1`
