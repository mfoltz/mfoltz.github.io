---
title: AB_Cursed_ToadKing_TongueGrab_Cast
guid: 1041279611
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_ToadKing_TongueGrab_Cast PrefabGuid(1041279611)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_ToadKing_TongueGrab_Hit1 PrefabGuid(-1240825455)`
