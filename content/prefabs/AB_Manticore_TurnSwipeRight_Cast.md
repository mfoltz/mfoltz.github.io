---
title: AB_Manticore_TurnSwipeRight_Cast
guid: 1573039480
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Manticore_TurnSwipeRight_Cast PrefabGuid(1573039480)`
...
- **[0]**
  - `SpawnPrefab: AB_Manticore_TurnSwipeRight_ProjectileSpawner PrefabGuid(603993577)`
...
- **[1]**
  - `SpawnPrefab: AB_Manticore_TurnSwipeRight_MeleeHit PrefabGuid(751756165)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
