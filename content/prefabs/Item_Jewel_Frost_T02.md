...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Frost_T02 PrefabGuid(1030854657) - Entity(11651:1)`
  - `ItemTypeGUID: Item_Jewel_Frost_T02 PrefabGuid(1030854657)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Frost_T02 PrefabGuid(-1982816801)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
