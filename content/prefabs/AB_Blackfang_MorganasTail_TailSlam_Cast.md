---
title: AB_Blackfang_MorganasTail_TailSlam_Cast
guid: 725885534
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_MorganasTail_TailSlam_Cast PrefabGuid(725885534)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_MorganasTail_TailSlam_Hit PrefabGuid(733131428)`
