---
title: AB_Blackfang_Morgana_SpectralBeamEmerge_Cast02
guid: 219174627
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_SpectralBeamEmerge_Cast02 PrefabGuid(219174627)`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Morgana_SpectralBeamEmerge_EndTrigger PrefabGuid(-895629603)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
