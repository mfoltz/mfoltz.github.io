---
title: AB_Blackfang_CarverBoss_MegaChopLeap_Cast01
guid: -1113063271
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_CarverBoss_MegaChopLeap_Cast01 PrefabGuid(-1113063271)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_MegaChopLeap_Travel PrefabGuid(1445522819)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_CarverBoss_MegaChopLeap_AggroBuff PrefabGuid(-1047968169)`
