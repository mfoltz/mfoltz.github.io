...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(2057596959)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0.1`
  - `WoundedTriggerSequenceGuid: SequenceGUID 231157382`
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 36.877094`
  - `SpellPower: 36.877094`
  - `ResourcePower: 26.8`
  - `SiegePower: 12.4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_Guardian PrefabGuid(-2045826902)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Guardian_AttackChain_Group PrefabGuid(1254118139)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Guardian_Block_AbilityGroup PrefabGuid(-313746247)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Guardian_Charge_AbilityGroup PrefabGuid(-955554663)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Undead_Guardian_ChargeFollowUp_AbilityGroup PrefabGuid(124368471)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_Undead_Normal_Rank02 PrefabGuid(891253714)`
