...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Frost_T04 PrefabGuid(-147757377) - Entity(11661:1)`
  - `ItemTypeGUID: Item_Jewel_Frost_T04 PrefabGuid(-147757377)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Frost_T04 PrefabGuid(1220982133)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
