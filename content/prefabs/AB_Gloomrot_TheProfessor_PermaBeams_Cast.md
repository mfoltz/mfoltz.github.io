---
title: AB_Gloomrot_TheProfessor_PermaBeams_Cast
guid: -1591210303
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Gloomrot_TheProfessor_PermaBeams_Cast PrefabGuid(-1591210303)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_PermaBeams_Trigger PrefabGuid(-888582520)`
...
- **[0]**
  - `SpawnPrefab: AB_Gloomrot_TheProfessor_PermaBeams_Immaterial PrefabGuid(-924837566)`
  - `BuffDuration: 0`
  - `Condition: None`
