---
title: TM_Castle_Floor_InvisibleFloor
guid: 1289169078
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Floor_InvisibleFloor PrefabGuid(1289169078) - Entity(6896:3)`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
  - `FloorType: ProjectM.CastleBuilding.CastleFloorTypes None`
  - `RoofType: ProjectM.Roofs.RoofCategoryType None`
...
- [ProjectM.CastleBuilding.RequireGroundedTag]({{% relref "components/RequireGroundedTag.md" %}})
