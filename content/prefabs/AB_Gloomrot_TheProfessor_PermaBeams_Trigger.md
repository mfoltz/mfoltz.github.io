...
- [ProjectM.Gameplay.Scripting.Script_CreateProfessorCoilEvent_DataServer]({{% relref "components/Script_CreateProfessorCoilEvent_DataServer.md" %}})
  - `EventType: ProjectM.Gameplay.Scripting.ProfessorCoilEventType PredefinedSequence`
  - `BeamCount: 3`
  - `PreviewTime: 3`
  - `BlastTime: 9999`
  - `Range: 25`
...
- [ProjectM.ProfessorCoilEvent_PredefinedSequence]({{% relref "components/ProfessorCoilEvent_PredefinedSequence.md" %}})
