...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Storm_T02 PrefabGuid(876293388) - Entity(11739:1)`
  - `ItemTypeGUID: Item_Jewel_Storm_T02 PrefabGuid(876293388)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Storm_T02 PrefabGuid(687440022)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
