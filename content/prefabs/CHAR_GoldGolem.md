...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1171440258)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acgfkchbiek`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_GoldGolem PrefabGuid(435261072)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_MeleeAttack_AbilityGroup PrefabGuid(1770841962)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_RockSlam_AbilityGroup PrefabGuid(92820140)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_Enrage_AbilityGroup PrefabGuid(-963623992)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_FallAsleep_Buff_AbilityGroup PrefabGuid(-685952199)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_Awake_Group PrefabGuid(-1656534946)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[5]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_Enrage_FistSlam_AbilityGroup PrefabGuid(-645101263)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[6]**
  - `BaseAbilityGroupOnSlot: AB_GoldGolem_AggroTarget_AbilityGroup PrefabGuid(72734316)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  ...
  - `Buff1: AB_GoldGolem_Invulnerability_Buff PrefabGuid(-748498013)`
...
- **[1]**
  ...
  - `Buff: Buff_General_Spawn_VBlood_Lucie_GoldGolem PrefabGuid(231346515)`
  - `OriginPositionFactor: 0`
  - `Weight: 1`
