---
title: AB_Spear_AThousandSpears_Stab_Channel
guid: -657549570
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Spear_AThousandSpears_Stab_Channel
...
- **[0]**
  - `SpawnPrefab: AB_Spear_AThousandSpears_Stab_Hit PrefabGuid(-1662516734)`
...
- **[0]**
  ...
  - `Slot: -1`
  - `ReplaceGroupId: AB_Spear_AThousandSpears_Stab_AbilityGroup PrefabGuid(377778793)`
  - `NewGroupId: AB_Spear_AThousandSpears_Recast_Impale_Group PrefabGuid(1250277114)`
  - `Priority: 1`
  - `Condition: None`
