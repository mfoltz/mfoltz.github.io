---
title: CHAR_Undead_SkeletonApprentice
guid: -1789347076
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 20.960276`
  - `SpellPower: 20.960276`
  - `ResourcePower: 18.8`
  - `SiegePower: 8.4`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_SkeletonApprentice PrefabGuid(1190623805)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Undead_SkeletonApprentice_Projectile_AbilityGroup PrefabGuid(-20539715)`
  - `ShowOnBar: True`
