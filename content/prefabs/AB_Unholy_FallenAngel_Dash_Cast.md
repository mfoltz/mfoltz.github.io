---
title: AB_Unholy_FallenAngel_Dash_Cast
guid: 1210009422
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Unholy_FallenAngel_Dash_Cast PrefabGuid(1210009422)`
...
- **[0]**
  - `SpawnPrefab: AB_Unholy_FallenAngel_Dash_Phase PrefabGuid(792307863)`
