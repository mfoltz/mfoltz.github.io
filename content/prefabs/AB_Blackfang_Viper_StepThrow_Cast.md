---
title: AB_Blackfang_Viper_StepThrow_Cast
guid: 1919046105
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Viper_StepThrow_Cast PrefabGuid(1919046105)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Viper_StepThrow_Projectile PrefabGuid(1334247937)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Viper_StepThrow_DashBuff PrefabGuid(-1455991071)`
  - `BuffDuration: 0.5`
  - `Condition: None`
