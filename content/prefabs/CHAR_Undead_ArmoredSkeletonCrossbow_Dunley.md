---
title: CHAR_Undead_ArmoredSkeletonCrossbow_Dunley
guid: -861407720
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 25.273851`
  - `SpellPower: 25.273851`
  - `ResourcePower: 19.539999`
  - `SiegePower: 11.6`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Undead_ArmoredSkeletonCrossbow_Dunley PrefabGuid(-863225659)`
