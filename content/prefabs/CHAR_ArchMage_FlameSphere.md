---
title: CHAR_ArchMage_FlameSphere
guid: 2138173476
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1242547076)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0.01`
  - `WoundedTriggerSequenceGuid: SequenceGUID -1842232727`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_acjjchgdejc`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_ArchMage_FlameSphere PrefabGuid(-1756104221)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_ArchMage_FlameSphere_Dash_AbilityGroup PrefabGuid(-1754787506)`
  - `ShowOnBar: True`
...
- **[1]**
  ...
  - `OverrideDuration: Il2CppSystem.Nullable_Unboxed`1[System.Single]`
  - `Stacks: 1`
  - `Buff0: AB_ArchMage_FlameSphere_AreaInitBuff PrefabGuid(451676082)`
  - `Buff1: GUID Not Found`
  - `Buff2: GUID Not Found`
  - `Buff3: GUID Not Found`
  - `EventOnConsume: Local - 0`
...
- **320 total elements but only showing the first 36**
