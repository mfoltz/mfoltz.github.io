---
title: AB_Corrupted_Wolf_SlaveringBite_Cast
guid: 227492828
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Corrupted_Wolf_SlaveringBite_Cast PrefabGuid(227492828)`
...
- **[0]**
  - `SpawnPrefab: AB_Corrupted_Wolf_SlaveringBite_Hit PrefabGuid(2118909752)`
