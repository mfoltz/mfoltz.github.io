---
title: CHAR_Bandit_Leader_Wolf_Summon
guid: -671059374
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.UnitStats]({{% relref "components/UnitStats.md" %}})
  - `PhysicalPower: 9.8233595`
  - `SpellPower: 9.8233595`
  - `ResourcePower: 8.32`
  - `SiegePower: 4.8`
...
- [ProjectM.GenericCombatMovementData]({{% relref "components/GenericCombatMovementData.md" %}})
  - `MinDistance: 0.1`
  - `GoalDistanceInner: 1.9`
  - `GoalDistanceOuter: 1.9`
  - `MaxDistance: 4`
  - `MovePattern: 1`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cbfdhbkddk`

- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Bandit_Leader_Wolf_Summon PrefabGuid(-1528391757)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Shared_MeleeAttack_Group PrefabGuid(556902791)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Wolf_Shared_DashAttack_AbilityGroup PrefabGuid(-744145902)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
