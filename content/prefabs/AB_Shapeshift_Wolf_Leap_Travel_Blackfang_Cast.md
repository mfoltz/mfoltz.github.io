---
title: AB_Shapeshift_Wolf_Leap_Travel_Blackfang_Cast
guid: 722131933
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Shapeshift_Wolf_Leap_Travel_Blackfang_Cast
...
- [ProjectM.AbilityState](/components/AbilityState)
  - `AbilityId: AB_Shapeshift_Wolf_Leap_Travel_Blackfang_Cast PrefabGuid(722131933)`
...
- **[0]**
  - `SpawnPrefab: AB_Shapeshift_Wolf_Leap_Travel_Blackfang_Phase PrefabGuid(1489317139)`
...
- **[1]**
  - `SpawnPrefab: AB_Shapeshift_Wolf_Leap_Travel_Blackfang_Buff PrefabGuid(-1075909278)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
