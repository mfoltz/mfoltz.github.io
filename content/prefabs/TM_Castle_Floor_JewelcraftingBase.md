---
title: TM_Castle_Floor_JewelcraftingBase
guid: 691024400
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Castle_Floor_JewelcraftingBase PrefabGuid(691024400) - Entity(14187:3)`
  - `Guid: TM_Castle_Floor_JewelcraftingBase PrefabGuid(691024400)`
...
- [ProjectM.CastleBuilding.CastleFloor]({{% relref "components/CastleFloor.md" %}})
  - `FloorType: ProjectM.CastleBuilding.CastleFloorTypes Temple`
