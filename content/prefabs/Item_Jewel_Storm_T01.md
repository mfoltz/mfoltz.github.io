...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Storm_T01 PrefabGuid(-560146452) - Entity(11771:1)`
  - `ItemTypeGUID: Item_Jewel_Storm_T01 PrefabGuid(-560146452)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Storm_T01 PrefabGuid(81501826)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Topaz_T01 PrefabGuid(867351268)`
  - `Amount: 1`
