...
- [ProjectM.Gameplay.Scripting.Script_Buff_IgnoresPathfindingLineOfSight_DataServer]({{% relref "components/Script_Buff_IgnoresPathfindingLineOfSight_DataServer.md" %}})
  - `ModId: Unset`
