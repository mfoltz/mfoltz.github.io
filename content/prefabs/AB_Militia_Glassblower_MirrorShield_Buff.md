---
title: AB_Militia_Glassblower_MirrorShield_Buff
guid: 1312286201
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Militia_Glassblower_MirrorShield_Buff
...
- [ProjectM.Gameplay.Scripting.AbilityProjectileFanOnGameplayEvent_DataServer](/components/AbilityProjectileFanOnGameplayEvent_DataServer)
  ...
  - `RandomOffset: 0`
  - `IndividualRandom: 0`
  - `NewProjectileEntity: AB_Militia_Glassblower_MirrorShield_Projectile PrefabGuid(706976478)`
  ...
  - `OverrideProjectileSpeedMin: 16`
  - `OverrideProjectileSpeedMax: 28`
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Militia_Glassblower_MirrorShield_RotationBuff PrefabGuid(796519131)`
...
- **[0]**
  - `SequenceGuid: SequenceGUID -1053570709`
