...
- [ProjectM.Gameplay.Scripting.Script_SommelierHorizontalBarrels_DataServer]({{% relref "components/Script_SommelierHorizontalBarrels_DataServer.md" %}})
...
- [ProjectM.Gameplay.Scripting.BarrelIds]({{% relref "components/BarrelIds.md" %}})
