---
title: MapIcon_WorldWaypoint_Active
guid: -1510127174
categories: ['All', 'Map']
nav_exclude: true
search_exclude: true
...
- [ProjectM.MapIconData]({{% relref "components/MapIconData.md" %}})
  - `HeaderLocalizedKey: 627c63df-7f72-47d0-8b83-c92d31b6fdef - Vampire Waygate`
...
- [ProjectM.WaypointMapIcon]({{% relref "components/WaypointMapIcon.md" %}})
  - `TargetNetworkId: ProjectM.Network.NetworkId (None)`
  - `IsLocked: False`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_kijdhbiid`
