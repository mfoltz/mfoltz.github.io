...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-334658510)`
...
- [ProjectM.WoundedConstants]({{% relref "components/WoundedConstants.md" %}})
  - `HealthFactor: 0.3`
  - `WoundedTriggerSequenceGuid: SequenceGUID -1298378053`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_Vampire_Withered PrefabGuid(-1184790773)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Vampire_Withered_SlowAttack_Group PrefabGuid(-593875444)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Generic_BehaviourVariationApproch_Group PrefabGuid(-447578631)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Generic_BehaviourVariationCircleClose_Group PrefabGuid(-2125818102)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Generic_BehaviourVariationCircleMid_Group PrefabGuid(-1357699119)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Generic_BehaviourVariationCircleFar_Group PrefabGuid(903306477)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Noctem_WItheredVampire PrefabGuid(-1147731982)`
