...
- [ProjectM.CastleBuilding.CastleRoomFloorsBuffer]({{% relref "components/CastleRoomFloorsBuffer.md" %}})

- [ProjectM.CastleBuilding.CastleRoomWallsBuffer]({{% relref "components/CastleRoomWallsBuffer.md" %}})

- [ProjectM.CastleBuilding.CastleRoomWorkstationsBuffer]({{% relref "components/CastleRoomWorkstationsBuffer.md" %}})
