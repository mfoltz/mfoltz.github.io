---
title: Item_Weapon_Slashers_Legendary_T08_Shattered
guid: 1271087499
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Slashers_Legendary_T08_Shattered PrefabGuid(1271087499) - Entity(11177:1)`
  - `ItemTypeGUID: Item_Weapon_Slashers_Legendary_T08_Shattered PrefabGuid(1271087499)`
...
- [ProjectM.ShatteredItem]({{% relref "components/ShatteredItem.md" %}})
  - `RequiredItem: Item_Weapon_Slashers_T08_Sanguine PrefabGuid(1322545846)`
  - `OutputItem: Item_Weapon_Slashers_Legendary_T08 PrefabGuid(821410795)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 3800`
  - `MaxDurability: 3800`
  - `RepairRecipe: Recipe_Weapon_Slashers_T08_Sanguine PrefabGuid(373339628)`
...
- [ProjectM.Shared.GeneratedName]({{% relref "components/GeneratedName.md" %}})
  - `RandomNamePrefix: 0`
  - `RandomNamePostfix: 0`
  - `NameGeneratorPrefixSource: Item_Weapon_Slashers_Legendary_NameGenerator_T08 PrefabGuid(810808231)`
  - `NameGeneratorPostfixSource: Item_Weapon_Slashers_Legendary_NameGenerator_T08 PrefabGuid(810808231)`
...
- **[0]**
  - `ItemId: Item_Weapon_Slashers_T08_Sanguine PrefabGuid(1322545846)`
  - `Amount: 1`
