---
title: AB_VHunter_CastleMan_ChaseTargetBuff_Cast
guid: 1574024896
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_VHunter_CastleMan_ChaseTargetBuff_Cast PrefabGuid(1574024896)`
...
- **[0]**
  - `SpawnPrefab: AB_VHunter_CastleMan_ChaseTargetBuff_RageBuff PrefabGuid(1035183129)`
