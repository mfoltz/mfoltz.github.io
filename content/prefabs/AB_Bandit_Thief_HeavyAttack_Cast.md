---
title: AB_Bandit_Thief_HeavyAttack_Cast
guid: 1927151107
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_Thief_HeavyAttack_Cast PrefabGuid(1927151107)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Thief_HeavyAttack_Hit PrefabGuid(1509293541)`
