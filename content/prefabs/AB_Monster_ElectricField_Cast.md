---
title: AB_Monster_ElectricField_Cast
guid: -698139719
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Monster_ElectricField_Cast PrefabGuid(-698139719)`
...
- [ProjectM.MoveStopAbilityData]({{% relref "components/MoveStopAbilityData.md" %}})
  - `Radius: 1`
  - `UnitAngle: 45`
  - `ResourceAngle: 15`
...
- **[0]**
  - `SpawnPrefab: AB_Monster_ElectricField_Trigger1 PrefabGuid(1083083247)`
...
- **[1]**
  - `SpawnPrefab: AB_Monster_ElectricField_Trigger2 PrefabGuid(-504585202)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[2]**
  - `SpawnPrefab: AB_Monster_ElectricField_Trigger4 PrefabGuid(461639256)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[3]**
  - `SpawnPrefab: AB_Monster_ElectricField_Trigger3 PrefabGuid(-838376627)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[4]**
  - `SpawnPrefab: AB_Monster_ElectricField_Trigger5 PrefabGuid(-1552062815)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- **[5]**
  - `SpawnPrefab: AB_Monster_FinalStage_AreaKnockback PrefabGuid(-55604971)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
