---
title: AB_Bandit_StoneBreaker_VBlood_RockSmash_Cast
guid: 852775925
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_StoneBreaker_VBlood_RockSmash_Cast PrefabGuid(852775925)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_VBlood_RockSmash_Projectile PrefabGuid(1173431424)`
...
- **[1]**
  - `SpawnPrefab: AB_Bandit_StoneBreaker_VBlood_RockSmash_Hit PrefabGuid(-1202407466)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
