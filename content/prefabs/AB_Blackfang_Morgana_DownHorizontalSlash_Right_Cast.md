---
title: AB_Blackfang_Morgana_DownHorizontalSlash_Right_Cast
guid: -1844243668
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_DownHorizontalSlash_Right_Cast PrefabGuid(-1844243668)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DownHorizontalSlash_Right_InitialHit PrefabGuid(1021234102)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_DownHorizontalSlash_Right_FollowupHitBuff PrefabGuid(-1980410717)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
