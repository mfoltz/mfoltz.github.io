---
title: AB_Corrupted_Wolf_CorruptionCharged_Cast
guid: 730303038
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Corrupted_Wolf_CorruptionCharged_Cast PrefabGuid(730303038)`
...
- **[0]**
  - `SpawnPrefab: AB_Corrupted_Wolf_CorruptionCharged_Buff PrefabGuid(630211818)`
