---
title: AB_Blackfang_Valyr_PhaseDual_SeismicJump_Cast02
guid: 1505658358
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Valyr_PhaseDual_SeismicJump_Cast02 PrefabGuid(1505658358)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseDual_SeismicJump_Projectile02 PrefabGuid(783824917)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Valyr_PhaseDual_SeismicJump_InitDamage02 PrefabGuid(991508961)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
