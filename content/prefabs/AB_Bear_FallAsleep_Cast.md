...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bear_FallAsleep_Cast PrefabGuid(1221985602)`
...
- **[0]**
  - `SpawnPrefab: AB_Bear_FallAsleep_SleepingIdle_Buff PrefabGuid(-883762685)`
