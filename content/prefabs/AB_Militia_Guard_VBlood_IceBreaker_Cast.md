---
title: AB_Militia_Guard_VBlood_IceBreaker_Cast
guid: -324287935
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_Guard_VBlood_IceBreaker_Cast PrefabGuid(-324287935)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_Guard_VBlood_IceBreaker_Hit PrefabGuid(628554069)`
...
- **[1]**
  - `SpawnPrefab: AB_Militia_Guard_VBlood_IceBreaker_WasTargetedBuff PrefabGuid(-411910491)`
