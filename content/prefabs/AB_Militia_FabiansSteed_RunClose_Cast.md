---
title: AB_Militia_FabiansSteed_RunClose_Cast
guid: -617347533
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Militia_FabiansSteed_RunClose_Cast PrefabGuid(-617347533)`
...
- **[0]**
  - `SpawnPrefab: AB_Militia_FabiansSteed_RunClose_Buff PrefabGuid(-38800429)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Militia_FabiansSteed_RunClose_MounterBuff PrefabGuid(-863496809)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
