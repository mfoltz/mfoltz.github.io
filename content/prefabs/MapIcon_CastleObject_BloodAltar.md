---
title: MapIcon_CastleObject_BloodAltar
guid: -1639620581
categories: ['All', 'Map']
nav_exclude: true
search_exclude: true
...
- [ProjectM.MapIconData]({{% relref "components/MapIconData.md" %}})
  - `HeaderLocalizedKey: ee2b6a64-6c77-4f8a-906b-246d926b9c0a - Altar of Recollection`
  ...
  - `ShowOutsideVision: False`
  - `RequiresReveal: False`
  - `CustomImplementation: False`
  - `AllySetting: ProjectM.MapIconShowSettings InVision`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_gjgidfgeh`
