---
title: AB_Bandit_Worker_Miner_Mine_Cast
guid: 156862047
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Bandit_Worker_Miner_Mine_Cast PrefabGuid(156862047)`
...
- **[0]**
  - `SpawnPrefab: AB_Bandit_Worker_Miner_Mine_Hit PrefabGuid(126204861)`
