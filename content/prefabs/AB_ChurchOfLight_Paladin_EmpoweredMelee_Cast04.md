---
title: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast04
guid: 397691284
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Paladin_EmpoweredMelee_Cast04 PrefabGuid(397691284)`
...
- [ProjectM.Gameplay.Scripting.Script_MultiShot_Cast_DataServer]({{% relref "components/Script_MultiShot_Cast_DataServer.md" %}})
  - `Angle: 0.5235988`
  - `OffsetAllAngles: 0`
  - `NewProjectile: AB_ChurchOfLight_Paladin_EmpoweredMelee_MainProjectile PrefabGuid(-207975116)`
  - `Count: 2`
  - `Condition: None`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_EmpoweredMelee_Hit04 PrefabGuid(-1041912276)`
