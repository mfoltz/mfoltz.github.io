---
title: AB_Blood_SanguineCoil_AbilityGroup
guid: 189403977
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Blood_SanguineCoil_AbilityGroup
...
- [ProjectM.AbilityGroupResetComboState](/components/AbilityGroupResetComboState)
  - `ComboResetTime: 0`
  - `ComboResetDuration: 2`

- [ProjectM.SpellModAbilityGroupCharges](/components/SpellModAbilityGroupCharges)
  - `SpellMod: SpellMod_Shared_AddCharges PrefabGuid(-1721922606)`
  - `Count: 1`
...
- [ProjectM.AbilityGroupInfo](/components/AbilityGroupInfo)
  ...
  - `MinRange: 0`
  - `MaxRange: 12`
  - `BehaviorType: ProjectM.AbilityBehaviorType Projectile`
  - `InputType: ProjectM.AbilityInputCastType Default`
  - `Target: ProjectM.AbilitySpawnTarget Owner`

- [ProjectM.AbilityGroupComboState](/components/AbilityGroupComboState)
  - `ComboIndex: 0`
  - `ComboLength: 2`

- [ProjectM.VBloodAbilityData](/components/VBloodAbilityData)
  - `AbilityType: ProjectM.AbilityTypeEnum SpellSlot1`
  - `AbilitySchool: ProjectM.AbilitySchoolType Blood`
  - `AbilityTooltipType: ProjectM.AbilityTooltipType None`

- [ProjectM.AbilitySpellSchool](/components/AbilitySpellSchool)
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot)
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_cbjidfdhfg`
...
- [ProjectM.Shared.AbilityJewelTemplate](/components/AbilityJewelTemplate)
...
- **[0]**
  - `PrefabGUID: AB_Blood_SanguineCoil_Cast01 PrefabGuid(-443292115)`

- **[1]**
  - `PrefabGUID: AB_Blood_SanguineCoil_Cast02 PrefabGuid(1200039838)`
...
- **140 total elements but only showing the first 36**
