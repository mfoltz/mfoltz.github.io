...
- [ProjectM.AbilityGroupComboState]({{% relref "components/AbilityGroupComboState.md" %}})
  - `ComboIndex: 0`
  - `ComboLength: 2`

- [ProjectM.VBloodAbilityData]({{% relref "components/VBloodAbilityData.md" %}})
...
- [ProjectM.AbilitySpellSchool]({{% relref "components/AbilitySpellSchool.md" %}})
...
- [ProjectM.Shared.AbilityJewelTemplate]({{% relref "components/AbilityJewelTemplate.md" %}})
