---
title: AB_Blackfang_Morgana_TravelToPosition_Swarm_Cast
guid: 478929064
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Morgana_TravelToPosition_Swarm_Cast PrefabGuid(478929064)`
...
- [ProjectM.Network.MoveDuringCastData]({{% relref "components/MoveDuringCastData.md" %}})
  - `ManualDuration: 1`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_TravelToPosition_Trigger PrefabGuid(-1307922425)`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_TravelToPosition_ImmaterialBuff PrefabGuid(-99719403)`
...
- **[2]**
  - `SpawnPrefab: AB_Blackfang_Morgana_TravelToPosition_Swarm_Thrower PrefabGuid(-730747480)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
...
- [ProjectM.AbilitySpawnPrefabOnStartCast]({{% relref "components/AbilitySpawnPrefabOnStartCast.md" %}})

- **[0]**
  - `SpawnPrefab: AB_Blackfang_Morgana_LoomingMists_Area_Dive PrefabGuid(-1664779682)`
  - `BuffDuration: 0`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Blackfang_Morgana_TravelToPosition_Swarm_CastTrackerBuff PrefabGuid(-1495038629)`
  - `BuffDuration: 0`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
