---
title: AB_ChurchOfLight_Paladin_Melee_Cast02
guid: -297122786
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_ChurchOfLight_Paladin_Melee_Cast02 PrefabGuid(-297122786)`
...
- **[0]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_Melee_Hit02 PrefabGuid(32333759)`
...
- **[1]**
  - `SpawnPrefab: AB_ChurchOfLight_Paladin_Melee_MainProjectile PrefabGuid(390812503)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
