---
title: CHAR_Gloomrot_Technician_Labworker_Servant
guid: -1034892278
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(1492511376)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Gloomrot_Technician_Labworker_Servant PrefabGuid(-1034892278)`
...
- [ProjectM.BloodConsumeSource](/components/BloodConsumeSource)
  ...
  - `BloodQuality: -1`
  - `UnitBloodType: ModifiablePrefabGUID PrefabGuid(-1776904174)`
...
- [ProjectM.CanPreventDisableWhenNoPlayersInRange](/components/CanPreventDisableWhenNoPlayersInRange)
  - `CanDisable: True`
...
- [ProjectM.GenericCombatMovementData](/components/GenericCombatMovementData)
  - `MinDistance: 0`
  - `GoalDistanceInner: 1.3`
  - `GoalDistanceOuter: 1.3`
  - `MaxDistance: 1.5`
  - `MovePattern: 0`
  - `ForceLookAtTarget: 0`
  - `CircleCurveInRange: ProjectM.CurveReference ProjectM.CurveReference`
...
- [ProjectM.Network.NetworkSnapshot](/components/NetworkSnapshot)
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_ajkbgeijih`

- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Gloomrot_Technician_Servant PrefabGuid(205365360)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Gloomrot_Technician_MeleeAttack_AbilityGroup PrefabGuid(-749335766)`
  - `ShowOnBar: True`
...
- **496 total elements but only showing the first 36**
...
- **[0]**
  - `DropTableGuid: DT_Unit_Gloomrot_Rank01 PrefabGuid(-1024925083)`
...
- [ProjectM.CharmSource](/components/CharmSource)
