...
- [ProjectM.CastOptionsUser]({{% relref "components/CastOptionsUser.md" %}})
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1999640100)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding]({{% relref "components/BehaviourTreeBinding.md" %}})
  - `PrefabGUID: BEH_RockElemental PrefabGuid(900390403)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_RockElemental_MeleeAttack_AbilityGroup PrefabGuid(-560639220)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_RockElemental_Rollout_AbilityGroup PrefabGuid(-150520781)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_RockElemental_Leap_AbilityGroup PrefabGuid(294532069)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_RockElemental_FallAsleep_Buff_AbilityGroup PrefabGuid(-1924288461)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_RockElemental_Awake_AbilityGroup PrefabGuid(-2050883182)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
...
- **[0]**
  - `DropTableGuid: DT_Unit_Dunley_RockElemental PrefabGuid(1042687092)`
