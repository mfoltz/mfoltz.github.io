---
title: AB_Wendigo_IceDash_Travel_Cast
guid: 955349764
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Wendigo_IceDash_Travel_Cast PrefabGuid(955349764)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IceDash_Travel_DashBuff PrefabGuid(1854395476)`
  - `BuffDuration: 1.2`
  - `Condition: None`
...
- **[1]**
  - `SpawnPrefab: AB_Wendigo_IceDash_EmpowerBuff PrefabGuid(-1991229776)`
  - `BuffDuration: 4`
  - `Condition: None`
  - `DestroyWhenCastDone: False`
  - `Target: ProjectM.AbilitySpawnPrefabOnStartCast+SpawnTarget Owner`
