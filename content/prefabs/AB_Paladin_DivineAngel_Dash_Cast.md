---
title: AB_Paladin_DivineAngel_Dash_Cast
guid: 1425523189
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Paladin_DivineAngel_Dash_Cast PrefabGuid(1425523189)`
...
- **[0]**
  - `SpawnPrefab: AB_Paladin_DivineAngel_Dash_Phase PrefabGuid(-1731620709)`
...
- **[1]**
  - `SpawnPrefab: Buff_Paladin_DivineAngel_ChaseBuff PrefabGuid(1277289010)`
  - `Target: ProjectM.AbilitySpawnTarget Owner`
  - `TargetEntity: Entity(0:0)`
  - `HoverDistance: 0`
  - `HoverCondition: None`
