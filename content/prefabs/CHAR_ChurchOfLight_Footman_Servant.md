---
title: CHAR_ChurchOfLight_Footman_Servant
guid: -1719944550
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(142107315)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_ChurchOfLight_Footman_Servant PrefabGuid(-1719944550)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_ChurchOfLight_Footman_Servant PrefabGuid(1825095219)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Footman_Thrust_Group PrefabGuid(979394873)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[1]**
  - `BaseAbilityGroupOnSlot: AB_Footman_SideStep_Back_AbilityGroup PrefabGuid(-153669671)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[2]**
  - `BaseAbilityGroupOnSlot: AB_Footman_SideStep_Right_AbilityGroup PrefabGuid(30220474)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[3]**
  - `BaseAbilityGroupOnSlot: AB_Footman_SideStep_Left_AbilityGroup PrefabGuid(680715401)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`

- **[4]**
  - `BaseAbilityGroupOnSlot: AB_Footman_OnAggro_AbilityGroup PrefabGuid(530843430)`
  - `ShowOnBar: True`
  - `GroupSlotEntity: NetworkedEntity(0:0)`
