---
title: AB_Vampire_BloodKnight_ThousandSpears_Channel
guid: -2011991325
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_Vampire_BloodKnight_ThousandSpears_Channel
...
- **[0]**
  ...
  - `Stacks: 1`
  - `Buff0: AB_Vampire_BloodKnight_ThousandSpears_PostCastBuff PrefabGuid(-1843888919)`
...
- **[0]**
  - `SpawnPrefab: AB_Vampire_BloodKnight_ThousandSpears_Hit PrefabGuid(-42667970)`
  - `CustomAbilitySpellModsSource: GUID Not Found`
  - `SpellTarget: ProjectM.SetSpellTarget Default`
