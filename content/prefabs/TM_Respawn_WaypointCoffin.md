---
title: TM_Respawn_WaypointCoffin
guid: 2022796115
categories: ['All', 'TM']
nav_exclude: true
search_exclude: true
...
- [ProjectM.BlueprintData]({{% relref "components/BlueprintData.md" %}})
  - `Entity: Prefab TM_Respawn_WaypointCoffin PrefabGuid(2022796115) - Entity(12078:3)`
  - `Guid: TM_Respawn_WaypointCoffin PrefabGuid(2022796115)`
...
- [ProjectM.RespawnPoint]({{% relref "components/RespawnPoint.md" %}})
  - `SpawnExitOffset: Unity.Mathematics.float3 float3(0f, 0f, 0f)`
...
- [ProjectM.Network.NetworkSnapshot]({{% relref "components/NetworkSnapshot.md" %}})
  - `Type: ProjectM.Network.NetworkSnapshotType Snapshot_affkdifcge`
