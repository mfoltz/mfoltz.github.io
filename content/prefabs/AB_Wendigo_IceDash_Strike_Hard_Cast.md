---
title: AB_Wendigo_IceDash_Strike_Hard_Cast
guid: 715646522
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Wendigo_IceDash_Strike_Hard_Cast PrefabGuid(715646522)`
...
- **[0]**
  - `SpawnPrefab: AB_Wendigo_IceDash_Strike_Hard_Hit PrefabGuid(-1340519546)`
...
- **[1]**
  - `SpawnPrefab: AB_Wendigo_SnowStorm_TargetedBuff PrefabGuid(486057639)`
