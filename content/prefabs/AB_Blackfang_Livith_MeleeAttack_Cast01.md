---
title: AB_Blackfang_Livith_MeleeAttack_Cast01
guid: -1282189200
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Blackfang_Livith_MeleeAttack_Cast01 PrefabGuid(-1282189200)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Livith_MeleeAttack_Hit01 PrefabGuid(267995118)`
...
- **[0]**
  - `SpawnPrefab: AB_Blackfang_Livith_MeleeAttack_RotationBuff PrefabGuid(-1037056595)`
  - `BuffDuration: 0`
  - `Condition: None`
