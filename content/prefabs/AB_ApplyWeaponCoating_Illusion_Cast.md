---
title: AB_ApplyWeaponCoating_Illusion_Cast
guid: -237809887
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
# AB_ApplyWeaponCoating_Illusion_Cast
...
- [ProjectM.AbilityState]{{< relref "components/AbilityState.md" >}}
  - `AbilityId: AB_ApplyWeaponCoating_Illusion_Cast PrefabGuid(-237809887)`
...
- [ProjectM.AbilityInterruptData]{{< relref "components/AbilityInterruptData.md" >}}
  ...
  - `InterruptTypes: ProjectM.InterruptTypes ManualInterrupt, GameplayAbilities`
...
- **[0]**
  - `SpawnPrefab: AB_ApplyWeaponCoating_Illusion_Activate PrefabGuid(1197567253)`
