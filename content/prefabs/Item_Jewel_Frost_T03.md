...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Frost_T03 PrefabGuid(223899244) - Entity(11750:1)`
  - `ItemTypeGUID: Item_Jewel_Frost_T03 PrefabGuid(223899244)`
...
- [ProjectM.Shared.Salvageable]({{% relref "components/Salvageable.md" %}})
  - `RecipeGUID: Recipe_Jewel_Frost_T03 PrefabGuid(106264515)`
  - `SalvageFactor: 0.25`
  - `SalvageTimer: 8`
