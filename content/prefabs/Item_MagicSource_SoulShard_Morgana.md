...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_MagicSource_SoulShard_Morgana PrefabGuid(1286615355) - Entity(22668:1)`
  - `ItemTypeGUID: Item_MagicSource_SoulShard_Morgana PrefabGuid(1286615355)`
...
- [ProjectM.EquippableData]({{% relref "components/EquippableData.md" %}})
  - `BuffGuid: Item_EquipBuff_MagicSource_Soulshard_Morgana PrefabGuid(-251408621)`
...
- [ProjectM.Shared.Durability]({{% relref "components/Durability.md" %}})
  - `Value: 2500`
  - `MaxDurability: 2500`
  - `RepairRecipe: Recipe_MagicSource_General_T09_Morgana PrefabGuid(1129993300)`
...
- **[0]**
  - `Prefab: MapIcon_Relic_Standard_Morgana PrefabGuid(1172401273)`
