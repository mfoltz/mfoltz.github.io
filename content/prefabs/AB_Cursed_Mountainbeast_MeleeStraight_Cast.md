---
title: AB_Cursed_Mountainbeast_MeleeStraight_Cast
guid: 612816399
categories: ['AB', 'All']
nav_exclude: true
search_exclude: true
...
- [ProjectM.AbilityState]({{% relref "components/AbilityState.md" %}})
  - `AbilityId: AB_Cursed_Mountainbeast_MeleeStraight_Cast PrefabGuid(612816399)`
...
- **[0]**
  - `SpawnPrefab: AB_Cursed_Mountainbeast_MeleeStraight_Hit PrefabGuid(900655664)`
...
- **[1]**
  - `SpawnPrefab: AB_Cursed_MountainBeast_MeleeStraight_TargetedBuff PrefabGuid(-1704661869)`
