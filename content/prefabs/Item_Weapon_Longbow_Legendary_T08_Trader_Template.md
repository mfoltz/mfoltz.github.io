---
title: Item_Weapon_Longbow_Legendary_T08_Trader_Template
guid: 19130904
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Weapon_Longbow_Legendary_T08_Trader_Template PrefabGuid(19130904) - Entity(19533:1)`
  - `ItemTypeGUID: Item_Weapon_Longbow_Legendary_T08_Trader_Template PrefabGuid(19130904)`
...
- [ProjectM.Shared.LegendaryItemTemplate]({{% relref "components/LegendaryItemTemplate.md" %}})
  - `TemplateLevel: 88`
  - `TemplateWeaponType: ProjectM.WeaponType Longbow`
