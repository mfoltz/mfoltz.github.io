---
title: CHAR_Farmlands_Woodcutter_Standard_Servant
guid: -1659842473
categories: ['All', 'CHAR']
nav_exclude: true
search_exclude: true
...
- [ProjectM.CastOptionsUser](/components/CastOptionsUser)
  - `CastOptionsPrefab: ModifiablePrefabGUID PrefabGuid(-1620992523)`
...
- [ProjectM.ServantConvertable](/components/ServantConvertable)
  - `ConvertToUnit: CHAR_Farmlands_Woodcutter_Standard_Servant PrefabGuid(-1659842473)`
...
- [ProjectM.Behaviours.BehaviourTreeBinding](/components/BehaviourTreeBinding)
  - `PrefabGUID: BEH_Woodcutter_Servant PrefabGuid(-1997993074)`
...
- **[0]**
  - `BaseAbilityGroupOnSlot: AB_Woodcutter_MeleeAttack_Group01 PrefabGuid(845410366)`
  - `ShowOnBar: True`
