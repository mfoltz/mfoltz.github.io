---
title: Item_Jewel_Frost_T02_CrystalLance
guid: -390381611
categories: ['All', 'Item']
nav_exclude: true
search_exclude: true
...
- [ProjectM.ItemData]({{% relref "components/ItemData.md" %}})
  - `SilverValue: 1`
  - `Entity: Prefab Item_Jewel_Frost_T02_CrystalLance PrefabGuid(-390381611) - Entity(11741:1)`
  - `ItemTypeGUID: Item_Jewel_Frost_T02_CrystalLance PrefabGuid(-390381611)`
...
- [ProjectM.Shared.JewelInstance]({{% relref "components/JewelInstance.md" %}})
  ...
  - `TierIndex: 1`
  - `OverrideAbilityType: AB_Frost_CrystalLance_AbilityGroup PrefabGuid(295045820)`
  - `Initialized: False`
...
- **[0]**
  - `Guid: Item_Ingredient_Gem_Sapphire_T02 PrefabGuid(131015492)`
  - `Amount: 1`
